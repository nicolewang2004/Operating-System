...
0000000000000a66 <main>:
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     aa2:	9f248493          	addi	s1,s1,-1550 # 1490 <buf.1163>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa6:	06300913          	li	s2,99
     aaa:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aae:	00001a17          	auipc	s4,0x1
     ab2:	9e5a0a13          	addi	s4,s4,-1563 # 1493 <buf.1163+0x3>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b3c:	95850513          	addi	a0,a0,-1704 # 1490 <buf.1163>
