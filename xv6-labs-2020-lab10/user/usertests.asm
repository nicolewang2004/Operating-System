...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	f2250513          	addi	a0,a0,-222 # 5f60 <malloc+0x4b8>
      46:	00006097          	auipc	ra,0x6
      4a:	9a2080e7          	jalr	-1630(ra) # 59e8 <printf>
      exit(1);
      4e:	4505                	li	a0,1
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
    if(uninit[i] != '\0'){
      ...
      5c:	3987c783          	lbu	a5,920(a5) # 93f0 <uninit>
      60:	e385                	bnez	a5,80 <bsstest+0x28>
      62:	00009797          	auipc	a5,0x9
      66:	38f78793          	addi	a5,a5,911 # 93f1 <uninit+0x1>
      6a:	0000c697          	auipc	a3,0xc
      6e:	a9668693          	addi	a3,a3,-1386 # bb00 <buf>
      ...
      7e:	8082                	ret
{
      ...
      8e:	ef650513          	addi	a0,a0,-266 # 5f80 <malloc+0x4d8>
      92:	00006097          	auipc	ra,0x6
      96:	956080e7          	jalr	-1706(ra) # 59e8 <printf>
      exit(1);
      9a:	4505                	li	a0,1
...
00000000000000a4 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      b6:	ee650513          	addi	a0,a0,-282 # 5f98 <malloc+0x4f0>
  ...
  fd = open("doesnotexist", 0);
      ...
      d4:	ee850513          	addi	a0,a0,-280 # 5fb8 <malloc+0x510>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f4:	eb050513          	addi	a0,a0,-336 # 5fa0 <malloc+0x4f8>
      f8:	00006097          	auipc	ra,0x6
      fc:	8f0080e7          	jalr	-1808(ra) # 59e8 <printf>
    exit(1);
     100:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     110:	ebc50513          	addi	a0,a0,-324 # 5fc8 <malloc+0x520>
     114:	00006097          	auipc	ra,0x6
     118:	8d4080e7          	jalr	-1836(ra) # 59e8 <printf>
    exit(1);
     11c:	4505                	li	a0,1
...
0000000000000126 <truncate2>:
{
  ...
  int n = write(fd1, "x", 1);
     ...
     18a:	e8258593          	addi	a1,a1,-382 # 6008 <malloc+0x560>
     18e:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     1a2:	e5250513          	addi	a0,a0,-430 # 5ff0 <malloc+0x548>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1d8:	e3c50513          	addi	a0,a0,-452 # 6010 <malloc+0x568>
     1dc:	00006097          	auipc	ra,0x6
     1e0:	80c080e7          	jalr	-2036(ra) # 59e8 <printf>
    exit(1);
     1e4:	4505                	li	a0,1
...
000000000000026e <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     28a:	db250513          	addi	a0,a0,-590 # 6038 <malloc+0x590>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     29e:	d9ea0a13          	addi	s4,s4,-610 # 6038 <malloc+0x590>
      int cc = write(fd, buf, sz);
     2a2:	0000c997          	auipc	s3,0xc
     2a6:	85e98993          	addi	s3,s3,-1954 # bb00 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2aa:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     320:	d2c50513          	addi	a0,a0,-724 # 6048 <malloc+0x5a0>
     324:	00005097          	auipc	ra,0x5
     328:	6c4080e7          	jalr	1732(ra) # 59e8 <printf>
      exit(1);
     32c:	4505                	li	a0,1
     ...
     344:	d2850513          	addi	a0,a0,-728 # 6068 <malloc+0x5c0>
     348:	00005097          	auipc	ra,0x5
     34c:	6a0080e7          	jalr	1696(ra) # 59e8 <printf>
        exit(1);
     350:	4505                	li	a0,1
...
000000000000035a <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     386:	cfea0a13          	addi	s4,s4,-770 # 6080 <malloc+0x5d8>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     430:	c5c50513          	addi	a0,a0,-932 # 6088 <malloc+0x5e0>
     434:	00005097          	auipc	ra,0x5
     438:	5b4080e7          	jalr	1460(ra) # 59e8 <printf>
      exit(1);
     43c:	4505                	li	a0,1
     ...
     44e:	c5650513          	addi	a0,a0,-938 # 60a0 <malloc+0x5f8>
     452:	00005097          	auipc	ra,0x5
     456:	596080e7          	jalr	1430(ra) # 59e8 <printf>
      exit(1);
     45a:	4505                	li	a0,1
     ...
     46c:	c6850513          	addi	a0,a0,-920 # 60d0 <malloc+0x628>
     470:	00005097          	auipc	ra,0x5
     474:	578080e7          	jalr	1400(ra) # 59e8 <printf>
      exit(1);
     478:	4505                	li	a0,1
     ...
     486:	c7e50513          	addi	a0,a0,-898 # 6100 <malloc+0x658>
     48a:	00005097          	auipc	ra,0x5
     48e:	55e080e7          	jalr	1374(ra) # 59e8 <printf>
      exit(1);
     492:	4505                	li	a0,1
     ...
     4a4:	c7050513          	addi	a0,a0,-912 # 6110 <malloc+0x668>
     4a8:	00005097          	auipc	ra,0x5
     4ac:	540080e7          	jalr	1344(ra) # 59e8 <printf>
      exit(1);
     4b0:	4505                	li	a0,1
...
00000000000004ba <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4e8:	c5ca0a13          	addi	s4,s4,-932 # 6140 <malloc+0x698>
    n = write(fds[1], "x", 1);
     4ec:	00006a97          	auipc	s5,0x6
     4f0:	b1ca8a93          	addi	s5,s5,-1252 # 6008 <malloc+0x560>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     594:	bb850513          	addi	a0,a0,-1096 # 6148 <malloc+0x6a0>
     598:	00005097          	auipc	ra,0x5
     59c:	450080e7          	jalr	1104(ra) # 59e8 <printf>
      exit(1);
     5a0:	4505                	li	a0,1
     ...
     5b2:	bb250513          	addi	a0,a0,-1102 # 6160 <malloc+0x6b8>
     5b6:	00005097          	auipc	ra,0x5
     5ba:	432080e7          	jalr	1074(ra) # 59e8 <printf>
      exit(1);
     5be:	4505                	li	a0,1
     ...
     5cc:	b3850513          	addi	a0,a0,-1224 # 6100 <malloc+0x658>
     5d0:	00005097          	auipc	ra,0x5
     5d4:	418080e7          	jalr	1048(ra) # 59e8 <printf>
      exit(1);
     5d8:	4505                	li	a0,1
     ...
     5e6:	bae50513          	addi	a0,a0,-1106 # 6190 <malloc+0x6e8>
     5ea:	00005097          	auipc	ra,0x5
     5ee:	3fe080e7          	jalr	1022(ra) # 59e8 <printf>
      exit(1);
     5f2:	4505                	li	a0,1
     ...
     604:	ba850513          	addi	a0,a0,-1112 # 61a8 <malloc+0x700>
     608:	00005097          	auipc	ra,0x5
     60c:	3e0080e7          	jalr	992(ra) # 59e8 <printf>
      exit(1);
     610:	4505                	li	a0,1
...
000000000000061a <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     65a:	9aa58593          	addi	a1,a1,-1622 # 6000 <malloc+0x558>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     676:	97e50513          	addi	a0,a0,-1666 # 5ff0 <malloc+0x548>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     6a2:	95250513          	addi	a0,a0,-1710 # 5ff0 <malloc+0x548>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6b6:	93e50513          	addi	a0,a0,-1730 # 5ff0 <malloc+0x548>
  ...
  write(fd1, "abcdef", 6);
     ...
     6f4:	b4858593          	addi	a1,a1,-1208 # 6238 <malloc+0x790>
     6f8:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     736:	8be50513          	addi	a0,a0,-1858 # 5ff0 <malloc+0x548>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     77a:	a6250513          	addi	a0,a0,-1438 # 61d8 <malloc+0x730>
     77e:	00005097          	auipc	ra,0x5
     782:	26a080e7          	jalr	618(ra) # 59e8 <printf>
    exit(1);
     786:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     796:	a6650513          	addi	a0,a0,-1434 # 61f8 <malloc+0x750>
     79a:	00005097          	auipc	ra,0x5
     79e:	24e080e7          	jalr	590(ra) # 59e8 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7a2:	8652                	mv	a2,s4
     7a4:	85d6                	mv	a1,s5
     7a6:	00006517          	auipc	a0,0x6
     7aa:	a6250513          	addi	a0,a0,-1438 # 6208 <malloc+0x760>
     7ae:	00005097          	auipc	ra,0x5
     7b2:	23a080e7          	jalr	570(ra) # 59e8 <printf>
    exit(1);
     7b6:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7c6:	a6650513          	addi	a0,a0,-1434 # 6228 <malloc+0x780>
     7ca:	00005097          	auipc	ra,0x5
     7ce:	21e080e7          	jalr	542(ra) # 59e8 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7d2:	8652                	mv	a2,s4
     7d4:	85d6                	mv	a1,s5
     7d6:	00006517          	auipc	a0,0x6
     7da:	a3250513          	addi	a0,a0,-1486 # 6208 <malloc+0x760>
     7de:	00005097          	auipc	ra,0x5
     7e2:	20a080e7          	jalr	522(ra) # 59e8 <printf>
    exit(1);
     7e6:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7f8:	a4c50513          	addi	a0,a0,-1460 # 6240 <malloc+0x798>
     7fc:	00005097          	auipc	ra,0x5
     800:	1ec080e7          	jalr	492(ra) # 59e8 <printf>
    exit(1);
     804:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     816:	a4e50513          	addi	a0,a0,-1458 # 6260 <malloc+0x7b8>
     81a:	00005097          	auipc	ra,0x5
     81e:	1ce080e7          	jalr	462(ra) # 59e8 <printf>
    exit(1);
     822:	4505                	li	a0,1
...
000000000000082c <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     84a:	a3a50513          	addi	a0,a0,-1478 # 6280 <malloc+0x7d8>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     862:	a4a98993          	addi	s3,s3,-1462 # 62a8 <malloc+0x800>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     866:	00006a97          	auipc	s5,0x6
     86a:	a7aa8a93          	addi	s5,s5,-1414 # 62e0 <malloc+0x838>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8b0:	9d450513          	addi	a0,a0,-1580 # 6280 <malloc+0x7d8>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8ca:	23a58593          	addi	a1,a1,570 # bb00 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8ec:	99850513          	addi	a0,a0,-1640 # 6280 <malloc+0x7d8>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     916:	97650513          	addi	a0,a0,-1674 # 6288 <malloc+0x7e0>
     91a:	00005097          	auipc	ra,0x5
     91e:	0ce080e7          	jalr	206(ra) # 59e8 <printf>
    exit(1);
     922:	4505                	li	a0,1
     ...
     934:	98850513          	addi	a0,a0,-1656 # 62b8 <malloc+0x810>
     938:	00005097          	auipc	ra,0x5
     93c:	0b0080e7          	jalr	176(ra) # 59e8 <printf>
      exit(1);
     940:	4505                	li	a0,1
     ...
     952:	9a250513          	addi	a0,a0,-1630 # 62f0 <malloc+0x848>
     956:	00005097          	auipc	ra,0x5
     95a:	092080e7          	jalr	146(ra) # 59e8 <printf>
      exit(1);
     95e:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     96e:	9ae50513          	addi	a0,a0,-1618 # 6318 <malloc+0x870>
     972:	00005097          	auipc	ra,0x5
     976:	076080e7          	jalr	118(ra) # 59e8 <printf>
    exit(1);
     97a:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     98a:	9b250513          	addi	a0,a0,-1614 # 6338 <malloc+0x890>
     98e:	00005097          	auipc	ra,0x5
     992:	05a080e7          	jalr	90(ra) # 59e8 <printf>
    exit(1);
     996:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9a6:	9ae50513          	addi	a0,a0,-1618 # 6350 <malloc+0x8a8>
     9aa:	00005097          	auipc	ra,0x5
     9ae:	03e080e7          	jalr	62(ra) # 59e8 <printf>
    exit(1);
     9b2:	4505                	li	a0,1
...
00000000000009bc <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9d8:	99c50513          	addi	a0,a0,-1636 # 6370 <malloc+0x8c8>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9ec:	11890913          	addi	s2,s2,280 # bb00 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a2a:	94a50513          	addi	a0,a0,-1718 # 6370 <malloc+0x8c8>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a3e:	0c690913          	addi	s2,s2,198 # bb00 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a72:	90a50513          	addi	a0,a0,-1782 # 6378 <malloc+0x8d0>
     a76:	00005097          	auipc	ra,0x5
     a7a:	f72080e7          	jalr	-142(ra) # 59e8 <printf>
    exit(1);
     a7e:	4505                	li	a0,1
     ...
     a90:	90c50513          	addi	a0,a0,-1780 # 6398 <malloc+0x8f0>
     a94:	00005097          	auipc	ra,0x5
     a98:	f54080e7          	jalr	-172(ra) # 59e8 <printf>
      exit(1);
     a9c:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     aac:	91850513          	addi	a0,a0,-1768 # 63c0 <malloc+0x918>
     ab0:	00005097          	auipc	ra,0x5
     ab4:	f38080e7          	jalr	-200(ra) # 59e8 <printf>
    exit(1);
     ab8:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ad8:	89c50513          	addi	a0,a0,-1892 # 6370 <malloc+0x8c8>
     ...
     b04:	8e050513          	addi	a0,a0,-1824 # 63e0 <malloc+0x938>
     b08:	00005097          	auipc	ra,0x5
     b0c:	ee0080e7          	jalr	-288(ra) # 59e8 <printf>
        exit(1);
     b10:	4505                	li	a0,1
     ...
     b22:	8ea50513          	addi	a0,a0,-1814 # 6408 <malloc+0x960>
     b26:	00005097          	auipc	ra,0x5
     b2a:	ec2080e7          	jalr	-318(ra) # 59e8 <printf>
      exit(1);
     b2e:	4505                	li	a0,1
     ...
     b40:	8e450513          	addi	a0,a0,-1820 # 6420 <malloc+0x978>
     b44:	00005097          	auipc	ra,0x5
     b48:	ea4080e7          	jalr	-348(ra) # 59e8 <printf>
      exit(1);
     b4c:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b5c:	8f050513          	addi	a0,a0,-1808 # 6448 <malloc+0x9a0>
     b60:	00005097          	auipc	ra,0x5
     b64:	e88080e7          	jalr	-376(ra) # 59e8 <printf>
    exit(1);
     b68:	4505                	li	a0,1
...
0000000000000b72 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b8a:	8da50513          	addi	a0,a0,-1830 # 6460 <malloc+0x9b8>
  ...
  write(fd, "hello", SZ);
     ...
     ba2:	8f258593          	addi	a1,a1,-1806 # 6490 <malloc+0x9e8>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bbe:	8a650513          	addi	a0,a0,-1882 # 6460 <malloc+0x9b8>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bd4:	89050513          	addi	a0,a0,-1904 # 6460 <malloc+0x9b8>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bea:	87a50513          	addi	a0,a0,-1926 # 6460 <malloc+0x9b8>
  ...
  write(fd1, "yyy", 3);
     ...
     bfe:	8de58593          	addi	a1,a1,-1826 # 64d8 <malloc+0xa30>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c1a:	eea58593          	addi	a1,a1,-278 # bb00 <buf>
     c1e:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c66:	7fe50513          	addi	a0,a0,2046 # 6460 <malloc+0x9b8>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c86:	7ee50513          	addi	a0,a0,2030 # 6470 <malloc+0x9c8>
     c8a:	00005097          	auipc	ra,0x5
     c8e:	d5e080e7          	jalr	-674(ra) # 59e8 <printf>
    exit(1);
     c92:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     ca2:	7fa50513          	addi	a0,a0,2042 # 6498 <malloc+0x9f0>
     ca6:	00005097          	auipc	ra,0x5
     caa:	d42080e7          	jalr	-702(ra) # 59e8 <printf>
    exit(1);
     cae:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cbe:	7fe50513          	addi	a0,a0,2046 # 64b8 <malloc+0xa10>
     cc2:	00005097          	auipc	ra,0x5
     cc6:	d26080e7          	jalr	-730(ra) # 59e8 <printf>
    exit(1);
     cca:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cda:	80a50513          	addi	a0,a0,-2038 # 64e0 <malloc+0xa38>
     cde:	00005097          	auipc	ra,0x5
     ce2:	d0a080e7          	jalr	-758(ra) # 59e8 <printf>
    exit(1);
     ce6:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     cf6:	80e50513          	addi	a0,a0,-2034 # 6500 <malloc+0xa58>
     cfa:	00005097          	auipc	ra,0x5
     cfe:	cee080e7          	jalr	-786(ra) # 59e8 <printf>
    exit(1);
     d02:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d12:	81250513          	addi	a0,a0,-2030 # 6520 <malloc+0xa78>
     d16:	00005097          	auipc	ra,0x5
     d1a:	cd2080e7          	jalr	-814(ra) # 59e8 <printf>
    exit(1);
     d1e:	4505                	li	a0,1
...
0000000000000d28 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d76:	71e58593          	addi	a1,a1,1822 # 6490 <malloc+0x9e8>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d96:	7b658593          	addi	a1,a1,1974 # 6548 <malloc+0xaa0>
     d9a:	00005517          	auipc	a0,0x5
     d9e:	7a650513          	addi	a0,a0,1958 # 6540 <malloc+0xa98>
  ...
  unlink("lf1");
     ...
     db2:	79250513          	addi	a0,a0,1938 # 6540 <malloc+0xa98>
     db6:	00005097          	auipc	ra,0x5
     dba:	8fa080e7          	jalr	-1798(ra) # 56b0 <unlink>
  if(open("lf1", 0) >= 0){
     dbe:	4581                	li	a1,0
     dc0:	00005517          	auipc	a0,0x5
     dc4:	78050513          	addi	a0,a0,1920 # 6540 <malloc+0xa98>
  ...
  fd = open("lf2", 0);
     ...
     dda:	77250513          	addi	a0,a0,1906 # 6548 <malloc+0xaa0>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     df2:	d1258593          	addi	a1,a1,-750 # bb00 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e12:	73a58593          	addi	a1,a1,1850 # 6548 <malloc+0xaa0>
     e16:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e28:	72450513          	addi	a0,a0,1828 # 6548 <malloc+0xaa0>
     e2c:	00005097          	auipc	ra,0x5
     e30:	884080e7          	jalr	-1916(ra) # 56b0 <unlink>
  if(link("lf2", "lf1") >= 0){
     e34:	00005597          	auipc	a1,0x5
     e38:	70c58593          	addi	a1,a1,1804 # 6540 <malloc+0xa98>
     e3c:	00005517          	auipc	a0,0x5
     e40:	70c50513          	addi	a0,a0,1804 # 6548 <malloc+0xaa0>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e54:	6f058593          	addi	a1,a1,1776 # 6540 <malloc+0xa98>
     e58:	00005517          	auipc	a0,0x5
     e5c:	7f850513          	addi	a0,a0,2040 # 6650 <malloc+0xba8>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e7e:	6d650513          	addi	a0,a0,1750 # 6550 <malloc+0xaa8>
     e82:	00005097          	auipc	ra,0x5
     e86:	b66080e7          	jalr	-1178(ra) # 59e8 <printf>
    exit(1);
     e8a:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e9a:	6d250513          	addi	a0,a0,1746 # 6568 <malloc+0xac0>
     e9e:	00005097          	auipc	ra,0x5
     ea2:	b4a080e7          	jalr	-1206(ra) # 59e8 <printf>
    exit(1);
     ea6:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     eb6:	6ce50513          	addi	a0,a0,1742 # 6580 <malloc+0xad8>
     eba:	00005097          	auipc	ra,0x5
     ebe:	b2e080e7          	jalr	-1234(ra) # 59e8 <printf>
    exit(1);
     ec2:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ed2:	6d250513          	addi	a0,a0,1746 # 65a0 <malloc+0xaf8>
     ed6:	00005097          	auipc	ra,0x5
     eda:	b12080e7          	jalr	-1262(ra) # 59e8 <printf>
    exit(1);
     ede:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     eee:	6e650513          	addi	a0,a0,1766 # 65d0 <malloc+0xb28>
     ef2:	00005097          	auipc	ra,0x5
     ef6:	af6080e7          	jalr	-1290(ra) # 59e8 <printf>
    exit(1);
     efa:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     f0a:	6e250513          	addi	a0,a0,1762 # 65e8 <malloc+0xb40>
     f0e:	00005097          	auipc	ra,0x5
     f12:	ada080e7          	jalr	-1318(ra) # 59e8 <printf>
    exit(1);
     f16:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f26:	6de50513          	addi	a0,a0,1758 # 6600 <malloc+0xb58>
     f2a:	00005097          	auipc	ra,0x5
     f2e:	abe080e7          	jalr	-1346(ra) # 59e8 <printf>
    exit(1);
     f32:	4505                	li	a0,1
    ...
    printf("%s: link non-existant succeeded! oops\n", s);
     ...
     f42:	6ea50513          	addi	a0,a0,1770 # 6628 <malloc+0xb80>
     f46:	00005097          	auipc	ra,0x5
     f4a:	aa2080e7          	jalr	-1374(ra) # 59e8 <printf>
    exit(1);
     f4e:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f5e:	6fe50513          	addi	a0,a0,1790 # 6658 <malloc+0xbb0>
     f62:	00005097          	auipc	ra,0x5
     f66:	a86080e7          	jalr	-1402(ra) # 59e8 <printf>
    exit(1);
     f6a:	4505                	li	a0,1
...
0000000000000f74 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fc4:	6b8a0a13          	addi	s4,s4,1720 # 6678 <malloc+0xbd0>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1016:	66650513          	addi	a0,a0,1638 # 6678 <malloc+0xbd0>
  ...
  for(i = 0; i < N; i++){
    ...
    1086:	5fe50513          	addi	a0,a0,1534 # 6680 <malloc+0xbd8>
    108a:	00005097          	auipc	ra,0x5
    108e:	95e080e7          	jalr	-1698(ra) # 59e8 <printf>
    exit(1);
    1092:	4505                	li	a0,1
    ...
    10a6:	5fe50513          	addi	a0,a0,1534 # 66a0 <malloc+0xbf8>
    10aa:	00005097          	auipc	ra,0x5
    10ae:	93e080e7          	jalr	-1730(ra) # 59e8 <printf>
      exit(1);
    10b2:	4505                	li	a0,1
    ...
    10c2:	60250513          	addi	a0,a0,1538 # 66c0 <malloc+0xc18>
    10c6:	00005097          	auipc	ra,0x5
    10ca:	922080e7          	jalr	-1758(ra) # 59e8 <printf>
      exit(1);
    10ce:	4505                	li	a0,1
...
00000000000010d8 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10f4:	5f098993          	addi	s3,s3,1520 # 66e0 <malloc+0xc38>
    10f8:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1130:	5c450513          	addi	a0,a0,1476 # 66f0 <malloc+0xc48>
    1134:	00005097          	auipc	ra,0x5
    1138:	8b4080e7          	jalr	-1868(ra) # 59e8 <printf>
      exit(1);
    113c:	4505                	li	a0,1
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1158:	17c78793          	addi	a5,a5,380 # 82d0 <digits+0x20>
...
badarg(char *s)
{
    ...
    1190:	35048493          	addi	s1,s1,848 # c350 <buf+0x850>
  for(int i = 0; i < 50000; i++){
    ...
    119e:	dfe98993          	addi	s3,s3,-514 # 5f98 <malloc+0x4f0>
    argv[0] = (char*)0xffffffff;
...
00000000000011c6 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1228:	6ac78793          	addi	a5,a5,1708 # 78d0 <malloc+0x1e28>
  ...
  if(pid == 0){
    ...
    125e:	18e78793          	addi	a5,a5,398 # 83e8 <big.1294>
    1262:	00008697          	auipc	a3,0x8
    1266:	18668693          	addi	a3,a3,390 # 93e8 <__global_pointer$+0x918>
      big[i] = 'x';
    ...
    127c:	16078823          	sb	zero,368(a5) # 93e8 <__global_pointer$+0x918>
    char *args2[] = { big, big, big, 0 };
    1280:	00005797          	auipc	a5,0x5
    1284:	91078793          	addi	a5,a5,-1776 # 5b90 <malloc+0xe8>
    ...
    12a8:	cf450513          	addi	a0,a0,-780 # 5f98 <malloc+0x4f0>
    ...
    12c0:	4dc50513          	addi	a0,a0,1244 # 6798 <malloc+0xcf0>
    12c4:	00004097          	auipc	ra,0x4
    12c8:	724080e7          	jalr	1828(ra) # 59e8 <printf>
      exit(1);
    12cc:	4505                	li	a0,1
    ...
    12e0:	43450513          	addi	a0,a0,1076 # 6710 <malloc+0xc68>
    12e4:	00004097          	auipc	ra,0x4
    12e8:	704080e7          	jalr	1796(ra) # 59e8 <printf>
    exit(1);
    12ec:	4505                	li	a0,1
    ...
    1300:	43450513          	addi	a0,a0,1076 # 6730 <malloc+0xc88>
    1304:	00004097          	auipc	ra,0x4
    1308:	6e4080e7          	jalr	1764(ra) # 59e8 <printf>
    exit(1);
    130c:	4505                	li	a0,1
    ...
    1322:	43250513          	addi	a0,a0,1074 # 6750 <malloc+0xca8>
    1326:	00004097          	auipc	ra,0x4
    132a:	6c2080e7          	jalr	1730(ra) # 59e8 <printf>
    exit(1);
    132e:	4505                	li	a0,1
    ...
    1342:	43a50513          	addi	a0,a0,1082 # 6778 <malloc+0xcd0>
    1346:	00004097          	auipc	ra,0x4
    134a:	6a2080e7          	jalr	1698(ra) # 59e8 <printf>
    exit(1);
    134e:	4505                	li	a0,1
    ...
    135c:	8a050513          	addi	a0,a0,-1888 # 6bf8 <malloc+0x1150>
    1360:	00004097          	auipc	ra,0x4
    1364:	688080e7          	jalr	1672(ra) # 59e8 <printf>
    exit(1);
    1368:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    13a6:	41e50513          	addi	a0,a0,1054 # 67c0 <malloc+0xd18>
    13aa:	00004097          	auipc	ra,0x4
    13ae:	63e080e7          	jalr	1598(ra) # 59e8 <printf>
    exit(1);
    13b2:	4505                	li	a0,1
...
00000000000013bc <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13d8:	c1c50513          	addi	a0,a0,-996 # 5ff0 <malloc+0x548>
  ...
  if(pid == 0){
    ...
    1402:	bf298993          	addi	s3,s3,-1038 # 5ff0 <malloc+0x548>
      int n = write(fd, "1234567890", 10);
    1406:	00005a97          	auipc	s5,0x5
    140a:	41aa8a93          	addi	s5,s5,1050 # 6820 <malloc+0xd78>
      int fd = open("truncfile", O_WRONLY);
    140e:	4585                	li	a1,1
    1410:	854e                	mv	a0,s3
    ...
    147a:	37a50513          	addi	a0,a0,890 # 67f0 <malloc+0xd48>
    147e:	00004097          	auipc	ra,0x4
    1482:	56a080e7          	jalr	1386(ra) # 59e8 <printf>
    exit(1);
    1486:	4505                	li	a0,1
    ...
    1496:	37650513          	addi	a0,a0,886 # 6808 <malloc+0xd60>
    149a:	00004097          	auipc	ra,0x4
    149e:	54e080e7          	jalr	1358(ra) # 59e8 <printf>
        exit(1);
    14a2:	4505                	li	a0,1
    ...
    14b4:	38050513          	addi	a0,a0,896 # 6830 <malloc+0xd88>
    14b8:	00004097          	auipc	ra,0x4
    14bc:	530080e7          	jalr	1328(ra) # 59e8 <printf>
        exit(1);
    14c0:	4505                	li	a0,1
    ...
    14d2:	b2298993          	addi	s3,s3,-1246 # 5ff0 <malloc+0x548>
    int n = write(fd, "xxx", 3);
    14d6:	00005a97          	auipc	s5,0x5
    14da:	37aa8a93          	addi	s5,s5,890 # 6850 <malloc+0xda8>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1524:	ad050513          	addi	a0,a0,-1328 # 5ff0 <malloc+0x548>
  ...
  exit(xstatus);
    ...
    1542:	2ca50513          	addi	a0,a0,714 # 6808 <malloc+0xd60>
    1546:	00004097          	auipc	ra,0x4
    154a:	4a2080e7          	jalr	1186(ra) # 59e8 <printf>
      exit(1);
    154e:	4505                	li	a0,1
    ...
    1560:	2fc50513          	addi	a0,a0,764 # 6858 <malloc+0xdb0>
    1564:	00004097          	auipc	ra,0x4
    1568:	484080e7          	jalr	1156(ra) # 59e8 <printf>
      exit(1);
    156c:	4505                	li	a0,1
...
0000000000001576 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1588:	a1478793          	addi	a5,a5,-1516 # 5f98 <malloc+0x4f0>
    158c:	fcf43023          	sd	a5,-64(s0)
    1590:	00005797          	auipc	a5,0x5
    1594:	2e878793          	addi	a5,a5,744 # 6878 <malloc+0xdd0>
    1598:	fcf43423          	sd	a5,-56(s0)
    159c:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    15a0:	00005517          	auipc	a0,0x5
    15a4:	2e050513          	addi	a0,a0,736 # 6880 <malloc+0xdd8>
  ...
  if(pid == 0) {
    ...
    15d2:	2b250513          	addi	a0,a0,690 # 6880 <malloc+0xdd8>
    ...
    15ee:	2b650513          	addi	a0,a0,694 # 68a0 <malloc+0xdf8>
    15f2:	00004097          	auipc	ra,0x4
    15f6:	3f6080e7          	jalr	1014(ra) # 59e8 <printf>
      exit(1);
    15fa:	4505                	li	a0,1
    ...
    160a:	1ea50513          	addi	a0,a0,490 # 67f0 <malloc+0xd48>
    160e:	00004097          	auipc	ra,0x4
    1612:	3da080e7          	jalr	986(ra) # 59e8 <printf>
     exit(1);
    1616:	4505                	li	a0,1
    ...
    1626:	26650513          	addi	a0,a0,614 # 6888 <malloc+0xde0>
    162a:	00004097          	auipc	ra,0x4
    162e:	3be080e7          	jalr	958(ra) # 59e8 <printf>
      exit(1);
    1632:	4505                	li	a0,1
    ...
    1644:	95850513          	addi	a0,a0,-1704 # 5f98 <malloc+0x4f0>
  ...
  if(xstatus != 0)
    ...
    1678:	23c50513          	addi	a0,a0,572 # 68b0 <malloc+0xe08>
    167c:	00004097          	auipc	ra,0x4
    1680:	36c080e7          	jalr	876(ra) # 59e8 <printf>
      exit(1);
    1684:	4505                	li	a0,1
    ...
    1694:	23850513          	addi	a0,a0,568 # 68c8 <malloc+0xe20>
    1698:	00004097          	auipc	ra,0x4
    169c:	350080e7          	jalr	848(ra) # 59e8 <printf>
    16a0:	b7d1                	j	1664 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    16a2:	4581                	li	a1,0
    16a4:	00005517          	auipc	a0,0x5
    16a8:	1dc50513          	addi	a0,a0,476 # 6880 <malloc+0xdd8>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16d2:	c6a50513          	addi	a0,a0,-918 # 6338 <malloc+0x890>
    16d6:	00004097          	auipc	ra,0x4
    16da:	312080e7          	jalr	786(ra) # 59e8 <printf>
    exit(1);
    16de:	4505                	li	a0,1
    ...
    16ee:	11e50513          	addi	a0,a0,286 # 6808 <malloc+0xd60>
    16f2:	00004097          	auipc	ra,0x4
    16f6:	2f6080e7          	jalr	758(ra) # 59e8 <printf>
    exit(1);
    16fa:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    1708:	17c50513          	addi	a0,a0,380 # 6880 <malloc+0xdd8>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1732:	1b250513          	addi	a0,a0,434 # 68e0 <malloc+0xe38>
    1736:	00004097          	auipc	ra,0x4
    173a:	2b2080e7          	jalr	690(ra) # 59e8 <printf>
    exit(1);
    173e:	4505                	li	a0,1
...
0000000000001752 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    179a:	36a90913          	addi	s2,s2,874 # bb00 <buf>
      if(cc > sizeof(buf))
    ...
    17c8:	33d70713          	addi	a4,a4,829 # bb01 <buf+0x1>
    ...
    17ee:	10e50513          	addi	a0,a0,270 # 68f8 <malloc+0xe50>
    17f2:	00004097          	auipc	ra,0x4
    17f6:	1f6080e7          	jalr	502(ra) # 59e8 <printf>
    exit(1);
    17fa:	4505                	li	a0,1
    ...
    1814:	2f0a8a93          	addi	s5,s5,752 # bb00 <buf>
    ...
    1834:	8b56                	mv	s6,s5
{
    ...
    187a:	09a50513          	addi	a0,a0,154 # 6910 <malloc+0xe68>
    187e:	00004097          	auipc	ra,0x4
    1882:	16a080e7          	jalr	362(ra) # 59e8 <printf>
        exit(1);
    1886:	4505                	li	a0,1
    ...
    1896:	09650513          	addi	a0,a0,150 # 6928 <malloc+0xe80>
    189a:	00004097          	auipc	ra,0x4
    189e:	14e080e7          	jalr	334(ra) # 59e8 <printf>
}
    ...
    18da:	06a50513          	addi	a0,a0,106 # 6940 <malloc+0xe98>
    18de:	00004097          	auipc	ra,0x4
    18e2:	10a080e7          	jalr	266(ra) # 59e8 <printf>
      exit(1);
    18e6:	4505                	li	a0,1
    ...
    191a:	04a50513          	addi	a0,a0,74 # 6960 <malloc+0xeb8>
    191e:	00004097          	auipc	ra,0x4
    1922:	0ca080e7          	jalr	202(ra) # 59e8 <printf>
    exit(1);
    1926:	4505                	li	a0,1
...
0000000000001930 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    198c:	e6850513          	addi	a0,a0,-408 # 67f0 <malloc+0xd48>
    1990:	00004097          	auipc	ra,0x4
    1994:	058080e7          	jalr	88(ra) # 59e8 <printf>
      exit(1);
    1998:	4505                	li	a0,1
    ...
    19a8:	fd450513          	addi	a0,a0,-44 # 6978 <malloc+0xed0>
    19ac:	00004097          	auipc	ra,0x4
    19b0:	03c080e7          	jalr	60(ra) # 59e8 <printf>
        exit(1);
    19b4:	4505                	li	a0,1
    ...
    19c4:	fd050513          	addi	a0,a0,-48 # 6990 <malloc+0xee8>
    19c8:	00004097          	auipc	ra,0x4
    19cc:	020080e7          	jalr	32(ra) # 59e8 <printf>
        exit(1);
    19d0:	4505                	li	a0,1
...
00000000000019e4 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a3c:	db850513          	addi	a0,a0,-584 # 67f0 <malloc+0xd48>
    1a40:	00004097          	auipc	ra,0x4
    1a44:	fa8080e7          	jalr	-88(ra) # 59e8 <printf>
      exit(1);
    1a48:	4505                	li	a0,1
    ...
    1a60:	d9450513          	addi	a0,a0,-620 # 67f0 <malloc+0xd48>
    1a64:	00004097          	auipc	ra,0x4
    1a68:	f84080e7          	jalr	-124(ra) # 59e8 <printf>
        exit(1);
    1a6c:	4505                	li	a0,1
...
0000000000001a7e <forkfork>:
{
    ...
    1ada:	eda50513          	addi	a0,a0,-294 # 69b0 <malloc+0xf08>
    1ade:	00004097          	auipc	ra,0x4
    1ae2:	f0a080e7          	jalr	-246(ra) # 59e8 <printf>
      exit(1);
    1ae6:	4505                	li	a0,1
    ...
    1aec:	b78080e7          	jalr	-1160(ra) # 5660 <exit>
{
    ...
    1b32:	e9250513          	addi	a0,a0,-366 # 69c0 <malloc+0xf18>
    1b36:	00004097          	auipc	ra,0x4
    1b3a:	eb2080e7          	jalr	-334(ra) # 59e8 <printf>
      exit(1);
    1b3e:	4505                	li	a0,1
...
0000000000001b48 <reparent2>:
{
  ...
  exit(0);
    ...
    1b80:	07c50513          	addi	a0,a0,124 # 6bf8 <malloc+0x1150>
    1b84:	00004097          	auipc	ra,0x4
    1b88:	e64080e7          	jalr	-412(ra) # 59e8 <printf>
      exit(1);
    1b8c:	4505                	li	a0,1
...
0000000000001bb0 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1c1e:	fde50513          	addi	a0,a0,-34 # 6bf8 <malloc+0x1150>
    1c22:	00004097          	auipc	ra,0x4
    1c26:	dc6080e7          	jalr	-570(ra) # 59e8 <printf>
      exit(1);
    1c2a:	4505                	li	a0,1
    ...
    1c4a:	c4250513          	addi	a0,a0,-958 # 6888 <malloc+0xde0>
    1c4e:	00004097          	auipc	ra,0x4
    1c52:	d9a080e7          	jalr	-614(ra) # 59e8 <printf>
          exit(1);
    1c56:	4505                	li	a0,1
    ...
    1cbc:	d2850513          	addi	a0,a0,-728 # 69e0 <malloc+0xf38>
    1cc0:	00004097          	auipc	ra,0x4
    1cc4:	d28080e7          	jalr	-728(ra) # 59e8 <printf>
            exit(1);
    1cc8:	4505                	li	a0,1
    ...
    1cf0:	d0c50513          	addi	a0,a0,-756 # 69f8 <malloc+0xf50>
    1cf4:	00004097          	auipc	ra,0x4
    1cf8:	cf4080e7          	jalr	-780(ra) # 59e8 <printf>
        exit(1);
    1cfc:	4505                	li	a0,1
    ...
    1d56:	cce50513          	addi	a0,a0,-818 # 6a20 <malloc+0xf78>
    1d5a:	00004097          	auipc	ra,0x4
    1d5e:	c8e080e7          	jalr	-882(ra) # 59e8 <printf>
        exit(1);
    1d62:	4505                	li	a0,1
...
0000000000001dd6 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1df6:	21650513          	addi	a0,a0,534 # 6008 <malloc+0x560>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e32:	1daa8a93          	addi	s5,s5,474 # 6008 <malloc+0x560>
      link("cat", "x");
    1e36:	00005b97          	auipc	s7,0x5
    1e3a:	c12b8b93          	addi	s7,s7,-1006 # 6a48 <malloc+0xfa0>
    1e3e:	a091                	j	1e82 <linkunlink+0xac>
    printf("%s: fork failed\n", s);
    1e40:	85a6                	mv	a1,s1
    1e42:	00005517          	auipc	a0,0x5
    1e46:	9ae50513          	addi	a0,a0,-1618 # 67f0 <malloc+0xd48>
    1e4a:	00004097          	auipc	ra,0x4
    1e4e:	b9e080e7          	jalr	-1122(ra) # 59e8 <printf>
    exit(1);
    1e52:	4505                	li	a0,1
...
0000000000001ed8 <manywrites>:
{
  ...
  exit(0);
    ...
    1f34:	cc850513          	addi	a0,a0,-824 # 6bf8 <malloc+0x1150>
    1f38:	00004097          	auipc	ra,0x4
    1f3c:	ab0080e7          	jalr	-1360(ra) # 59e8 <printf>
      exit(1);
    1f40:	4505                	li	a0,1
    ...
    1f70:	b94a8a93          	addi	s5,s5,-1132 # bb00 <buf>
    ...
    1fe4:	a7050513          	addi	a0,a0,-1424 # 6a50 <malloc+0xfa8>
    1fe8:	00004097          	auipc	ra,0x4
    1fec:	a00080e7          	jalr	-1536(ra) # 59e8 <printf>
            exit(1);
    1ff0:	4505                	li	a0,1
    ...
    2004:	06850513          	addi	a0,a0,104 # 6068 <malloc+0x5c0>
    2008:	00004097          	auipc	ra,0x4
    200c:	9e0080e7          	jalr	-1568(ra) # 59e8 <printf>
            exit(1);
    2010:	4505                	li	a0,1
...
0000000000002022 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    2052:	a3250513          	addi	a0,a0,-1486 # 6a80 <malloc+0xfd8>
    2056:	00004097          	auipc	ra,0x4
    205a:	992080e7          	jalr	-1646(ra) # 59e8 <printf>
    exit(1);
    205e:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    20b4:	9b850513          	addi	a0,a0,-1608 # 6a68 <malloc+0xfc0>
    20b8:	00004097          	auipc	ra,0x4
    20bc:	930080e7          	jalr	-1744(ra) # 59e8 <printf>
    exit(1);
    20c0:	4505                	li	a0,1
    ...
    20d0:	9dc50513          	addi	a0,a0,-1572 # 6aa8 <malloc+0x1000>
    20d4:	00004097          	auipc	ra,0x4
    20d8:	914080e7          	jalr	-1772(ra) # 59e8 <printf>
      exit(1);
    20dc:	4505                	li	a0,1
    ...
    20ec:	9d850513          	addi	a0,a0,-1576 # 6ac0 <malloc+0x1018>
    20f0:	00004097          	auipc	ra,0x4
    20f4:	8f8080e7          	jalr	-1800(ra) # 59e8 <printf>
    exit(1);
    20f8:	4505                	li	a0,1
...
0000000000002102 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    211e:	35098993          	addi	s3,s3,848 # c350 <buf+0x850>
    2122:	1003d937          	lui	s2,0x1003d
    2126:	090e                	slli	s2,s2,0x3
    2128:	48090913          	addi	s2,s2,1152 # 1003d480 <_end+0x1002e970>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    216c:	68850513          	addi	a0,a0,1672 # 67f0 <malloc+0xd48>
    2170:	00004097          	auipc	ra,0x4
    2174:	878080e7          	jalr	-1928(ra) # 59e8 <printf>
      exit(1);
    2178:	4505                	li	a0,1
    ...
    218e:	94e50513          	addi	a0,a0,-1714 # 6ad8 <malloc+0x1030>
    2192:	00004097          	auipc	ra,0x4
    2196:	856080e7          	jalr	-1962(ra) # 59e8 <printf>
      exit(1);
    219a:	4505                	li	a0,1
...
00000000000021ae <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    21be:	93e50513          	addi	a0,a0,-1730 # 6af8 <malloc+0x1050>
  ...
  fd = open("bigarg-ok", 0);
    ...
    21f0:	90c50513          	addi	a0,a0,-1780 # 6af8 <malloc+0x1050>
  ...
  close(fd);
    ...
    2216:	0d678793          	addi	a5,a5,214 # 82e8 <args.1864>
    221a:	00006697          	auipc	a3,0x6
    221e:	1c668693          	addi	a3,a3,454 # 83e0 <args.1864+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    2222:	00005717          	auipc	a4,0x5
    2226:	8e670713          	addi	a4,a4,-1818 # 6b08 <malloc+0x1060>
    ...
    227a:	97250513          	addi	a0,a0,-1678 # 6be8 <malloc+0x1140>
    227e:	00003097          	auipc	ra,0x3
    2282:	76a080e7          	jalr	1898(ra) # 59e8 <printf>
    exit(1);
    2286:	4505                	li	a0,1
    ...
    229e:	96e50513          	addi	a0,a0,-1682 # 6c08 <malloc+0x1160>
    22a2:	00003097          	auipc	ra,0x3
    22a6:	746080e7          	jalr	1862(ra) # 59e8 <printf>
    exit(1);
    22aa:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    22f2:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <_end+0xffffffffffff04f0>
    22f6:	85a6                	mv	a1,s1
    22f8:	00005517          	auipc	a0,0x5
    22fc:	93050513          	addi	a0,a0,-1744 # 6c28 <malloc+0x1180>
    2300:	00003097          	auipc	ra,0x3
    2304:	6e8080e7          	jalr	1768(ra) # 59e8 <printf>
    exit(1);
    2308:	4505                	li	a0,1
    ...
    2318:	4dc50513          	addi	a0,a0,1244 # 67f0 <malloc+0xd48>
    231c:	00003097          	auipc	ra,0x3
    2320:	6cc080e7          	jalr	1740(ra) # 59e8 <printf>
    exit(1);
    2324:	4505                	li	a0,1
...
0000000000002338 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    23b6:	51e78793          	addi	a5,a5,1310 # 78d0 <malloc+0x1e28>
  ...
  if(ret != -1){
    ...
    23fa:	85a50513          	addi	a0,a0,-1958 # 6c50 <malloc+0x11a8>
    23fe:	00003097          	auipc	ra,0x3
    2402:	5ea080e7          	jalr	1514(ra) # 59e8 <printf>
    exit(1);
    2406:	4505                	li	a0,1
    ...
    2418:	2fc50513          	addi	a0,a0,764 # 6710 <malloc+0xc68>
    241c:	00003097          	auipc	ra,0x3
    2420:	5cc080e7          	jalr	1484(ra) # 59e8 <printf>
    exit(1);
    2424:	4505                	li	a0,1
    ...
    2436:	2fe50513          	addi	a0,a0,766 # 6730 <malloc+0xc88>
    243a:	00003097          	auipc	ra,0x3
    243e:	5ae080e7          	jalr	1454(ra) # 59e8 <printf>
    exit(1);
    2442:	4505                	li	a0,1
    ...
    2456:	2fe50513          	addi	a0,a0,766 # 6750 <malloc+0xca8>
    245a:	00003097          	auipc	ra,0x3
    245e:	58e080e7          	jalr	1422(ra) # 59e8 <printf>
    exit(1);
    2462:	4505                	li	a0,1
    ...
    2474:	30850513          	addi	a0,a0,776 # 6778 <malloc+0xcd0>
    2478:	00003097          	auipc	ra,0x3
    247c:	570080e7          	jalr	1392(ra) # 59e8 <printf>
    exit(1);
    2480:	4505                	li	a0,1
...
000000000000248a <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    24c0:	7d450513          	addi	a0,a0,2004 # 6c90 <malloc+0x11e8>
  ...
  if(n >= 0){
    ...
    24f0:	7c450513          	addi	a0,a0,1988 # 6cb0 <malloc+0x1208>
    24f4:	00003097          	auipc	ra,0x3
    24f8:	4f4080e7          	jalr	1268(ra) # 59e8 <printf>
    exit(1);
    24fc:	4505                	li	a0,1
    ...
    250a:	75250513          	addi	a0,a0,1874 # 6c58 <malloc+0x11b0>
    250e:	00003097          	auipc	ra,0x3
    2512:	4da080e7          	jalr	1242(ra) # 59e8 <printf>
    exit(1);
    2516:	4505                	li	a0,1
    ...
    2524:	75050513          	addi	a0,a0,1872 # 6c70 <malloc+0x11c8>
    2528:	00003097          	auipc	ra,0x3
    252c:	4c0080e7          	jalr	1216(ra) # 59e8 <printf>
    exit(1);
    2530:	4505                	li	a0,1
    ...
    253e:	75e50513          	addi	a0,a0,1886 # 6c98 <malloc+0x11f0>
    2542:	00003097          	auipc	ra,0x3
    2546:	4a6080e7          	jalr	1190(ra) # 59e8 <printf>
    exit(1);
    254a:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2562:	73250513          	addi	a0,a0,1842 # 6c90 <malloc+0x11e8>
    2566:	00003097          	auipc	ra,0x3
    256a:	14a080e7          	jalr	330(ra) # 56b0 <unlink>
  fd = open("README", O_RDONLY);
    256e:	4581                	li	a1,0
    2570:	00004517          	auipc	a0,0x4
    2574:	bd050513          	addi	a0,a0,-1072 # 6140 <malloc+0x698>
  ...
  if(n >= 0){
    ...
    259e:	74650513          	addi	a0,a0,1862 # 6ce0 <malloc+0x1238>
    25a2:	00003097          	auipc	ra,0x3
    25a6:	446080e7          	jalr	1094(ra) # 59e8 <printf>
    exit(1);
    25aa:	4505                	li	a0,1
    ...
    25b8:	6e450513          	addi	a0,a0,1764 # 6c98 <malloc+0x11f0>
    25bc:	00003097          	auipc	ra,0x3
    25c0:	42c080e7          	jalr	1068(ra) # 59e8 <printf>
    exit(1);
    25c4:	4505                	li	a0,1
...
00000000000025e2 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2620:	6705                	lui	a4,0x1
      *b = 99;
    2622:	00d50023          	sb	a3,0(a0) # 40000000 <_end+0x3fff14f0>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    263a:	6d250513          	addi	a0,a0,1746 # 6d08 <malloc+0x1260>
    263e:	00003097          	auipc	ra,0x3
    2642:	3aa080e7          	jalr	938(ra) # 59e8 <printf>
    exit(1);
    2646:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    268e:	69e50513          	addi	a0,a0,1694 # 6d28 <malloc+0x1280>
    2692:	00003097          	auipc	ra,0x3
    2696:	356080e7          	jalr	854(ra) # 59e8 <printf>
    exit(1);
    269a:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    26f0:	69c50513          	addi	a0,a0,1692 # 6d88 <malloc+0x12e0>
    26f4:	00003097          	auipc	ra,0x3
    26f8:	2f4080e7          	jalr	756(ra) # 59e8 <printf>
    exit(1);
    26fc:	4505                	li	a0,1
    ...
    2710:	63c50513          	addi	a0,a0,1596 # 6d48 <malloc+0x12a0>
    2714:	00003097          	auipc	ra,0x3
    2718:	2d4080e7          	jalr	724(ra) # 59e8 <printf>
      exit(1);
    271c:	4505                	li	a0,1
    ...
    272c:	64050513          	addi	a0,a0,1600 # 6d68 <malloc+0x12c0>
    2730:	00003097          	auipc	ra,0x3
    2734:	2b8080e7          	jalr	696(ra) # 59e8 <printf>
    exit(1);
    2738:	4505                	li	a0,1
...
0000000000002768 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    27c8:	fee78fa3          	sb	a4,-1(a5) # 63fffff <_end+0x63f14ef>
  a = sbrk(0);
    27cc:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    282c:	fff7c703          	lbu	a4,-1(a5) # 63fffff <_end+0x63f14ef>
  ...
  if(c != a){
    ...
    2874:	53850513          	addi	a0,a0,1336 # 6da8 <malloc+0x1300>
    2878:	00003097          	auipc	ra,0x3
    287c:	170080e7          	jalr	368(ra) # 59e8 <printf>
    exit(1);
    2880:	4505                	li	a0,1
    ...
    2890:	56450513          	addi	a0,a0,1380 # 6df0 <malloc+0x1348>
    2894:	00003097          	auipc	ra,0x3
    2898:	154080e7          	jalr	340(ra) # 59e8 <printf>
    exit(1);
    289c:	4505                	li	a0,1
    ...
    28b0:	56450513          	addi	a0,a0,1380 # 6e10 <malloc+0x1368>
    28b4:	00003097          	auipc	ra,0x3
    28b8:	134080e7          	jalr	308(ra) # 59e8 <printf>
    exit(1);
    28bc:	4505                	li	a0,1
    ...
    28d0:	58450513          	addi	a0,a0,1412 # 6e50 <malloc+0x13a8>
    28d4:	00003097          	auipc	ra,0x3
    28d8:	114080e7          	jalr	276(ra) # 59e8 <printf>
    exit(1);
    28dc:	4505                	li	a0,1
    ...
    28ec:	59850513          	addi	a0,a0,1432 # 6e80 <malloc+0x13d8>
    28f0:	00003097          	auipc	ra,0x3
    28f4:	0f8080e7          	jalr	248(ra) # 59e8 <printf>
    exit(1);
    28f8:	4505                	li	a0,1
    ...
    290c:	5b050513          	addi	a0,a0,1456 # 6eb8 <malloc+0x1410>
    2910:	00003097          	auipc	ra,0x3
    2914:	0d8080e7          	jalr	216(ra) # 59e8 <printf>
    exit(1);
    2918:	4505                	li	a0,1
...
0000000000002922 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2946:	59e50513          	addi	a0,a0,1438 # 6ee0 <malloc+0x1438>
    294a:	00003097          	auipc	ra,0x3
    294e:	d56080e7          	jalr	-682(ra) # 56a0 <open>
    2952:	84aa                	mv	s1,a0
  unlink("sbrk");
    2954:	00004517          	auipc	a0,0x4
    2958:	58c50513          	addi	a0,a0,1420 # 6ee0 <malloc+0x1438>
  ...
  if(pipe((int *) a) != 0){
    ...
    29ac:	54050513          	addi	a0,a0,1344 # 6ee8 <malloc+0x1440>
    29b0:	00003097          	auipc	ra,0x3
    29b4:	038080e7          	jalr	56(ra) # 59e8 <printf>
    exit(1);
    29b8:	4505                	li	a0,1
    ...
    29c8:	53c50513          	addi	a0,a0,1340 # 6f00 <malloc+0x1458>
    29cc:	00003097          	auipc	ra,0x3
    29d0:	01c080e7          	jalr	28(ra) # 59e8 <printf>
    exit(1);
    29d4:	4505                	li	a0,1
    ...
    29e4:	f1850513          	addi	a0,a0,-232 # 68f8 <malloc+0xe50>
    29e8:	00003097          	auipc	ra,0x3
    29ec:	000080e7          	jalr	ra # 59e8 <printf>
    exit(1);
    29f0:	4505                	li	a0,1
...
00000000000029fa <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a0e:	50e50513          	addi	a0,a0,1294 # 6f18 <malloc+0x1470>
  ...
  close(fd);
    ...
    2a56:	db650513          	addi	a0,a0,-586 # 6808 <malloc+0xd60>
    2a5a:	00003097          	auipc	ra,0x3
    2a5e:	f8e080e7          	jalr	-114(ra) # 59e8 <printf>
    exit(1);
    2a62:	4505                	li	a0,1
...
0000000000002a6c <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2aa6:	15650513          	addi	a0,a0,342 # 6bf8 <malloc+0x1150>
    2aaa:	00003097          	auipc	ra,0x3
    2aae:	f3e080e7          	jalr	-194(ra) # 59e8 <printf>
    exit(1);
    2ab2:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2afc:	10050513          	addi	a0,a0,256 # 6bf8 <malloc+0x1150>
    2b00:	00003097          	auipc	ra,0x3
    2b04:	ee8080e7          	jalr	-280(ra) # 59e8 <printf>
    exit(1);
    2b08:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2b5c:	0a050513          	addi	a0,a0,160 # 6bf8 <malloc+0x1150>
    2b60:	00003097          	auipc	ra,0x3
    2b64:	e88080e7          	jalr	-376(ra) # 59e8 <printf>
    exit(1);
    2b68:	4505                	li	a0,1
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2bc8:	03450513          	addi	a0,a0,52 # 6bf8 <malloc+0x1150>
    2bcc:	00003097          	auipc	ra,0x3
    2bd0:	e1c080e7          	jalr	-484(ra) # 59e8 <printf>
      exit(1);
    2bd4:	4505                	li	a0,1
    ...
    2c1c:	38050513          	addi	a0,a0,896 # 5f98 <malloc+0x4f0>
    2c20:	faa43c23          	sd	a0,-72(s0)
    2c24:	00003797          	auipc	a5,0x3
    2c28:	3e478793          	addi	a5,a5,996 # 6008 <malloc+0x560>
...
0000000000002c4a <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2c5a:	49a50513          	addi	a0,a0,1178 # 70f0 <malloc+0x1648>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2c6c:	2e050513          	addi	a0,a0,736 # 6f48 <malloc+0x14a0>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2c82:	32250513          	addi	a0,a0,802 # 6fa0 <malloc+0x14f8>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2ca0:	37c50513          	addi	a0,a0,892 # 7018 <malloc+0x1570>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2cbc:	3d050513          	addi	a0,a0,976 # 7088 <malloc+0x15e0>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2cce:	41650513          	addi	a0,a0,1046 # 70e0 <malloc+0x1638>
  ...
  unlink("12345678901234");
    ...
    2d4c:	1d850513          	addi	a0,a0,472 # 6f20 <malloc+0x1478>
    2d50:	00003097          	auipc	ra,0x3
    2d54:	c98080e7          	jalr	-872(ra) # 59e8 <printf>
    exit(1);
    2d58:	4505                	li	a0,1
    ...
    2d68:	20450513          	addi	a0,a0,516 # 6f68 <malloc+0x14c0>
    2d6c:	00003097          	auipc	ra,0x3
    2d70:	c7c080e7          	jalr	-900(ra) # 59e8 <printf>
    exit(1);
    2d74:	4505                	li	a0,1
    ...
    2d84:	25050513          	addi	a0,a0,592 # 6fd0 <malloc+0x1528>
    2d88:	00003097          	auipc	ra,0x3
    2d8c:	c60080e7          	jalr	-928(ra) # 59e8 <printf>
    exit(1);
    2d90:	4505                	li	a0,1
    ...
    2da0:	2ac50513          	addi	a0,a0,684 # 7048 <malloc+0x15a0>
    2da4:	00003097          	auipc	ra,0x3
    2da8:	c44080e7          	jalr	-956(ra) # 59e8 <printf>
    exit(1);
    2dac:	4505                	li	a0,1
    ...
    2dbc:	2f050513          	addi	a0,a0,752 # 70a8 <malloc+0x1600>
    2dc0:	00003097          	auipc	ra,0x3
    2dc4:	c28080e7          	jalr	-984(ra) # 59e8 <printf>
    exit(1);
    2dc8:	4505                	li	a0,1
    ...
    2dd8:	32c50513          	addi	a0,a0,812 # 7100 <malloc+0x1658>
    2ddc:	00003097          	auipc	ra,0x3
    2de0:	c0c080e7          	jalr	-1012(ra) # 59e8 <printf>
    exit(1);
    2de4:	4505                	li	a0,1
...
0000000000002dee <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2dfe:	33e50513          	addi	a0,a0,830 # 7138 <malloc+0x1690>
  ...
  if(chdir("iputdir") < 0){
    ...
    2e12:	32a50513          	addi	a0,a0,810 # 7138 <malloc+0x1690>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2e26:	35650513          	addi	a0,a0,854 # 7178 <malloc+0x16d0>
  ...
  if(chdir("/") < 0){
    ...
    2e3a:	37250513          	addi	a0,a0,882 # 71a8 <malloc+0x1700>
    ...
    2e5a:	2ea50513          	addi	a0,a0,746 # 7140 <malloc+0x1698>
    2e5e:	00003097          	auipc	ra,0x3
    2e62:	b8a080e7          	jalr	-1142(ra) # 59e8 <printf>
    exit(1);
    2e66:	4505                	li	a0,1
    ...
    2e76:	2e650513          	addi	a0,a0,742 # 7158 <malloc+0x16b0>
    2e7a:	00003097          	auipc	ra,0x3
    2e7e:	b6e080e7          	jalr	-1170(ra) # 59e8 <printf>
    exit(1);
    2e82:	4505                	li	a0,1
    ...
    2e92:	2fa50513          	addi	a0,a0,762 # 7188 <malloc+0x16e0>
    2e96:	00003097          	auipc	ra,0x3
    2e9a:	b52080e7          	jalr	-1198(ra) # 59e8 <printf>
    exit(1);
    2e9e:	4505                	li	a0,1
    ...
    2eae:	30650513          	addi	a0,a0,774 # 71b0 <malloc+0x1708>
    2eb2:	00003097          	auipc	ra,0x3
    2eb6:	b36080e7          	jalr	-1226(ra) # 59e8 <printf>
    exit(1);
    2eba:	4505                	li	a0,1
...
0000000000002ec4 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2ee2:	25a50513          	addi	a0,a0,602 # 7138 <malloc+0x1690>
    ...
    2ef6:	24650513          	addi	a0,a0,582 # 7138 <malloc+0x1690>
    ...
    2f0a:	27250513          	addi	a0,a0,626 # 7178 <malloc+0x16d0>
    ...
    2f2a:	8ca50513          	addi	a0,a0,-1846 # 67f0 <malloc+0xd48>
    2f2e:	00003097          	auipc	ra,0x3
    2f32:	aba080e7          	jalr	-1350(ra) # 59e8 <printf>
    exit(1);
    2f36:	4505                	li	a0,1
    ...
    2f46:	1fe50513          	addi	a0,a0,510 # 7140 <malloc+0x1698>
    2f4a:	00003097          	auipc	ra,0x3
    2f4e:	a9e080e7          	jalr	-1378(ra) # 59e8 <printf>
      exit(1);
    2f52:	4505                	li	a0,1
    ...
    2f62:	26a50513          	addi	a0,a0,618 # 71c8 <malloc+0x1720>
    2f66:	00003097          	auipc	ra,0x3
    2f6a:	a82080e7          	jalr	-1406(ra) # 59e8 <printf>
      exit(1);
    2f6e:	4505                	li	a0,1
    ...
    2f7e:	20e50513          	addi	a0,a0,526 # 7188 <malloc+0x16e0>
    2f82:	00003097          	auipc	ra,0x3
    2f86:	a66080e7          	jalr	-1434(ra) # 59e8 <printf>
      exit(1);
    2f8a:	4505                	li	a0,1
...
0000000000002fac <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    2fbc:	22850513          	addi	a0,a0,552 # 71e0 <malloc+0x1738>
  ...
  if(chdir("dir0") < 0){
    ...
    2fd0:	21450513          	addi	a0,a0,532 # 71e0 <malloc+0x1738>
  ...
  if(chdir("..") < 0){
    ...
    2fe4:	22050513          	addi	a0,a0,544 # 7200 <malloc+0x1758>
  ...
  if(unlink("dir0") < 0){
    ...
    2ff8:	1ec50513          	addi	a0,a0,492 # 71e0 <malloc+0x1738>
    ...
    3018:	12c50513          	addi	a0,a0,300 # 7140 <malloc+0x1698>
    301c:	00003097          	auipc	ra,0x3
    3020:	9cc080e7          	jalr	-1588(ra) # 59e8 <printf>
    exit(1);
    3024:	4505                	li	a0,1
    ...
    3034:	1b850513          	addi	a0,a0,440 # 71e8 <malloc+0x1740>
    3038:	00003097          	auipc	ra,0x3
    303c:	9b0080e7          	jalr	-1616(ra) # 59e8 <printf>
    exit(1);
    3040:	4505                	li	a0,1
    ...
    3050:	1bc50513          	addi	a0,a0,444 # 7208 <malloc+0x1760>
    3054:	00003097          	auipc	ra,0x3
    3058:	994080e7          	jalr	-1644(ra) # 59e8 <printf>
    exit(1);
    305c:	4505                	li	a0,1
    ...
    306c:	1b850513          	addi	a0,a0,440 # 7220 <malloc+0x1778>
    3070:	00003097          	auipc	ra,0x3
    3074:	978080e7          	jalr	-1672(ra) # 59e8 <printf>
    exit(1);
    3078:	4505                	li	a0,1
...
0000000000003082 <subdir>:
{
  ...
  unlink("ff");
    ...
    3094:	2d850513          	addi	a0,a0,728 # 7368 <malloc+0x18c0>
    3098:	00002097          	auipc	ra,0x2
    309c:	618080e7          	jalr	1560(ra) # 56b0 <unlink>
  if(mkdir("dd") != 0){
    30a0:	00004517          	auipc	a0,0x4
    30a4:	19850513          	addi	a0,a0,408 # 7238 <malloc+0x1790>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    30bc:	1a050513          	addi	a0,a0,416 # 7258 <malloc+0x17b0>
  ...
  write(fd, "ff", 2);
    ...
    30d4:	29858593          	addi	a1,a1,664 # 7368 <malloc+0x18c0>
  ...
  if(unlink("dd") >= 0){
    ...
    30ee:	14e50513          	addi	a0,a0,334 # 7238 <malloc+0x1790>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3102:	1b250513          	addi	a0,a0,434 # 72b0 <malloc+0x1808>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    311a:	1c250513          	addi	a0,a0,450 # 72d8 <malloc+0x1830>
  ...
  write(fd, "FF", 2);
    ...
    3132:	1da58593          	addi	a1,a1,474 # 7308 <malloc+0x1860>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    314e:	1c650513          	addi	a0,a0,454 # 7310 <malloc+0x1868>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    3166:	99e58593          	addi	a1,a1,-1634 # bb00 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    317c:	98874703          	lbu	a4,-1656(a4) # bb00 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3196:	1ce58593          	addi	a1,a1,462 # 7360 <malloc+0x18b8>
    319a:	00004517          	auipc	a0,0x4
    319e:	13e50513          	addi	a0,a0,318 # 72d8 <malloc+0x1830>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    31b2:	12a50513          	addi	a0,a0,298 # 72d8 <malloc+0x1830>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    31c8:	11450513          	addi	a0,a0,276 # 72d8 <malloc+0x1830>
  ...
  if(chdir("dd") != 0){
    ...
    31dc:	06050513          	addi	a0,a0,96 # 7238 <malloc+0x1790>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    31f0:	20c50513          	addi	a0,a0,524 # 73f8 <malloc+0x1950>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3204:	22850513          	addi	a0,a0,552 # 7428 <malloc+0x1980>
  ...
  if(chdir("./..") != 0){
    ...
    3218:	24450513          	addi	a0,a0,580 # 7458 <malloc+0x19b0>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    322e:	13650513          	addi	a0,a0,310 # 7360 <malloc+0x18b8>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    3246:	8be58593          	addi	a1,a1,-1858 # bb00 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3268:	07450513          	addi	a0,a0,116 # 72d8 <malloc+0x1830>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3280:	26c50513          	addi	a0,a0,620 # 74e8 <malloc+0x1a40>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3298:	28450513          	addi	a0,a0,644 # 7518 <malloc+0x1a70>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    32b0:	f8c50513          	addi	a0,a0,-116 # 7238 <malloc+0x1790>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    32c6:	f7650513          	addi	a0,a0,-138 # 7238 <malloc+0x1790>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    32dc:	f6050513          	addi	a0,a0,-160 # 7238 <malloc+0x1790>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    32f0:	2bc58593          	addi	a1,a1,700 # 75a8 <malloc+0x1b00>
    32f4:	00004517          	auipc	a0,0x4
    32f8:	1f450513          	addi	a0,a0,500 # 74e8 <malloc+0x1a40>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    330c:	2a058593          	addi	a1,a1,672 # 75a8 <malloc+0x1b00>
    3310:	00004517          	auipc	a0,0x4
    3314:	20850513          	addi	a0,a0,520 # 7518 <malloc+0x1a70>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    3328:	03c58593          	addi	a1,a1,60 # 7360 <malloc+0x18b8>
    332c:	00004517          	auipc	a0,0x4
    3330:	f2c50513          	addi	a0,a0,-212 # 7258 <malloc+0x17b0>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3344:	1a850513          	addi	a0,a0,424 # 74e8 <malloc+0x1a40>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    3358:	1c450513          	addi	a0,a0,452 # 7518 <malloc+0x1a70>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    336c:	ff850513          	addi	a0,a0,-8 # 7360 <malloc+0x18b8>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3380:	19c50513          	addi	a0,a0,412 # 7518 <malloc+0x1a70>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3394:	15850513          	addi	a0,a0,344 # 74e8 <malloc+0x1a40>
  ...
  if(chdir("dd/ff") == 0){
    ...
    33a8:	eb450513          	addi	a0,a0,-332 # 7258 <malloc+0x17b0>
  ...
  if(chdir("dd/xx") == 0){
    ...
    33bc:	34050513          	addi	a0,a0,832 # 76f8 <malloc+0x1c50>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    33d0:	f9450513          	addi	a0,a0,-108 # 7360 <malloc+0x18b8>
  ...
  if(unlink("dd/ff") != 0){
    ...
    33e4:	e7850513          	addi	a0,a0,-392 # 7258 <malloc+0x17b0>
  ...
  if(unlink("dd") == 0){
    ...
    33f8:	e4450513          	addi	a0,a0,-444 # 7238 <malloc+0x1790>
  ...
  if(unlink("dd/dd") < 0){
    ...
    340c:	36050513          	addi	a0,a0,864 # 7768 <malloc+0x1cc0>
  ...
  if(unlink("dd") < 0){
    ...
    3420:	e1c50513          	addi	a0,a0,-484 # 7238 <malloc+0x1790>
    ...
    3442:	e0250513          	addi	a0,a0,-510 # 7240 <malloc+0x1798>
    3446:	00002097          	auipc	ra,0x2
    344a:	5a2080e7          	jalr	1442(ra) # 59e8 <printf>
    exit(1);
    344e:	4505                	li	a0,1
    ...
    345e:	e0650513          	addi	a0,a0,-506 # 7260 <malloc+0x17b8>
    3462:	00002097          	auipc	ra,0x2
    3466:	586080e7          	jalr	1414(ra) # 59e8 <printf>
    exit(1);
    346a:	4505                	li	a0,1
    ...
    347a:	e0a50513          	addi	a0,a0,-502 # 7280 <malloc+0x17d8>
    347e:	00002097          	auipc	ra,0x2
    3482:	56a080e7          	jalr	1386(ra) # 59e8 <printf>
    exit(1);
    3486:	4505                	li	a0,1
    ...
    3496:	e2650513          	addi	a0,a0,-474 # 72b8 <malloc+0x1810>
    349a:	00002097          	auipc	ra,0x2
    349e:	54e080e7          	jalr	1358(ra) # 59e8 <printf>
    exit(1);
    34a2:	4505                	li	a0,1
    ...
    34b2:	e3a50513          	addi	a0,a0,-454 # 72e8 <malloc+0x1840>
    34b6:	00002097          	auipc	ra,0x2
    34ba:	532080e7          	jalr	1330(ra) # 59e8 <printf>
    exit(1);
    34be:	4505                	li	a0,1
    ...
    34ce:	e5650513          	addi	a0,a0,-426 # 7320 <malloc+0x1878>
    34d2:	00002097          	auipc	ra,0x2
    34d6:	516080e7          	jalr	1302(ra) # 59e8 <printf>
    exit(1);
    34da:	4505                	li	a0,1
    ...
    34ea:	e5a50513          	addi	a0,a0,-422 # 7340 <malloc+0x1898>
    34ee:	00002097          	auipc	ra,0x2
    34f2:	4fa080e7          	jalr	1274(ra) # 59e8 <printf>
    exit(1);
    34f6:	4505                	li	a0,1
    ...
    3506:	e6e50513          	addi	a0,a0,-402 # 7370 <malloc+0x18c8>
    350a:	00002097          	auipc	ra,0x2
    350e:	4de080e7          	jalr	1246(ra) # 59e8 <printf>
    exit(1);
    3512:	4505                	li	a0,1
    ...
    3522:	e7a50513          	addi	a0,a0,-390 # 7398 <malloc+0x18f0>
    3526:	00002097          	auipc	ra,0x2
    352a:	4c2080e7          	jalr	1218(ra) # 59e8 <printf>
    exit(1);
    352e:	4505                	li	a0,1
    ...
    353e:	e7e50513          	addi	a0,a0,-386 # 73b8 <malloc+0x1910>
    3542:	00002097          	auipc	ra,0x2
    3546:	4a6080e7          	jalr	1190(ra) # 59e8 <printf>
    exit(1);
    354a:	4505                	li	a0,1
    ...
    355a:	e8a50513          	addi	a0,a0,-374 # 73e0 <malloc+0x1938>
    355e:	00002097          	auipc	ra,0x2
    3562:	48a080e7          	jalr	1162(ra) # 59e8 <printf>
    exit(1);
    3566:	4505                	li	a0,1
    ...
    3576:	e9650513          	addi	a0,a0,-362 # 7408 <malloc+0x1960>
    357a:	00002097          	auipc	ra,0x2
    357e:	46e080e7          	jalr	1134(ra) # 59e8 <printf>
    exit(1);
    3582:	4505                	li	a0,1
    ...
    3592:	eaa50513          	addi	a0,a0,-342 # 7438 <malloc+0x1990>
    3596:	00002097          	auipc	ra,0x2
    359a:	452080e7          	jalr	1106(ra) # 59e8 <printf>
    exit(1);
    359e:	4505                	li	a0,1
    ...
    35ae:	eb650513          	addi	a0,a0,-330 # 7460 <malloc+0x19b8>
    35b2:	00002097          	auipc	ra,0x2
    35b6:	436080e7          	jalr	1078(ra) # 59e8 <printf>
    exit(1);
    35ba:	4505                	li	a0,1
    ...
    35ca:	eb250513          	addi	a0,a0,-334 # 7478 <malloc+0x19d0>
    35ce:	00002097          	auipc	ra,0x2
    35d2:	41a080e7          	jalr	1050(ra) # 59e8 <printf>
    exit(1);
    35d6:	4505                	li	a0,1
    ...
    35e6:	eb650513          	addi	a0,a0,-330 # 7498 <malloc+0x19f0>
    35ea:	00002097          	auipc	ra,0x2
    35ee:	3fe080e7          	jalr	1022(ra) # 59e8 <printf>
    exit(1);
    35f2:	4505                	li	a0,1
    ...
    3602:	eba50513          	addi	a0,a0,-326 # 74b8 <malloc+0x1a10>
    3606:	00002097          	auipc	ra,0x2
    360a:	3e2080e7          	jalr	994(ra) # 59e8 <printf>
    exit(1);
    360e:	4505                	li	a0,1
    ...
    361e:	ede50513          	addi	a0,a0,-290 # 74f8 <malloc+0x1a50>
    3622:	00002097          	auipc	ra,0x2
    3626:	3c6080e7          	jalr	966(ra) # 59e8 <printf>
    exit(1);
    362a:	4505                	li	a0,1
    ...
    363a:	ef250513          	addi	a0,a0,-270 # 7528 <malloc+0x1a80>
    363e:	00002097          	auipc	ra,0x2
    3642:	3aa080e7          	jalr	938(ra) # 59e8 <printf>
    exit(1);
    3646:	4505                	li	a0,1
    ...
    3656:	ef650513          	addi	a0,a0,-266 # 7548 <malloc+0x1aa0>
    365a:	00002097          	auipc	ra,0x2
    365e:	38e080e7          	jalr	910(ra) # 59e8 <printf>
    exit(1);
    3662:	4505                	li	a0,1
    ...
    3672:	efa50513          	addi	a0,a0,-262 # 7568 <malloc+0x1ac0>
    3676:	00002097          	auipc	ra,0x2
    367a:	372080e7          	jalr	882(ra) # 59e8 <printf>
    exit(1);
    367e:	4505                	li	a0,1
    ...
    368e:	efe50513          	addi	a0,a0,-258 # 7588 <malloc+0x1ae0>
    3692:	00002097          	auipc	ra,0x2
    3696:	356080e7          	jalr	854(ra) # 59e8 <printf>
    exit(1);
    369a:	4505                	li	a0,1
    ...
    36aa:	f1250513          	addi	a0,a0,-238 # 75b8 <malloc+0x1b10>
    36ae:	00002097          	auipc	ra,0x2
    36b2:	33a080e7          	jalr	826(ra) # 59e8 <printf>
    exit(1);
    36b6:	4505                	li	a0,1
    ...
    36c6:	f1e50513          	addi	a0,a0,-226 # 75e0 <malloc+0x1b38>
    36ca:	00002097          	auipc	ra,0x2
    36ce:	31e080e7          	jalr	798(ra) # 59e8 <printf>
    exit(1);
    36d2:	4505                	li	a0,1
    ...
    36e2:	f2a50513          	addi	a0,a0,-214 # 7608 <malloc+0x1b60>
    36e6:	00002097          	auipc	ra,0x2
    36ea:	302080e7          	jalr	770(ra) # 59e8 <printf>
    exit(1);
    36ee:	4505                	li	a0,1
    ...
    36fe:	f3650513          	addi	a0,a0,-202 # 7630 <malloc+0x1b88>
    3702:	00002097          	auipc	ra,0x2
    3706:	2e6080e7          	jalr	742(ra) # 59e8 <printf>
    exit(1);
    370a:	4505                	li	a0,1
    ...
    371a:	f3a50513          	addi	a0,a0,-198 # 7650 <malloc+0x1ba8>
    371e:	00002097          	auipc	ra,0x2
    3722:	2ca080e7          	jalr	714(ra) # 59e8 <printf>
    exit(1);
    3726:	4505                	li	a0,1
    ...
    3736:	f3e50513          	addi	a0,a0,-194 # 7670 <malloc+0x1bc8>
    373a:	00002097          	auipc	ra,0x2
    373e:	2ae080e7          	jalr	686(ra) # 59e8 <printf>
    exit(1);
    3742:	4505                	li	a0,1
    ...
    3752:	f4a50513          	addi	a0,a0,-182 # 7698 <malloc+0x1bf0>
    3756:	00002097          	auipc	ra,0x2
    375a:	292080e7          	jalr	658(ra) # 59e8 <printf>
    exit(1);
    375e:	4505                	li	a0,1
    ...
    376e:	f4e50513          	addi	a0,a0,-178 # 76b8 <malloc+0x1c10>
    3772:	00002097          	auipc	ra,0x2
    3776:	276080e7          	jalr	630(ra) # 59e8 <printf>
    exit(1);
    377a:	4505                	li	a0,1
    ...
    378a:	f5250513          	addi	a0,a0,-174 # 76d8 <malloc+0x1c30>
    378e:	00002097          	auipc	ra,0x2
    3792:	25a080e7          	jalr	602(ra) # 59e8 <printf>
    exit(1);
    3796:	4505                	li	a0,1
    ...
    37a6:	f5e50513          	addi	a0,a0,-162 # 7700 <malloc+0x1c58>
    37aa:	00002097          	auipc	ra,0x2
    37ae:	23e080e7          	jalr	574(ra) # 59e8 <printf>
    exit(1);
    37b2:	4505                	li	a0,1
    ...
    37c2:	bda50513          	addi	a0,a0,-1062 # 7398 <malloc+0x18f0>
    37c6:	00002097          	auipc	ra,0x2
    37ca:	222080e7          	jalr	546(ra) # 59e8 <printf>
    exit(1);
    37ce:	4505                	li	a0,1
    ...
    37de:	f4650513          	addi	a0,a0,-186 # 7720 <malloc+0x1c78>
    37e2:	00002097          	auipc	ra,0x2
    37e6:	206080e7          	jalr	518(ra) # 59e8 <printf>
    exit(1);
    37ea:	4505                	li	a0,1
    ...
    37fa:	f4a50513          	addi	a0,a0,-182 # 7740 <malloc+0x1c98>
    37fe:	00002097          	auipc	ra,0x2
    3802:	1ea080e7          	jalr	490(ra) # 59e8 <printf>
    exit(1);
    3806:	4505                	li	a0,1
    ...
    3816:	f5e50513          	addi	a0,a0,-162 # 7770 <malloc+0x1cc8>
    381a:	00002097          	auipc	ra,0x2
    381e:	1ce080e7          	jalr	462(ra) # 59e8 <printf>
    exit(1);
    3822:	4505                	li	a0,1
    ...
    3832:	f6250513          	addi	a0,a0,-158 # 7790 <malloc+0x1ce8>
    3836:	00002097          	auipc	ra,0x2
    383a:	1b2080e7          	jalr	434(ra) # 59e8 <printf>
    exit(1);
    383e:	4505                	li	a0,1
...
0000000000003848 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3858:	f5450513          	addi	a0,a0,-172 # 77a8 <malloc+0x1d00>
  ...
  if(chdir("dots") != 0){
    ...
    386a:	f4250513          	addi	a0,a0,-190 # 77a8 <malloc+0x1d00>
  ...
  if(unlink(".") == 0){
    ...
    387c:	dd850513          	addi	a0,a0,-552 # 6650 <malloc+0xba8>
  ...
  if(unlink("..") == 0){
    ...
    388e:	97650513          	addi	a0,a0,-1674 # 7200 <malloc+0x1758>
  ...
  if(chdir("/") != 0){
    ...
    38a0:	90c50513          	addi	a0,a0,-1780 # 71a8 <malloc+0x1700>
  ...
  if(unlink("dots/.") == 0){
    ...
    38b2:	f6250513          	addi	a0,a0,-158 # 7810 <malloc+0x1d68>
  ...
  if(unlink("dots/..") == 0){
    ...
    38c4:	f7850513          	addi	a0,a0,-136 # 7838 <malloc+0x1d90>
  ...
  if(unlink("dots") != 0){
    ...
    38d6:	ed650513          	addi	a0,a0,-298 # 77a8 <malloc+0x1d00>
    ...
    38f4:	ec050513          	addi	a0,a0,-320 # 77b0 <malloc+0x1d08>
    38f8:	00002097          	auipc	ra,0x2
    38fc:	0f0080e7          	jalr	240(ra) # 59e8 <printf>
    exit(1);
    3900:	4505                	li	a0,1
    ...
    3910:	ebc50513          	addi	a0,a0,-324 # 77c8 <malloc+0x1d20>
    3914:	00002097          	auipc	ra,0x2
    3918:	0d4080e7          	jalr	212(ra) # 59e8 <printf>
    exit(1);
    391c:	4505                	li	a0,1
    ...
    392c:	eb850513          	addi	a0,a0,-328 # 77e0 <malloc+0x1d38>
    3930:	00002097          	auipc	ra,0x2
    3934:	0b8080e7          	jalr	184(ra) # 59e8 <printf>
    exit(1);
    3938:	4505                	li	a0,1
    ...
    3948:	eb450513          	addi	a0,a0,-332 # 77f8 <malloc+0x1d50>
    394c:	00002097          	auipc	ra,0x2
    3950:	09c080e7          	jalr	156(ra) # 59e8 <printf>
    exit(1);
    3954:	4505                	li	a0,1
    ...
    3964:	85050513          	addi	a0,a0,-1968 # 71b0 <malloc+0x1708>
    3968:	00002097          	auipc	ra,0x2
    396c:	080080e7          	jalr	128(ra) # 59e8 <printf>
    exit(1);
    3970:	4505                	li	a0,1
    ...
    3980:	e9c50513          	addi	a0,a0,-356 # 7818 <malloc+0x1d70>
    3984:	00002097          	auipc	ra,0x2
    3988:	064080e7          	jalr	100(ra) # 59e8 <printf>
    exit(1);
    398c:	4505                	li	a0,1
    ...
    399c:	ea850513          	addi	a0,a0,-344 # 7840 <malloc+0x1d98>
    39a0:	00002097          	auipc	ra,0x2
    39a4:	048080e7          	jalr	72(ra) # 59e8 <printf>
    exit(1);
    39a8:	4505                	li	a0,1
    ...
    39b8:	eac50513          	addi	a0,a0,-340 # 7860 <malloc+0x1db8>
    39bc:	00002097          	auipc	ra,0x2
    39c0:	02c080e7          	jalr	44(ra) # 59e8 <printf>
    exit(1);
    39c4:	4505                	li	a0,1
...
00000000000039ce <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    39e4:	ea050513          	addi	a0,a0,-352 # 7880 <malloc+0x1dd8>
  ...
  if(chdir("dirfile") == 0){
    ...
    3a00:	e8450513          	addi	a0,a0,-380 # 7880 <malloc+0x1dd8>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3a14:	eb850513          	addi	a0,a0,-328 # 78c8 <malloc+0x1e20>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3a2c:	ea050513          	addi	a0,a0,-352 # 78c8 <malloc+0x1e20>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3a40:	e8c50513          	addi	a0,a0,-372 # 78c8 <malloc+0x1e20>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3a54:	e7850513          	addi	a0,a0,-392 # 78c8 <malloc+0x1e20>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3a68:	e6458593          	addi	a1,a1,-412 # 78c8 <malloc+0x1e20>
    3a6c:	00002517          	auipc	a0,0x2
    3a70:	6d450513          	addi	a0,a0,1748 # 6140 <malloc+0x698>
  ...
  if(unlink("dirfile") != 0){
    ...
    3a84:	e0050513          	addi	a0,a0,-512 # 7880 <malloc+0x1dd8>
  ...
  fd = open(".", O_RDWR);
    ...
    3a9a:	bba50513          	addi	a0,a0,-1094 # 6650 <malloc+0xba8>
  ...
  fd = open(".", 0);
    ...
    3ab0:	ba450513          	addi	a0,a0,-1116 # 6650 <malloc+0xba8>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3ac4:	54858593          	addi	a1,a1,1352 # 6008 <malloc+0x560>
  ...
  close(fd);
    ...
    3af0:	d9c50513          	addi	a0,a0,-612 # 7888 <malloc+0x1de0>
    3af4:	00002097          	auipc	ra,0x2
    3af8:	ef4080e7          	jalr	-268(ra) # 59e8 <printf>
    exit(1);
    3afc:	4505                	li	a0,1
    ...
    3b0c:	da050513          	addi	a0,a0,-608 # 78a8 <malloc+0x1e00>
    3b10:	00002097          	auipc	ra,0x2
    3b14:	ed8080e7          	jalr	-296(ra) # 59e8 <printf>
    exit(1);
    3b18:	4505                	li	a0,1
    ...
    3b28:	db450513          	addi	a0,a0,-588 # 78d8 <malloc+0x1e30>
    3b2c:	00002097          	auipc	ra,0x2
    3b30:	ebc080e7          	jalr	-324(ra) # 59e8 <printf>
    exit(1);
    3b34:	4505                	li	a0,1
    ...
    3b44:	d9850513          	addi	a0,a0,-616 # 78d8 <malloc+0x1e30>
    3b48:	00002097          	auipc	ra,0x2
    3b4c:	ea0080e7          	jalr	-352(ra) # 59e8 <printf>
    exit(1);
    3b50:	4505                	li	a0,1
    ...
    3b60:	da450513          	addi	a0,a0,-604 # 7900 <malloc+0x1e58>
    3b64:	00002097          	auipc	ra,0x2
    3b68:	e84080e7          	jalr	-380(ra) # 59e8 <printf>
    exit(1);
    3b6c:	4505                	li	a0,1
    ...
    3b7c:	db050513          	addi	a0,a0,-592 # 7928 <malloc+0x1e80>
    3b80:	00002097          	auipc	ra,0x2
    3b84:	e68080e7          	jalr	-408(ra) # 59e8 <printf>
    exit(1);
    3b88:	4505                	li	a0,1
    ...
    3b98:	dbc50513          	addi	a0,a0,-580 # 7950 <malloc+0x1ea8>
    3b9c:	00002097          	auipc	ra,0x2
    3ba0:	e4c080e7          	jalr	-436(ra) # 59e8 <printf>
    exit(1);
    3ba4:	4505                	li	a0,1
    ...
    3bb4:	dc850513          	addi	a0,a0,-568 # 7978 <malloc+0x1ed0>
    3bb8:	00002097          	auipc	ra,0x2
    3bbc:	e30080e7          	jalr	-464(ra) # 59e8 <printf>
    exit(1);
    3bc0:	4505                	li	a0,1
    ...
    3bd0:	dcc50513          	addi	a0,a0,-564 # 7998 <malloc+0x1ef0>
    3bd4:	00002097          	auipc	ra,0x2
    3bd8:	e14080e7          	jalr	-492(ra) # 59e8 <printf>
    exit(1);
    3bdc:	4505                	li	a0,1
    ...
    3bec:	dd850513          	addi	a0,a0,-552 # 79c0 <malloc+0x1f18>
    3bf0:	00002097          	auipc	ra,0x2
    3bf4:	df8080e7          	jalr	-520(ra) # 59e8 <printf>
    exit(1);
    3bf8:	4505                	li	a0,1
...
0000000000003c02 <iref>:
{
    ...
    3c20:	dbca0a13          	addi	s4,s4,-580 # 79d8 <malloc+0x1f30>
    mkdir("");
    3c24:	00004497          	auipc	s1,0x4
    3c28:	8bc48493          	addi	s1,s1,-1860 # 74e0 <malloc+0x1a38>
    link("README", "");
    3c2c:	00002a97          	auipc	s5,0x2
    3c30:	514a8a93          	addi	s5,s5,1300 # 6140 <malloc+0x698>
    fd = open("xx", O_CREATE);
    3c34:	00004997          	auipc	s3,0x4
    3c38:	c9c98993          	addi	s3,s3,-868 # 78d0 <malloc+0x1e28>
    3c3c:	a891                	j	3c90 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3c3e:	85da                	mv	a1,s6
    3c40:	00004517          	auipc	a0,0x4
    3c44:	da050513          	addi	a0,a0,-608 # 79e0 <malloc+0x1f38>
    3c48:	00002097          	auipc	ra,0x2
    3c4c:	da0080e7          	jalr	-608(ra) # 59e8 <printf>
      exit(1);
    3c50:	4505                	li	a0,1
    ...
    3c60:	d9c50513          	addi	a0,a0,-612 # 79f8 <malloc+0x1f50>
    3c64:	00002097          	auipc	ra,0x2
    3c68:	d84080e7          	jalr	-636(ra) # 59e8 <printf>
      exit(1);
    3c6c:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3cf4:	51098993          	addi	s3,s3,1296 # 7200 <malloc+0x1758>
    unlink("irefd");
    3cf8:	00004917          	auipc	s2,0x4
    3cfc:	ce090913          	addi	s2,s2,-800 # 79d8 <malloc+0x1f30>
    chdir("..");
    3d00:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3d1c:	49050513          	addi	a0,a0,1168 # 71a8 <malloc+0x1700>
...
0000000000003d3c <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3d4c:	cc850513          	addi	a0,a0,-824 # 7a10 <malloc+0x1f68>
  ...
  if(pid == 0){
    ...
    3d70:	ca450513          	addi	a0,a0,-860 # 7a10 <malloc+0x1f68>
    ...
    3d86:	cae50513          	addi	a0,a0,-850 # 7a30 <malloc+0x1f88>
    3d8a:	00002097          	auipc	ra,0x2
    3d8e:	c5e080e7          	jalr	-930(ra) # 59e8 <printf>
      exit(1);
    3d92:	4505                	li	a0,1
    ...
    3da2:	c7a50513          	addi	a0,a0,-902 # 7a18 <malloc+0x1f70>
    3da6:	00002097          	auipc	ra,0x2
    3daa:	c42080e7          	jalr	-958(ra) # 59e8 <printf>
    exit(1);
    3dae:	4505                	li	a0,1
    ...
    3dbe:	a3650513          	addi	a0,a0,-1482 # 67f0 <malloc+0xd48>
    3dc2:	00002097          	auipc	ra,0x2
    3dc6:	c26080e7          	jalr	-986(ra) # 59e8 <printf>
    exit(1);
    3dca:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3dec:	c2850513          	addi	a0,a0,-984 # 7a10 <malloc+0x1f68>
    ...
    3e00:	be450513          	addi	a0,a0,-1052 # 69e0 <malloc+0xf38>
    3e04:	00002097          	auipc	ra,0x2
    3e08:	be4080e7          	jalr	-1052(ra) # 59e8 <printf>
    exit(1);
    3e0c:	4505                	li	a0,1
...
0000000000003e2e <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3e3e:	c1e50513          	addi	a0,a0,-994 # 7a58 <malloc+0x1fb0>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3e6a:	bf250513          	addi	a0,a0,-1038 # 7a58 <malloc+0x1fb0>
  ...
  sleep(10); // one second
    ...
    3ea2:	b1250513          	addi	a0,a0,-1262 # 69b0 <malloc+0xf08>
    3ea6:	00002097          	auipc	ra,0x2
    3eaa:	b42080e7          	jalr	-1214(ra) # 59e8 <printf>
    exit(1);
    3eae:	4505                	li	a0,1
    ...
    3ebc:	ba048493          	addi	s1,s1,-1120 # 7a58 <malloc+0x1fb0>
    3ec0:	4581                	li	a1,0
    3ec2:	8526                	mv	a0,s1
...
0000000000003efe <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3f28:	a8c50513          	addi	a0,a0,-1396 # 69b0 <malloc+0xf08>
    3f2c:	00002097          	auipc	ra,0x2
    3f30:	abc080e7          	jalr	-1348(ra) # 59e8 <printf>
    exit(1);
    3f34:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    3f56:	89e50513          	addi	a0,a0,-1890 # 67f0 <malloc+0xd48>
    3f5a:	00002097          	auipc	ra,0x2
    3f5e:	a8e080e7          	jalr	-1394(ra) # 59e8 <printf>
    exit(1);
    3f62:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    3f9a:	07258593          	addi	a1,a1,114 # 6008 <malloc+0x560>
    ...
    3fc4:	83050513          	addi	a0,a0,-2000 # 67f0 <malloc+0xd48>
    3fc8:	00002097          	auipc	ra,0x2
    3fcc:	a20080e7          	jalr	-1504(ra) # 59e8 <printf>
     exit(1);
    3fd0:	4505                	li	a0,1
    ...
    3fe0:	a8c50513          	addi	a0,a0,-1396 # 7a68 <malloc+0x1fc0>
    3fe4:	00002097          	auipc	ra,0x2
    3fe8:	a04080e7          	jalr	-1532(ra) # 59e8 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4000:	b0458593          	addi	a1,a1,-1276 # bb00 <buf>
    ...
    401c:	a6850513          	addi	a0,a0,-1432 # 7a80 <malloc+0x1fd8>
    4020:	00002097          	auipc	ra,0x2
    4024:	9c8080e7          	jalr	-1592(ra) # 59e8 <printf>
}
  ...
  printf("kill... ");
    ...
    4048:	a5450513          	addi	a0,a0,-1452 # 7a98 <malloc+0x1ff0>
    404c:	00002097          	auipc	ra,0x2
    4050:	99c080e7          	jalr	-1636(ra) # 59e8 <printf>
  kill(pid1);
    4054:	854e                	mv	a0,s3
  ...
  printf("wait... ");
    ...
    4076:	a3650513          	addi	a0,a0,-1482 # 7aa8 <malloc+0x2000>
    407a:	00002097          	auipc	ra,0x2
    407e:	96e080e7          	jalr	-1682(ra) # 59e8 <printf>
  wait(0);
    4082:	4501                	li	a0,0
...
00000000000040a2 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    40d8:	82450513          	addi	a0,a0,-2012 # 68f8 <malloc+0xe50>
    40dc:	00002097          	auipc	ra,0x2
    40e0:	90c080e7          	jalr	-1780(ra) # 59e8 <printf>
    exit(1);
    40e4:	4505                	li	a0,1
    ...
    410c:	f0058593          	addi	a1,a1,-256 # 6008 <malloc+0x560>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    41d0:	8ec50513          	addi	a0,a0,-1812 # 7ab8 <malloc+0x2010>
    41d4:	00002097          	auipc	ra,0x2
    41d8:	814080e7          	jalr	-2028(ra) # 59e8 <printf>
    exit(1);
    41dc:	4505                	li	a0,1
    ...
    41ec:	60850513          	addi	a0,a0,1544 # 67f0 <malloc+0xd48>
    41f0:	00001097          	auipc	ra,0x1
    41f4:	7f8080e7          	jalr	2040(ra) # 59e8 <printf>
    exit(1);
    41f8:	4505                	li	a0,1
    ...
    4238:	8a450513          	addi	a0,a0,-1884 # 7ad8 <malloc+0x2030>
    423c:	00001097          	auipc	ra,0x1
    4240:	7ac080e7          	jalr	1964(ra) # 59e8 <printf>
    exit(1);
    4244:	4505                	li	a0,1
...
0000000000004258 <reparent>:
{
  ...
  exit(0);
    ...
    42ac:	54850513          	addi	a0,a0,1352 # 67f0 <malloc+0xd48>
    42b0:	00001097          	auipc	ra,0x1
    42b4:	738080e7          	jalr	1848(ra) # 59e8 <printf>
      exit(1);
    42b8:	4505                	li	a0,1
    ...
    42c8:	6b450513          	addi	a0,a0,1716 # 6978 <malloc+0xed0>
    42cc:	00001097          	auipc	ra,0x1
    42d0:	71c080e7          	jalr	1820(ra) # 59e8 <printf>
        exit(1);
    42d4:	4505                	li	a0,1
...
0000000000004308 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4330:	77c080e7          	jalr	1916(ra) # 5aa8 <malloc>
    ...
    4348:	6da080e7          	jalr	1754(ra) # 5a1e <free>
      m1 = m2;
    434c:	84ca                	mv	s1,s2
    while(m1){
    ...
    4358:	754080e7          	jalr	1876(ra) # 5aa8 <malloc>
    if(m1 == 0){
    435c:	c911                	beqz	a0,4370 <mem+0x68>
    free(m1);
    435e:	00001097          	auipc	ra,0x1
    4362:	6c0080e7          	jalr	1728(ra) # 5a1e <free>
    exit(0);
    4366:	4501                	li	a0,0
    ...
    4376:	79650513          	addi	a0,a0,1942 # 7b08 <malloc+0x2060>
    437a:	00001097          	auipc	ra,0x1
    437e:	66e080e7          	jalr	1646(ra) # 59e8 <printf>
      exit(1);
    4382:	4505                	li	a0,1
...
00000000000043b4 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    444a:	6f250513          	addi	a0,a0,1778 # 7b38 <malloc+0x2090>
    444e:	00001097          	auipc	ra,0x1
    4452:	59a080e7          	jalr	1434(ra) # 59e8 <printf>
    exit(1);
    4456:	4505                	li	a0,1
    ...
    4466:	6fe50513          	addi	a0,a0,1790 # 7b60 <malloc+0x20b8>
    446a:	00001097          	auipc	ra,0x1
    446e:	57e080e7          	jalr	1406(ra) # 59e8 <printf>
      exit(1);
    4472:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    44aa:	68250513          	addi	a0,a0,1666 # 7b28 <malloc+0x2080>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    44ea:	69a50513          	addi	a0,a0,1690 # 7b80 <malloc+0x20d8>
    44ee:	00001097          	auipc	ra,0x1
    44f2:	4fa080e7          	jalr	1274(ra) # 59e8 <printf>
    exit(1);
    44f6:	4505                	li	a0,1
    ...
    4504:	fd2783e3          	beq	a5,s2,44ca <sharedfd+0x116>
      if(buf[i] == 'c')
    4508:	0007c703          	lbu	a4,0(a5) # 3e800000 <_end+0x3e7f14f0>
  ...
  unlink("sharedfd");
    ...
    4526:	60650513          	addi	a0,a0,1542 # 7b28 <malloc+0x2080>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    454c:	66050513          	addi	a0,a0,1632 # 7ba8 <malloc+0x2100>
    4550:	00001097          	auipc	ra,0x1
    4554:	498080e7          	jalr	1176(ra) # 59e8 <printf>
    exit(1);
    4558:	4505                	li	a0,1
...
000000000000456c <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4590:	63478793          	addi	a5,a5,1588 # 7bc0 <malloc+0x2118>
    4594:	f6f43823          	sd	a5,-144(s0)
    4598:	00003797          	auipc	a5,0x3
    459c:	63078793          	addi	a5,a5,1584 # 7bc8 <malloc+0x2120>
    45a0:	f6f43c23          	sd	a5,-136(s0)
    45a4:	00003797          	auipc	a5,0x3
    45a8:	62c78793          	addi	a5,a5,1580 # 7bd0 <malloc+0x2128>
    45ac:	f8f43023          	sd	a5,-128(s0)
    45b0:	00003797          	auipc	a5,0x3
    45b4:	62878793          	addi	a5,a5,1576 # 7bd8 <malloc+0x2130>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    460c:	4f898993          	addi	s3,s3,1272 # bb00 <buf>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4622:	5da50513          	addi	a0,a0,1498 # 6bf8 <malloc+0x1150>
    4626:	00001097          	auipc	ra,0x1
    462a:	3c2080e7          	jalr	962(ra) # 59e8 <printf>
      exit(1);
    462e:	4505                	li	a0,1
    ...
    469a:	54a50513          	addi	a0,a0,1354 # 7be0 <malloc+0x2138>
    469e:	00001097          	auipc	ra,0x1
    46a2:	34a080e7          	jalr	842(ra) # 59e8 <printf>
        exit(1);
    46a6:	4505                	li	a0,1
    ...
    46b6:	53e50513          	addi	a0,a0,1342 # 7bf0 <malloc+0x2148>
    46ba:	00001097          	auipc	ra,0x1
    46be:	32e080e7          	jalr	814(ra) # 59e8 <printf>
          exit(1);
    46c2:	4505                	li	a0,1
    ...
    46f6:	40f78793          	addi	a5,a5,1039 # bb01 <buf+0x1>
    ...
    4718:	4f450513          	addi	a0,a0,1268 # 7c08 <malloc+0x2160>
    471c:	00001097          	auipc	ra,0x1
    4720:	2cc080e7          	jalr	716(ra) # 59e8 <printf>
          exit(1);
    4724:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    476e:	4ae50513          	addi	a0,a0,1198 # 7c18 <malloc+0x2170>
    4772:	00001097          	auipc	ra,0x1
    4776:	276080e7          	jalr	630(ra) # 59e8 <printf>
      exit(1);
    477a:	4505                	li	a0,1
...
00000000000047a2 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    47d0:	464b8b93          	addi	s7,s7,1124 # 7c30 <malloc+0x2188>
  for(i = 0; i < N; i++){
    ...
    4812:	42a50513          	addi	a0,a0,1066 # 7c38 <malloc+0x2190>
    4816:	00001097          	auipc	ra,0x1
    481a:	1d2080e7          	jalr	466(ra) # 59e8 <printf>
        exit(1);
    481e:	4505                	li	a0,1
    ...
    4830:	40450513          	addi	a0,a0,1028 # 7c30 <malloc+0x2188>
  ...
  fd = open(".", 0);
    ...
    4868:	dec50513          	addi	a0,a0,-532 # 6650 <malloc+0xba8>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    48de:	37e50513          	addi	a0,a0,894 # 7c58 <malloc+0x21b0>
    48e2:	00001097          	auipc	ra,0x1
    48e6:	106080e7          	jalr	262(ra) # 59e8 <printf>
        exit(1);
    48ea:	4505                	li	a0,1
    ...
    48fe:	37e50513          	addi	a0,a0,894 # 7c78 <malloc+0x21d0>
    4902:	00001097          	auipc	ra,0x1
    4906:	0e6080e7          	jalr	230(ra) # 59e8 <printf>
        exit(1);
    490a:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4936:	36e50513          	addi	a0,a0,878 # 7ca0 <malloc+0x21f8>
    493a:	00001097          	auipc	ra,0x1
    493e:	0ae080e7          	jalr	174(ra) # 59e8 <printf>
    exit(1);
    4942:	4505                	li	a0,1
    ...
    4952:	ea250513          	addi	a0,a0,-350 # 67f0 <malloc+0xd48>
    4956:	00001097          	auipc	ra,0x1
    495a:	092080e7          	jalr	146(ra) # 59e8 <printf>
      exit(1);
    495e:	4505                	li	a0,1
...
0000000000004afc <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4b3c:	fc890913          	addi	s2,s2,-56 # bb00 <buf>
  for(i = 0; i < N; i++){
    4b40:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4b84:	15850513          	addi	a0,a0,344 # 7cd8 <malloc+0x2230>
  ...
  for(i = 0; ; i++){
    ...
    4b9a:	f6a90913          	addi	s2,s2,-150 # bb00 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4be8:	10450513          	addi	a0,a0,260 # 7ce8 <malloc+0x2240>
    4bec:	00001097          	auipc	ra,0x1
    4bf0:	dfc080e7          	jalr	-516(ra) # 59e8 <printf>
    exit(1);
    4bf4:	4505                	li	a0,1
    ...
    4c04:	10850513          	addi	a0,a0,264 # 7d08 <malloc+0x2260>
    4c08:	00001097          	auipc	ra,0x1
    4c0c:	de0080e7          	jalr	-544(ra) # 59e8 <printf>
      exit(1);
    4c10:	4505                	li	a0,1
    ...
    4c20:	10c50513          	addi	a0,a0,268 # 7d28 <malloc+0x2280>
    4c24:	00001097          	auipc	ra,0x1
    4c28:	dc4080e7          	jalr	-572(ra) # 59e8 <printf>
    exit(1);
    4c2c:	4505                	li	a0,1
    ...
    4c3c:	11050513          	addi	a0,a0,272 # 7d48 <malloc+0x22a0>
    4c40:	00001097          	auipc	ra,0x1
    4c44:	da8080e7          	jalr	-600(ra) # 59e8 <printf>
      exit(1);
    4c48:	4505                	li	a0,1
    ...
    4c58:	11450513          	addi	a0,a0,276 # 7d68 <malloc+0x22c0>
    4c5c:	00001097          	auipc	ra,0x1
    4c60:	d8c080e7          	jalr	-628(ra) # 59e8 <printf>
      exit(1);
    4c64:	4505                	li	a0,1
    ...
    4c74:	11050513          	addi	a0,a0,272 # 7d80 <malloc+0x22d8>
    4c78:	00001097          	auipc	ra,0x1
    4c7c:	d70080e7          	jalr	-656(ra) # 59e8 <printf>
      exit(1);
    4c80:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4ca2:	03a50513          	addi	a0,a0,58 # 7cd8 <malloc+0x2230>
    ...
    4cc6:	0de50513          	addi	a0,a0,222 # 7da0 <malloc+0x22f8>
    4cca:	00001097          	auipc	ra,0x1
    4cce:	d1e080e7          	jalr	-738(ra) # 59e8 <printf>
    exit(1);
    4cd2:	4505                	li	a0,1
...
0000000000004cdc <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4cfe:	0c650513          	addi	a0,a0,198 # 7dc0 <malloc+0x2318>
    4d02:	00001097          	auipc	ra,0x1
    4d06:	ce6080e7          	jalr	-794(ra) # 59e8 <printf>
  for(nfiles = 0; ; nfiles++){
    4d0a:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4d1e:	0b6c8c93          	addi	s9,s9,182 # 7dd0 <malloc+0x2328>
    int total = 0;
    4d22:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4d24:	00007a17          	auipc	s4,0x7
    4d28:	ddca0a13          	addi	s4,s4,-548 # bb00 <buf>
    name[0] = 'f';
    ...
    4d76:	c76080e7          	jalr	-906(ra) # 59e8 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4d98:	04c50513          	addi	a0,a0,76 # 7de0 <malloc+0x2338>
    4d9c:	00001097          	auipc	ra,0x1
    4da0:	c4c080e7          	jalr	-948(ra) # 59e8 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    4e0e:	ff650513          	addi	a0,a0,-10 # 7e00 <malloc+0x2358>
    4e12:	00001097          	auipc	ra,0x1
    4e16:	bd6080e7          	jalr	-1066(ra) # 59e8 <printf>
}
    ...
    4e5e:	f9650513          	addi	a0,a0,-106 # 7df0 <malloc+0x2348>
    4e62:	00001097          	auipc	ra,0x1
    4e66:	b86080e7          	jalr	-1146(ra) # 59e8 <printf>
    close(fd);
    4e6a:	854e                	mv	a0,s3
...
0000000000004e7c <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    4e86:	45670713          	addi	a4,a4,1110 # 82d8 <randstate>
    4e8a:	6308                	ld	a0,0(a4)
    4e8c:	001967b7          	lui	a5,0x196
    4e90:	60d78793          	addi	a5,a5,1549 # 19660d <_end+0x187afd>
    4e94:	02f50533          	mul	a0,a0,a5
    4e98:	3c6ef7b7          	lui	a5,0x3c6ef
    4e9c:	35f78793          	addi	a5,a5,863 # 3c6ef35f <_end+0x3c6e084f>
...
0000000000004eac <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    4f20:	efc50513          	addi	a0,a0,-260 # 7e18 <malloc+0x2370>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    4f38:	0d458593          	addi	a1,a1,212 # 6008 <malloc+0x560>
    ...
    4f4e:	eee50513          	addi	a0,a0,-274 # 7e38 <malloc+0x2390>
    4f52:	00001097          	auipc	ra,0x1
    4f56:	a96080e7          	jalr	-1386(ra) # 59e8 <printf>
    exit(1);
    4f5a:	4505                	li	a0,1
    ...
    4f68:	ebc50513          	addi	a0,a0,-324 # 7e20 <malloc+0x2378>
    4f6c:	00001097          	auipc	ra,0x1
    4f70:	a7c080e7          	jalr	-1412(ra) # 59e8 <printf>
      exit(1);
    4f74:	4505                	li	a0,1
    ...
    4f82:	ea250513          	addi	a0,a0,-350 # 7e20 <malloc+0x2378>
    4f86:	00001097          	auipc	ra,0x1
    4f8a:	a62080e7          	jalr	-1438(ra) # 59e8 <printf>
    exit(1);
    4f8e:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    4fa6:	e7650513          	addi	a0,a0,-394 # 7e18 <malloc+0x2370>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    4ffc:	01090913          	addi	s2,s2,16 # 6008 <malloc+0x560>
      uint64 a = (uint64) sbrk(4096);
    ...
    5030:	e5c50513          	addi	a0,a0,-420 # 7e88 <malloc+0x23e0>
    5034:	00001097          	auipc	ra,0x1
    5038:	9b4080e7          	jalr	-1612(ra) # 59e8 <printf>
        exit(1);
    503c:	4505                	li	a0,1
    ...
    504a:	e0250513          	addi	a0,a0,-510 # 7e48 <malloc+0x23a0>
    504e:	00001097          	auipc	ra,0x1
    5052:	99a080e7          	jalr	-1638(ra) # 59e8 <printf>
    exit(1);
    5056:	4505                	li	a0,1
    ...
    5064:	e0850513          	addi	a0,a0,-504 # 7e68 <malloc+0x23c0>
    5068:	00001097          	auipc	ra,0x1
    506c:	980080e7          	jalr	-1664(ra) # 59e8 <printf>
    exit(1);
    5070:	4505                	li	a0,1
  ...
  while(1){
    ...
    5098:	e1450513          	addi	a0,a0,-492 # 7ea8 <malloc+0x2400>
    509c:	00001097          	auipc	ra,0x1
    50a0:	94c080e7          	jalr	-1716(ra) # 59e8 <printf>
      exit(1);
    50a4:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5102:	dca50513          	addi	a0,a0,-566 # 7ec8 <malloc+0x2420>
    5106:	00001097          	auipc	ra,0x1
    510a:	8e2080e7          	jalr	-1822(ra) # 59e8 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    5132:	dc250513          	addi	a0,a0,-574 # 7ef0 <malloc+0x2448>
    5136:	00001097          	auipc	ra,0x1
    513a:	8b2080e7          	jalr	-1870(ra) # 59e8 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    5156:	d8650513          	addi	a0,a0,-634 # 7ed8 <malloc+0x2430>
    515a:	00001097          	auipc	ra,0x1
    515e:	88e080e7          	jalr	-1906(ra) # 59e8 <printf>
    exit(1);
    5162:	4505                	li	a0,1
    ...
    517e:	d7e50513          	addi	a0,a0,-642 # 7ef8 <malloc+0x2450>
    5182:	00001097          	auipc	ra,0x1
    5186:	866080e7          	jalr	-1946(ra) # 59e8 <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    51c6:	9ee78793          	addi	a5,a5,-1554 # 5bb0 <malloc+0x108>
    51ca:	c1040713          	addi	a4,s0,-1008
    51ce:	00001817          	auipc	a6,0x1
    51d2:	d8280813          	addi	a6,a6,-638 # 5f50 <malloc+0x4a8>
  ...
  printf("usertests starting\n");
    ...
    51fe:	db650513          	addi	a0,a0,-586 # 7fb0 <malloc+0x2508>
    5202:	00000097          	auipc	ra,0x0
    5206:	7e6080e7          	jalr	2022(ra) # 59e8 <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    5238:	d3450513          	addi	a0,a0,-716 # 7f68 <malloc+0x24c0>
    523c:	00000097          	auipc	ra,0x0
    5240:	7ac080e7          	jalr	1964(ra) # 59e8 <printf>
    exit(1);
    5244:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    5254:	cb058593          	addi	a1,a1,-848 # 7f00 <malloc+0x2458>
    ...
    526a:	d8258593          	addi	a1,a1,-638 # 7fe8 <malloc+0x2540>
    ...
    528e:	c7e50513          	addi	a0,a0,-898 # 7f08 <malloc+0x2460>
    5292:	00000097          	auipc	ra,0x0
    5296:	756080e7          	jalr	1878(ra) # 59e8 <printf>
    exit(1);
    529a:	4505                	li	a0,1
    ...
    52b8:	734080e7          	jalr	1844(ra) # 59e8 <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    5300:	c5450513          	addi	a0,a0,-940 # 7f50 <malloc+0x24a8>
    5304:	00000097          	auipc	ra,0x0
    5308:	6e4080e7          	jalr	1764(ra) # 59e8 <printf>
    exit(1);
    530c:	4505                	li	a0,1
    ...
    531a:	c8250513          	addi	a0,a0,-894 # 7f98 <malloc+0x24f0>
    531e:	00000097          	auipc	ra,0x0
    5322:	6ca080e7          	jalr	1738(ra) # 59e8 <printf>
    exit(0);
    5326:	4501                	li	a0,0
    ...
    5336:	6b6080e7          	jalr	1718(ra) # 59e8 <printf>
        if(continuous != 2)
    ...
    5378:	83c78793          	addi	a5,a5,-1988 # 5bb0 <malloc+0x108>
    537c:	c1040713          	addi	a4,s0,-1008
    5380:	00001817          	auipc	a6,0x1
    5384:	bd080813          	addi	a6,a6,-1072 # 5f50 <malloc+0x4a8>
    ...
    53b0:	c1c50513          	addi	a0,a0,-996 # 7fc8 <malloc+0x2520>
    53b4:	00000097          	auipc	ra,0x0
    53b8:	634080e7          	jalr	1588(ra) # 59e8 <printf>
        printf("SOME TESTS FAILED\n");
    53bc:	00003a97          	auipc	s5,0x3
    53c0:	b94a8a93          	addi	s5,s5,-1132 # 7f50 <malloc+0x24a8>
        if(continuous != 2)
    53c4:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    53c6:	00003b17          	auipc	s6,0x3
    53ca:	b6ab0b13          	addi	s6,s6,-1174 # 7f30 <malloc+0x2488>
...
putc(int fd, char c)
{
    ...
    5718:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    571c:	4605                	li	a2,1
    571e:	fef40593          	addi	a1,s0,-17
    5722:	00000097          	auipc	ra,0x0
    5726:	f5e080e7          	jalr	-162(ra) # 5680 <write>
}
    572a:	60e2                	ld	ra,24(sp)
    572c:	6442                	ld	s0,16(sp)
    572e:	6105                	addi	sp,sp,32
    5730:	8082                	ret

0000000000005732 <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    5732:	7139                	addi	sp,sp,-64
    5734:	fc06                	sd	ra,56(sp)
    5736:	f822                	sd	s0,48(sp)
    5738:	f426                	sd	s1,40(sp)
    573a:	f04a                	sd	s2,32(sp)
    573c:	ec4e                	sd	s3,24(sp)
    573e:	0080                	addi	s0,sp,64
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    5740:	c299                	beqz	a3,5746 <printint+0x14>
    5742:	0005cd63          	bltz	a1,575c <printint+0x2a>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    5746:	2581                	sext.w	a1,a1
  neg = 0;
    5748:	4301                	li	t1,0
    574a:	fc040713          	addi	a4,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    5750:	2601                	sext.w	a2,a2
    5752:	00003897          	auipc	a7,0x3
    5756:	b5e88893          	addi	a7,a7,-1186 # 82b0 <digits>
    575a:	a801                	j	576a <printint+0x38>
    x = -xx;
    575c:	40b005bb          	negw	a1,a1
    5760:	2581                	sext.w	a1,a1
    neg = 1;
    5762:	4305                	li	t1,1
    x = -xx;
    5764:	b7dd                	j	574a <printint+0x18>
  }while((x /= base) != 0);
    5766:	85be                	mv	a1,a5
    buf[i++] = digits[x % base];
    5768:	8836                	mv	a6,a3
    576a:	0018069b          	addiw	a3,a6,1
    576e:	02c5f7bb          	remuw	a5,a1,a2
    5772:	1782                	slli	a5,a5,0x20
    5774:	9381                	srli	a5,a5,0x20
    5776:	97c6                	add	a5,a5,a7
    5778:	0007c783          	lbu	a5,0(a5)
    577c:	00f70023          	sb	a5,0(a4)
  }while((x /= base) != 0);
    5780:	0705                	addi	a4,a4,1
    5782:	02c5d7bb          	divuw	a5,a1,a2
    5786:	fec5f0e3          	bleu	a2,a1,5766 <printint+0x34>
  if(neg)
    578a:	00030b63          	beqz	t1,57a0 <printint+0x6e>
    buf[i++] = '-';
    578e:	fd040793          	addi	a5,s0,-48
    5792:	96be                	add	a3,a3,a5
    5794:	02d00793          	li	a5,45
    5798:	fef68823          	sb	a5,-16(a3) # ff0 <bigdir+0x7c>
    579c:	0028069b          	addiw	a3,a6,2

  while(--i >= 0)
    57a0:	02d05963          	blez	a3,57d2 <printint+0xa0>
    57a4:	89aa                	mv	s3,a0
    57a6:	fc040793          	addi	a5,s0,-64
    57aa:	00d784b3          	add	s1,a5,a3
    57ae:	fff78913          	addi	s2,a5,-1
    57b2:	9936                	add	s2,s2,a3
    57b4:	36fd                	addiw	a3,a3,-1
    57b6:	1682                	slli	a3,a3,0x20
    57b8:	9281                	srli	a3,a3,0x20
    57ba:	40d90933          	sub	s2,s2,a3
    putc(fd, buf[i]);
    57be:	fff4c583          	lbu	a1,-1(s1)
    57c2:	854e                	mv	a0,s3
    57c4:	00000097          	auipc	ra,0x0
    57c8:	f4c080e7          	jalr	-180(ra) # 5710 <putc>
  while(--i >= 0)
    57cc:	14fd                	addi	s1,s1,-1
    57ce:	ff2498e3          	bne	s1,s2,57be <printint+0x8c>
}
    57d2:	70e2                	ld	ra,56(sp)
    57d4:	7442                	ld	s0,48(sp)
    57d6:	74a2                	ld	s1,40(sp)
    57d8:	7902                	ld	s2,32(sp)
    57da:	69e2                	ld	s3,24(sp)
    57dc:	6121                	addi	sp,sp,64
    57de:	8082                	ret

00000000000057e0 <vprintf>:
}
...
{
    57e0:	7119                	addi	sp,sp,-128
    57e2:	fc86                	sd	ra,120(sp)
    57e4:	f8a2                	sd	s0,112(sp)
    57e6:	f4a6                	sd	s1,104(sp)
    57e8:	f0ca                	sd	s2,96(sp)
    57ea:	ecce                	sd	s3,88(sp)
    57ec:	e8d2                	sd	s4,80(sp)
    57ee:	e4d6                	sd	s5,72(sp)
    57f0:	e0da                	sd	s6,64(sp)
    57f2:	fc5e                	sd	s7,56(sp)
    57f4:	f862                	sd	s8,48(sp)
    57f6:	f466                	sd	s9,40(sp)
    57f8:	f06a                	sd	s10,32(sp)
    57fa:	ec6e                	sd	s11,24(sp)
    57fc:	0100                	addi	s0,sp,128
  char *s;
  int c, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    57fe:	0005c483          	lbu	s1,0(a1)
    5802:	18048d63          	beqz	s1,599c <vprintf+0x1bc>
    5806:	8aaa                	mv	s5,a0
    5808:	8b32                	mv	s6,a2
    580a:	00158913          	addi	s2,a1,1
  state = 0;
    580e:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5810:	02500a13          	li	s4,37
      if(c == 'd'){
    5814:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    5818:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    581c:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    5820:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5824:	00003b97          	auipc	s7,0x3
    5828:	a8cb8b93          	addi	s7,s7,-1396 # 82b0 <digits>
    582c:	a839                	j	584a <vprintf+0x6a>
        putc(fd, c);
    582e:	85a6                	mv	a1,s1
    5830:	8556                	mv	a0,s5
    5832:	00000097          	auipc	ra,0x0
    5836:	ede080e7          	jalr	-290(ra) # 5710 <putc>
    583a:	a019                	j	5840 <vprintf+0x60>
    } else if(state == '%'){
    583c:	01498f63          	beq	s3,s4,585a <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    5840:	0905                	addi	s2,s2,1
    5842:	fff94483          	lbu	s1,-1(s2)
    5846:	14048b63          	beqz	s1,599c <vprintf+0x1bc>
    c = fmt[i] & 0xff;
    584a:	0004879b          	sext.w	a5,s1
    if(state == 0){
    584e:	fe0997e3          	bnez	s3,583c <vprintf+0x5c>
      if(c == '%'){
    5852:	fd479ee3          	bne	a5,s4,582e <vprintf+0x4e>
        state = '%';
    5856:	89be                	mv	s3,a5
    5858:	b7e5                	j	5840 <vprintf+0x60>
      if(c == 'd'){
    585a:	05878063          	beq	a5,s8,589a <vprintf+0xba>
      } else if(c == 'l') {
    585e:	05978c63          	beq	a5,s9,58b6 <vprintf+0xd6>
      } else if(c == 'x') {
    5862:	07a78863          	beq	a5,s10,58d2 <vprintf+0xf2>
      } else if(c == 'p') {
    5866:	09b78463          	beq	a5,s11,58ee <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    586a:	07300713          	li	a4,115
    586e:	0ce78563          	beq	a5,a4,5938 <vprintf+0x158>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    5872:	06300713          	li	a4,99
    5876:	0ee78c63          	beq	a5,a4,596e <vprintf+0x18e>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    587a:	11478663          	beq	a5,s4,5986 <vprintf+0x1a6>
        putc(fd, c);
      } else {
    ...
    5886:	e8e080e7          	jalr	-370(ra) # 5710 <putc>
        putc(fd, c);
    588a:	85a6                	mv	a1,s1
    588c:	8556                	mv	a0,s5
    588e:	00000097          	auipc	ra,0x0
    5892:	e82080e7          	jalr	-382(ra) # 5710 <putc>
      }
      state = 0;
    5896:	4981                	li	s3,0
    5898:	b765                	j	5840 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    589a:	008b0493          	addi	s1,s6,8
    589e:	4685                	li	a3,1
    58a0:	4629                	li	a2,10
    58a2:	000b2583          	lw	a1,0(s6)
    58a6:	8556                	mv	a0,s5
    58a8:	00000097          	auipc	ra,0x0
    58ac:	e8a080e7          	jalr	-374(ra) # 5732 <printint>
    58b0:	8b26                	mv	s6,s1
      state = 0;
    58b2:	4981                	li	s3,0
    58b4:	b771                	j	5840 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    58b6:	008b0493          	addi	s1,s6,8
    58ba:	4681                	li	a3,0
    58bc:	4629                	li	a2,10
    58be:	000b2583          	lw	a1,0(s6)
    58c2:	8556                	mv	a0,s5
    58c4:	00000097          	auipc	ra,0x0
    58c8:	e6e080e7          	jalr	-402(ra) # 5732 <printint>
    58cc:	8b26                	mv	s6,s1
      state = 0;
    58ce:	4981                	li	s3,0
    58d0:	bf85                	j	5840 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    58d2:	008b0493          	addi	s1,s6,8
    58d6:	4681                	li	a3,0
    58d8:	4641                	li	a2,16
    58da:	000b2583          	lw	a1,0(s6)
    58de:	8556                	mv	a0,s5
    58e0:	00000097          	auipc	ra,0x0
    58e4:	e52080e7          	jalr	-430(ra) # 5732 <printint>
    58e8:	8b26                	mv	s6,s1
      state = 0;
    58ea:	4981                	li	s3,0
    58ec:	bf91                	j	5840 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    58ee:	008b0793          	addi	a5,s6,8
    58f2:	f8f43423          	sd	a5,-120(s0)
    58f6:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    58fa:	03000593          	li	a1,48
    58fe:	8556                	mv	a0,s5
    5900:	00000097          	auipc	ra,0x0
    5904:	e10080e7          	jalr	-496(ra) # 5710 <putc>
  putc(fd, 'x');
    5908:	85ea                	mv	a1,s10
    590a:	8556                	mv	a0,s5
    590c:	00000097          	auipc	ra,0x0
    5910:	e04080e7          	jalr	-508(ra) # 5710 <putc>
    5914:	44c1                	li	s1,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5916:	03c9d793          	srli	a5,s3,0x3c
    591a:	97de                	add	a5,a5,s7
    591c:	0007c583          	lbu	a1,0(a5)
    5920:	8556                	mv	a0,s5
    5922:	00000097          	auipc	ra,0x0
    5926:	dee080e7          	jalr	-530(ra) # 5710 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    592a:	0992                	slli	s3,s3,0x4
    592c:	34fd                	addiw	s1,s1,-1
    592e:	f4e5                	bnez	s1,5916 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    5930:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5934:	4981                	li	s3,0
    5936:	b729                	j	5840 <vprintf+0x60>
        s = va_arg(ap, char*);
    5938:	008b0993          	addi	s3,s6,8
    593c:	000b3483          	ld	s1,0(s6)
        if(s == 0)
    5940:	c085                	beqz	s1,5960 <vprintf+0x180>
        while(*s != 0){
    5942:	0004c583          	lbu	a1,0(s1)
    5946:	c9a1                	beqz	a1,5996 <vprintf+0x1b6>
          putc(fd, *s);
    5948:	8556                	mv	a0,s5
    594a:	00000097          	auipc	ra,0x0
    594e:	dc6080e7          	jalr	-570(ra) # 5710 <putc>
          s++;
    5952:	0485                	addi	s1,s1,1
        while(*s != 0){
    5954:	0004c583          	lbu	a1,0(s1)
    5958:	f9e5                	bnez	a1,5948 <vprintf+0x168>
        s = va_arg(ap, char*);
    595a:	8b4e                	mv	s6,s3
      state = 0;
    595c:	4981                	li	s3,0
    595e:	b5cd                	j	5840 <vprintf+0x60>
          s = "(null)";
    5960:	00003497          	auipc	s1,0x3
    5964:	96848493          	addi	s1,s1,-1688 # 82c8 <digits+0x18>
        while(*s != 0){
    5968:	02800593          	li	a1,40
    596c:	bff1                	j	5948 <vprintf+0x168>
        putc(fd, va_arg(ap, uint));
    596e:	008b0493          	addi	s1,s6,8
    5972:	000b4583          	lbu	a1,0(s6)
    5976:	8556                	mv	a0,s5
    5978:	00000097          	auipc	ra,0x0
    597c:	d98080e7          	jalr	-616(ra) # 5710 <putc>
    5980:	8b26                	mv	s6,s1
      state = 0;
    5982:	4981                	li	s3,0
    5984:	bd75                	j	5840 <vprintf+0x60>
        putc(fd, c);
    5986:	85d2                	mv	a1,s4
    5988:	8556                	mv	a0,s5
    598a:	00000097          	auipc	ra,0x0
    598e:	d86080e7          	jalr	-634(ra) # 5710 <putc>
      state = 0;
    5992:	4981                	li	s3,0
    5994:	b575                	j	5840 <vprintf+0x60>
        s = va_arg(ap, char*);
    5996:	8b4e                	mv	s6,s3
      state = 0;
    5998:	4981                	li	s3,0
    599a:	b55d                	j	5840 <vprintf+0x60>
    }
  }
}
    599c:	70e6                	ld	ra,120(sp)
    599e:	7446                	ld	s0,112(sp)
    59a0:	74a6                	ld	s1,104(sp)
    59a2:	7906                	ld	s2,96(sp)
    59a4:	69e6                	ld	s3,88(sp)
    59a6:	6a46                	ld	s4,80(sp)
    59a8:	6aa6                	ld	s5,72(sp)
    59aa:	6b06                	ld	s6,64(sp)
    59ac:	7be2                	ld	s7,56(sp)
    59ae:	7c42                	ld	s8,48(sp)
    59b0:	7ca2                	ld	s9,40(sp)
    59b2:	7d02                	ld	s10,32(sp)
    59b4:	6de2                	ld	s11,24(sp)
    59b6:	6109                	addi	sp,sp,128
    59b8:	8082                	ret

00000000000059ba <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    59ba:	715d                	addi	sp,sp,-80
    59bc:	ec06                	sd	ra,24(sp)
    59be:	e822                	sd	s0,16(sp)
    59c0:	1000                	addi	s0,sp,32
    59c2:	e010                	sd	a2,0(s0)
    59c4:	e414                	sd	a3,8(s0)
    59c6:	e818                	sd	a4,16(s0)
    59c8:	ec1c                	sd	a5,24(s0)
    59ca:	03043023          	sd	a6,32(s0)
    59ce:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    59d2:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    59d6:	8622                	mv	a2,s0
    59d8:	00000097          	auipc	ra,0x0
    59dc:	e08080e7          	jalr	-504(ra) # 57e0 <vprintf>
}
    59e0:	60e2                	ld	ra,24(sp)
    59e2:	6442                	ld	s0,16(sp)
    59e4:	6161                	addi	sp,sp,80
    59e6:	8082                	ret

00000000000059e8 <printf>:

void
printf(const char *fmt, ...)
{
    59e8:	711d                	addi	sp,sp,-96
    59ea:	ec06                	sd	ra,24(sp)
    59ec:	e822                	sd	s0,16(sp)
    59ee:	1000                	addi	s0,sp,32
    59f0:	e40c                	sd	a1,8(s0)
    59f2:	e810                	sd	a2,16(s0)
    59f4:	ec14                	sd	a3,24(s0)
    59f6:	f018                	sd	a4,32(s0)
    59f8:	f41c                	sd	a5,40(s0)
    59fa:	03043823          	sd	a6,48(s0)
    59fe:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5a02:	00840613          	addi	a2,s0,8
    5a06:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5a0a:	85aa                	mv	a1,a0
    5a0c:	4505                	li	a0,1
    5a0e:	00000097          	auipc	ra,0x0
    5a12:	dd2080e7          	jalr	-558(ra) # 57e0 <vprintf>
}
    5a16:	60e2                	ld	ra,24(sp)
    5a18:	6442                	ld	s0,16(sp)
    5a1a:	6125                	addi	sp,sp,96
    5a1c:	8082                	ret

0000000000005a1e <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    ...
    5a20:	e422                	sd	s0,8(sp)
    5a22:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5a24:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5a28:	00003797          	auipc	a5,0x3
    5a2c:	8b878793          	addi	a5,a5,-1864 # 82e0 <_edata>
    5a30:	639c                	ld	a5,0(a5)
    5a32:	a805                	j	5a62 <free+0x44>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5a34:	4618                	lw	a4,8(a2)
    5a36:	9db9                	addw	a1,a1,a4
    5a38:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5a3c:	6398                	ld	a4,0(a5)
    5a3e:	6318                	ld	a4,0(a4)
    5a40:	fee53823          	sd	a4,-16(a0)
    5a44:	a091                	j	5a88 <free+0x6a>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5a46:	ff852703          	lw	a4,-8(a0)
    5a4a:	9e39                	addw	a2,a2,a4
    5a4c:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    5a4e:	ff053703          	ld	a4,-16(a0)
    5a52:	e398                	sd	a4,0(a5)
    5a54:	a099                	j	5a9a <free+0x7c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5a56:	6398                	ld	a4,0(a5)
    5a58:	00e7e463          	bltu	a5,a4,5a60 <free+0x42>
    5a5c:	00e6ea63          	bltu	a3,a4,5a70 <free+0x52>
{
    5a60:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5a62:	fed7fae3          	bleu	a3,a5,5a56 <free+0x38>
    5a66:	6398                	ld	a4,0(a5)
    5a68:	00e6e463          	bltu	a3,a4,5a70 <free+0x52>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5a6c:	fee7eae3          	bltu	a5,a4,5a60 <free+0x42>
  if(bp + bp->s.size == p->s.ptr){
    5a70:	ff852583          	lw	a1,-8(a0)
    5a74:	6390                	ld	a2,0(a5)
    5a76:	02059713          	slli	a4,a1,0x20
    5a7a:	9301                	srli	a4,a4,0x20
    5a7c:	0712                	slli	a4,a4,0x4
    5a7e:	9736                	add	a4,a4,a3
    5a80:	fae60ae3          	beq	a2,a4,5a34 <free+0x16>
    bp->s.ptr = p->s.ptr;
    5a84:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5a88:	4790                	lw	a2,8(a5)
    5a8a:	02061713          	slli	a4,a2,0x20
    5a8e:	9301                	srli	a4,a4,0x20
    5a90:	0712                	slli	a4,a4,0x4
    5a92:	973e                	add	a4,a4,a5
    5a94:	fae689e3          	beq	a3,a4,5a46 <free+0x28>
  } else
    p->s.ptr = bp;
    5a98:	e394                	sd	a3,0(a5)
  freep = p;
    5a9a:	00003717          	auipc	a4,0x3
    5a9e:	84f73323          	sd	a5,-1978(a4) # 82e0 <_edata>
}
    5aa2:	6422                	ld	s0,8(sp)
    5aa4:	0141                	addi	sp,sp,16
    5aa6:	8082                	ret

0000000000005aa8 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5aa8:	7139                	addi	sp,sp,-64
    5aaa:	fc06                	sd	ra,56(sp)
    5aac:	f822                	sd	s0,48(sp)
    5aae:	f426                	sd	s1,40(sp)
    5ab0:	f04a                	sd	s2,32(sp)
    5ab2:	ec4e                	sd	s3,24(sp)
    5ab4:	e852                	sd	s4,16(sp)
    5ab6:	e456                	sd	s5,8(sp)
    5ab8:	e05a                	sd	s6,0(sp)
    5aba:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5abc:	02051993          	slli	s3,a0,0x20
    5ac0:	0209d993          	srli	s3,s3,0x20
    5ac4:	09bd                	addi	s3,s3,15
    5ac6:	0049d993          	srli	s3,s3,0x4
    5aca:	2985                	addiw	s3,s3,1
    5acc:	0009891b          	sext.w	s2,s3
  if((prevp = freep) == 0){
    5ad0:	00003797          	auipc	a5,0x3
    5ad4:	81078793          	addi	a5,a5,-2032 # 82e0 <_edata>
    5ad8:	6388                	ld	a0,0(a5)
    5ada:	c515                	beqz	a0,5b06 <malloc+0x5e>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5adc:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5ade:	4798                	lw	a4,8(a5)
    5ae0:	03277f63          	bleu	s2,a4,5b1e <malloc+0x76>
    5ae4:	8a4e                	mv	s4,s3
    5ae6:	0009871b          	sext.w	a4,s3
    5aea:	6685                	lui	a3,0x1
    5aec:	00d77363          	bleu	a3,a4,5af2 <malloc+0x4a>
    5af0:	6a05                	lui	s4,0x1
    5af2:	000a0a9b          	sext.w	s5,s4
  p = sbrk(nu * sizeof(Header));
    5af6:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5afa:	00002497          	auipc	s1,0x2
    5afe:	7e648493          	addi	s1,s1,2022 # 82e0 <_edata>
  if(p == (char*)-1)
    5b02:	5b7d                	li	s6,-1
    5b04:	a885                	j	5b74 <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
    5b06:	00009797          	auipc	a5,0x9
    5b0a:	ffa78793          	addi	a5,a5,-6 # eb00 <base>
    5b0e:	00002717          	auipc	a4,0x2
    5b12:	7cf73923          	sd	a5,2002(a4) # 82e0 <_edata>
    5b16:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5b18:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5b1c:	b7e1                	j	5ae4 <malloc+0x3c>
      if(p->s.size == nunits)
    5b1e:	02e90b63          	beq	s2,a4,5b54 <malloc+0xac>
        p->s.size -= nunits;
    5b22:	4137073b          	subw	a4,a4,s3
    5b26:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5b28:	1702                	slli	a4,a4,0x20
    5b2a:	9301                	srli	a4,a4,0x20
    5b2c:	0712                	slli	a4,a4,0x4
    5b2e:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5b30:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5b34:	00002717          	auipc	a4,0x2
    5b38:	7aa73623          	sd	a0,1964(a4) # 82e0 <_edata>
      return (void*)(p + 1);
    5b3c:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    5b40:	70e2                	ld	ra,56(sp)
    5b42:	7442                	ld	s0,48(sp)
    5b44:	74a2                	ld	s1,40(sp)
    5b46:	7902                	ld	s2,32(sp)
    5b48:	69e2                	ld	s3,24(sp)
    5b4a:	6a42                	ld	s4,16(sp)
    5b4c:	6aa2                	ld	s5,8(sp)
    5b4e:	6b02                	ld	s6,0(sp)
    5b50:	6121                	addi	sp,sp,64
    5b52:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    5b54:	6398                	ld	a4,0(a5)
    5b56:	e118                	sd	a4,0(a0)
    5b58:	bff1                	j	5b34 <malloc+0x8c>
  hp->s.size = nu;
    5b5a:	01552423          	sw	s5,8(a0)
  free((void*)(hp + 1));
    5b5e:	0541                	addi	a0,a0,16
    5b60:	00000097          	auipc	ra,0x0
    5b64:	ebe080e7          	jalr	-322(ra) # 5a1e <free>
  return freep;
    5b68:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
    5b6a:	d979                	beqz	a0,5b40 <malloc+0x98>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5b6c:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5b6e:	4798                	lw	a4,8(a5)
    5b70:	fb2777e3          	bleu	s2,a4,5b1e <malloc+0x76>
    if(p == freep)
    5b74:	6098                	ld	a4,0(s1)
    5b76:	853e                	mv	a0,a5
    5b78:	fef71ae3          	bne	a4,a5,5b6c <malloc+0xc4>
  p = sbrk(nu * sizeof(Header));
    5b7c:	8552                	mv	a0,s4
    5b7e:	00000097          	auipc	ra,0x0
    5b82:	b6a080e7          	jalr	-1174(ra) # 56e8 <sbrk>
  if(p == (char*)-1)
    5b86:	fd651ae3          	bne	a0,s6,5b5a <malloc+0xb2>
        return 0;
    5b8a:	4501                	li	a0,0
    5b8c:	bf55                	j	5b40 <malloc+0x98>
