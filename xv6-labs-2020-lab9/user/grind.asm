 ...
 */
    ...
    lo = x % 127773;
      16:	66fd                	lui	a3,0x1f
      18:	31d68693          	addi	a3,a3,797 # 1f31d <__global_pointer$+0x1d475>
      1c:	02d7e733          	rem	a4,a5,a3
    x = 16807 * lo - 2836 * hi;
      20:	6611                	lui	a2,0x4
      22:	1a760613          	addi	a2,a2,423 # 41a7 <__global_pointer$+0x22ff>
      26:	02c70733          	mul	a4,a4,a2
    hi = x / 127773;
      2a:	02d7c7b3          	div	a5,a5,a3
    x = 16807 * lo - 2836 * hi;
      2e:	76fd                	lui	a3,0xfffff
      30:	4ec68693          	addi	a3,a3,1260 # fffffffffffff4ec <__global_pointer$+0xffffffffffffd644>
...
go(int which_child)
{
  ...
  if(chdir("grindir") != 0){
    ...
    printf("grind: chdir grindir failed\n");
      ...
      c8:	138080e7          	jalr	312(ra) # 11fc <printf>
    exit(1);
      cc:	4505                	li	a0,1
  ...
  while(1){
    ...
    if((iters % 500) == 0)
      ...
      ea:	2fa90913          	addi	s2,s2,762 # 13e0 <malloc+0x124>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001917          	auipc	s2,0x1
      f4:	2e890913          	addi	s2,s2,744 # 13d8 <malloc+0x11c>
    iters++;
      f8:	4485                	li	s1,1
  int fd = -1;
      fa:	59fd                	li	s3,-1
      ...
      sbrk(6011);
      fc:	6a05                	lui	s4,0x1
      fe:	77ba0a13          	addi	s4,s4,1915 # 177b <buf.1254+0xc3>
     102:	a825                	j	13a <go+0xc2>
      close(open("grindir/../a", O_CREATE|O_RDWR));
     104:	20200593          	li	a1,514
     108:	00001517          	auipc	a0,0x1
     10c:	2e050513          	addi	a0,a0,736 # 13e8 <malloc+0x12c>
    ...
    if(what == 1){
     ...
     296:	37658593          	addi	a1,a1,886 # 1608 <malloc+0x34c>
     ...
     2ba:	3aa50513          	addi	a0,a0,938 # 1660 <malloc+0x3a4>
     2be:	00001097          	auipc	ra,0x1
     2c2:	f3e080e7          	jalr	-194(ra) # 11fc <printf>
        exit(1);
     2c6:	4505                	li	a0,1
     ...
     2d8:	12450513          	addi	a0,a0,292 # 13f8 <malloc+0x13c>
     ...
     360:	0bc50513          	addi	a0,a0,188 # 1418 <malloc+0x15c>
     ...
     382:	0aa50513          	addi	a0,a0,170 # 1428 <malloc+0x16c>
     ...
     39a:	32258593          	addi	a1,a1,802 # 16b8 <buf.1254>
     39e:	854e                	mv	a0,s3
     ...
     3b2:	30a58593          	addi	a1,a1,778 # 16b8 <buf.1254>
     3b6:	854e                	mv	a0,s3
     ...
     3c6:	02650513          	addi	a0,a0,38 # 13e8 <malloc+0x12c>
     3ca:	00001097          	auipc	ra,0x1
     3ce:	b1a080e7          	jalr	-1254(ra) # ee4 <mkdir>
      close(open("a/../a/./a", O_CREATE|O_RDWR));
     3d2:	20200593          	li	a1,514
     3d6:	00001517          	auipc	a0,0x1
     3da:	06a50513          	addi	a0,a0,106 # 1440 <malloc+0x184>
     ...
     4b8:	ff450513          	addi	a0,a0,-12 # 14a8 <malloc+0x1ec>
     4bc:	00001097          	auipc	ra,0x1
     4c0:	d40080e7          	jalr	-704(ra) # 11fc <printf>
        exit(1);
     4c4:	4505                	li	a0,1
     ...
     506:	fa650513          	addi	a0,a0,-90 # 14a8 <malloc+0x1ec>
     50a:	00001097          	auipc	ra,0x1
     50e:	cf2080e7          	jalr	-782(ra) # 11fc <printf>
        exit(1);
     512:	4505                	li	a0,1
     ...
     562:	f6250513          	addi	a0,a0,-158 # 14c0 <malloc+0x204>
     ...
     58e:	efe50513          	addi	a0,a0,-258 # 1488 <malloc+0x1cc>
     ...
     5b0:	efc50513          	addi	a0,a0,-260 # 14a8 <malloc+0x1ec>
     5b4:	00001097          	auipc	ra,0x1
     5b8:	c48080e7          	jalr	-952(ra) # 11fc <printf>
        exit(1);
     5bc:	4505                	li	a0,1
     ...
     5ca:	f0a50513          	addi	a0,a0,-246 # 14d0 <malloc+0x214>
     5ce:	00001097          	auipc	ra,0x1
     5d2:	c2e080e7          	jalr	-978(ra) # 11fc <printf>
        exit(1);
     5d6:	4505                	li	a0,1
     ...
     618:	e9450513          	addi	a0,a0,-364 # 14a8 <malloc+0x1ec>
     61c:	00001097          	auipc	ra,0x1
     620:	be0080e7          	jalr	-1056(ra) # 11fc <printf>
        exit(1);
     624:	4505                	li	a0,1
     ...
     674:	e7850513          	addi	a0,a0,-392 # 14e8 <malloc+0x22c>
     678:	00001097          	auipc	ra,0x1
     67c:	b84080e7          	jalr	-1148(ra) # 11fc <printf>
        exit(1);
     680:	4505                	li	a0,1
     ...
     6a0:	e6458593          	addi	a1,a1,-412 # 1500 <malloc+0x244>
     ...
     6dc:	e3050513          	addi	a0,a0,-464 # 1508 <malloc+0x24c>
     6e0:	00001097          	auipc	ra,0x1
     6e4:	b1c080e7          	jalr	-1252(ra) # 11fc <printf>
     6e8:	b7f9                	j	6b6 <go+0x63e>
          printf("grind: pipe read failed\n");
     6ea:	00001517          	auipc	a0,0x1
     6ee:	e3e50513          	addi	a0,a0,-450 # 1528 <malloc+0x26c>
     6f2:	00001097          	auipc	ra,0x1
     6f6:	b0a080e7          	jalr	-1270(ra) # 11fc <printf>
     6fa:	bfd1                	j	6ce <go+0x656>
        printf("grind: fork failed\n");
     6fc:	00001517          	auipc	a0,0x1
     700:	dac50513          	addi	a0,a0,-596 # 14a8 <malloc+0x1ec>
     704:	00001097          	auipc	ra,0x1
     708:	af8080e7          	jalr	-1288(ra) # 11fc <printf>
        exit(1);
     70c:	4505                	li	a0,1
     ...
     7a2:	d0a50513          	addi	a0,a0,-758 # 14a8 <malloc+0x1ec>
     7a6:	00001097          	auipc	ra,0x1
     7aa:	a56080e7          	jalr	-1450(ra) # 11fc <printf>
        exit(1);
     7ae:	4505                	li	a0,1
     ...
     7e8:	d1c58593          	addi	a1,a1,-740 # 1500 <malloc+0x244>
     ...
     82e:	d1e50513          	addi	a0,a0,-738 # 1548 <malloc+0x28c>
     832:	00000097          	auipc	ra,0x0
     836:	69a080e7          	jalr	1690(ra) # ecc <unlink>
     83a:	b0dd                	j	120 <go+0xa8>
        printf("grind: create c failed\n");
     83c:	00001517          	auipc	a0,0x1
     840:	d1450513          	addi	a0,a0,-748 # 1550 <malloc+0x294>
     844:	00001097          	auipc	ra,0x1
     848:	9b8080e7          	jalr	-1608(ra) # 11fc <printf>
        exit(1);
     84c:	4505                	li	a0,1
     ...
     85a:	d1250513          	addi	a0,a0,-750 # 1568 <malloc+0x2ac>
     85e:	00001097          	auipc	ra,0x1
     862:	99e080e7          	jalr	-1634(ra) # 11fc <printf>
        exit(1);
     866:	4505                	li	a0,1
     ...
     874:	d1050513          	addi	a0,a0,-752 # 1580 <malloc+0x2c4>
     878:	00001097          	auipc	ra,0x1
     87c:	984080e7          	jalr	-1660(ra) # 11fc <printf>
        exit(1);
     880:	4505                	li	a0,1
     ...
     890:	d0c50513          	addi	a0,a0,-756 # 1598 <malloc+0x2dc>
     894:	00001097          	auipc	ra,0x1
     898:	968080e7          	jalr	-1688(ra) # 11fc <printf>
        exit(1);
     89c:	4505                	li	a0,1
     ...
     8aa:	d1a50513          	addi	a0,a0,-742 # 15c0 <malloc+0x304>
     8ae:	00001097          	auipc	ra,0x1
     8b2:	94e080e7          	jalr	-1714(ra) # 11fc <printf>
        exit(1);
     8b6:	4505                	li	a0,1
     ...
     8c4:	c2858593          	addi	a1,a1,-984 # 14e8 <malloc+0x22c>
     8c8:	4509                	li	a0,2
     8ca:	00001097          	auipc	ra,0x1
     8ce:	904080e7          	jalr	-1788(ra) # 11ce <fprintf>
        exit(1);
     8d2:	4505                	li	a0,1
     ...
     8e0:	c0c58593          	addi	a1,a1,-1012 # 14e8 <malloc+0x22c>
     8e4:	4509                	li	a0,2
     8e6:	00001097          	auipc	ra,0x1
     8ea:	8e8080e7          	jalr	-1816(ra) # 11ce <fprintf>
        exit(1);
     8ee:	4505                	li	a0,1
     ...
     93c:	cb058593          	addi	a1,a1,-848 # 15e8 <malloc+0x32c>
     940:	4509                	li	a0,2
     942:	00001097          	auipc	ra,0x1
     946:	88c080e7          	jalr	-1908(ra) # 11ce <fprintf>
          exit(1);
     94a:	4505                	li	a0,1
     ...
     9b0:	afc58593          	addi	a1,a1,-1284 # 14a8 <malloc+0x1ec>
     9b4:	4509                	li	a0,2
     9b6:	00001097          	auipc	ra,0x1
     9ba:	818080e7          	jalr	-2024(ra) # 11ce <fprintf>
        exit(3);
     9be:	450d                	li	a0,3
     ...
     9fc:	bf058593          	addi	a1,a1,-1040 # 15e8 <malloc+0x32c>
     a00:	4509                	li	a0,2
     a02:	00000097          	auipc	ra,0x0
     a06:	7cc080e7          	jalr	1996(ra) # 11ce <fprintf>
          exit(4);
     a0a:	4511                	li	a0,4
     ...
     a40:	bac58593          	addi	a1,a1,-1108 # 15e8 <malloc+0x32c>
     a44:	4509                	li	a0,2
     a46:	00000097          	auipc	ra,0x0
     a4a:	788080e7          	jalr	1928(ra) # 11ce <fprintf>
          exit(5);
     a4e:	4515                	li	a0,5
     ...
     aa8:	a0458593          	addi	a1,a1,-1532 # 14a8 <malloc+0x1ec>
     aac:	4509                	li	a0,2
     aae:	00000097          	auipc	ra,0x0
     ab2:	720080e7          	jalr	1824(ra) # 11ce <fprintf>
        exit(7);
     ab6:	451d                	li	a0,7
...
iter()
{
  ...
  unlink("a");
     ...
     ad0:	9bc50513          	addi	a0,a0,-1604 # 1488 <malloc+0x1cc>
     ad4:	00000097          	auipc	ra,0x0
     ad8:	3f8080e7          	jalr	1016(ra) # ecc <unlink>
  unlink("b");
     adc:	00001517          	auipc	a0,0x1
     ae0:	95c50513          	addi	a0,a0,-1700 # 1438 <malloc+0x17c>
  ...
  if(pid1 == 0){
    ...
    rand_next = 31;
     ...
     b02:	baf73523          	sd	a5,-1110(a4) # 16a8 <rand_next>
    go(0);
     b06:	4501                	li	a0,0
    ...
    printf("grind: fork failed\n");
     ...
     b14:	99850513          	addi	a0,a0,-1640 # 14a8 <malloc+0x1ec>
     b18:	00000097          	auipc	ra,0x0
     b1c:	6e4080e7          	jalr	1764(ra) # 11fc <printf>
    exit(1);
     b20:	4505                	li	a0,1
  ...
  if(pid2 == 0){
    ...
    rand_next = 7177;
     b3a:	6789                	lui	a5,0x2
     b3c:	c0978793          	addi	a5,a5,-1015 # 1c09 <_end+0x159>
     b40:	00001717          	auipc	a4,0x1
     b44:	b6f73423          	sd	a5,-1176(a4) # 16a8 <rand_next>
    go(1);
     b48:	4505                	li	a0,1
    ...
    printf("grind: fork failed\n");
     ...
     b56:	95650513          	addi	a0,a0,-1706 # 14a8 <malloc+0x1ec>
     b5a:	00000097          	auipc	ra,0x0
     b5e:	6a2080e7          	jalr	1698(ra) # 11fc <printf>
    exit(1);
     b62:	4505                	li	a0,1
...
putc(int fd, char c)
{
     ...
     f2c:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
     f30:	4605                	li	a2,1
     f32:	fef40593          	addi	a1,s0,-17
     f36:	00000097          	auipc	ra,0x0
     f3a:	f66080e7          	jalr	-154(ra) # e9c <write>
}
...
0000000000000f46 <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
     f46:	7139                	addi	sp,sp,-64
     f48:	fc06                	sd	ra,56(sp)
     f4a:	f822                	sd	s0,48(sp)
     f4c:	f426                	sd	s1,40(sp)
     f4e:	f04a                	sd	s2,32(sp)
     f50:	ec4e                	sd	s3,24(sp)
  ...
  neg = 0;
  if(sgn && xx < 0){
     f54:	c299                	beqz	a3,f5a <printint+0x14>
     f56:	0005cd63          	bltz	a1,f70 <printint+0x2a>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f66:	00000897          	auipc	a7,0x0
     f6a:	72288893          	addi	a7,a7,1826 # 1688 <digits>
     f6e:	a801                	j	f7e <printint+0x38>
    x = -xx;
    ...
    neg = 1;
     f76:	4305                	li	t1,1
    x = -xx;
     f78:	b7dd                	j	f5e <printint+0x18>
  }while((x /= base) != 0);
     f7a:	85be                	mv	a1,a5
    buf[i++] = digits[x % base];
     f7c:	8836                	mv	a6,a3
     f7e:	0018069b          	addiw	a3,a6,1
     f82:	02c5f7bb          	remuw	a5,a1,a2
     f86:	1782                	slli	a5,a5,0x20
     f88:	9381                	srli	a5,a5,0x20
     f8a:	97c6                	add	a5,a5,a7
     f8c:	0007c783          	lbu	a5,0(a5)
     f90:	00f70023          	sb	a5,0(a4)
  }while((x /= base) != 0);
     f94:	0705                	addi	a4,a4,1
     f96:	02c5d7bb          	divuw	a5,a1,a2
     f9a:	fec5f0e3          	bleu	a2,a1,f7a <printint+0x34>
  if(neg)
     f9e:	00030b63          	beqz	t1,fb4 <printint+0x6e>
    buf[i++] = '-';
     fa2:	fd040793          	addi	a5,s0,-48
     fa6:	96be                	add	a3,a3,a5
     fa8:	02d00793          	li	a5,45
     fac:	fef68823          	sb	a5,-16(a3)
     fb0:	0028069b          	addiw	a3,a6,2

  while(--i >= 0)
     fb4:	02d05963          	blez	a3,fe6 <printint+0xa0>
     fb8:	89aa                	mv	s3,a0
     fba:	fc040793          	addi	a5,s0,-64
     fbe:	00d784b3          	add	s1,a5,a3
     fc2:	fff78913          	addi	s2,a5,-1
     fc6:	9936                	add	s2,s2,a3
     fc8:	36fd                	addiw	a3,a3,-1
     fca:	1682                	slli	a3,a3,0x20
     fcc:	9281                	srli	a3,a3,0x20
     fce:	40d90933          	sub	s2,s2,a3
    putc(fd, buf[i]);
     fd2:	fff4c583          	lbu	a1,-1(s1)
     fd6:	854e                	mv	a0,s3
     fd8:	00000097          	auipc	ra,0x0
     fdc:	f4c080e7          	jalr	-180(ra) # f24 <putc>
  while(--i >= 0)
     fe0:	14fd                	addi	s1,s1,-1
     fe2:	ff2498e3          	bne	s1,s2,fd2 <printint+0x8c>
}
...
{
     ff4:	7119                	addi	sp,sp,-128
     ff6:	fc86                	sd	ra,120(sp)
     ff8:	f8a2                	sd	s0,112(sp)
     ffa:	f4a6                	sd	s1,104(sp)
     ffc:	f0ca                	sd	s2,96(sp)
     ffe:	ecce                	sd	s3,88(sp)
    1000:	e8d2                	sd	s4,80(sp)
    1002:	e4d6                	sd	s5,72(sp)
    1004:	e0da                	sd	s6,64(sp)
    1006:	fc5e                	sd	s7,56(sp)
    1008:	f862                	sd	s8,48(sp)
    100a:	f466                	sd	s9,40(sp)
    100c:	f06a                	sd	s10,32(sp)
    100e:	ec6e                	sd	s11,24(sp)
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
    1012:	0005c483          	lbu	s1,0(a1)
    1016:	18048d63          	beqz	s1,11b0 <vprintf+0x1bc>
    101a:	8aaa                	mv	s5,a0
    101c:	8b32                	mv	s6,a2
    101e:	00158913          	addi	s2,a1,1
  state = 0;
    1022:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    1024:	02500a13          	li	s4,37
      if(c == 'd'){
    1028:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    102c:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    1030:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    1034:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    1038:	00000b97          	auipc	s7,0x0
    103c:	650b8b93          	addi	s7,s7,1616 # 1688 <digits>
    1040:	a839                	j	105e <vprintf+0x6a>
        putc(fd, c);
    1042:	85a6                	mv	a1,s1
    1044:	8556                	mv	a0,s5
    1046:	00000097          	auipc	ra,0x0
    104a:	ede080e7          	jalr	-290(ra) # f24 <putc>
    104e:	a019                	j	1054 <vprintf+0x60>
    } else if(state == '%'){
    1050:	01498f63          	beq	s3,s4,106e <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    1054:	0905                	addi	s2,s2,1
    1056:	fff94483          	lbu	s1,-1(s2)
    105a:	14048b63          	beqz	s1,11b0 <vprintf+0x1bc>
    c = fmt[i] & 0xff;
    105e:	0004879b          	sext.w	a5,s1
    if(state == 0){
    1062:	fe0997e3          	bnez	s3,1050 <vprintf+0x5c>
      if(c == '%'){
    1066:	fd479ee3          	bne	a5,s4,1042 <vprintf+0x4e>
        state = '%';
    106a:	89be                	mv	s3,a5
    106c:	b7e5                	j	1054 <vprintf+0x60>
      if(c == 'd'){
    106e:	05878063          	beq	a5,s8,10ae <vprintf+0xba>
      } else if(c == 'l') {
    1072:	05978c63          	beq	a5,s9,10ca <vprintf+0xd6>
      } else if(c == 'x') {
    1076:	07a78863          	beq	a5,s10,10e6 <vprintf+0xf2>
      } else if(c == 'p') {
    107a:	09b78463          	beq	a5,s11,1102 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    107e:	07300713          	li	a4,115
    1082:	0ce78563          	beq	a5,a4,114c <vprintf+0x158>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    1086:	06300713          	li	a4,99
    108a:	0ee78c63          	beq	a5,a4,1182 <vprintf+0x18e>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    108e:	11478663          	beq	a5,s4,119a <vprintf+0x1a6>
        putc(fd, c);
      } else {
    ...
    109a:	e8e080e7          	jalr	-370(ra) # f24 <putc>
        putc(fd, c);
    109e:	85a6                	mv	a1,s1
    10a0:	8556                	mv	a0,s5
    10a2:	00000097          	auipc	ra,0x0
    10a6:	e82080e7          	jalr	-382(ra) # f24 <putc>
      }
      state = 0;
    10aa:	4981                	li	s3,0
    10ac:	b765                	j	1054 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    10ae:	008b0493          	addi	s1,s6,8
    10b2:	4685                	li	a3,1
    10b4:	4629                	li	a2,10
    10b6:	000b2583          	lw	a1,0(s6)
    10ba:	8556                	mv	a0,s5
    10bc:	00000097          	auipc	ra,0x0
    10c0:	e8a080e7          	jalr	-374(ra) # f46 <printint>
    10c4:	8b26                	mv	s6,s1
      state = 0;
    10c6:	4981                	li	s3,0
    10c8:	b771                	j	1054 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    10ca:	008b0493          	addi	s1,s6,8
    10ce:	4681                	li	a3,0
    10d0:	4629                	li	a2,10
    10d2:	000b2583          	lw	a1,0(s6)
    10d6:	8556                	mv	a0,s5
    10d8:	00000097          	auipc	ra,0x0
    10dc:	e6e080e7          	jalr	-402(ra) # f46 <printint>
    10e0:	8b26                	mv	s6,s1
      state = 0;
    10e2:	4981                	li	s3,0
    10e4:	bf85                	j	1054 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    10e6:	008b0493          	addi	s1,s6,8
    10ea:	4681                	li	a3,0
    10ec:	4641                	li	a2,16
    10ee:	000b2583          	lw	a1,0(s6)
    10f2:	8556                	mv	a0,s5
    10f4:	00000097          	auipc	ra,0x0
    10f8:	e52080e7          	jalr	-430(ra) # f46 <printint>
    10fc:	8b26                	mv	s6,s1
      state = 0;
    10fe:	4981                	li	s3,0
    1100:	bf91                	j	1054 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    1102:	008b0793          	addi	a5,s6,8
    1106:	f8f43423          	sd	a5,-120(s0)
    110a:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    110e:	03000593          	li	a1,48
    1112:	8556                	mv	a0,s5
    1114:	00000097          	auipc	ra,0x0
    1118:	e10080e7          	jalr	-496(ra) # f24 <putc>
  putc(fd, 'x');
    111c:	85ea                	mv	a1,s10
    111e:	8556                	mv	a0,s5
    1120:	00000097          	auipc	ra,0x0
    1124:	e04080e7          	jalr	-508(ra) # f24 <putc>
    1128:	44c1                	li	s1,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    112a:	03c9d793          	srli	a5,s3,0x3c
    112e:	97de                	add	a5,a5,s7
    1130:	0007c583          	lbu	a1,0(a5)
    1134:	8556                	mv	a0,s5
    1136:	00000097          	auipc	ra,0x0
    113a:	dee080e7          	jalr	-530(ra) # f24 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    113e:	0992                	slli	s3,s3,0x4
    1140:	34fd                	addiw	s1,s1,-1
    1142:	f4e5                	bnez	s1,112a <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    1144:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    1148:	4981                	li	s3,0
    114a:	b729                	j	1054 <vprintf+0x60>
        s = va_arg(ap, char*);
    114c:	008b0993          	addi	s3,s6,8
    1150:	000b3483          	ld	s1,0(s6)
        if(s == 0)
    1154:	c085                	beqz	s1,1174 <vprintf+0x180>
        while(*s != 0){
    1156:	0004c583          	lbu	a1,0(s1)
    115a:	c9a1                	beqz	a1,11aa <vprintf+0x1b6>
          putc(fd, *s);
    115c:	8556                	mv	a0,s5
    115e:	00000097          	auipc	ra,0x0
    1162:	dc6080e7          	jalr	-570(ra) # f24 <putc>
          s++;
    1166:	0485                	addi	s1,s1,1
        while(*s != 0){
    1168:	0004c583          	lbu	a1,0(s1)
    116c:	f9e5                	bnez	a1,115c <vprintf+0x168>
        s = va_arg(ap, char*);
    116e:	8b4e                	mv	s6,s3
      state = 0;
    1170:	4981                	li	s3,0
    1172:	b5cd                	j	1054 <vprintf+0x60>
          s = "(null)";
    1174:	00000497          	auipc	s1,0x0
    1178:	52c48493          	addi	s1,s1,1324 # 16a0 <digits+0x18>
        while(*s != 0){
    117c:	02800593          	li	a1,40
    1180:	bff1                	j	115c <vprintf+0x168>
        putc(fd, va_arg(ap, uint));
    1182:	008b0493          	addi	s1,s6,8
    1186:	000b4583          	lbu	a1,0(s6)
    118a:	8556                	mv	a0,s5
    118c:	00000097          	auipc	ra,0x0
    1190:	d98080e7          	jalr	-616(ra) # f24 <putc>
    1194:	8b26                	mv	s6,s1
      state = 0;
    1196:	4981                	li	s3,0
    1198:	bd75                	j	1054 <vprintf+0x60>
        putc(fd, c);
    119a:	85d2                	mv	a1,s4
    119c:	8556                	mv	a0,s5
    119e:	00000097          	auipc	ra,0x0
    11a2:	d86080e7          	jalr	-634(ra) # f24 <putc>
      state = 0;
    11a6:	4981                	li	s3,0
    11a8:	b575                	j	1054 <vprintf+0x60>
        s = va_arg(ap, char*);
    11aa:	8b4e                	mv	s6,s3
      state = 0;
    11ac:	4981                	li	s3,0
    11ae:	b55d                	j	1054 <vprintf+0x60>
    }
  }
}
    11b0:	70e6                	ld	ra,120(sp)
    11b2:	7446                	ld	s0,112(sp)
    11b4:	74a6                	ld	s1,104(sp)
    11b6:	7906                	ld	s2,96(sp)
    11b8:	69e6                	ld	s3,88(sp)
    11ba:	6a46                	ld	s4,80(sp)
    11bc:	6aa6                	ld	s5,72(sp)
    11be:	6b06                	ld	s6,64(sp)
    11c0:	7be2                	ld	s7,56(sp)
    11c2:	7c42                	ld	s8,48(sp)
    11c4:	7ca2                	ld	s9,40(sp)
    11c6:	7d02                	ld	s10,32(sp)
    11c8:	6de2                	ld	s11,24(sp)
    11ca:	6109                	addi	sp,sp,128
    11cc:	8082                	ret

00000000000011ce <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    11ce:	715d                	addi	sp,sp,-80
    11d0:	ec06                	sd	ra,24(sp)
    11d2:	e822                	sd	s0,16(sp)
    11d4:	1000                	addi	s0,sp,32
    11d6:	e010                	sd	a2,0(s0)
    11d8:	e414                	sd	a3,8(s0)
    11da:	e818                	sd	a4,16(s0)
    11dc:	ec1c                	sd	a5,24(s0)
    11de:	03043023          	sd	a6,32(s0)
    11e2:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    11e6:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    11ea:	8622                	mv	a2,s0
    11ec:	00000097          	auipc	ra,0x0
    11f0:	e08080e7          	jalr	-504(ra) # ff4 <vprintf>
}
...
00000000000011fc <printf>:

void
printf(const char *fmt, ...)
{
    11fc:	711d                	addi	sp,sp,-96
    11fe:	ec06                	sd	ra,24(sp)
    1200:	e822                	sd	s0,16(sp)
    1202:	1000                	addi	s0,sp,32
    1204:	e40c                	sd	a1,8(s0)
    1206:	e810                	sd	a2,16(s0)
    1208:	ec14                	sd	a3,24(s0)
    120a:	f018                	sd	a4,32(s0)
    120c:	f41c                	sd	a5,40(s0)
    120e:	03043823          	sd	a6,48(s0)
    1212:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    1216:	00840613          	addi	a2,s0,8
    121a:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    121e:	85aa                	mv	a1,a0
    1220:	4505                	li	a0,1
    1222:	00000097          	auipc	ra,0x0
    1226:	dd2080e7          	jalr	-558(ra) # ff4 <vprintf>
}
    122a:	60e2                	ld	ra,24(sp)
    122c:	6442                	ld	s0,16(sp)
    122e:	6125                	addi	sp,sp,96
    1230:	8082                	ret
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    1238:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    123c:	00000797          	auipc	a5,0x0
    1240:	47478793          	addi	a5,a5,1140 # 16b0 <_edata>
    1244:	639c                	ld	a5,0(a5)
    1246:	a805                	j	1276 <free+0x44>
  ...
  if(p + p->s.size == bp){
    ...
    1268:	a099                	j	12ae <free+0x7c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    126a:	6398                	ld	a4,0(a5)
    126c:	00e7e463          	bltu	a5,a4,1274 <free+0x42>
    1270:	00e6ea63          	bltu	a3,a4,1284 <free+0x52>
{
    1274:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1276:	fed7fae3          	bleu	a3,a5,126a <free+0x38>
    127a:	6398                	ld	a4,0(a5)
    127c:	00e6e463          	bltu	a3,a4,1284 <free+0x52>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1280:	fee7eae3          	bltu	a5,a4,1274 <free+0x42>
  if(bp + bp->s.size == p->s.ptr){
    ...
    1294:	fae60ae3          	beq	a2,a4,1248 <free+0x16>
    bp->s.ptr = p->s.ptr;
  ...
  if(p + p->s.size == bp){
    ...
    12a8:	fae689e3          	beq	a3,a4,125a <free+0x28>
  } else
    p->s.ptr = bp;
    12ac:	e394                	sd	a3,0(a5)
  freep = p;
    12ae:	00000717          	auipc	a4,0x0
    12b2:	40f73123          	sd	a5,1026(a4) # 16b0 <_edata>
}
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    12d0:	02051993          	slli	s3,a0,0x20
    12d4:	0209d993          	srli	s3,s3,0x20
    12d8:	09bd                	addi	s3,s3,15
    12da:	0049d993          	srli	s3,s3,0x4
    12de:	2985                	addiw	s3,s3,1
    12e0:	0009891b          	sext.w	s2,s3
  if((prevp = freep) == 0){
    12e4:	00000797          	auipc	a5,0x0
    12e8:	3cc78793          	addi	a5,a5,972 # 16b0 <_edata>
    12ec:	6388                	ld	a0,0(a5)
    12ee:	c515                	beqz	a0,131a <malloc+0x5e>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    12f4:	03277f63          	bleu	s2,a4,1332 <malloc+0x76>
    12f8:	8a4e                	mv	s4,s3
    12fa:	0009871b          	sext.w	a4,s3
    12fe:	6685                	lui	a3,0x1
    1300:	00d77363          	bleu	a3,a4,1306 <malloc+0x4a>
    1304:	6a05                	lui	s4,0x1
    1306:	000a0a9b          	sext.w	s5,s4
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    130e:	00000497          	auipc	s1,0x0
    1312:	3a248493          	addi	s1,s1,930 # 16b0 <_edata>
  if(p == (char*)-1)
    1316:	5b7d                	li	s6,-1
    1318:	a885                	j	1388 <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
    131a:	00000797          	auipc	a5,0x0
    131e:	78678793          	addi	a5,a5,1926 # 1aa0 <base>
    1322:	00000717          	auipc	a4,0x0
    1326:	38f73723          	sd	a5,910(a4) # 16b0 <_edata>
    132a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    132c:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    1330:	b7e1                	j	12f8 <malloc+0x3c>
      if(p->s.size == nunits)
    1332:	02e90b63          	beq	s2,a4,1368 <malloc+0xac>
        p->s.size -= nunits;
    ...
    134c:	36a73423          	sd	a0,872(a4) # 16b0 <_edata>
      return (void*)(p + 1);
    ...
    136c:	bff1                	j	1348 <malloc+0x8c>
  hp->s.size = nu;
    136e:	01552423          	sw	s5,8(a0)
  free((void*)(hp + 1));
    1372:	0541                	addi	a0,a0,16
    1374:	00000097          	auipc	ra,0x0
    1378:	ebe080e7          	jalr	-322(ra) # 1232 <free>
  return freep;
    137c:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
    137e:	d979                	beqz	a0,1354 <malloc+0x98>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1380:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    1382:	4798                	lw	a4,8(a5)
    1384:	fb2777e3          	bleu	s2,a4,1332 <malloc+0x76>
    if(p == freep)
    1388:	6098                	ld	a4,0(s1)
    138a:	853e                	mv	a0,a5
    138c:	fef71ae3          	bne	a4,a5,1380 <malloc+0xc4>
  p = sbrk(nu * sizeof(Header));
    1390:	8552                	mv	a0,s4
    1392:	00000097          	auipc	ra,0x0
    1396:	b72080e7          	jalr	-1166(ra) # f04 <sbrk>
  if(p == (char*)-1)
    139a:	fd651ae3          	bne	a0,s6,136e <malloc+0xb2>
        return 0;
    139e:	4501                	li	a0,0
    13a0:	bf55                	j	1354 <malloc+0x98>
