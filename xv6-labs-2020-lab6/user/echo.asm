...
main(int argc, char *argv[])
{
  ...
  2e:	80ea0a13          	addi	s4,s4,-2034 # 838 <malloc+0xec>
    write(1, argv[i], strlen(argv[i]));
  ...
  6c:	7d858593          	addi	a1,a1,2008 # 840 <malloc+0xf4>
  70:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fa:	45288893          	addi	a7,a7,1106 # 848 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4cc:	380b8b93          	addi	s7,s7,896 # 848 <digits>
 ...
 608:	25c48493          	addi	s1,s1,604 # 860 <digits+0x18>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d0:	19c78793          	addi	a5,a5,412 # 868 <__bss_start>
 6d4:	639c                	ld	a5,0(a5)
 ...
 700:	00e6ea63          	bltu	a3,a4,714 <free+0x52>
{
 ...
 742:	12f73523          	sd	a5,298(a4) # 868 <__bss_start>
}
 746:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 778:	0f478793          	addi	a5,a5,244 # 868 <__bss_start>
 77c:	6388                	ld	a0,0(a5)
 ...
 7a2:	0ca48493          	addi	s1,s1,202 # 868 <__bss_start>
  if(p == (char*)-1)
 7a6:	5b7d                	li	s6,-1
 7a8:	a885                	j	818 <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
 7aa:	00000797          	auipc	a5,0x0
 7ae:	0c678793          	addi	a5,a5,198 # 870 <base>
 7b2:	00000717          	auipc	a4,0x0
 7b6:	0af73b23          	sd	a5,182(a4) # 868 <__bss_start>
 7ba:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7dc:	08a73823          	sd	a0,144(a4) # 868 <__bss_start>
      return (void*)(p + 1);
