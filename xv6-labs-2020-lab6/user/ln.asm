...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d6:	46e88893          	addi	a7,a7,1134 # 840 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a8:	39cb8b93          	addi	s7,s7,924 # 840 <digits>
 ...
 5e4:	27848493          	addi	s1,s1,632 # 858 <digits+0x18>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6ac:	1b878793          	addi	a5,a5,440 # 860 <__bss_start>
 6b0:	639c                	ld	a5,0(a5)
 ...
 6dc:	00e6ea63          	bltu	a3,a4,6f0 <free+0x52>
{
 ...
 71e:	14f73323          	sd	a5,326(a4) # 860 <__bss_start>
}
 722:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 754:	11078793          	addi	a5,a5,272 # 860 <__bss_start>
 758:	6388                	ld	a0,0(a5)
 ...
 77e:	0e648493          	addi	s1,s1,230 # 860 <__bss_start>
  if(p == (char*)-1)
 782:	5b7d                	li	s6,-1
 784:	a885                	j	7f4 <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
 786:	00000797          	auipc	a5,0x0
 78a:	0e278793          	addi	a5,a5,226 # 868 <base>
 78e:	00000717          	auipc	a4,0x0
 792:	0cf73923          	sd	a5,210(a4) # 860 <__bss_start>
 796:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7b8:	0aa73623          	sd	a0,172(a4) # 860 <__bss_start>
      return (void*)(p + 1);
