...
main(void)
{
  ...
  12:	89a50513          	addi	a0,a0,-1894 # 8a8 <malloc+0xe8>
  ...
  3a:	87a90913          	addi	s2,s2,-1926 # 8b0 <malloc+0xf0>
  3e:	854a                	mv	a0,s2
  ...
  6e:	89650513          	addi	a0,a0,-1898 # 900 <malloc+0x140>
  ...
  8c:	82050513          	addi	a0,a0,-2016 # 8a8 <malloc+0xe8>
  90:	00000097          	auipc	ra,0x0
  94:	340080e7          	jalr	832(ra) # 3d0 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	80e50513          	addi	a0,a0,-2034 # 8a8 <malloc+0xe8>
  a2:	00000097          	auipc	ra,0x0
  a6:	326080e7          	jalr	806(ra) # 3c8 <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	81c50513          	addi	a0,a0,-2020 # 8c8 <malloc+0x108>
  ...
  d2:	81250513          	addi	a0,a0,-2030 # 8e0 <malloc+0x120>
  d6:	00000097          	auipc	ra,0x0
  da:	2ea080e7          	jalr	746(ra) # 3c0 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	80a50513          	addi	a0,a0,-2038 # 8e8 <malloc+0x128>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 46e:	4b688893          	addi	a7,a7,1206 # 920 <digits>
 ...
 49e:	fec5f0e3          	bleu	a2,a1,47e <printint+0x34>
  if(neg)
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 540:	3e4b8b93          	addi	s7,s7,996 # 920 <digits>
 ...
 67c:	2c048493          	addi	s1,s1,704 # 938 <digits+0x18>
        while(*s != 0){
...
free(void *ap)
{
 ...
 744:	21078793          	addi	a5,a5,528 # 950 <_edata>
 748:	639c                	ld	a5,0(a5)
 ...
 774:	00e6ea63          	bltu	a3,a4,788 <free+0x52>
{
 778:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 77a:	fed7fae3          	bleu	a3,a5,76e <free+0x38>
 77e:	6398                	ld	a4,0(a5)
 ...
 7b6:	18f73f23          	sd	a5,414(a4) # 950 <_edata>
}
 7ba:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7ec:	16878793          	addi	a5,a5,360 # 950 <_edata>
 7f0:	6388                	ld	a0,0(a5)
 ...
 7f4:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 7f6:	4798                	lw	a4,8(a5)
 7f8:	03277f63          	bleu	s2,a4,836 <malloc+0x76>
 7fc:	8a4e                	mv	s4,s3
 7fe:	0009871b          	sext.w	a4,s3
 802:	6685                	lui	a3,0x1
 804:	00d77363          	bleu	a3,a4,80a <malloc+0x4a>
 808:	6a05                	lui	s4,0x1
 ...
 816:	13e48493          	addi	s1,s1,318 # 950 <_edata>
  if(p == (char*)-1)
 81a:	5b7d                	li	s6,-1
 81c:	a885                	j	88c <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
 81e:	00000797          	auipc	a5,0x0
 822:	13a78793          	addi	a5,a5,314 # 958 <base>
 826:	00000717          	auipc	a4,0x0
 82a:	12f73523          	sd	a5,298(a4) # 950 <_edata>
 82e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 850:	10a73223          	sd	a0,260(a4) # 950 <_edata>
      return (void*)(p + 1);
 ...
 884:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 886:	4798                	lw	a4,8(a5)
 888:	fb2777e3          	bleu	s2,a4,836 <malloc+0x76>
    if(p == freep)
 88c:	6098                	ld	a4,0(s1)
 88e:	853e                	mv	a0,a5
 ...
 89a:	b7a080e7          	jalr	-1158(ra) # 410 <sbrk>
  if(p == (char*)-1)
