...
int main(int argc, char *argv[]) {
  ...
  1a:	382080e7          	jalr	898(ra) # 398 <pipe>
  pipe(pipes2);
  1e:	fd040513          	addi	a0,s0,-48
  22:	00000097          	auipc	ra,0x0
  26:	376080e7          	jalr	886(ra) # 398 <pipe>

  int ret = fork();
  2a:	00000097          	auipc	ra,0x0
  2e:	356080e7          	jalr	854(ra) # 380 <fork>
  ...
  // lazy
  if (ret == 0) {
  32:	e135                	bnez	a0,96 <main+0x96>
    // i am the child
    pid = getpid();
  34:	00000097          	auipc	ra,0x0
  38:	3d4080e7          	jalr	980(ra) # 408 <getpid>
  3c:	84aa                	mv	s1,a0
    close(pipes1[1]);
  3e:	fdc42503          	lw	a0,-36(s0)
  42:	00000097          	auipc	ra,0x0
  46:	36e080e7          	jalr	878(ra) # 3b0 <close>
    close(pipes2[0]);
  4a:	fd042503          	lw	a0,-48(s0)
  4e:	00000097          	auipc	ra,0x0
  52:	362080e7          	jalr	866(ra) # 3b0 <close>
    read(pipes1[0], buf, 1);
  56:	4605                	li	a2,1
  58:	fc840593          	addi	a1,s0,-56
  5c:	fd842503          	lw	a0,-40(s0)
  60:	00000097          	auipc	ra,0x0
  64:	340080e7          	jalr	832(ra) # 3a0 <read>
    printf("%d: received ping\n", pid);
  68:	85a6                	mv	a1,s1
  6a:	00001517          	auipc	a0,0x1
  6e:	84650513          	addi	a0,a0,-1978 # 8b0 <malloc+0xe8>
  72:	00000097          	auipc	ra,0x0
  76:	696080e7          	jalr	1686(ra) # 708 <printf>
    write(pipes2[1], buf, 1);
  7a:	4605                	li	a2,1
  7c:	fc840593          	addi	a1,s0,-56
  80:	fd442503          	lw	a0,-44(s0)
  84:	00000097          	auipc	ra,0x0
  88:	324080e7          	jalr	804(ra) # 3a8 <write>
    exit(0);
  8c:	4501                	li	a0,0
  8e:	00000097          	auipc	ra,0x0
  92:	2fa080e7          	jalr	762(ra) # 388 <exit>
  } else {
    // i am the parent
    pid = getpid();
  96:	00000097          	auipc	ra,0x0
  9a:	372080e7          	jalr	882(ra) # 408 <getpid>
  9e:	84aa                	mv	s1,a0
    close(pipes1[0]);
  a0:	fd842503          	lw	a0,-40(s0)
  a4:	00000097          	auipc	ra,0x0
  a8:	30c080e7          	jalr	780(ra) # 3b0 <close>
    close(pipes2[1]);
  ac:	fd442503          	lw	a0,-44(s0)
  b0:	00000097          	auipc	ra,0x0
  b4:	300080e7          	jalr	768(ra) # 3b0 <close>
    write(pipes1[1], buf, 1);
  b8:	4605                	li	a2,1
  ba:	fc840593          	addi	a1,s0,-56
  be:	fdc42503          	lw	a0,-36(s0)
  c2:	00000097          	auipc	ra,0x0
  c6:	2e6080e7          	jalr	742(ra) # 3a8 <write>
    read(pipes2[0], buf, 1);
  ca:	4605                	li	a2,1
  cc:	fc840593          	addi	a1,s0,-56
  d0:	fd042503          	lw	a0,-48(s0)
  d4:	00000097          	auipc	ra,0x0
  d8:	2cc080e7          	jalr	716(ra) # 3a0 <read>
    printf("%d: received pong\n", pid);
  dc:	85a6                	mv	a1,s1
  de:	00000517          	auipc	a0,0x0
  e2:	7ea50513          	addi	a0,a0,2026 # 8c8 <malloc+0x100>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 476:	46e88893          	addi	a7,a7,1134 # 8e0 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 548:	39cb8b93          	addi	s7,s7,924 # 8e0 <digits>
 ...
 684:	27848493          	addi	s1,s1,632 # 8f8 <digits+0x18>
        while(*s != 0){
...
free(void *ap)
{
 ...
 74c:	1b878793          	addi	a5,a5,440 # 900 <__bss_start>
 750:	639c                	ld	a5,0(a5)
 ...
 77c:	00e6ea63          	bltu	a3,a4,790 <free+0x52>
{
 ...
 7be:	14f73323          	sd	a5,326(a4) # 900 <__bss_start>
}
 7c2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7f4:	11078793          	addi	a5,a5,272 # 900 <__bss_start>
 7f8:	6388                	ld	a0,0(a5)
 ...
 81e:	0e648493          	addi	s1,s1,230 # 900 <__bss_start>
  if(p == (char*)-1)
 822:	5b7d                	li	s6,-1
 824:	a885                	j	894 <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
 826:	00000797          	auipc	a5,0x0
 82a:	0e278793          	addi	a5,a5,226 # 908 <base>
 82e:	00000717          	auipc	a4,0x0
 832:	0cf73923          	sd	a5,210(a4) # 900 <__bss_start>
 836:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 858:	0aa73623          	sd	a0,172(a4) # 900 <__bss_start>
      return (void*)(p + 1);
