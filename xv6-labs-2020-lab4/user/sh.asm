...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	33858593          	addi	a1,a1,824 # 1348 <malloc+0x116>
      18:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	2f058593          	addi	a1,a1,752 # 1350 <malloc+0x11e>
      68:	4509                	li	a0,2
      6a:	00001097          	auipc	ra,0x1
      6e:	0da080e7          	jalr	218(ra) # 1144 <fprintf>
  exit(1);
      72:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	2be50513          	addi	a0,a0,702 # 1358 <malloc+0x126>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	25270713          	addi	a4,a4,594 # 1318 <malloc+0xe6>
    ...
    panic("runcmd");
      ...
      e4:	28050513          	addi	a0,a0,640 # 1360 <malloc+0x12e>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	26658593          	addi	a1,a1,614 # 1368 <malloc+0x136>
     10a:	4509                	li	a0,2
     10c:	00001097          	auipc	ra,0x1
     110:	038080e7          	jalr	56(ra) # 1144 <fprintf>
  exit(0);
     114:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     152:	22a58593          	addi	a1,a1,554 # 1378 <malloc+0x146>
     156:	4509                	li	a0,2
     158:	00001097          	auipc	ra,0x1
     15c:	fec080e7          	jalr	-20(ra) # 1144 <fprintf>
      exit(1);
     160:	4505                	li	a0,1
    ...
    break;
     ...
     1e8:	1a450513          	addi	a0,a0,420 # 1388 <malloc+0x156>
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     28a:	fac080e7          	jalr	-84(ra) # 1232 <malloc>
     28e:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     2d4:	f62080e7          	jalr	-158(ra) # 1232 <malloc>
     2d8:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     32e:	f08080e7          	jalr	-248(ra) # 1232 <malloc>
     332:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     334:	4661                	li	a2,24
     336:	4581                	li	a1,0
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     374:	ec2080e7          	jalr	-318(ra) # 1232 <malloc>
     378:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     37a:	4661                	li	a2,24
     37c:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3b6:	e80080e7          	jalr	-384(ra) # 1232 <malloc>
     3ba:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     3bc:	4641                	li	a2,16
     3be:	4581                	li	a1,0
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     400:	08498993          	addi	s3,s3,132 # 1480 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     44c:	03898993          	addi	s3,s3,56 # 1480 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     490:	ff498993          	addi	s3,s3,-12 # 1480 <whitespace>
     494:	00001a97          	auipc	s5,0x1
     498:	fe4a8a93          	addi	s5,s5,-28 # 1478 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     540:	f4498993          	addi	s3,s3,-188 # 1480 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5b0:	e04b8b93          	addi	s7,s7,-508 # 13b0 <malloc+0x17e>
  ...
  while(peek(ps, es, "<>")){
     ...
     5c2:	dd250513          	addi	a0,a0,-558 # 1390 <malloc+0x15e>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6aa:	d1260613          	addi	a2,a2,-750 # 13b8 <malloc+0x186>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6da:	d02b0b13          	addi	s6,s6,-766 # 13d8 <malloc+0x1a6>
  ...
  return ret;
     ...
     714:	cb050513          	addi	a0,a0,-848 # 13c0 <malloc+0x18e>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     772:	c5a50513          	addi	a0,a0,-934 # 13c8 <malloc+0x196>
...
000000000000078c <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7ac:	c3860613          	addi	a2,a2,-968 # 13e0 <malloc+0x1ae>
     7b0:	85ce                	mv	a1,s3
     7b2:	854a                	mv	a0,s2
...
00000000000007fa <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     81c:	bd0a0a13          	addi	s4,s4,-1072 # 13e8 <malloc+0x1b6>
     820:	8652                	mv	a2,s4
     822:	85ca                	mv	a1,s2
     824:	8526                	mv	a0,s1
  ...
  if(peek(ps, es, ";")){
     ...
     852:	ba260613          	addi	a2,a2,-1118 # 13f0 <malloc+0x1be>
     856:	85ca                	mv	a1,s2
     858:	8526                	mv	a0,s1
...
00000000000008a2 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b8:	b0460613          	addi	a2,a2,-1276 # 13b8 <malloc+0x186>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e8:	b2460613          	addi	a2,a2,-1244 # 1408 <malloc+0x1d6>
     8ec:	85ca                	mv	a1,s2
     8ee:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     92a:	ad250513          	addi	a0,a0,-1326 # 13f8 <malloc+0x1c6>
     92e:	fffff097          	auipc	ra,0xfffff
     932:	728080e7          	jalr	1832(ra) # 56 <panic>
    panic("syntax - missing )");
     936:	00001517          	auipc	a0,0x1
     93a:	ada50513          	addi	a0,a0,-1318 # 1410 <malloc+0x1de>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     966:	9ce70713          	addi	a4,a4,-1586 # 1330 <malloc+0xfe>
...
00000000000009de <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a12:	a1a60613          	addi	a2,a2,-1510 # 1428 <malloc+0x1f6>
     a16:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a48:	9ec58593          	addi	a1,a1,-1556 # 1430 <malloc+0x1fe>
     a4c:	4509                	li	a0,2
     a4e:	00000097          	auipc	ra,0x0
     a52:	6f6080e7          	jalr	1782(ra) # 1144 <fprintf>
    panic("syntax");
     a56:	00001517          	auipc	a0,0x1
     a5a:	96a50513          	addi	a0,a0,-1686 # 13c0 <malloc+0x18e>
...
0000000000000a66 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a7c:	9c848493          	addi	s1,s1,-1592 # 1440 <malloc+0x20e>
     a80:	4589                	li	a1,2
     a82:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     aa2:	9f248493          	addi	s1,s1,-1550 # 1490 <buf.1158>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa6:	06300913          	li	s2,99
     aaa:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aae:	00001a17          	auipc	s4,0x1
     ab2:	9e5a0a13          	addi	s4,s4,-1563 # 1493 <buf.1158+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab6:	00001a97          	auipc	s5,0x1
     aba:	992a8a93          	addi	s5,s5,-1646 # 1448 <malloc+0x216>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b32:	616080e7          	jalr	1558(ra) # 1144 <fprintf>
     b36:	bf79                	j	ad4 <main+0x6e>
      runcmd(parsecmd(buf));
     b38:	00001517          	auipc	a0,0x1
     b3c:	95850513          	addi	a0,a0,-1704 # 1490 <buf.1158>
...
printint(int fd, int xx, int base, int sgn)
{
     ...
     ec4:	f04a                	sd	s2,32(sp)
     ec6:	ec4e                	sd	s3,24(sp)
  ...
  neg = 0;
  if(sgn && xx < 0){
     eca:	c299                	beqz	a3,ed0 <printint+0x14>
     ecc:	0005cd63          	bltz	a1,ee6 <printint+0x2a>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     edc:	00000897          	auipc	a7,0x0
     ee0:	57c88893          	addi	a7,a7,1404 # 1458 <digits>
     ee4:	a801                	j	ef4 <printint+0x38>
    x = -xx;
     ee6:	40b005bb          	negw	a1,a1
     eea:	2581                	sext.w	a1,a1
    neg = 1;
     eec:	4305                	li	t1,1
    x = -xx;
     eee:	b7dd                	j	ed4 <printint+0x18>
  }while((x /= base) != 0);
     ef0:	85be                	mv	a1,a5
    buf[i++] = digits[x % base];
     ef2:	8836                	mv	a6,a3
     ef4:	0018069b          	addiw	a3,a6,1
     ef8:	02c5f7bb          	remuw	a5,a1,a2
     efc:	1782                	slli	a5,a5,0x20
     efe:	9381                	srli	a5,a5,0x20
     f00:	97c6                	add	a5,a5,a7
     f02:	0007c783          	lbu	a5,0(a5)
     f06:	00f70023          	sb	a5,0(a4)
  }while((x /= base) != 0);
     f0a:	0705                	addi	a4,a4,1
     f0c:	02c5d7bb          	divuw	a5,a1,a2
     f10:	fec5f0e3          	bleu	a2,a1,ef0 <printint+0x34>
  if(neg)
     f14:	00030b63          	beqz	t1,f2a <printint+0x6e>
    buf[i++] = '-';
     f18:	fd040793          	addi	a5,s0,-48
     f1c:	96be                	add	a3,a3,a5
     f1e:	02d00793          	li	a5,45
     f22:	fef68823          	sb	a5,-16(a3)
     f26:	0028069b          	addiw	a3,a6,2

  while(--i >= 0)
     f2a:	02d05963          	blez	a3,f5c <printint+0xa0>
     f2e:	89aa                	mv	s3,a0
     f30:	fc040793          	addi	a5,s0,-64
     f34:	00d784b3          	add	s1,a5,a3
     f38:	fff78913          	addi	s2,a5,-1
     f3c:	9936                	add	s2,s2,a3
     f3e:	36fd                	addiw	a3,a3,-1
     f40:	1682                	slli	a3,a3,0x20
     f42:	9281                	srli	a3,a3,0x20
     f44:	40d90933          	sub	s2,s2,a3
    putc(fd, buf[i]);
     f48:	fff4c583          	lbu	a1,-1(s1)
     f4c:	854e                	mv	a0,s3
     f4e:	00000097          	auipc	ra,0x0
     f52:	f4c080e7          	jalr	-180(ra) # e9a <putc>
  while(--i >= 0)
     f56:	14fd                	addi	s1,s1,-1
     f58:	ff2498e3          	bne	s1,s2,f48 <printint+0x8c>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
     f88:	0005c483          	lbu	s1,0(a1)
     f8c:	18048d63          	beqz	s1,1126 <vprintf+0x1bc>
     f90:	8aaa                	mv	s5,a0
     f92:	8b32                	mv	s6,a2
     f94:	00158913          	addi	s2,a1,1
  state = 0;
     f98:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     fb2:	4aab8b93          	addi	s7,s7,1194 # 1458 <digits>
     fb6:	a839                	j	fd4 <vprintf+0x6a>
        putc(fd, c);
     fb8:	85a6                	mv	a1,s1
     fba:	8556                	mv	a0,s5
     fbc:	00000097          	auipc	ra,0x0
     fc0:	ede080e7          	jalr	-290(ra) # e9a <putc>
     fc4:	a019                	j	fca <vprintf+0x60>
    } else if(state == '%'){
     fc6:	01498f63          	beq	s3,s4,fe4 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
     fca:	0905                	addi	s2,s2,1
     fcc:	fff94483          	lbu	s1,-1(s2)
     fd0:	14048b63          	beqz	s1,1126 <vprintf+0x1bc>
    c = fmt[i] & 0xff;
     fd4:	0004879b          	sext.w	a5,s1
    if(state == 0){
     ...
     ff8:	0ce78563          	beq	a5,a4,10c2 <vprintf+0x158>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    1000:	0ee78c63          	beq	a5,a4,10f8 <vprintf+0x18e>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    1004:	11478663          	beq	a5,s4,1110 <vprintf+0x1a6>
        putc(fd, c);
      } else {
    ...
    1010:	e8e080e7          	jalr	-370(ra) # e9a <putc>
        putc(fd, c);
    1014:	85a6                	mv	a1,s1
    1016:	8556                	mv	a0,s5
    1018:	00000097          	auipc	ra,0x0
    101c:	e82080e7          	jalr	-382(ra) # e9a <putc>
      }
      state = 0;
    1020:	4981                	li	s3,0
    1022:	b765                	j	fca <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    1024:	008b0493          	addi	s1,s6,8
    1028:	4685                	li	a3,1
    102a:	4629                	li	a2,10
    102c:	000b2583          	lw	a1,0(s6)
    1030:	8556                	mv	a0,s5
    1032:	00000097          	auipc	ra,0x0
    1036:	e8a080e7          	jalr	-374(ra) # ebc <printint>
    103a:	8b26                	mv	s6,s1
      state = 0;
    103c:	4981                	li	s3,0
    ...
    1052:	e6e080e7          	jalr	-402(ra) # ebc <printint>
    1056:	8b26                	mv	s6,s1
      state = 0;
    1058:	4981                	li	s3,0
    ...
    106e:	e52080e7          	jalr	-430(ra) # ebc <printint>
    1072:	8b26                	mv	s6,s1
      state = 0;
    1074:	4981                	li	s3,0
  ...
  putc(fd, '0');
    ...
    108e:	e10080e7          	jalr	-496(ra) # e9a <putc>
  putc(fd, 'x');
    1092:	85ea                	mv	a1,s10
    1094:	8556                	mv	a0,s5
    1096:	00000097          	auipc	ra,0x0
    109a:	e04080e7          	jalr	-508(ra) # e9a <putc>
    109e:	44c1                	li	s1,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10b6:	34fd                	addiw	s1,s1,-1
    10b8:	f4e5                	bnez	s1,10a0 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    10ba:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    10be:	4981                	li	s3,0
    10c0:	b729                	j	fca <vprintf+0x60>
        s = va_arg(ap, char*);
    10c2:	008b0993          	addi	s3,s6,8
    10c6:	000b3483          	ld	s1,0(s6)
        if(s == 0)
    10ca:	c085                	beqz	s1,10ea <vprintf+0x180>
        while(*s != 0){
    10cc:	0004c583          	lbu	a1,0(s1)
    10d0:	c9a1                	beqz	a1,1120 <vprintf+0x1b6>
          putc(fd, *s);
    10d2:	8556                	mv	a0,s5
    10d4:	00000097          	auipc	ra,0x0
    10d8:	dc6080e7          	jalr	-570(ra) # e9a <putc>
          s++;
    10dc:	0485                	addi	s1,s1,1
        while(*s != 0){
    10de:	0004c583          	lbu	a1,0(s1)
    10e2:	f9e5                	bnez	a1,10d2 <vprintf+0x168>
        s = va_arg(ap, char*);
    10e4:	8b4e                	mv	s6,s3
      state = 0;
    10e6:	4981                	li	s3,0
    10e8:	b5cd                	j	fca <vprintf+0x60>
          s = "(null)";
    10ea:	00000497          	auipc	s1,0x0
    10ee:	38648493          	addi	s1,s1,902 # 1470 <digits+0x18>
        while(*s != 0){
    10f2:	02800593          	li	a1,40
    10f6:	bff1                	j	10d2 <vprintf+0x168>
        putc(fd, va_arg(ap, uint));
    10f8:	008b0493          	addi	s1,s6,8
    10fc:	000b4583          	lbu	a1,0(s6)
    1100:	8556                	mv	a0,s5
    1102:	00000097          	auipc	ra,0x0
    1106:	d98080e7          	jalr	-616(ra) # e9a <putc>
    110a:	8b26                	mv	s6,s1
      state = 0;
    110c:	4981                	li	s3,0
    110e:	bd75                	j	fca <vprintf+0x60>
        putc(fd, c);
    1110:	85d2                	mv	a1,s4
    1112:	8556                	mv	a0,s5
    1114:	00000097          	auipc	ra,0x0
    1118:	d86080e7          	jalr	-634(ra) # e9a <putc>
      state = 0;
    111c:	4981                	li	s3,0
    111e:	b575                	j	fca <vprintf+0x60>
        s = va_arg(ap, char*);
    1120:	8b4e                	mv	s6,s3
      state = 0;
    1122:	4981                	li	s3,0
    1124:	b55d                	j	fca <vprintf+0x60>
    }
  }
}
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  vprintf(fd, fmt, ap);
    ...
    1166:	e08080e7          	jalr	-504(ra) # f6a <vprintf>
}
...
printf(const char *fmt, ...)
{
  ...
  vprintf(1, fmt, ap);
    ...
    119c:	dd2080e7          	jalr	-558(ra) # f6a <vprintf>
}
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11b6:	2d678793          	addi	a5,a5,726 # 1488 <freep>
    11ba:	639c                	ld	a5,0(a5)
    11bc:	a805                	j	11ec <free+0x44>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    11be:	4618                	lw	a4,8(a2)
    11c0:	9db9                	addw	a1,a1,a4
    11c2:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    11c6:	6398                	ld	a4,0(a5)
    11c8:	6318                	ld	a4,0(a4)
    11ca:	fee53823          	sd	a4,-16(a0)
    11ce:	a091                	j	1212 <free+0x6a>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    11d0:	ff852703          	lw	a4,-8(a0)
    11d4:	9e39                	addw	a2,a2,a4
    11d6:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    11d8:	ff053703          	ld	a4,-16(a0)
    11dc:	e398                	sd	a4,0(a5)
    11de:	a099                	j	1224 <free+0x7c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11e0:	6398                	ld	a4,0(a5)
    11e2:	00e7e463          	bltu	a5,a4,11ea <free+0x42>
    11e6:	00e6ea63          	bltu	a3,a4,11fa <free+0x52>
{
    11ea:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    11ec:	fed7fae3          	bleu	a3,a5,11e0 <free+0x38>
    11f0:	6398                	ld	a4,0(a5)
    11f2:	00e6e463          	bltu	a3,a4,11fa <free+0x52>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11f6:	fee7eae3          	bltu	a5,a4,11ea <free+0x42>
  if(bp + bp->s.size == p->s.ptr){
    11fa:	ff852583          	lw	a1,-8(a0)
    11fe:	6390                	ld	a2,0(a5)
    1200:	02059713          	slli	a4,a1,0x20
    1204:	9301                	srli	a4,a4,0x20
    1206:	0712                	slli	a4,a4,0x4
    1208:	9736                	add	a4,a4,a3
    120a:	fae60ae3          	beq	a2,a4,11be <free+0x16>
    bp->s.ptr = p->s.ptr;
    120e:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    1212:	4790                	lw	a2,8(a5)
    1214:	02061713          	slli	a4,a2,0x20
    1218:	9301                	srli	a4,a4,0x20
    121a:	0712                	slli	a4,a4,0x4
    121c:	973e                	add	a4,a4,a5
    121e:	fae689e3          	beq	a3,a4,11d0 <free+0x28>
  } else
    p->s.ptr = bp;
    1222:	e394                	sd	a3,0(a5)
  freep = p;
    1224:	00000717          	auipc	a4,0x0
    1228:	26f73223          	sd	a5,612(a4) # 1488 <freep>
}
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1246:	02051993          	slli	s3,a0,0x20
    124a:	0209d993          	srli	s3,s3,0x20
    124e:	09bd                	addi	s3,s3,15
    1250:	0049d993          	srli	s3,s3,0x4
    1254:	2985                	addiw	s3,s3,1
    1256:	0009891b          	sext.w	s2,s3
  if((prevp = freep) == 0){
    125a:	00000797          	auipc	a5,0x0
    125e:	22e78793          	addi	a5,a5,558 # 1488 <freep>
    1262:	6388                	ld	a0,0(a5)
    1264:	c515                	beqz	a0,1290 <malloc+0x5e>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    126a:	03277f63          	bleu	s2,a4,12a8 <malloc+0x76>
    126e:	8a4e                	mv	s4,s3
    1270:	0009871b          	sext.w	a4,s3
    1274:	6685                	lui	a3,0x1
    1276:	00d77363          	bleu	a3,a4,127c <malloc+0x4a>
    127a:	6a05                	lui	s4,0x1
    127c:	000a0a9b          	sext.w	s5,s4
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    1284:	00000497          	auipc	s1,0x0
    1288:	20448493          	addi	s1,s1,516 # 1488 <freep>
  if(p == (char*)-1)
    128c:	5b7d                	li	s6,-1
    128e:	a885                	j	12fe <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
    1290:	00000797          	auipc	a5,0x0
    1294:	26878793          	addi	a5,a5,616 # 14f8 <base>
    1298:	00000717          	auipc	a4,0x0
    129c:	1ef73823          	sd	a5,496(a4) # 1488 <freep>
    12a0:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    12a2:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    12a6:	b7e1                	j	126e <malloc+0x3c>
      if(p->s.size == nunits)
    12a8:	02e90b63          	beq	s2,a4,12de <malloc+0xac>
        p->s.size -= nunits;
    ...
    12c2:	1ca73523          	sd	a0,458(a4) # 1488 <freep>
      return (void*)(p + 1);
    ...
    12e2:	bff1                	j	12be <malloc+0x8c>
  hp->s.size = nu;
    12e4:	01552423          	sw	s5,8(a0)
  free((void*)(hp + 1));
    12e8:	0541                	addi	a0,a0,16
    12ea:	00000097          	auipc	ra,0x0
    12ee:	ebe080e7          	jalr	-322(ra) # 11a8 <free>
  return freep;
    12f2:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
    12f4:	d979                	beqz	a0,12ca <malloc+0x98>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12f6:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    12f8:	4798                	lw	a4,8(a5)
    12fa:	fb2777e3          	bleu	s2,a4,12a8 <malloc+0x76>
    if(p == freep)
    12fe:	6098                	ld	a4,0(s1)
    1300:	853e                	mv	a0,a5
    1302:	fef71ae3          	bne	a4,a5,12f6 <malloc+0xc4>
  p = sbrk(nu * sizeof(Header));
    1306:	8552                	mv	a0,s4
    1308:	00000097          	auipc	ra,0x0
    130c:	b6a080e7          	jalr	-1174(ra) # e72 <sbrk>
  if(p == (char*)-1)
    1310:	fd651ae3          	bne	a0,s6,12e4 <malloc+0xb2>
        return 0;
    1314:	4501                	li	a0,0
    1316:	bf55                	j	12ca <malloc+0x98>
