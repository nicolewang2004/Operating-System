...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	32858593          	addi	a1,a1,808 # 1338 <malloc+0x116>
      18:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	2e058593          	addi	a1,a1,736 # 1340 <malloc+0x11e>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	2ae50513          	addi	a0,a0,686 # 1348 <malloc+0x126>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	24270713          	addi	a4,a4,578 # 1308 <malloc+0xe6>
    ...
    panic("runcmd");
      ...
      e4:	27050513          	addi	a0,a0,624 # 1350 <malloc+0x12e>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	25658593          	addi	a1,a1,598 # 1358 <malloc+0x136>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	21a58593          	addi	a1,a1,538 # 1368 <malloc+0x146>
     156:	4509                	li	a0,2
    ...
    break;
     ...
     1e8:	19450513          	addi	a0,a0,404 # 1378 <malloc+0x156>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     400:	07498993          	addi	s3,s3,116 # 1470 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     44c:	02898993          	addi	s3,s3,40 # 1470 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     490:	fe498993          	addi	s3,s3,-28 # 1470 <whitespace>
     494:	00001a97          	auipc	s5,0x1
     498:	fd4a8a93          	addi	s5,s5,-44 # 1468 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     540:	f3498993          	addi	s3,s3,-204 # 1470 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5b0:	df4b8b93          	addi	s7,s7,-524 # 13a0 <malloc+0x17e>
  ...
  while(peek(ps, es, "<>")){
     ...
     5c2:	dc250513          	addi	a0,a0,-574 # 1380 <malloc+0x15e>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6aa:	d0260613          	addi	a2,a2,-766 # 13a8 <malloc+0x186>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6da:	cf2b0b13          	addi	s6,s6,-782 # 13c8 <malloc+0x1a6>
  ...
  return ret;
     ...
     714:	ca050513          	addi	a0,a0,-864 # 13b0 <malloc+0x18e>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     772:	c4a50513          	addi	a0,a0,-950 # 13b8 <malloc+0x196>
...
000000000000078c <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7ac:	c2860613          	addi	a2,a2,-984 # 13d0 <malloc+0x1ae>
     7b0:	85ce                	mv	a1,s3
     7b2:	854a                	mv	a0,s2
...
00000000000007fa <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     81c:	bc0a0a13          	addi	s4,s4,-1088 # 13d8 <malloc+0x1b6>
     820:	8652                	mv	a2,s4
     822:	85ca                	mv	a1,s2
     824:	8526                	mv	a0,s1
  ...
  if(peek(ps, es, ";")){
     ...
     852:	b9260613          	addi	a2,a2,-1134 # 13e0 <malloc+0x1be>
     856:	85ca                	mv	a1,s2
     858:	8526                	mv	a0,s1
...
00000000000008a2 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b8:	af460613          	addi	a2,a2,-1292 # 13a8 <malloc+0x186>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e8:	b1460613          	addi	a2,a2,-1260 # 13f8 <malloc+0x1d6>
     8ec:	85ca                	mv	a1,s2
     8ee:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     92a:	ac250513          	addi	a0,a0,-1342 # 13e8 <malloc+0x1c6>
     92e:	fffff097          	auipc	ra,0xfffff
     932:	728080e7          	jalr	1832(ra) # 56 <panic>
    panic("syntax - missing )");
     936:	00001517          	auipc	a0,0x1
     93a:	aca50513          	addi	a0,a0,-1334 # 1400 <malloc+0x1de>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     966:	9be70713          	addi	a4,a4,-1602 # 1320 <malloc+0xfe>
...
00000000000009de <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a12:	a0a60613          	addi	a2,a2,-1526 # 1418 <malloc+0x1f6>
     a16:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a48:	9dc58593          	addi	a1,a1,-1572 # 1420 <malloc+0x1fe>
     a4c:	4509                	li	a0,2
     a4e:	00000097          	auipc	ra,0x0
     a52:	6e6080e7          	jalr	1766(ra) # 1134 <fprintf>
    panic("syntax");
     a56:	00001517          	auipc	a0,0x1
     a5a:	95a50513          	addi	a0,a0,-1702 # 13b0 <malloc+0x18e>
...
0000000000000a66 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a7c:	9b848493          	addi	s1,s1,-1608 # 1430 <malloc+0x20e>
     a80:	4589                	li	a1,2
     a82:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     aa2:	9e248493          	addi	s1,s1,-1566 # 1480 <buf.1153>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa6:	06300913          	li	s2,99
     aaa:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aae:	00001a17          	auipc	s4,0x1
     ab2:	9d5a0a13          	addi	s4,s4,-1579 # 1483 <buf.1153+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab6:	00001a97          	auipc	s5,0x1
     aba:	982a8a93          	addi	s5,s5,-1662 # 1438 <malloc+0x216>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b3c:	94850513          	addi	a0,a0,-1720 # 1480 <buf.1153>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ed0:	57c88893          	addi	a7,a7,1404 # 1448 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     fa2:	4aab8b93          	addi	s7,s7,1194 # 1448 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10de:	38648493          	addi	s1,s1,902 # 1460 <digits+0x18>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11a6:	2d678793          	addi	a5,a5,726 # 1478 <freep>
    ...
    11d6:	00e6ea63          	bltu	a3,a4,11ea <free+0x52>
{
  ...
  freep = p;
    ...
    1218:	26f73223          	sd	a5,612(a4) # 1478 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    124e:	22e78793          	addi	a5,a5,558 # 1478 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1278:	20448493          	addi	s1,s1,516 # 1478 <freep>
  if(p == (char*)-1)
    127c:	5b7d                	li	s6,-1
    127e:	a885                	j	12ee <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
    1280:	00000797          	auipc	a5,0x0
    1284:	26878793          	addi	a5,a5,616 # 14e8 <base>
    1288:	00000717          	auipc	a4,0x0
    128c:	1ef73823          	sd	a5,496(a4) # 1478 <freep>
    ...
    12b2:	1ca73523          	sd	a0,458(a4) # 1478 <freep>
      return (void*)(p + 1);
