 ...
 */
    ...
    lo = x % 127773;
      16:	66fd                	lui	a3,0x1f
      18:	31d68693          	addi	a3,a3,797 # 1f31d <__global_pointer$+0x1d47d>
      1c:	02d7e733          	rem	a4,a5,a3
    x = 16807 * lo - 2836 * hi;
      20:	6611                	lui	a2,0x4
      22:	1a760613          	addi	a2,a2,423 # 41a7 <__global_pointer$+0x2307>
      26:	02c70733          	mul	a4,a4,a2
    hi = x / 127773;
      2a:	02d7c7b3          	div	a5,a5,a3
    x = 16807 * lo - 2836 * hi;
      2e:	76fd                	lui	a3,0xfffff
      30:	4ec68693          	addi	a3,a3,1260 # fffffffffffff4ec <__global_pointer$+0xffffffffffffd64c>
...
go(int which_child)
{
  ...
  while(1){
    ...
    if((iters % 500) == 0)
      ...
      ea:	2f290913          	addi	s2,s2,754 # 13d8 <malloc+0x124>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001917          	auipc	s2,0x1
      f4:	2e090913          	addi	s2,s2,736 # 13d0 <malloc+0x11c>
    iters++;
      f8:	4485                	li	s1,1
  int fd = -1;
      fa:	59fd                	li	s3,-1
      ...
      sbrk(6011);
      fc:	6a05                	lui	s4,0x1
      fe:	77ba0a13          	addi	s4,s4,1915 # 177b <buf.1251+0xcb>
     102:	a825                	j	13a <go+0xc2>
      close(open("grindir/../a", O_CREATE|O_RDWR));
     104:	20200593          	li	a1,514
     108:	00001517          	auipc	a0,0x1
     10c:	2d850513          	addi	a0,a0,728 # 13e0 <malloc+0x12c>
    ...
    if(what == 1){
     ...
     296:	36e58593          	addi	a1,a1,878 # 1600 <malloc+0x34c>
     ...
     2ba:	3a250513          	addi	a0,a0,930 # 1658 <malloc+0x3a4>
     ...
     2d8:	11c50513          	addi	a0,a0,284 # 13f0 <malloc+0x13c>
     ...
     360:	0b450513          	addi	a0,a0,180 # 1410 <malloc+0x15c>
     ...
     382:	0a250513          	addi	a0,a0,162 # 1420 <malloc+0x16c>
     ...
     39a:	31a58593          	addi	a1,a1,794 # 16b0 <buf.1251>
     39e:	854e                	mv	a0,s3
     ...
     3b2:	30258593          	addi	a1,a1,770 # 16b0 <buf.1251>
     3b6:	854e                	mv	a0,s3
     ...
     562:	f5a50513          	addi	a0,a0,-166 # 14b8 <malloc+0x204>
     ...
     58e:	ef650513          	addi	a0,a0,-266 # 1480 <malloc+0x1cc>
     ...
     5b0:	ef450513          	addi	a0,a0,-268 # 14a0 <malloc+0x1ec>
     ...
     5ca:	f0250513          	addi	a0,a0,-254 # 14c8 <malloc+0x214>
     ...
     618:	e8c50513          	addi	a0,a0,-372 # 14a0 <malloc+0x1ec>
     ...
     674:	e7050513          	addi	a0,a0,-400 # 14e0 <malloc+0x22c>
     ...
     6a0:	e5c58593          	addi	a1,a1,-420 # 14f8 <malloc+0x244>
     ...
     7a2:	d0250513          	addi	a0,a0,-766 # 14a0 <malloc+0x1ec>
     ...
     7e8:	d1458593          	addi	a1,a1,-748 # 14f8 <malloc+0x244>
     ...
     85a:	d0a50513          	addi	a0,a0,-758 # 1560 <malloc+0x2ac>
     ...
     874:	d0850513          	addi	a0,a0,-760 # 1578 <malloc+0x2c4>
     ...
     890:	d0450513          	addi	a0,a0,-764 # 1590 <malloc+0x2dc>
     ...
     8aa:	d1250513          	addi	a0,a0,-750 # 15b8 <malloc+0x304>
     ...
     8c4:	c2058593          	addi	a1,a1,-992 # 14e0 <malloc+0x22c>
     8c8:	4509                	li	a0,2
     ...
     8e0:	c0458593          	addi	a1,a1,-1020 # 14e0 <malloc+0x22c>
     8e4:	4509                	li	a0,2
     ...
     93c:	ca858593          	addi	a1,a1,-856 # 15e0 <malloc+0x32c>
     940:	4509                	li	a0,2
     ...
     9b0:	af458593          	addi	a1,a1,-1292 # 14a0 <malloc+0x1ec>
     9b4:	4509                	li	a0,2
     ...
     9fc:	be858593          	addi	a1,a1,-1048 # 15e0 <malloc+0x32c>
     a00:	4509                	li	a0,2
     ...
     a40:	ba458593          	addi	a1,a1,-1116 # 15e0 <malloc+0x32c>
     a44:	4509                	li	a0,2
     ...
     aa8:	9fc58593          	addi	a1,a1,-1540 # 14a0 <malloc+0x1ec>
     aac:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     ad0:	9b450513          	addi	a0,a0,-1612 # 1480 <malloc+0x1cc>
     ad4:	00000097          	auipc	ra,0x0
     ad8:	3f8080e7          	jalr	1016(ra) # ecc <unlink>
  unlink("b");
     adc:	00001517          	auipc	a0,0x1
     ae0:	95450513          	addi	a0,a0,-1708 # 1430 <malloc+0x17c>
  ...
  if(pid1 == 0){
    ...
    rand_next = 31;
     ...
     b02:	baf73123          	sd	a5,-1118(a4) # 16a0 <rand_next>
    go(0);
     b06:	4501                	li	a0,0
    ...
    printf("grind: fork failed\n");
     ...
     b14:	99050513          	addi	a0,a0,-1648 # 14a0 <malloc+0x1ec>
  ...
  if(pid2 == 0){
    ...
    rand_next = 7177;
     b3a:	6789                	lui	a5,0x2
     b3c:	c0978793          	addi	a5,a5,-1015 # 1c09 <_end+0x161>
     b40:	00001717          	auipc	a4,0x1
     b44:	b6f73023          	sd	a5,-1184(a4) # 16a0 <rand_next>
    go(1);
     b48:	4505                	li	a0,1
    ...
    printf("grind: fork failed\n");
     ...
     b56:	94e50513          	addi	a0,a0,-1714 # 14a0 <malloc+0x1ec>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f62:	72288893          	addi	a7,a7,1826 # 1680 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    1034:	650b8b93          	addi	s7,s7,1616 # 1680 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1170:	52c48493          	addi	s1,s1,1324 # 1698 <digits+0x18>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1238:	47478793          	addi	a5,a5,1140 # 16a8 <_edata>
    ...
    1268:	00e6ea63          	bltu	a3,a4,127c <free+0x52>
{
  ...
  freep = p;
    ...
    12aa:	40f73123          	sd	a5,1026(a4) # 16a8 <_edata>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    12e0:	3cc78793          	addi	a5,a5,972 # 16a8 <_edata>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    130a:	3a248493          	addi	s1,s1,930 # 16a8 <_edata>
  if(p == (char*)-1)
    130e:	5b7d                	li	s6,-1
    1310:	a885                	j	1380 <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
    1312:	00000797          	auipc	a5,0x0
    1316:	78678793          	addi	a5,a5,1926 # 1a98 <base>
    131a:	00000717          	auipc	a4,0x0
    131e:	38f73723          	sd	a5,910(a4) # 16a8 <_edata>
    ...
    1344:	36a73423          	sd	a0,872(a4) # 16a8 <_edata>
      return (void*)(p + 1);
