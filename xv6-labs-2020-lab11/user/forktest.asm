...
forktest(void)
{
  ...
  3e:	41e50513          	addi	a0,a0,1054 # 458 <connect+0xa>
  ...
  68:	40450513          	addi	a0,a0,1028 # 468 <connect+0x1a>
  ...
  b8:	40450513          	addi	a0,a0,1028 # 4b8 <connect+0x6a>
  ...
  d4:	3b850513          	addi	a0,a0,952 # 488 <connect+0x3a>
  ...
  ee:	3b650513          	addi	a0,a0,950 # 4a0 <connect+0x52>
...
gets(char *buf, int max)
{
 ...
 21e:	1ac080e7          	jalr	428(ra) # 3c6 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 270:	182080e7          	jalr	386(ra) # 3ee <open>
  if(fd < 0)
 ...
 280:	18a080e7          	jalr	394(ra) # 406 <fstat>
 284:	892a                	mv	s2,a0
  close(fd);
 286:	8526                	mv	a0,s1
 288:	00000097          	auipc	ra,0x0
 28c:	14e080e7          	jalr	334(ra) # 3d6 <close>
  return r;
}
 290:	854a                	mv	a0,s2
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 2f0:	0800                	addi	s0,sp,16
  ...
  src = vsrc;
  if (src > dst) {
 2f2:	02b57663          	bleu	a1,a0,31e <memmove+0x32>
    while(n-- > 0)
...
memcmp(const void *s1, const void *s2, uint n)
{
 ...
 36a:	0585                	addi	a1,a1,1
  while (n-- > 0) {
 36c:	00d50d63          	beq	a0,a3,386 <memcmp+0x3e>
    if (*p1 != *p2) {
 370:	00054783          	lbu	a5,0(a0)
 374:	0005c703          	lbu	a4,0(a1)
 378:	fee788e3          	beq	a5,a4,368 <memcmp+0x20>
      return *p1 - *p2;
 ...
 384:	8082                	ret
  return 0;
 386:	4501                	li	a0,0
 388:	bfe5                	j	380 <memcmp+0x38>
 38a:	4501                	li	a0,0
 38c:	bfd5                	j	380 <memcmp+0x38>
...
memcpy(void *dst, const void *src, uint n)
{
 ...
 39a:	f56080e7          	jalr	-170(ra) # 2ec <memmove>
}
 39e:	60a2                	ld	ra,8(sp)
 3a0:	6402                	ld	s0,0(sp)
