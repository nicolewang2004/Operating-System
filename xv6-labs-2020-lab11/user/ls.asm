...
fmtname(char *path)
{
  ...
  74:	ac090913          	addi	s2,s2,-1344 # b30 <buf.1135>
...
ls(char *path)
{
 ...
 1fc:	8f8a0a13          	addi	s4,s4,-1800 # af0 <malloc+0x144>
        printf("ls: cannot stat %s\n", buf);
 200:	00001a97          	auipc	s5,0x1
 204:	8b0a8a93          	addi	s5,s5,-1872 # ab0 <malloc+0x104>
...
main(int argc, char *argv[])
{
 ...
 2c6:	83e50513          	addi	a0,a0,-1986 # b00 <malloc+0x154>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 65a:	4b288893          	addi	a7,a7,1202 # b08 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 72c:	3e0b8b93          	addi	s7,s7,992 # b08 <digits>
 ...
 868:	2bc48493          	addi	s1,s1,700 # b20 <digits+0x18>
        while(*s != 0){
...
free(void *ap)
{
 ...
 930:	1fc78793          	addi	a5,a5,508 # b28 <__bss_start>
 934:	639c                	ld	a5,0(a5)
 ...
 960:	00e6ea63          	bltu	a3,a4,974 <free+0x52>
{
 ...
 9a2:	18f73523          	sd	a5,394(a4) # b28 <__bss_start>
}
 9a6:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9d8:	15478793          	addi	a5,a5,340 # b28 <__bss_start>
 9dc:	6388                	ld	a0,0(a5)
 ...
 a02:	12a48493          	addi	s1,s1,298 # b28 <__bss_start>
  if(p == (char*)-1)
 a06:	5b7d                	li	s6,-1
 a08:	a885                	j	a78 <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
 a0a:	00000797          	auipc	a5,0x0
 a0e:	13678793          	addi	a5,a5,310 # b40 <base>
 a12:	00000717          	auipc	a4,0x0
 a16:	10f73b23          	sd	a5,278(a4) # b28 <__bss_start>
 a1a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a3c:	0ea73823          	sd	a0,240(a4) # b28 <__bss_start>
      return (void*)(p + 1);
