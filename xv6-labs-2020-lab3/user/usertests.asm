...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	cca50513          	addi	a0,a0,-822 # 5d08 <statistics+0x426>
      46:	00005097          	auipc	ra,0x5
      4a:	6f6080e7          	jalr	1782(ra) # 573c <printf>
      exit(1);
      4e:	4505                	li	a0,1
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
    if(uninit[i] != '\0'){
      ...
      5c:	0c87c783          	lbu	a5,200(a5) # 9120 <uninit>
      60:	e385                	bnez	a5,80 <bsstest+0x28>
      62:	00009797          	auipc	a5,0x9
      66:	0bf78793          	addi	a5,a5,191 # 9121 <uninit+0x1>
      6a:	0000b697          	auipc	a3,0xb
      6e:	7c668693          	addi	a3,a3,1990 # b830 <buf>
      ...
      7e:	8082                	ret
{
      ...
      8e:	c9e50513          	addi	a0,a0,-866 # 5d28 <statistics+0x446>
      92:	00005097          	auipc	ra,0x5
      96:	6aa080e7          	jalr	1706(ra) # 573c <printf>
      exit(1);
      9a:	4505                	li	a0,1
...
00000000000000a4 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      b6:	c8e50513          	addi	a0,a0,-882 # 5d40 <statistics+0x45e>
  ...
  fd = open("doesnotexist", 0);
      ...
      d4:	c9050513          	addi	a0,a0,-880 # 5d60 <statistics+0x47e>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f4:	c5850513          	addi	a0,a0,-936 # 5d48 <statistics+0x466>
      f8:	00005097          	auipc	ra,0x5
      fc:	644080e7          	jalr	1604(ra) # 573c <printf>
    exit(1);
     100:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     110:	c6450513          	addi	a0,a0,-924 # 5d70 <statistics+0x48e>
     114:	00005097          	auipc	ra,0x5
     118:	628080e7          	jalr	1576(ra) # 573c <printf>
    exit(1);
     11c:	4505                	li	a0,1
...
0000000000000126 <truncate2>:
{
  ...
  int n = write(fd1, "x", 1);
     ...
     18a:	c2a58593          	addi	a1,a1,-982 # 5db0 <statistics+0x4ce>
     18e:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     1a2:	bfa50513          	addi	a0,a0,-1030 # 5d98 <statistics+0x4b6>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1d8:	be450513          	addi	a0,a0,-1052 # 5db8 <statistics+0x4d6>
     1dc:	00005097          	auipc	ra,0x5
     1e0:	560080e7          	jalr	1376(ra) # 573c <printf>
    exit(1);
     1e4:	4505                	li	a0,1
...
00000000000001ee <createtest>:
{
  ...
  name[0] = 'a';
     ...
     200:	e0c78793          	addi	a5,a5,-500 # 8008 <_edata>
  ...
  name[0] = 'a';
     ...
     242:	dca78793          	addi	a5,a5,-566 # 8008 <_edata>
...
0000000000000282 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     29e:	b4650513          	addi	a0,a0,-1210 # 5de0 <statistics+0x4fe>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     2b2:	b32a0a13          	addi	s4,s4,-1230 # 5de0 <statistics+0x4fe>
      int cc = write(fd, buf, sz);
     2b6:	0000b997          	auipc	s3,0xb
     2ba:	57a98993          	addi	s3,s3,1402 # b830 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2be:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     334:	ac050513          	addi	a0,a0,-1344 # 5df0 <statistics+0x50e>
     338:	00005097          	auipc	ra,0x5
     33c:	404080e7          	jalr	1028(ra) # 573c <printf>
      exit(1);
     340:	4505                	li	a0,1
     ...
     358:	abc50513          	addi	a0,a0,-1348 # 5e10 <statistics+0x52e>
     35c:	00005097          	auipc	ra,0x5
     360:	3e0080e7          	jalr	992(ra) # 573c <printf>
        exit(1);
     364:	4505                	li	a0,1
...
000000000000036e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     39a:	a92a0a13          	addi	s4,s4,-1390 # 5e28 <statistics+0x546>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     444:	9f050513          	addi	a0,a0,-1552 # 5e30 <statistics+0x54e>
     448:	00005097          	auipc	ra,0x5
     44c:	2f4080e7          	jalr	756(ra) # 573c <printf>
      exit(1);
     450:	4505                	li	a0,1
     ...
     462:	9ea50513          	addi	a0,a0,-1558 # 5e48 <statistics+0x566>
     466:	00005097          	auipc	ra,0x5
     46a:	2d6080e7          	jalr	726(ra) # 573c <printf>
      exit(1);
     46e:	4505                	li	a0,1
     ...
     480:	9fc50513          	addi	a0,a0,-1540 # 5e78 <statistics+0x596>
     484:	00005097          	auipc	ra,0x5
     488:	2b8080e7          	jalr	696(ra) # 573c <printf>
      exit(1);
     48c:	4505                	li	a0,1
     ...
     49a:	a1250513          	addi	a0,a0,-1518 # 5ea8 <statistics+0x5c6>
     49e:	00005097          	auipc	ra,0x5
     4a2:	29e080e7          	jalr	670(ra) # 573c <printf>
      exit(1);
     4a6:	4505                	li	a0,1
     ...
     4b8:	a0450513          	addi	a0,a0,-1532 # 5eb8 <statistics+0x5d6>
     4bc:	00005097          	auipc	ra,0x5
     4c0:	280080e7          	jalr	640(ra) # 573c <printf>
      exit(1);
     4c4:	4505                	li	a0,1
...
00000000000004ce <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4fc:	9f0a0a13          	addi	s4,s4,-1552 # 5ee8 <statistics+0x606>
    n = write(fds[1], "x", 1);
     500:	00006a97          	auipc	s5,0x6
     504:	8b0a8a93          	addi	s5,s5,-1872 # 5db0 <statistics+0x4ce>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     5a8:	94c50513          	addi	a0,a0,-1716 # 5ef0 <statistics+0x60e>
     5ac:	00005097          	auipc	ra,0x5
     5b0:	190080e7          	jalr	400(ra) # 573c <printf>
      exit(1);
     5b4:	4505                	li	a0,1
     ...
     5c6:	94650513          	addi	a0,a0,-1722 # 5f08 <statistics+0x626>
     5ca:	00005097          	auipc	ra,0x5
     5ce:	172080e7          	jalr	370(ra) # 573c <printf>
      exit(1);
     5d2:	4505                	li	a0,1
     ...
     5e0:	8cc50513          	addi	a0,a0,-1844 # 5ea8 <statistics+0x5c6>
     5e4:	00005097          	auipc	ra,0x5
     5e8:	158080e7          	jalr	344(ra) # 573c <printf>
      exit(1);
     5ec:	4505                	li	a0,1
     ...
     5fa:	94250513          	addi	a0,a0,-1726 # 5f38 <statistics+0x656>
     5fe:	00005097          	auipc	ra,0x5
     602:	13e080e7          	jalr	318(ra) # 573c <printf>
      exit(1);
     606:	4505                	li	a0,1
     ...
     618:	93c50513          	addi	a0,a0,-1732 # 5f50 <statistics+0x66e>
     61c:	00005097          	auipc	ra,0x5
     620:	120080e7          	jalr	288(ra) # 573c <printf>
      exit(1);
     624:	4505                	li	a0,1
...
000000000000062e <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     66e:	73e58593          	addi	a1,a1,1854 # 5da8 <statistics+0x4c6>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     68a:	71250513          	addi	a0,a0,1810 # 5d98 <statistics+0x4b6>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     6b6:	6e650513          	addi	a0,a0,1766 # 5d98 <statistics+0x4b6>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6ca:	6d250513          	addi	a0,a0,1746 # 5d98 <statistics+0x4b6>
  ...
  write(fd1, "abcdef", 6);
     ...
     708:	8dc58593          	addi	a1,a1,-1828 # 5fe0 <statistics+0x6fe>
     70c:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     74a:	65250513          	addi	a0,a0,1618 # 5d98 <statistics+0x4b6>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     78e:	7f650513          	addi	a0,a0,2038 # 5f80 <statistics+0x69e>
     792:	00005097          	auipc	ra,0x5
     796:	faa080e7          	jalr	-86(ra) # 573c <printf>
    exit(1);
     79a:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     7aa:	7fa50513          	addi	a0,a0,2042 # 5fa0 <statistics+0x6be>
     7ae:	00005097          	auipc	ra,0x5
     7b2:	f8e080e7          	jalr	-114(ra) # 573c <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7b6:	8652                	mv	a2,s4
     7b8:	85d6                	mv	a1,s5
     7ba:	00005517          	auipc	a0,0x5
     7be:	7f650513          	addi	a0,a0,2038 # 5fb0 <statistics+0x6ce>
     7c2:	00005097          	auipc	ra,0x5
     7c6:	f7a080e7          	jalr	-134(ra) # 573c <printf>
    exit(1);
     7ca:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7da:	7fa50513          	addi	a0,a0,2042 # 5fd0 <statistics+0x6ee>
     7de:	00005097          	auipc	ra,0x5
     7e2:	f5e080e7          	jalr	-162(ra) # 573c <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7e6:	8652                	mv	a2,s4
     7e8:	85d6                	mv	a1,s5
     7ea:	00005517          	auipc	a0,0x5
     7ee:	7c650513          	addi	a0,a0,1990 # 5fb0 <statistics+0x6ce>
     7f2:	00005097          	auipc	ra,0x5
     7f6:	f4a080e7          	jalr	-182(ra) # 573c <printf>
    exit(1);
     7fa:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     80c:	7e050513          	addi	a0,a0,2016 # 5fe8 <statistics+0x706>
     810:	00005097          	auipc	ra,0x5
     814:	f2c080e7          	jalr	-212(ra) # 573c <printf>
    exit(1);
     818:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     82a:	7e250513          	addi	a0,a0,2018 # 6008 <statistics+0x726>
     82e:	00005097          	auipc	ra,0x5
     832:	f0e080e7          	jalr	-242(ra) # 573c <printf>
    exit(1);
     836:	4505                	li	a0,1
...
0000000000000840 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     85e:	7ce50513          	addi	a0,a0,1998 # 6028 <statistics+0x746>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     876:	7de98993          	addi	s3,s3,2014 # 6050 <statistics+0x76e>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     87a:	00006a97          	auipc	s5,0x6
     87e:	80ea8a93          	addi	s5,s5,-2034 # 6088 <statistics+0x7a6>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8c4:	76850513          	addi	a0,a0,1896 # 6028 <statistics+0x746>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8de:	f5658593          	addi	a1,a1,-170 # b830 <buf>
  ...
  if(unlink("small") < 0){
     ...
     900:	72c50513          	addi	a0,a0,1836 # 6028 <statistics+0x746>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     92a:	70a50513          	addi	a0,a0,1802 # 6030 <statistics+0x74e>
     92e:	00005097          	auipc	ra,0x5
     932:	e0e080e7          	jalr	-498(ra) # 573c <printf>
    exit(1);
     936:	4505                	li	a0,1
     ...
     946:	71e50513          	addi	a0,a0,1822 # 6060 <statistics+0x77e>
     94a:	00005097          	auipc	ra,0x5
     94e:	df2080e7          	jalr	-526(ra) # 573c <printf>
      exit(1);
     952:	4505                	li	a0,1
     ...
     962:	73a50513          	addi	a0,a0,1850 # 6098 <statistics+0x7b6>
     966:	00005097          	auipc	ra,0x5
     96a:	dd6080e7          	jalr	-554(ra) # 573c <printf>
      exit(1);
     96e:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     97e:	74650513          	addi	a0,a0,1862 # 60c0 <statistics+0x7de>
     982:	00005097          	auipc	ra,0x5
     986:	dba080e7          	jalr	-582(ra) # 573c <printf>
    exit(1);
     98a:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     99a:	74a50513          	addi	a0,a0,1866 # 60e0 <statistics+0x7fe>
     99e:	00005097          	auipc	ra,0x5
     9a2:	d9e080e7          	jalr	-610(ra) # 573c <printf>
    exit(1);
     9a6:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9b6:	74650513          	addi	a0,a0,1862 # 60f8 <statistics+0x816>
     9ba:	00005097          	auipc	ra,0x5
     9be:	d82080e7          	jalr	-638(ra) # 573c <printf>
    exit(1);
     9c2:	4505                	li	a0,1
...
00000000000009cc <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9e8:	73450513          	addi	a0,a0,1844 # 6118 <statistics+0x836>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9fc:	e3890913          	addi	s2,s2,-456 # b830 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a3a:	6e250513          	addi	a0,a0,1762 # 6118 <statistics+0x836>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a4e:	de690913          	addi	s2,s2,-538 # b830 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a82:	6a250513          	addi	a0,a0,1698 # 6120 <statistics+0x83e>
     a86:	00005097          	auipc	ra,0x5
     a8a:	cb6080e7          	jalr	-842(ra) # 573c <printf>
    exit(1);
     a8e:	4505                	li	a0,1
     ...
     a9e:	6a650513          	addi	a0,a0,1702 # 6140 <statistics+0x85e>
     aa2:	00005097          	auipc	ra,0x5
     aa6:	c9a080e7          	jalr	-870(ra) # 573c <printf>
      exit(1);
     aaa:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     aba:	6b250513          	addi	a0,a0,1714 # 6168 <statistics+0x886>
     abe:	00005097          	auipc	ra,0x5
     ac2:	c7e080e7          	jalr	-898(ra) # 573c <printf>
    exit(1);
     ac6:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ae6:	63650513          	addi	a0,a0,1590 # 6118 <statistics+0x836>
     ...
     b10:	67c50513          	addi	a0,a0,1660 # 6188 <statistics+0x8a6>
     b14:	00005097          	auipc	ra,0x5
     b18:	c28080e7          	jalr	-984(ra) # 573c <printf>
        exit(1);
     b1c:	4505                	li	a0,1
     ...
     b2c:	68850513          	addi	a0,a0,1672 # 61b0 <statistics+0x8ce>
     b30:	00005097          	auipc	ra,0x5
     b34:	c0c080e7          	jalr	-1012(ra) # 573c <printf>
      exit(1);
     b38:	4505                	li	a0,1
     ...
     b48:	68450513          	addi	a0,a0,1668 # 61c8 <statistics+0x8e6>
     b4c:	00005097          	auipc	ra,0x5
     b50:	bf0080e7          	jalr	-1040(ra) # 573c <printf>
      exit(1);
     b54:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b64:	69050513          	addi	a0,a0,1680 # 61f0 <statistics+0x90e>
     b68:	00005097          	auipc	ra,0x5
     b6c:	bd4080e7          	jalr	-1068(ra) # 573c <printf>
    exit(1);
     b70:	4505                	li	a0,1
...
0000000000000b7a <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b92:	67a50513          	addi	a0,a0,1658 # 6208 <statistics+0x926>
  ...
  write(fd, "hello", SZ);
     ...
     baa:	69258593          	addi	a1,a1,1682 # 6238 <statistics+0x956>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bc6:	64650513          	addi	a0,a0,1606 # 6208 <statistics+0x926>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bdc:	63050513          	addi	a0,a0,1584 # 6208 <statistics+0x926>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bf2:	61a50513          	addi	a0,a0,1562 # 6208 <statistics+0x926>
  ...
  write(fd1, "yyy", 3);
     ...
     c06:	67e58593          	addi	a1,a1,1662 # 6280 <statistics+0x99e>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c22:	c1258593          	addi	a1,a1,-1006 # b830 <buf>
     c26:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c6e:	59e50513          	addi	a0,a0,1438 # 6208 <statistics+0x926>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c8e:	58e50513          	addi	a0,a0,1422 # 6218 <statistics+0x936>
     c92:	00005097          	auipc	ra,0x5
     c96:	aaa080e7          	jalr	-1366(ra) # 573c <printf>
    exit(1);
     c9a:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     caa:	59a50513          	addi	a0,a0,1434 # 6240 <statistics+0x95e>
     cae:	00005097          	auipc	ra,0x5
     cb2:	a8e080e7          	jalr	-1394(ra) # 573c <printf>
    exit(1);
     cb6:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cc6:	59e50513          	addi	a0,a0,1438 # 6260 <statistics+0x97e>
     cca:	00005097          	auipc	ra,0x5
     cce:	a72080e7          	jalr	-1422(ra) # 573c <printf>
    exit(1);
     cd2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ce2:	5aa50513          	addi	a0,a0,1450 # 6288 <statistics+0x9a6>
     ce6:	00005097          	auipc	ra,0x5
     cea:	a56080e7          	jalr	-1450(ra) # 573c <printf>
    exit(1);
     cee:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     cfe:	5ae50513          	addi	a0,a0,1454 # 62a8 <statistics+0x9c6>
     d02:	00005097          	auipc	ra,0x5
     d06:	a3a080e7          	jalr	-1478(ra) # 573c <printf>
    exit(1);
     d0a:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d1a:	5b250513          	addi	a0,a0,1458 # 62c8 <statistics+0x9e6>
     d1e:	00005097          	auipc	ra,0x5
     d22:	a1e080e7          	jalr	-1506(ra) # 573c <printf>
    exit(1);
     d26:	4505                	li	a0,1
...
0000000000000d30 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d7e:	4be58593          	addi	a1,a1,1214 # 6238 <statistics+0x956>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d9e:	55658593          	addi	a1,a1,1366 # 62f0 <statistics+0xa0e>
     da2:	00005517          	auipc	a0,0x5
     da6:	54650513          	addi	a0,a0,1350 # 62e8 <statistics+0xa06>
  ...
  unlink("lf1");
     ...
     dba:	53250513          	addi	a0,a0,1330 # 62e8 <statistics+0xa06>
     dbe:	00004097          	auipc	ra,0x4
     dc2:	656080e7          	jalr	1622(ra) # 5414 <unlink>
  if(open("lf1", 0) >= 0){
     dc6:	4581                	li	a1,0
     dc8:	00005517          	auipc	a0,0x5
     dcc:	52050513          	addi	a0,a0,1312 # 62e8 <statistics+0xa06>
  ...
  fd = open("lf2", 0);
     ...
     de2:	51250513          	addi	a0,a0,1298 # 62f0 <statistics+0xa0e>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     dfa:	a3a58593          	addi	a1,a1,-1478 # b830 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e1a:	4da58593          	addi	a1,a1,1242 # 62f0 <statistics+0xa0e>
     e1e:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e30:	4c450513          	addi	a0,a0,1220 # 62f0 <statistics+0xa0e>
     e34:	00004097          	auipc	ra,0x4
     e38:	5e0080e7          	jalr	1504(ra) # 5414 <unlink>
  if(link("lf2", "lf1") >= 0){
     e3c:	00005597          	auipc	a1,0x5
     e40:	4ac58593          	addi	a1,a1,1196 # 62e8 <statistics+0xa06>
     e44:	00005517          	auipc	a0,0x5
     e48:	4ac50513          	addi	a0,a0,1196 # 62f0 <statistics+0xa0e>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e5c:	49058593          	addi	a1,a1,1168 # 62e8 <statistics+0xa06>
     e60:	00005517          	auipc	a0,0x5
     e64:	59850513          	addi	a0,a0,1432 # 63f8 <statistics+0xb16>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e86:	47650513          	addi	a0,a0,1142 # 62f8 <statistics+0xa16>
     e8a:	00005097          	auipc	ra,0x5
     e8e:	8b2080e7          	jalr	-1870(ra) # 573c <printf>
    exit(1);
     e92:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     ea2:	47250513          	addi	a0,a0,1138 # 6310 <statistics+0xa2e>
     ea6:	00005097          	auipc	ra,0x5
     eaa:	896080e7          	jalr	-1898(ra) # 573c <printf>
    exit(1);
     eae:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ebe:	46e50513          	addi	a0,a0,1134 # 6328 <statistics+0xa46>
     ec2:	00005097          	auipc	ra,0x5
     ec6:	87a080e7          	jalr	-1926(ra) # 573c <printf>
    exit(1);
     eca:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     eda:	47250513          	addi	a0,a0,1138 # 6348 <statistics+0xa66>
     ede:	00005097          	auipc	ra,0x5
     ee2:	85e080e7          	jalr	-1954(ra) # 573c <printf>
    exit(1);
     ee6:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     ef6:	48650513          	addi	a0,a0,1158 # 6378 <statistics+0xa96>
     efa:	00005097          	auipc	ra,0x5
     efe:	842080e7          	jalr	-1982(ra) # 573c <printf>
    exit(1);
     f02:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     f12:	48250513          	addi	a0,a0,1154 # 6390 <statistics+0xaae>
     f16:	00005097          	auipc	ra,0x5
     f1a:	826080e7          	jalr	-2010(ra) # 573c <printf>
    exit(1);
     f1e:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f2e:	47e50513          	addi	a0,a0,1150 # 63a8 <statistics+0xac6>
     f32:	00005097          	auipc	ra,0x5
     f36:	80a080e7          	jalr	-2038(ra) # 573c <printf>
    exit(1);
     f3a:	4505                	li	a0,1
    ...
    printf("%s: link non-existant succeeded! oops\n", s);
     ...
     f4a:	48a50513          	addi	a0,a0,1162 # 63d0 <statistics+0xaee>
     f4e:	00004097          	auipc	ra,0x4
     f52:	7ee080e7          	jalr	2030(ra) # 573c <printf>
    exit(1);
     f56:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f66:	49e50513          	addi	a0,a0,1182 # 6400 <statistics+0xb1e>
     f6a:	00004097          	auipc	ra,0x4
     f6e:	7d2080e7          	jalr	2002(ra) # 573c <printf>
    exit(1);
     f72:	4505                	li	a0,1
...
0000000000000f7c <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fcc:	458a0a13          	addi	s4,s4,1112 # 6420 <statistics+0xb3e>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    101e:	40650513          	addi	a0,a0,1030 # 6420 <statistics+0xb3e>
  ...
  for(i = 0; i < N; i++){
    ...
    108e:	39e50513          	addi	a0,a0,926 # 6428 <statistics+0xb46>
    1092:	00004097          	auipc	ra,0x4
    1096:	6aa080e7          	jalr	1706(ra) # 573c <printf>
    exit(1);
    109a:	4505                	li	a0,1
    ...
    10ae:	39e50513          	addi	a0,a0,926 # 6448 <statistics+0xb66>
    10b2:	00004097          	auipc	ra,0x4
    10b6:	68a080e7          	jalr	1674(ra) # 573c <printf>
      exit(1);
    10ba:	4505                	li	a0,1
    ...
    10ca:	3a250513          	addi	a0,a0,930 # 6468 <statistics+0xb86>
    10ce:	00004097          	auipc	ra,0x4
    10d2:	66e080e7          	jalr	1646(ra) # 573c <printf>
      exit(1);
    10d6:	4505                	li	a0,1
...
00000000000010e0 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10fc:	39098993          	addi	s3,s3,912 # 6488 <statistics+0xba6>
    1100:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1138:	36450513          	addi	a0,a0,868 # 6498 <statistics+0xbb6>
    113c:	00004097          	auipc	ra,0x4
    1140:	600080e7          	jalr	1536(ra) # 573c <printf>
      exit(1);
    1144:	4505                	li	a0,1
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1160:	e9c78793          	addi	a5,a5,-356 # 7ff8 <digits+0x48>
...
badarg(char *s)
{
    ...
    1198:	35048493          	addi	s1,s1,848 # c350 <buf+0xb20>
  for(int i = 0; i < 50000; i++){
    ...
    11a6:	b9e98993          	addi	s3,s3,-1122 # 5d40 <statistics+0x45e>
    argv[0] = (char*)0xffffffff;
...
00000000000011ce <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1230:	33478793          	addi	a5,a5,820 # 7560 <statistics+0x1c7e>
  ...
  if(pid == 0){
    ...
    1266:	eb678793          	addi	a5,a5,-330 # 8118 <big.1289>
    126a:	00008697          	auipc	a3,0x8
    126e:	eae68693          	addi	a3,a3,-338 # 9118 <__global_pointer$+0x920>
      big[i] = 'x';
    ...
    1284:	e8078c23          	sb	zero,-360(a5) # 9118 <__global_pointer$+0x920>
    char *args2[] = { big, big, big, 0 };
    1288:	00004797          	auipc	a5,0x4
    128c:	6e078793          	addi	a5,a5,1760 # 5968 <statistics+0x86>
    ...
    12b0:	a9450513          	addi	a0,a0,-1388 # 5d40 <statistics+0x45e>
    ...
    12c8:	27c50513          	addi	a0,a0,636 # 6540 <statistics+0xc5e>
    12cc:	00004097          	auipc	ra,0x4
    12d0:	470080e7          	jalr	1136(ra) # 573c <printf>
      exit(1);
    12d4:	4505                	li	a0,1
    ...
    12e8:	1d450513          	addi	a0,a0,468 # 64b8 <statistics+0xbd6>
    12ec:	00004097          	auipc	ra,0x4
    12f0:	450080e7          	jalr	1104(ra) # 573c <printf>
    exit(1);
    12f4:	4505                	li	a0,1
    ...
    1308:	1d450513          	addi	a0,a0,468 # 64d8 <statistics+0xbf6>
    130c:	00004097          	auipc	ra,0x4
    1310:	430080e7          	jalr	1072(ra) # 573c <printf>
    exit(1);
    1314:	4505                	li	a0,1
    ...
    132a:	1d250513          	addi	a0,a0,466 # 64f8 <statistics+0xc16>
    132e:	00004097          	auipc	ra,0x4
    1332:	40e080e7          	jalr	1038(ra) # 573c <printf>
    exit(1);
    1336:	4505                	li	a0,1
    ...
    134a:	1da50513          	addi	a0,a0,474 # 6520 <statistics+0xc3e>
    134e:	00004097          	auipc	ra,0x4
    1352:	3ee080e7          	jalr	1006(ra) # 573c <printf>
    exit(1);
    1356:	4505                	li	a0,1
    ...
    1364:	62850513          	addi	a0,a0,1576 # 6988 <statistics+0x10a6>
    1368:	00004097          	auipc	ra,0x4
    136c:	3d4080e7          	jalr	980(ra) # 573c <printf>
    exit(1);
    1370:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    13ae:	1be50513          	addi	a0,a0,446 # 6568 <statistics+0xc86>
    13b2:	00004097          	auipc	ra,0x4
    13b6:	38a080e7          	jalr	906(ra) # 573c <printf>
    exit(1);
    13ba:	4505                	li	a0,1
...
00000000000013c4 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13e0:	9bc50513          	addi	a0,a0,-1604 # 5d98 <statistics+0x4b6>
  ...
  if(pid == 0){
    ...
    140a:	99298993          	addi	s3,s3,-1646 # 5d98 <statistics+0x4b6>
      int n = write(fd, "1234567890", 10);
    140e:	00005a97          	auipc	s5,0x5
    1412:	1baa8a93          	addi	s5,s5,442 # 65c8 <statistics+0xce6>
      int fd = open("truncfile", O_WRONLY);
    1416:	4585                	li	a1,1
    1418:	854e                	mv	a0,s3
    ...
    1482:	11a50513          	addi	a0,a0,282 # 6598 <statistics+0xcb6>
    1486:	00004097          	auipc	ra,0x4
    148a:	2b6080e7          	jalr	694(ra) # 573c <printf>
    exit(1);
    148e:	4505                	li	a0,1
    ...
    149e:	11650513          	addi	a0,a0,278 # 65b0 <statistics+0xcce>
    14a2:	00004097          	auipc	ra,0x4
    14a6:	29a080e7          	jalr	666(ra) # 573c <printf>
        exit(1);
    14aa:	4505                	li	a0,1
    ...
    14bc:	12050513          	addi	a0,a0,288 # 65d8 <statistics+0xcf6>
    14c0:	00004097          	auipc	ra,0x4
    14c4:	27c080e7          	jalr	636(ra) # 573c <printf>
        exit(1);
    14c8:	4505                	li	a0,1
    ...
    14da:	8c298993          	addi	s3,s3,-1854 # 5d98 <statistics+0x4b6>
    int n = write(fd, "xxx", 3);
    14de:	00005a97          	auipc	s5,0x5
    14e2:	11aa8a93          	addi	s5,s5,282 # 65f8 <statistics+0xd16>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    152c:	87050513          	addi	a0,a0,-1936 # 5d98 <statistics+0x4b6>
  ...
  exit(xstatus);
    ...
    154a:	06a50513          	addi	a0,a0,106 # 65b0 <statistics+0xcce>
    154e:	00004097          	auipc	ra,0x4
    1552:	1ee080e7          	jalr	494(ra) # 573c <printf>
      exit(1);
    1556:	4505                	li	a0,1
    ...
    1568:	09c50513          	addi	a0,a0,156 # 6600 <statistics+0xd1e>
    156c:	00004097          	auipc	ra,0x4
    1570:	1d0080e7          	jalr	464(ra) # 573c <printf>
      exit(1);
    1574:	4505                	li	a0,1
...
000000000000157e <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1590:	7b478793          	addi	a5,a5,1972 # 5d40 <statistics+0x45e>
    1594:	fcf43023          	sd	a5,-64(s0)
    1598:	00005797          	auipc	a5,0x5
    159c:	08878793          	addi	a5,a5,136 # 6620 <statistics+0xd3e>
    15a0:	fcf43423          	sd	a5,-56(s0)
    15a4:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    15a8:	00005517          	auipc	a0,0x5
    15ac:	08050513          	addi	a0,a0,128 # 6628 <statistics+0xd46>
  ...
  if(pid == 0) {
    ...
    15da:	05250513          	addi	a0,a0,82 # 6628 <statistics+0xd46>
    ...
    15f6:	05650513          	addi	a0,a0,86 # 6648 <statistics+0xd66>
    15fa:	00004097          	auipc	ra,0x4
    15fe:	142080e7          	jalr	322(ra) # 573c <printf>
      exit(1);
    1602:	4505                	li	a0,1
    ...
    1612:	f8a50513          	addi	a0,a0,-118 # 6598 <statistics+0xcb6>
    1616:	00004097          	auipc	ra,0x4
    161a:	126080e7          	jalr	294(ra) # 573c <printf>
     exit(1);
    161e:	4505                	li	a0,1
    ...
    162e:	00650513          	addi	a0,a0,6 # 6630 <statistics+0xd4e>
    1632:	00004097          	auipc	ra,0x4
    1636:	10a080e7          	jalr	266(ra) # 573c <printf>
      exit(1);
    163a:	4505                	li	a0,1
    ...
    164c:	6f850513          	addi	a0,a0,1784 # 5d40 <statistics+0x45e>
  ...
  if(xstatus != 0)
    ...
    1680:	fdc50513          	addi	a0,a0,-36 # 6658 <statistics+0xd76>
    1684:	00004097          	auipc	ra,0x4
    1688:	0b8080e7          	jalr	184(ra) # 573c <printf>
      exit(1);
    168c:	4505                	li	a0,1
    ...
    169c:	fd850513          	addi	a0,a0,-40 # 6670 <statistics+0xd8e>
    16a0:	00004097          	auipc	ra,0x4
    16a4:	09c080e7          	jalr	156(ra) # 573c <printf>
    16a8:	b7d1                	j	166c <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    16aa:	4581                	li	a1,0
    16ac:	00005517          	auipc	a0,0x5
    16b0:	f7c50513          	addi	a0,a0,-132 # 6628 <statistics+0xd46>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16da:	a0a50513          	addi	a0,a0,-1526 # 60e0 <statistics+0x7fe>
    16de:	00004097          	auipc	ra,0x4
    16e2:	05e080e7          	jalr	94(ra) # 573c <printf>
    exit(1);
    16e6:	4505                	li	a0,1
    ...
    16f6:	ebe50513          	addi	a0,a0,-322 # 65b0 <statistics+0xcce>
    16fa:	00004097          	auipc	ra,0x4
    16fe:	042080e7          	jalr	66(ra) # 573c <printf>
    exit(1);
    1702:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    1710:	f1c50513          	addi	a0,a0,-228 # 6628 <statistics+0xd46>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    173a:	f5250513          	addi	a0,a0,-174 # 6688 <statistics+0xda6>
    173e:	00004097          	auipc	ra,0x4
    1742:	ffe080e7          	jalr	-2(ra) # 573c <printf>
    exit(1);
    1746:	4505                	li	a0,1
...
000000000000175a <pipe1>:
{
  ...
  if(pid == 0){
    ...
    17a2:	09290913          	addi	s2,s2,146 # b830 <buf>
      if(cc > sizeof(buf))
    ...
    17d0:	06570713          	addi	a4,a4,101 # b831 <buf+0x1>
    ...
    17f6:	eae50513          	addi	a0,a0,-338 # 66a0 <statistics+0xdbe>
    17fa:	00004097          	auipc	ra,0x4
    17fe:	f42080e7          	jalr	-190(ra) # 573c <printf>
    exit(1);
    1802:	4505                	li	a0,1
    ...
    181c:	018a8a93          	addi	s5,s5,24 # b830 <buf>
    ...
    183c:	8b56                	mv	s6,s5
{
    ...
    1882:	e3a50513          	addi	a0,a0,-454 # 66b8 <statistics+0xdd6>
    1886:	00004097          	auipc	ra,0x4
    188a:	eb6080e7          	jalr	-330(ra) # 573c <printf>
        exit(1);
    188e:	4505                	li	a0,1
    ...
    189e:	e3650513          	addi	a0,a0,-458 # 66d0 <statistics+0xdee>
    18a2:	00004097          	auipc	ra,0x4
    18a6:	e9a080e7          	jalr	-358(ra) # 573c <printf>
}
    ...
    18e2:	e0a50513          	addi	a0,a0,-502 # 66e8 <statistics+0xe06>
    18e6:	00004097          	auipc	ra,0x4
    18ea:	e56080e7          	jalr	-426(ra) # 573c <printf>
      exit(1);
    18ee:	4505                	li	a0,1
    ...
    1922:	dea50513          	addi	a0,a0,-534 # 6708 <statistics+0xe26>
    1926:	00004097          	auipc	ra,0x4
    192a:	e16080e7          	jalr	-490(ra) # 573c <printf>
    exit(1);
    192e:	4505                	li	a0,1
...
0000000000001938 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1994:	c0850513          	addi	a0,a0,-1016 # 6598 <statistics+0xcb6>
    1998:	00004097          	auipc	ra,0x4
    199c:	da4080e7          	jalr	-604(ra) # 573c <printf>
      exit(1);
    19a0:	4505                	li	a0,1
    ...
    19b0:	d7450513          	addi	a0,a0,-652 # 6720 <statistics+0xe3e>
    19b4:	00004097          	auipc	ra,0x4
    19b8:	d88080e7          	jalr	-632(ra) # 573c <printf>
        exit(1);
    19bc:	4505                	li	a0,1
    ...
    19cc:	d7050513          	addi	a0,a0,-656 # 6738 <statistics+0xe56>
    19d0:	00004097          	auipc	ra,0x4
    19d4:	d6c080e7          	jalr	-660(ra) # 573c <printf>
        exit(1);
    19d8:	4505                	li	a0,1
...
00000000000019ec <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a44:	b5850513          	addi	a0,a0,-1192 # 6598 <statistics+0xcb6>
    1a48:	00004097          	auipc	ra,0x4
    1a4c:	cf4080e7          	jalr	-780(ra) # 573c <printf>
      exit(1);
    1a50:	4505                	li	a0,1
    ...
    1a68:	b3450513          	addi	a0,a0,-1228 # 6598 <statistics+0xcb6>
    1a6c:	00004097          	auipc	ra,0x4
    1a70:	cd0080e7          	jalr	-816(ra) # 573c <printf>
        exit(1);
    1a74:	4505                	li	a0,1
...
0000000000001a86 <forkfork>:
{
    ...
    1ae2:	c7a50513          	addi	a0,a0,-902 # 6758 <statistics+0xe76>
    1ae6:	00004097          	auipc	ra,0x4
    1aea:	c56080e7          	jalr	-938(ra) # 573c <printf>
      exit(1);
    1aee:	4505                	li	a0,1
    ...
    1af4:	8d4080e7          	jalr	-1836(ra) # 53c4 <exit>
{
    ...
    1b3a:	c3250513          	addi	a0,a0,-974 # 6768 <statistics+0xe86>
    1b3e:	00004097          	auipc	ra,0x4
    1b42:	bfe080e7          	jalr	-1026(ra) # 573c <printf>
      exit(1);
    1b46:	4505                	li	a0,1
...
0000000000001b50 <reparent2>:
{
  ...
  exit(0);
    ...
    1b88:	e0450513          	addi	a0,a0,-508 # 6988 <statistics+0x10a6>
    1b8c:	00004097          	auipc	ra,0x4
    1b90:	bb0080e7          	jalr	-1104(ra) # 573c <printf>
      exit(1);
    1b94:	4505                	li	a0,1
...
0000000000001bb8 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1c26:	d6650513          	addi	a0,a0,-666 # 6988 <statistics+0x10a6>
    1c2a:	00004097          	auipc	ra,0x4
    1c2e:	b12080e7          	jalr	-1262(ra) # 573c <printf>
      exit(1);
    1c32:	4505                	li	a0,1
    ...
    1c52:	9e250513          	addi	a0,a0,-1566 # 6630 <statistics+0xd4e>
    1c56:	00004097          	auipc	ra,0x4
    1c5a:	ae6080e7          	jalr	-1306(ra) # 573c <printf>
          exit(1);
    1c5e:	4505                	li	a0,1
    ...
    1cc4:	ac850513          	addi	a0,a0,-1336 # 6788 <statistics+0xea6>
    1cc8:	00004097          	auipc	ra,0x4
    1ccc:	a74080e7          	jalr	-1420(ra) # 573c <printf>
            exit(1);
    1cd0:	4505                	li	a0,1
    ...
    1cf8:	aac50513          	addi	a0,a0,-1364 # 67a0 <statistics+0xebe>
    1cfc:	00004097          	auipc	ra,0x4
    1d00:	a40080e7          	jalr	-1472(ra) # 573c <printf>
        exit(1);
    1d04:	4505                	li	a0,1
    ...
    1d5e:	a6e50513          	addi	a0,a0,-1426 # 67c8 <statistics+0xee6>
    1d62:	00004097          	auipc	ra,0x4
    1d66:	9da080e7          	jalr	-1574(ra) # 573c <printf>
        exit(1);
    1d6a:	4505                	li	a0,1
...
0000000000001dde <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dfe:	fb650513          	addi	a0,a0,-74 # 5db0 <statistics+0x4ce>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e3a:	f7aa8a93          	addi	s5,s5,-134 # 5db0 <statistics+0x4ce>
      link("cat", "x");
    1e3e:	00005b97          	auipc	s7,0x5
    1e42:	9b2b8b93          	addi	s7,s7,-1614 # 67f0 <statistics+0xf0e>
    1e46:	a091                	j	1e8a <linkunlink+0xac>
    printf("%s: fork failed\n", s);
    1e48:	85a6                	mv	a1,s1
    1e4a:	00004517          	auipc	a0,0x4
    1e4e:	74e50513          	addi	a0,a0,1870 # 6598 <statistics+0xcb6>
    1e52:	00004097          	auipc	ra,0x4
    1e56:	8ea080e7          	jalr	-1814(ra) # 573c <printf>
    exit(1);
    1e5a:	4505                	li	a0,1
...
0000000000001ee0 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1f10:	90450513          	addi	a0,a0,-1788 # 6810 <statistics+0xf2e>
    1f14:	00004097          	auipc	ra,0x4
    1f18:	828080e7          	jalr	-2008(ra) # 573c <printf>
    exit(1);
    1f1c:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    1f72:	88a50513          	addi	a0,a0,-1910 # 67f8 <statistics+0xf16>
    1f76:	00003097          	auipc	ra,0x3
    1f7a:	7c6080e7          	jalr	1990(ra) # 573c <printf>
    exit(1);
    1f7e:	4505                	li	a0,1
    ...
    1f8e:	8ae50513          	addi	a0,a0,-1874 # 6838 <statistics+0xf56>
    1f92:	00003097          	auipc	ra,0x3
    1f96:	7aa080e7          	jalr	1962(ra) # 573c <printf>
      exit(1);
    1f9a:	4505                	li	a0,1
    ...
    1faa:	8aa50513          	addi	a0,a0,-1878 # 6850 <statistics+0xf6e>
    1fae:	00003097          	auipc	ra,0x3
    1fb2:	78e080e7          	jalr	1934(ra) # 573c <printf>
    exit(1);
    1fb6:	4505                	li	a0,1
...
0000000000001fc0 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1fdc:	35098993          	addi	s3,s3,848 # c350 <buf+0xb20>
    1fe0:	1003d937          	lui	s2,0x1003d
    1fe4:	090e                	slli	s2,s2,0x3
    1fe6:	48090913          	addi	s2,s2,1152 # 1003d480 <_end+0x1002ec40>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    202a:	57250513          	addi	a0,a0,1394 # 6598 <statistics+0xcb6>
    202e:	00003097          	auipc	ra,0x3
    2032:	70e080e7          	jalr	1806(ra) # 573c <printf>
      exit(1);
    2036:	4505                	li	a0,1
    ...
    204a:	82250513          	addi	a0,a0,-2014 # 6868 <statistics+0xf86>
    204e:	00003097          	auipc	ra,0x3
    2052:	6ee080e7          	jalr	1774(ra) # 573c <printf>
      exit(1);
    2056:	4505                	li	a0,1
...
000000000000206a <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    207a:	81250513          	addi	a0,a0,-2030 # 6888 <statistics+0xfa6>
  ...
  fd = open("bigarg-ok", 0);
    ...
    20ac:	7e050513          	addi	a0,a0,2016 # 6888 <statistics+0xfa6>
  ...
  close(fd);
    ...
    20d2:	f4a78793          	addi	a5,a5,-182 # 8018 <args.1826>
    20d6:	00006697          	auipc	a3,0x6
    20da:	03a68693          	addi	a3,a3,58 # 8110 <args.1826+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    20de:	00004717          	auipc	a4,0x4
    20e2:	7ba70713          	addi	a4,a4,1978 # 6898 <statistics+0xfb6>
    ...
    2136:	84650513          	addi	a0,a0,-1978 # 6978 <statistics+0x1096>
    213a:	00003097          	auipc	ra,0x3
    213e:	602080e7          	jalr	1538(ra) # 573c <printf>
    exit(1);
    2142:	4505                	li	a0,1
    ...
    215a:	84250513          	addi	a0,a0,-1982 # 6998 <statistics+0x10b6>
    215e:	00003097          	auipc	ra,0x3
    2162:	5de080e7          	jalr	1502(ra) # 573c <printf>
    exit(1);
    2166:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    21ae:	0007c583          	lbu	a1,0(a5) # fffffffffffff000 <_end+0xffffffffffff07c0>
    21b2:	00005517          	auipc	a0,0x5
    21b6:	80650513          	addi	a0,a0,-2042 # 69b8 <statistics+0x10d6>
    21ba:	00003097          	auipc	ra,0x3
    21be:	582080e7          	jalr	1410(ra) # 573c <printf>
    exit(1);
    21c2:	4505                	li	a0,1
    ...
    21d2:	3ca50513          	addi	a0,a0,970 # 6598 <statistics+0xcb6>
    21d6:	00003097          	auipc	ra,0x3
    21da:	566080e7          	jalr	1382(ra) # 573c <printf>
    exit(1);
    21de:	4505                	li	a0,1
...
00000000000021f2 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2270:	2f478793          	addi	a5,a5,756 # 7560 <statistics+0x1c7e>
  ...
  if(ret != -1){
    ...
    22b4:	73050513          	addi	a0,a0,1840 # 69e0 <statistics+0x10fe>
    22b8:	00003097          	auipc	ra,0x3
    22bc:	484080e7          	jalr	1156(ra) # 573c <printf>
    exit(1);
    22c0:	4505                	li	a0,1
    ...
    22d2:	1ea50513          	addi	a0,a0,490 # 64b8 <statistics+0xbd6>
    22d6:	00003097          	auipc	ra,0x3
    22da:	466080e7          	jalr	1126(ra) # 573c <printf>
    exit(1);
    22de:	4505                	li	a0,1
    ...
    22f0:	1ec50513          	addi	a0,a0,492 # 64d8 <statistics+0xbf6>
    22f4:	00003097          	auipc	ra,0x3
    22f8:	448080e7          	jalr	1096(ra) # 573c <printf>
    exit(1);
    22fc:	4505                	li	a0,1
    ...
    2310:	1ec50513          	addi	a0,a0,492 # 64f8 <statistics+0xc16>
    2314:	00003097          	auipc	ra,0x3
    2318:	428080e7          	jalr	1064(ra) # 573c <printf>
    exit(1);
    231c:	4505                	li	a0,1
    ...
    232e:	1f650513          	addi	a0,a0,502 # 6520 <statistics+0xc3e>
    2332:	00003097          	auipc	ra,0x3
    2336:	40a080e7          	jalr	1034(ra) # 573c <printf>
    exit(1);
    233a:	4505                	li	a0,1
...
0000000000002344 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2382:	6705                	lui	a4,0x1
      *b = 99;
    2384:	00d50023          	sb	a3,0(a0) # 40000000 <_end+0x3fff17c0>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    239c:	65050513          	addi	a0,a0,1616 # 69e8 <statistics+0x1106>
    23a0:	00003097          	auipc	ra,0x3
    23a4:	39c080e7          	jalr	924(ra) # 573c <printf>
    exit(1);
    23a8:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    23f0:	61c50513          	addi	a0,a0,1564 # 6a08 <statistics+0x1126>
    23f4:	00003097          	auipc	ra,0x3
    23f8:	348080e7          	jalr	840(ra) # 573c <printf>
    exit(1);
    23fc:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    2452:	61a50513          	addi	a0,a0,1562 # 6a68 <statistics+0x1186>
    2456:	00003097          	auipc	ra,0x3
    245a:	2e6080e7          	jalr	742(ra) # 573c <printf>
    exit(1);
    245e:	4505                	li	a0,1
    ...
    2472:	5ba50513          	addi	a0,a0,1466 # 6a28 <statistics+0x1146>
    2476:	00003097          	auipc	ra,0x3
    247a:	2c6080e7          	jalr	710(ra) # 573c <printf>
      exit(1);
    247e:	4505                	li	a0,1
    ...
    248e:	5be50513          	addi	a0,a0,1470 # 6a48 <statistics+0x1166>
    2492:	00003097          	auipc	ra,0x3
    2496:	2aa080e7          	jalr	682(ra) # 573c <printf>
    exit(1);
    249a:	4505                	li	a0,1
...
00000000000024ca <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    252a:	fee78fa3          	sb	a4,-1(a5) # 63fffff <_end+0x63f17bf>
  a = sbrk(0);
    252e:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    258e:	fff7c703          	lbu	a4,-1(a5) # 63fffff <_end+0x63f17bf>
  ...
  if(c != a){
    ...
    25d6:	4b650513          	addi	a0,a0,1206 # 6a88 <statistics+0x11a6>
    25da:	00003097          	auipc	ra,0x3
    25de:	162080e7          	jalr	354(ra) # 573c <printf>
    exit(1);
    25e2:	4505                	li	a0,1
    ...
    25f2:	4e250513          	addi	a0,a0,1250 # 6ad0 <statistics+0x11ee>
    25f6:	00003097          	auipc	ra,0x3
    25fa:	146080e7          	jalr	326(ra) # 573c <printf>
    exit(1);
    25fe:	4505                	li	a0,1
    ...
    2610:	4e450513          	addi	a0,a0,1252 # 6af0 <statistics+0x120e>
    2614:	00003097          	auipc	ra,0x3
    2618:	128080e7          	jalr	296(ra) # 573c <printf>
    exit(1);
    261c:	4505                	li	a0,1
    ...
    262e:	50650513          	addi	a0,a0,1286 # 6b30 <statistics+0x124e>
    2632:	00003097          	auipc	ra,0x3
    2636:	10a080e7          	jalr	266(ra) # 573c <printf>
    exit(1);
    263a:	4505                	li	a0,1
    ...
    264a:	51a50513          	addi	a0,a0,1306 # 6b60 <statistics+0x127e>
    264e:	00003097          	auipc	ra,0x3
    2652:	0ee080e7          	jalr	238(ra) # 573c <printf>
    exit(1);
    2656:	4505                	li	a0,1
    ...
    2668:	53450513          	addi	a0,a0,1332 # 6b98 <statistics+0x12b6>
    266c:	00003097          	auipc	ra,0x3
    2670:	0d0080e7          	jalr	208(ra) # 573c <printf>
    exit(1);
    2674:	4505                	li	a0,1
...
000000000000267e <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    26a2:	52250513          	addi	a0,a0,1314 # 6bc0 <statistics+0x12de>
    26a6:	00003097          	auipc	ra,0x3
    26aa:	d5e080e7          	jalr	-674(ra) # 5404 <open>
    26ae:	84aa                	mv	s1,a0
  unlink("sbrk");
    26b0:	00004517          	auipc	a0,0x4
    26b4:	51050513          	addi	a0,a0,1296 # 6bc0 <statistics+0x12de>
  ...
  if(pipe((int *) a) != 0){
    ...
    2708:	4c450513          	addi	a0,a0,1220 # 6bc8 <statistics+0x12e6>
    270c:	00003097          	auipc	ra,0x3
    2710:	030080e7          	jalr	48(ra) # 573c <printf>
    exit(1);
    2714:	4505                	li	a0,1
    ...
    2724:	4c050513          	addi	a0,a0,1216 # 6be0 <statistics+0x12fe>
    2728:	00003097          	auipc	ra,0x3
    272c:	014080e7          	jalr	20(ra) # 573c <printf>
    exit(1);
    2730:	4505                	li	a0,1
    ...
    2740:	f6450513          	addi	a0,a0,-156 # 66a0 <statistics+0xdbe>
    2744:	00003097          	auipc	ra,0x3
    2748:	ff8080e7          	jalr	-8(ra) # 573c <printf>
    exit(1);
    274c:	4505                	li	a0,1
...
0000000000002756 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    276a:	49250513          	addi	a0,a0,1170 # 6bf8 <statistics+0x1316>
  ...
  close(fd);
    ...
    27b2:	e0250513          	addi	a0,a0,-510 # 65b0 <statistics+0xcce>
    27b6:	00003097          	auipc	ra,0x3
    27ba:	f86080e7          	jalr	-122(ra) # 573c <printf>
    exit(1);
    27be:	4505                	li	a0,1
...
00000000000027c8 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2802:	18a50513          	addi	a0,a0,394 # 6988 <statistics+0x10a6>
    2806:	00003097          	auipc	ra,0x3
    280a:	f36080e7          	jalr	-202(ra) # 573c <printf>
    exit(1);
    280e:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2858:	13450513          	addi	a0,a0,308 # 6988 <statistics+0x10a6>
    285c:	00003097          	auipc	ra,0x3
    2860:	ee0080e7          	jalr	-288(ra) # 573c <printf>
    exit(1);
    2864:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    28b8:	0d450513          	addi	a0,a0,212 # 6988 <statistics+0x10a6>
    28bc:	00003097          	auipc	ra,0x3
    28c0:	e80080e7          	jalr	-384(ra) # 573c <printf>
    exit(1);
    28c4:	4505                	li	a0,1
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2924:	06850513          	addi	a0,a0,104 # 6988 <statistics+0x10a6>
    2928:	00003097          	auipc	ra,0x3
    292c:	e14080e7          	jalr	-492(ra) # 573c <printf>
      exit(1);
    2930:	4505                	li	a0,1
    ...
    2978:	3cc50513          	addi	a0,a0,972 # 5d40 <statistics+0x45e>
    297c:	faa43c23          	sd	a0,-72(s0)
    2980:	00003797          	auipc	a5,0x3
    2984:	43078793          	addi	a5,a5,1072 # 5db0 <statistics+0x4ce>
...
00000000000029a6 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    29b6:	41e50513          	addi	a0,a0,1054 # 6dd0 <statistics+0x14ee>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    29c8:	26450513          	addi	a0,a0,612 # 6c28 <statistics+0x1346>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    29de:	2a650513          	addi	a0,a0,678 # 6c80 <statistics+0x139e>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    29fc:	30050513          	addi	a0,a0,768 # 6cf8 <statistics+0x1416>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2a18:	35450513          	addi	a0,a0,852 # 6d68 <statistics+0x1486>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2a2a:	39a50513          	addi	a0,a0,922 # 6dc0 <statistics+0x14de>
  ...
  unlink("12345678901234");
    ...
    2aa8:	15c50513          	addi	a0,a0,348 # 6c00 <statistics+0x131e>
    2aac:	00003097          	auipc	ra,0x3
    2ab0:	c90080e7          	jalr	-880(ra) # 573c <printf>
    exit(1);
    2ab4:	4505                	li	a0,1
    ...
    2ac4:	18850513          	addi	a0,a0,392 # 6c48 <statistics+0x1366>
    2ac8:	00003097          	auipc	ra,0x3
    2acc:	c74080e7          	jalr	-908(ra) # 573c <printf>
    exit(1);
    2ad0:	4505                	li	a0,1
    ...
    2ae0:	1d450513          	addi	a0,a0,468 # 6cb0 <statistics+0x13ce>
    2ae4:	00003097          	auipc	ra,0x3
    2ae8:	c58080e7          	jalr	-936(ra) # 573c <printf>
    exit(1);
    2aec:	4505                	li	a0,1
    ...
    2afc:	23050513          	addi	a0,a0,560 # 6d28 <statistics+0x1446>
    2b00:	00003097          	auipc	ra,0x3
    2b04:	c3c080e7          	jalr	-964(ra) # 573c <printf>
    exit(1);
    2b08:	4505                	li	a0,1
    ...
    2b18:	27450513          	addi	a0,a0,628 # 6d88 <statistics+0x14a6>
    2b1c:	00003097          	auipc	ra,0x3
    2b20:	c20080e7          	jalr	-992(ra) # 573c <printf>
    exit(1);
    2b24:	4505                	li	a0,1
    ...
    2b34:	2b050513          	addi	a0,a0,688 # 6de0 <statistics+0x14fe>
    2b38:	00003097          	auipc	ra,0x3
    2b3c:	c04080e7          	jalr	-1020(ra) # 573c <printf>
    exit(1);
    2b40:	4505                	li	a0,1
...
0000000000002b4a <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2b5a:	2c250513          	addi	a0,a0,706 # 6e18 <statistics+0x1536>
  ...
  if(chdir("iputdir") < 0){
    ...
    2b6e:	2ae50513          	addi	a0,a0,686 # 6e18 <statistics+0x1536>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2b82:	2da50513          	addi	a0,a0,730 # 6e58 <statistics+0x1576>
  ...
  if(chdir("/") < 0){
    ...
    2b96:	2f650513          	addi	a0,a0,758 # 6e88 <statistics+0x15a6>
    ...
    2bb6:	26e50513          	addi	a0,a0,622 # 6e20 <statistics+0x153e>
    2bba:	00003097          	auipc	ra,0x3
    2bbe:	b82080e7          	jalr	-1150(ra) # 573c <printf>
    exit(1);
    2bc2:	4505                	li	a0,1
    ...
    2bd2:	26a50513          	addi	a0,a0,618 # 6e38 <statistics+0x1556>
    2bd6:	00003097          	auipc	ra,0x3
    2bda:	b66080e7          	jalr	-1178(ra) # 573c <printf>
    exit(1);
    2bde:	4505                	li	a0,1
    ...
    2bee:	27e50513          	addi	a0,a0,638 # 6e68 <statistics+0x1586>
    2bf2:	00003097          	auipc	ra,0x3
    2bf6:	b4a080e7          	jalr	-1206(ra) # 573c <printf>
    exit(1);
    2bfa:	4505                	li	a0,1
    ...
    2c0a:	28a50513          	addi	a0,a0,650 # 6e90 <statistics+0x15ae>
    2c0e:	00003097          	auipc	ra,0x3
    2c12:	b2e080e7          	jalr	-1234(ra) # 573c <printf>
    exit(1);
    2c16:	4505                	li	a0,1
...
0000000000002c20 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2c3e:	1de50513          	addi	a0,a0,478 # 6e18 <statistics+0x1536>
    ...
    2c52:	1ca50513          	addi	a0,a0,458 # 6e18 <statistics+0x1536>
    ...
    2c66:	1f650513          	addi	a0,a0,502 # 6e58 <statistics+0x1576>
    ...
    2c86:	91650513          	addi	a0,a0,-1770 # 6598 <statistics+0xcb6>
    2c8a:	00003097          	auipc	ra,0x3
    2c8e:	ab2080e7          	jalr	-1358(ra) # 573c <printf>
    exit(1);
    2c92:	4505                	li	a0,1
    ...
    2ca2:	18250513          	addi	a0,a0,386 # 6e20 <statistics+0x153e>
    2ca6:	00003097          	auipc	ra,0x3
    2caa:	a96080e7          	jalr	-1386(ra) # 573c <printf>
      exit(1);
    2cae:	4505                	li	a0,1
    ...
    2cbe:	1ee50513          	addi	a0,a0,494 # 6ea8 <statistics+0x15c6>
    2cc2:	00003097          	auipc	ra,0x3
    2cc6:	a7a080e7          	jalr	-1414(ra) # 573c <printf>
      exit(1);
    2cca:	4505                	li	a0,1
    ...
    2cda:	19250513          	addi	a0,a0,402 # 6e68 <statistics+0x1586>
    2cde:	00003097          	auipc	ra,0x3
    2ce2:	a5e080e7          	jalr	-1442(ra) # 573c <printf>
      exit(1);
    2ce6:	4505                	li	a0,1
...
0000000000002d08 <subdir>:
{
  ...
  unlink("ff");
    ...
    2d1a:	2da50513          	addi	a0,a0,730 # 6ff0 <statistics+0x170e>
    2d1e:	00002097          	auipc	ra,0x2
    2d22:	6f6080e7          	jalr	1782(ra) # 5414 <unlink>
  if(mkdir("dd") != 0){
    2d26:	00004517          	auipc	a0,0x4
    2d2a:	19a50513          	addi	a0,a0,410 # 6ec0 <statistics+0x15de>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2d42:	1a250513          	addi	a0,a0,418 # 6ee0 <statistics+0x15fe>
  ...
  write(fd, "ff", 2);
    ...
    2d5a:	29a58593          	addi	a1,a1,666 # 6ff0 <statistics+0x170e>
  ...
  if(unlink("dd") >= 0){
    ...
    2d74:	15050513          	addi	a0,a0,336 # 6ec0 <statistics+0x15de>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    2d88:	1b450513          	addi	a0,a0,436 # 6f38 <statistics+0x1656>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2da0:	1c450513          	addi	a0,a0,452 # 6f60 <statistics+0x167e>
  ...
  write(fd, "FF", 2);
    ...
    2db8:	1dc58593          	addi	a1,a1,476 # 6f90 <statistics+0x16ae>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2dd4:	1c850513          	addi	a0,a0,456 # 6f98 <statistics+0x16b6>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    2dec:	a4858593          	addi	a1,a1,-1464 # b830 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2e02:	a3274703          	lbu	a4,-1486(a4) # b830 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    2e1c:	1d058593          	addi	a1,a1,464 # 6fe8 <statistics+0x1706>
    2e20:	00004517          	auipc	a0,0x4
    2e24:	14050513          	addi	a0,a0,320 # 6f60 <statistics+0x167e>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    2e38:	12c50513          	addi	a0,a0,300 # 6f60 <statistics+0x167e>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2e4e:	11650513          	addi	a0,a0,278 # 6f60 <statistics+0x167e>
  ...
  if(chdir("dd") != 0){
    ...
    2e62:	06250513          	addi	a0,a0,98 # 6ec0 <statistics+0x15de>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    2e76:	20e50513          	addi	a0,a0,526 # 7080 <statistics+0x179e>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    2e8a:	22a50513          	addi	a0,a0,554 # 70b0 <statistics+0x17ce>
  ...
  if(chdir("./..") != 0){
    ...
    2e9e:	24650513          	addi	a0,a0,582 # 70e0 <statistics+0x17fe>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    2eb4:	13850513          	addi	a0,a0,312 # 6fe8 <statistics+0x1706>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2ecc:	96858593          	addi	a1,a1,-1688 # b830 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2eee:	07650513          	addi	a0,a0,118 # 6f60 <statistics+0x167e>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2f06:	26e50513          	addi	a0,a0,622 # 7170 <statistics+0x188e>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2f1e:	28650513          	addi	a0,a0,646 # 71a0 <statistics+0x18be>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2f36:	f8e50513          	addi	a0,a0,-114 # 6ec0 <statistics+0x15de>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    2f4c:	f7850513          	addi	a0,a0,-136 # 6ec0 <statistics+0x15de>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    2f62:	f6250513          	addi	a0,a0,-158 # 6ec0 <statistics+0x15de>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    2f76:	2be58593          	addi	a1,a1,702 # 7230 <statistics+0x194e>
    2f7a:	00004517          	auipc	a0,0x4
    2f7e:	1f650513          	addi	a0,a0,502 # 7170 <statistics+0x188e>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2f92:	2a258593          	addi	a1,a1,674 # 7230 <statistics+0x194e>
    2f96:	00004517          	auipc	a0,0x4
    2f9a:	20a50513          	addi	a0,a0,522 # 71a0 <statistics+0x18be>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2fae:	03e58593          	addi	a1,a1,62 # 6fe8 <statistics+0x1706>
    2fb2:	00004517          	auipc	a0,0x4
    2fb6:	f2e50513          	addi	a0,a0,-210 # 6ee0 <statistics+0x15fe>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2fca:	1aa50513          	addi	a0,a0,426 # 7170 <statistics+0x188e>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2fde:	1c650513          	addi	a0,a0,454 # 71a0 <statistics+0x18be>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2ff2:	ffa50513          	addi	a0,a0,-6 # 6fe8 <statistics+0x1706>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3006:	19e50513          	addi	a0,a0,414 # 71a0 <statistics+0x18be>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    301a:	15a50513          	addi	a0,a0,346 # 7170 <statistics+0x188e>
  ...
  if(chdir("dd/ff") == 0){
    ...
    302e:	eb650513          	addi	a0,a0,-330 # 6ee0 <statistics+0x15fe>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3042:	34250513          	addi	a0,a0,834 # 7380 <statistics+0x1a9e>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3056:	f9650513          	addi	a0,a0,-106 # 6fe8 <statistics+0x1706>
  ...
  if(unlink("dd/ff") != 0){
    ...
    306a:	e7a50513          	addi	a0,a0,-390 # 6ee0 <statistics+0x15fe>
  ...
  if(unlink("dd") == 0){
    ...
    307e:	e4650513          	addi	a0,a0,-442 # 6ec0 <statistics+0x15de>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3092:	36250513          	addi	a0,a0,866 # 73f0 <statistics+0x1b0e>
  ...
  if(unlink("dd") < 0){
    ...
    30a6:	e1e50513          	addi	a0,a0,-482 # 6ec0 <statistics+0x15de>
    ...
    30c8:	e0450513          	addi	a0,a0,-508 # 6ec8 <statistics+0x15e6>
    30cc:	00002097          	auipc	ra,0x2
    30d0:	670080e7          	jalr	1648(ra) # 573c <printf>
    exit(1);
    30d4:	4505                	li	a0,1
    ...
    30e4:	e0850513          	addi	a0,a0,-504 # 6ee8 <statistics+0x1606>
    30e8:	00002097          	auipc	ra,0x2
    30ec:	654080e7          	jalr	1620(ra) # 573c <printf>
    exit(1);
    30f0:	4505                	li	a0,1
    ...
    3100:	e0c50513          	addi	a0,a0,-500 # 6f08 <statistics+0x1626>
    3104:	00002097          	auipc	ra,0x2
    3108:	638080e7          	jalr	1592(ra) # 573c <printf>
    exit(1);
    310c:	4505                	li	a0,1
    ...
    311c:	e2850513          	addi	a0,a0,-472 # 6f40 <statistics+0x165e>
    3120:	00002097          	auipc	ra,0x2
    3124:	61c080e7          	jalr	1564(ra) # 573c <printf>
    exit(1);
    3128:	4505                	li	a0,1
    ...
    3138:	e3c50513          	addi	a0,a0,-452 # 6f70 <statistics+0x168e>
    313c:	00002097          	auipc	ra,0x2
    3140:	600080e7          	jalr	1536(ra) # 573c <printf>
    exit(1);
    3144:	4505                	li	a0,1
    ...
    3154:	e5850513          	addi	a0,a0,-424 # 6fa8 <statistics+0x16c6>
    3158:	00002097          	auipc	ra,0x2
    315c:	5e4080e7          	jalr	1508(ra) # 573c <printf>
    exit(1);
    3160:	4505                	li	a0,1
    ...
    3170:	e5c50513          	addi	a0,a0,-420 # 6fc8 <statistics+0x16e6>
    3174:	00002097          	auipc	ra,0x2
    3178:	5c8080e7          	jalr	1480(ra) # 573c <printf>
    exit(1);
    317c:	4505                	li	a0,1
    ...
    318c:	e7050513          	addi	a0,a0,-400 # 6ff8 <statistics+0x1716>
    3190:	00002097          	auipc	ra,0x2
    3194:	5ac080e7          	jalr	1452(ra) # 573c <printf>
    exit(1);
    3198:	4505                	li	a0,1
    ...
    31a8:	e7c50513          	addi	a0,a0,-388 # 7020 <statistics+0x173e>
    31ac:	00002097          	auipc	ra,0x2
    31b0:	590080e7          	jalr	1424(ra) # 573c <printf>
    exit(1);
    31b4:	4505                	li	a0,1
    ...
    31c4:	e8050513          	addi	a0,a0,-384 # 7040 <statistics+0x175e>
    31c8:	00002097          	auipc	ra,0x2
    31cc:	574080e7          	jalr	1396(ra) # 573c <printf>
    exit(1);
    31d0:	4505                	li	a0,1
    ...
    31e0:	e8c50513          	addi	a0,a0,-372 # 7068 <statistics+0x1786>
    31e4:	00002097          	auipc	ra,0x2
    31e8:	558080e7          	jalr	1368(ra) # 573c <printf>
    exit(1);
    31ec:	4505                	li	a0,1
    ...
    31fc:	e9850513          	addi	a0,a0,-360 # 7090 <statistics+0x17ae>
    3200:	00002097          	auipc	ra,0x2
    3204:	53c080e7          	jalr	1340(ra) # 573c <printf>
    exit(1);
    3208:	4505                	li	a0,1
    ...
    3218:	eac50513          	addi	a0,a0,-340 # 70c0 <statistics+0x17de>
    321c:	00002097          	auipc	ra,0x2
    3220:	520080e7          	jalr	1312(ra) # 573c <printf>
    exit(1);
    3224:	4505                	li	a0,1
    ...
    3234:	eb850513          	addi	a0,a0,-328 # 70e8 <statistics+0x1806>
    3238:	00002097          	auipc	ra,0x2
    323c:	504080e7          	jalr	1284(ra) # 573c <printf>
    exit(1);
    3240:	4505                	li	a0,1
    ...
    3250:	eb450513          	addi	a0,a0,-332 # 7100 <statistics+0x181e>
    3254:	00002097          	auipc	ra,0x2
    3258:	4e8080e7          	jalr	1256(ra) # 573c <printf>
    exit(1);
    325c:	4505                	li	a0,1
    ...
    326c:	eb850513          	addi	a0,a0,-328 # 7120 <statistics+0x183e>
    3270:	00002097          	auipc	ra,0x2
    3274:	4cc080e7          	jalr	1228(ra) # 573c <printf>
    exit(1);
    3278:	4505                	li	a0,1
    ...
    3288:	ebc50513          	addi	a0,a0,-324 # 7140 <statistics+0x185e>
    328c:	00002097          	auipc	ra,0x2
    3290:	4b0080e7          	jalr	1200(ra) # 573c <printf>
    exit(1);
    3294:	4505                	li	a0,1
    ...
    32a4:	ee050513          	addi	a0,a0,-288 # 7180 <statistics+0x189e>
    32a8:	00002097          	auipc	ra,0x2
    32ac:	494080e7          	jalr	1172(ra) # 573c <printf>
    exit(1);
    32b0:	4505                	li	a0,1
    ...
    32c0:	ef450513          	addi	a0,a0,-268 # 71b0 <statistics+0x18ce>
    32c4:	00002097          	auipc	ra,0x2
    32c8:	478080e7          	jalr	1144(ra) # 573c <printf>
    exit(1);
    32cc:	4505                	li	a0,1
    ...
    32dc:	ef850513          	addi	a0,a0,-264 # 71d0 <statistics+0x18ee>
    32e0:	00002097          	auipc	ra,0x2
    32e4:	45c080e7          	jalr	1116(ra) # 573c <printf>
    exit(1);
    32e8:	4505                	li	a0,1
    ...
    32f8:	efc50513          	addi	a0,a0,-260 # 71f0 <statistics+0x190e>
    32fc:	00002097          	auipc	ra,0x2
    3300:	440080e7          	jalr	1088(ra) # 573c <printf>
    exit(1);
    3304:	4505                	li	a0,1
    ...
    3314:	f0050513          	addi	a0,a0,-256 # 7210 <statistics+0x192e>
    3318:	00002097          	auipc	ra,0x2
    331c:	424080e7          	jalr	1060(ra) # 573c <printf>
    exit(1);
    3320:	4505                	li	a0,1
    ...
    3330:	f1450513          	addi	a0,a0,-236 # 7240 <statistics+0x195e>
    3334:	00002097          	auipc	ra,0x2
    3338:	408080e7          	jalr	1032(ra) # 573c <printf>
    exit(1);
    333c:	4505                	li	a0,1
    ...
    334c:	f2050513          	addi	a0,a0,-224 # 7268 <statistics+0x1986>
    3350:	00002097          	auipc	ra,0x2
    3354:	3ec080e7          	jalr	1004(ra) # 573c <printf>
    exit(1);
    3358:	4505                	li	a0,1
    ...
    3368:	f2c50513          	addi	a0,a0,-212 # 7290 <statistics+0x19ae>
    336c:	00002097          	auipc	ra,0x2
    3370:	3d0080e7          	jalr	976(ra) # 573c <printf>
    exit(1);
    3374:	4505                	li	a0,1
    ...
    3384:	f3850513          	addi	a0,a0,-200 # 72b8 <statistics+0x19d6>
    3388:	00002097          	auipc	ra,0x2
    338c:	3b4080e7          	jalr	948(ra) # 573c <printf>
    exit(1);
    3390:	4505                	li	a0,1
    ...
    33a0:	f3c50513          	addi	a0,a0,-196 # 72d8 <statistics+0x19f6>
    33a4:	00002097          	auipc	ra,0x2
    33a8:	398080e7          	jalr	920(ra) # 573c <printf>
    exit(1);
    33ac:	4505                	li	a0,1
    ...
    33bc:	f4050513          	addi	a0,a0,-192 # 72f8 <statistics+0x1a16>
    33c0:	00002097          	auipc	ra,0x2
    33c4:	37c080e7          	jalr	892(ra) # 573c <printf>
    exit(1);
    33c8:	4505                	li	a0,1
    ...
    33d8:	f4c50513          	addi	a0,a0,-180 # 7320 <statistics+0x1a3e>
    33dc:	00002097          	auipc	ra,0x2
    33e0:	360080e7          	jalr	864(ra) # 573c <printf>
    exit(1);
    33e4:	4505                	li	a0,1
    ...
    33f4:	f5050513          	addi	a0,a0,-176 # 7340 <statistics+0x1a5e>
    33f8:	00002097          	auipc	ra,0x2
    33fc:	344080e7          	jalr	836(ra) # 573c <printf>
    exit(1);
    3400:	4505                	li	a0,1
    ...
    3410:	f5450513          	addi	a0,a0,-172 # 7360 <statistics+0x1a7e>
    3414:	00002097          	auipc	ra,0x2
    3418:	328080e7          	jalr	808(ra) # 573c <printf>
    exit(1);
    341c:	4505                	li	a0,1
    ...
    342c:	f6050513          	addi	a0,a0,-160 # 7388 <statistics+0x1aa6>
    3430:	00002097          	auipc	ra,0x2
    3434:	30c080e7          	jalr	780(ra) # 573c <printf>
    exit(1);
    3438:	4505                	li	a0,1
    ...
    3448:	bdc50513          	addi	a0,a0,-1060 # 7020 <statistics+0x173e>
    344c:	00002097          	auipc	ra,0x2
    3450:	2f0080e7          	jalr	752(ra) # 573c <printf>
    exit(1);
    3454:	4505                	li	a0,1
    ...
    3464:	f4850513          	addi	a0,a0,-184 # 73a8 <statistics+0x1ac6>
    3468:	00002097          	auipc	ra,0x2
    346c:	2d4080e7          	jalr	724(ra) # 573c <printf>
    exit(1);
    3470:	4505                	li	a0,1
    ...
    3480:	f4c50513          	addi	a0,a0,-180 # 73c8 <statistics+0x1ae6>
    3484:	00002097          	auipc	ra,0x2
    3488:	2b8080e7          	jalr	696(ra) # 573c <printf>
    exit(1);
    348c:	4505                	li	a0,1
    ...
    349c:	f6050513          	addi	a0,a0,-160 # 73f8 <statistics+0x1b16>
    34a0:	00002097          	auipc	ra,0x2
    34a4:	29c080e7          	jalr	668(ra) # 573c <printf>
    exit(1);
    34a8:	4505                	li	a0,1
    ...
    34b8:	f6450513          	addi	a0,a0,-156 # 7418 <statistics+0x1b36>
    34bc:	00002097          	auipc	ra,0x2
    34c0:	280080e7          	jalr	640(ra) # 573c <printf>
    exit(1);
    34c4:	4505                	li	a0,1
...
00000000000034ce <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    34de:	f5650513          	addi	a0,a0,-170 # 7430 <statistics+0x1b4e>
  ...
  if(chdir("dots") != 0){
    ...
    34f0:	f4450513          	addi	a0,a0,-188 # 7430 <statistics+0x1b4e>
  ...
  if(unlink(".") == 0){
    ...
    3502:	efa50513          	addi	a0,a0,-262 # 63f8 <statistics+0xb16>
  ...
  if(unlink("..") == 0){
    ...
    3514:	f7050513          	addi	a0,a0,-144 # 7480 <statistics+0x1b9e>
  ...
  if(chdir("/") != 0){
    ...
    3526:	96650513          	addi	a0,a0,-1690 # 6e88 <statistics+0x15a6>
  ...
  if(unlink("dots/.") == 0){
    ...
    3538:	f6c50513          	addi	a0,a0,-148 # 74a0 <statistics+0x1bbe>
  ...
  if(unlink("dots/..") == 0){
    ...
    354a:	f8250513          	addi	a0,a0,-126 # 74c8 <statistics+0x1be6>
  ...
  if(unlink("dots") != 0){
    ...
    355c:	ed850513          	addi	a0,a0,-296 # 7430 <statistics+0x1b4e>
    ...
    357a:	ec250513          	addi	a0,a0,-318 # 7438 <statistics+0x1b56>
    357e:	00002097          	auipc	ra,0x2
    3582:	1be080e7          	jalr	446(ra) # 573c <printf>
    exit(1);
    3586:	4505                	li	a0,1
    ...
    3596:	ebe50513          	addi	a0,a0,-322 # 7450 <statistics+0x1b6e>
    359a:	00002097          	auipc	ra,0x2
    359e:	1a2080e7          	jalr	418(ra) # 573c <printf>
    exit(1);
    35a2:	4505                	li	a0,1
    ...
    35b2:	eba50513          	addi	a0,a0,-326 # 7468 <statistics+0x1b86>
    35b6:	00002097          	auipc	ra,0x2
    35ba:	186080e7          	jalr	390(ra) # 573c <printf>
    exit(1);
    35be:	4505                	li	a0,1
    ...
    35ce:	ebe50513          	addi	a0,a0,-322 # 7488 <statistics+0x1ba6>
    35d2:	00002097          	auipc	ra,0x2
    35d6:	16a080e7          	jalr	362(ra) # 573c <printf>
    exit(1);
    35da:	4505                	li	a0,1
    ...
    35ea:	8aa50513          	addi	a0,a0,-1878 # 6e90 <statistics+0x15ae>
    35ee:	00002097          	auipc	ra,0x2
    35f2:	14e080e7          	jalr	334(ra) # 573c <printf>
    exit(1);
    35f6:	4505                	li	a0,1
    ...
    3606:	ea650513          	addi	a0,a0,-346 # 74a8 <statistics+0x1bc6>
    360a:	00002097          	auipc	ra,0x2
    360e:	132080e7          	jalr	306(ra) # 573c <printf>
    exit(1);
    3612:	4505                	li	a0,1
    ...
    3622:	eb250513          	addi	a0,a0,-334 # 74d0 <statistics+0x1bee>
    3626:	00002097          	auipc	ra,0x2
    362a:	116080e7          	jalr	278(ra) # 573c <printf>
    exit(1);
    362e:	4505                	li	a0,1
    ...
    363e:	eb650513          	addi	a0,a0,-330 # 74f0 <statistics+0x1c0e>
    3642:	00002097          	auipc	ra,0x2
    3646:	0fa080e7          	jalr	250(ra) # 573c <printf>
    exit(1);
    364a:	4505                	li	a0,1
...
0000000000003654 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    366a:	eaa50513          	addi	a0,a0,-342 # 7510 <statistics+0x1c2e>
  ...
  if(chdir("dirfile") == 0){
    ...
    3686:	e8e50513          	addi	a0,a0,-370 # 7510 <statistics+0x1c2e>
  ...
  fd = open("dirfile/xx", 0);
    ...
    369a:	ec250513          	addi	a0,a0,-318 # 7558 <statistics+0x1c76>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    36b2:	eaa50513          	addi	a0,a0,-342 # 7558 <statistics+0x1c76>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    36c6:	e9650513          	addi	a0,a0,-362 # 7558 <statistics+0x1c76>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    36da:	e8250513          	addi	a0,a0,-382 # 7558 <statistics+0x1c76>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    36ee:	e6e58593          	addi	a1,a1,-402 # 7558 <statistics+0x1c76>
    36f2:	00002517          	auipc	a0,0x2
    36f6:	7f650513          	addi	a0,a0,2038 # 5ee8 <statistics+0x606>
  ...
  if(unlink("dirfile") != 0){
    ...
    370a:	e0a50513          	addi	a0,a0,-502 # 7510 <statistics+0x1c2e>
  ...
  fd = open(".", O_RDWR);
    ...
    3720:	cdc50513          	addi	a0,a0,-804 # 63f8 <statistics+0xb16>
  ...
  fd = open(".", 0);
    ...
    3736:	cc650513          	addi	a0,a0,-826 # 63f8 <statistics+0xb16>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    374a:	66a58593          	addi	a1,a1,1642 # 5db0 <statistics+0x4ce>
  ...
  close(fd);
    ...
    3776:	da650513          	addi	a0,a0,-602 # 7518 <statistics+0x1c36>
    377a:	00002097          	auipc	ra,0x2
    377e:	fc2080e7          	jalr	-62(ra) # 573c <printf>
    exit(1);
    3782:	4505                	li	a0,1
    ...
    3792:	daa50513          	addi	a0,a0,-598 # 7538 <statistics+0x1c56>
    3796:	00002097          	auipc	ra,0x2
    379a:	fa6080e7          	jalr	-90(ra) # 573c <printf>
    exit(1);
    379e:	4505                	li	a0,1
    ...
    37ae:	dbe50513          	addi	a0,a0,-578 # 7568 <statistics+0x1c86>
    37b2:	00002097          	auipc	ra,0x2
    37b6:	f8a080e7          	jalr	-118(ra) # 573c <printf>
    exit(1);
    37ba:	4505                	li	a0,1
    ...
    37ca:	da250513          	addi	a0,a0,-606 # 7568 <statistics+0x1c86>
    37ce:	00002097          	auipc	ra,0x2
    37d2:	f6e080e7          	jalr	-146(ra) # 573c <printf>
    exit(1);
    37d6:	4505                	li	a0,1
    ...
    37e6:	dae50513          	addi	a0,a0,-594 # 7590 <statistics+0x1cae>
    37ea:	00002097          	auipc	ra,0x2
    37ee:	f52080e7          	jalr	-174(ra) # 573c <printf>
    exit(1);
    37f2:	4505                	li	a0,1
    ...
    3802:	dba50513          	addi	a0,a0,-582 # 75b8 <statistics+0x1cd6>
    3806:	00002097          	auipc	ra,0x2
    380a:	f36080e7          	jalr	-202(ra) # 573c <printf>
    exit(1);
    380e:	4505                	li	a0,1
    ...
    381e:	dc650513          	addi	a0,a0,-570 # 75e0 <statistics+0x1cfe>
    3822:	00002097          	auipc	ra,0x2
    3826:	f1a080e7          	jalr	-230(ra) # 573c <printf>
    exit(1);
    382a:	4505                	li	a0,1
    ...
    383a:	dd250513          	addi	a0,a0,-558 # 7608 <statistics+0x1d26>
    383e:	00002097          	auipc	ra,0x2
    3842:	efe080e7          	jalr	-258(ra) # 573c <printf>
    exit(1);
    3846:	4505                	li	a0,1
    ...
    3856:	dd650513          	addi	a0,a0,-554 # 7628 <statistics+0x1d46>
    385a:	00002097          	auipc	ra,0x2
    385e:	ee2080e7          	jalr	-286(ra) # 573c <printf>
    exit(1);
    3862:	4505                	li	a0,1
    ...
    3872:	de250513          	addi	a0,a0,-542 # 7650 <statistics+0x1d6e>
    3876:	00002097          	auipc	ra,0x2
    387a:	ec6080e7          	jalr	-314(ra) # 573c <printf>
    exit(1);
    387e:	4505                	li	a0,1
...
0000000000003888 <iref>:
{
    ...
    38a6:	dc6a0a13          	addi	s4,s4,-570 # 7668 <statistics+0x1d86>
    mkdir("");
    38aa:	00004497          	auipc	s1,0x4
    38ae:	8be48493          	addi	s1,s1,-1858 # 7168 <statistics+0x1886>
    link("README", "");
    38b2:	00002a97          	auipc	s5,0x2
    38b6:	636a8a93          	addi	s5,s5,1590 # 5ee8 <statistics+0x606>
    fd = open("xx", O_CREATE);
    38ba:	00004997          	auipc	s3,0x4
    38be:	ca698993          	addi	s3,s3,-858 # 7560 <statistics+0x1c7e>
    38c2:	a891                	j	3916 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    38c4:	85da                	mv	a1,s6
    38c6:	00004517          	auipc	a0,0x4
    38ca:	daa50513          	addi	a0,a0,-598 # 7670 <statistics+0x1d8e>
    38ce:	00002097          	auipc	ra,0x2
    38d2:	e6e080e7          	jalr	-402(ra) # 573c <printf>
      exit(1);
    38d6:	4505                	li	a0,1
    ...
    38e6:	da650513          	addi	a0,a0,-602 # 7688 <statistics+0x1da6>
    38ea:	00002097          	auipc	ra,0x2
    38ee:	e52080e7          	jalr	-430(ra) # 573c <printf>
      exit(1);
    38f2:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    397a:	b0a98993          	addi	s3,s3,-1270 # 7480 <statistics+0x1b9e>
    unlink("irefd");
    397e:	00004917          	auipc	s2,0x4
    3982:	cea90913          	addi	s2,s2,-790 # 7668 <statistics+0x1d86>
    chdir("..");
    3986:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    39a2:	4ea50513          	addi	a0,a0,1258 # 6e88 <statistics+0x15a6>
...
00000000000039c2 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    39d2:	cd250513          	addi	a0,a0,-814 # 76a0 <statistics+0x1dbe>
  ...
  if(pid == 0){
    ...
    39f6:	cae50513          	addi	a0,a0,-850 # 76a0 <statistics+0x1dbe>
    ...
    3a0c:	cb850513          	addi	a0,a0,-840 # 76c0 <statistics+0x1dde>
    3a10:	00002097          	auipc	ra,0x2
    3a14:	d2c080e7          	jalr	-724(ra) # 573c <printf>
      exit(1);
    3a18:	4505                	li	a0,1
    ...
    3a28:	c8450513          	addi	a0,a0,-892 # 76a8 <statistics+0x1dc6>
    3a2c:	00002097          	auipc	ra,0x2
    3a30:	d10080e7          	jalr	-752(ra) # 573c <printf>
    exit(1);
    3a34:	4505                	li	a0,1
    ...
    3a44:	b5850513          	addi	a0,a0,-1192 # 6598 <statistics+0xcb6>
    3a48:	00002097          	auipc	ra,0x2
    3a4c:	cf4080e7          	jalr	-780(ra) # 573c <printf>
    exit(1);
    3a50:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3a72:	c3250513          	addi	a0,a0,-974 # 76a0 <statistics+0x1dbe>
    ...
    3a86:	d0650513          	addi	a0,a0,-762 # 6788 <statistics+0xea6>
    3a8a:	00002097          	auipc	ra,0x2
    3a8e:	cb2080e7          	jalr	-846(ra) # 573c <printf>
    exit(1);
    3a92:	4505                	li	a0,1
...
0000000000003ab4 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3ac4:	c2850513          	addi	a0,a0,-984 # 76e8 <statistics+0x1e06>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3af0:	bfc50513          	addi	a0,a0,-1028 # 76e8 <statistics+0x1e06>
  ...
  sleep(10); // one second
    ...
    3b28:	c3450513          	addi	a0,a0,-972 # 6758 <statistics+0xe76>
    3b2c:	00002097          	auipc	ra,0x2
    3b30:	c10080e7          	jalr	-1008(ra) # 573c <printf>
    exit(1);
    3b34:	4505                	li	a0,1
    ...
    3b42:	baa48493          	addi	s1,s1,-1110 # 76e8 <statistics+0x1e06>
    3b46:	4581                	li	a1,0
    3b48:	8526                	mv	a0,s1
...
0000000000003b84 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3bac:	bb050513          	addi	a0,a0,-1104 # 6758 <statistics+0xe76>
    3bb0:	00002097          	auipc	ra,0x2
    3bb4:	b8c080e7          	jalr	-1140(ra) # 573c <printf>
    exit(1);
    3bb8:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    3bda:	9c250513          	addi	a0,a0,-1598 # 6598 <statistics+0xcb6>
    3bde:	00002097          	auipc	ra,0x2
    3be2:	b5e080e7          	jalr	-1186(ra) # 573c <printf>
    exit(1);
    3be6:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    3c1e:	19658593          	addi	a1,a1,406 # 5db0 <statistics+0x4ce>
    ...
    3c48:	95450513          	addi	a0,a0,-1708 # 6598 <statistics+0xcb6>
    3c4c:	00002097          	auipc	ra,0x2
    3c50:	af0080e7          	jalr	-1296(ra) # 573c <printf>
     exit(1);
    3c54:	4505                	li	a0,1
    ...
    3c62:	a9a50513          	addi	a0,a0,-1382 # 76f8 <statistics+0x1e16>
    3c66:	00002097          	auipc	ra,0x2
    3c6a:	ad6080e7          	jalr	-1322(ra) # 573c <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3c82:	bb258593          	addi	a1,a1,-1102 # b830 <buf>
    ...
    3c9c:	a7850513          	addi	a0,a0,-1416 # 7710 <statistics+0x1e2e>
    3ca0:	00002097          	auipc	ra,0x2
    3ca4:	a9c080e7          	jalr	-1380(ra) # 573c <printf>
}
  ...
  printf("kill... ");
    ...
    3cc8:	a6450513          	addi	a0,a0,-1436 # 7728 <statistics+0x1e46>
    3ccc:	00002097          	auipc	ra,0x2
    3cd0:	a70080e7          	jalr	-1424(ra) # 573c <printf>
  kill(pid1);
    3cd4:	854e                	mv	a0,s3
  ...
  printf("wait... ");
    ...
    3cf6:	a4650513          	addi	a0,a0,-1466 # 7738 <statistics+0x1e56>
    3cfa:	00002097          	auipc	ra,0x2
    3cfe:	a42080e7          	jalr	-1470(ra) # 573c <printf>
  wait(0);
    3d02:	4501                	li	a0,0
...
0000000000003d22 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3d58:	94c50513          	addi	a0,a0,-1716 # 66a0 <statistics+0xdbe>
    3d5c:	00002097          	auipc	ra,0x2
    3d60:	9e0080e7          	jalr	-1568(ra) # 573c <printf>
    exit(1);
    3d64:	4505                	li	a0,1
    ...
    3d8c:	02858593          	addi	a1,a1,40 # 5db0 <statistics+0x4ce>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    3e50:	8fc50513          	addi	a0,a0,-1796 # 7748 <statistics+0x1e66>
    3e54:	00002097          	auipc	ra,0x2
    3e58:	8e8080e7          	jalr	-1816(ra) # 573c <printf>
    exit(1);
    3e5c:	4505                	li	a0,1
    ...
    3e6c:	73050513          	addi	a0,a0,1840 # 6598 <statistics+0xcb6>
    3e70:	00002097          	auipc	ra,0x2
    3e74:	8cc080e7          	jalr	-1844(ra) # 573c <printf>
    exit(1);
    3e78:	4505                	li	a0,1
    ...
    3eb6:	8b650513          	addi	a0,a0,-1866 # 7768 <statistics+0x1e86>
    3eba:	00002097          	auipc	ra,0x2
    3ebe:	882080e7          	jalr	-1918(ra) # 573c <printf>
    exit(1);
    3ec2:	4505                	li	a0,1
...
0000000000003ed6 <reparent>:
{
  ...
  exit(0);
    ...
    3f2a:	67250513          	addi	a0,a0,1650 # 6598 <statistics+0xcb6>
    3f2e:	00002097          	auipc	ra,0x2
    3f32:	80e080e7          	jalr	-2034(ra) # 573c <printf>
      exit(1);
    3f36:	4505                	li	a0,1
    ...
    3f46:	7de50513          	addi	a0,a0,2014 # 6720 <statistics+0xe3e>
    3f4a:	00001097          	auipc	ra,0x1
    3f4e:	7f2080e7          	jalr	2034(ra) # 573c <printf>
        exit(1);
    3f52:	4505                	li	a0,1
...
0000000000003f86 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3fae:	852080e7          	jalr	-1966(ra) # 57fc <malloc>
    ...
    3fc6:	7b0080e7          	jalr	1968(ra) # 5772 <free>
      m1 = m2;
    3fca:	84ca                	mv	s1,s2
    while(m1){
    ...
    3fd6:	82a080e7          	jalr	-2006(ra) # 57fc <malloc>
    if(m1 == 0){
    3fda:	c911                	beqz	a0,3fee <mem+0x68>
    free(m1);
    3fdc:	00001097          	auipc	ra,0x1
    3fe0:	796080e7          	jalr	1942(ra) # 5772 <free>
    exit(0);
    3fe4:	4501                	li	a0,0
    ...
    3ff4:	7a850513          	addi	a0,a0,1960 # 7798 <statistics+0x1eb6>
    3ff8:	00001097          	auipc	ra,0x1
    3ffc:	744080e7          	jalr	1860(ra) # 573c <printf>
      exit(1);
    4000:	4505                	li	a0,1
...
0000000000004032 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    40c8:	70450513          	addi	a0,a0,1796 # 77c8 <statistics+0x1ee6>
    40cc:	00001097          	auipc	ra,0x1
    40d0:	670080e7          	jalr	1648(ra) # 573c <printf>
    exit(1);
    40d4:	4505                	li	a0,1
    ...
    40e4:	71050513          	addi	a0,a0,1808 # 77f0 <statistics+0x1f0e>
    40e8:	00001097          	auipc	ra,0x1
    40ec:	654080e7          	jalr	1620(ra) # 573c <printf>
      exit(1);
    40f0:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    4128:	69450513          	addi	a0,a0,1684 # 77b8 <statistics+0x1ed6>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4168:	6ac50513          	addi	a0,a0,1708 # 7810 <statistics+0x1f2e>
    416c:	00001097          	auipc	ra,0x1
    4170:	5d0080e7          	jalr	1488(ra) # 573c <printf>
    exit(1);
    4174:	4505                	li	a0,1
    ...
    4182:	fd2783e3          	beq	a5,s2,4148 <sharedfd+0x116>
      if(buf[i] == 'c')
    4186:	0007c703          	lbu	a4,0(a5) # 3e800000 <_end+0x3e7f17c0>
  ...
  unlink("sharedfd");
    ...
    41a4:	61850513          	addi	a0,a0,1560 # 77b8 <statistics+0x1ed6>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    41ca:	67250513          	addi	a0,a0,1650 # 7838 <statistics+0x1f56>
    41ce:	00001097          	auipc	ra,0x1
    41d2:	56e080e7          	jalr	1390(ra) # 573c <printf>
    exit(1);
    41d6:	4505                	li	a0,1
...
00000000000041ea <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    420e:	64678793          	addi	a5,a5,1606 # 7850 <statistics+0x1f6e>
    4212:	f6f43823          	sd	a5,-144(s0)
    4216:	00003797          	auipc	a5,0x3
    421a:	64278793          	addi	a5,a5,1602 # 7858 <statistics+0x1f76>
    421e:	f6f43c23          	sd	a5,-136(s0)
    4222:	00003797          	auipc	a5,0x3
    4226:	63e78793          	addi	a5,a5,1598 # 7860 <statistics+0x1f7e>
    422a:	f8f43023          	sd	a5,-128(s0)
    422e:	00003797          	auipc	a5,0x3
    4232:	63a78793          	addi	a5,a5,1594 # 7868 <statistics+0x1f86>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    428a:	5aa98993          	addi	s3,s3,1450 # b830 <buf>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    42a0:	6ec50513          	addi	a0,a0,1772 # 6988 <statistics+0x10a6>
    42a4:	00001097          	auipc	ra,0x1
    42a8:	498080e7          	jalr	1176(ra) # 573c <printf>
      exit(1);
    42ac:	4505                	li	a0,1
    ...
    4318:	55c50513          	addi	a0,a0,1372 # 7870 <statistics+0x1f8e>
    431c:	00001097          	auipc	ra,0x1
    4320:	420080e7          	jalr	1056(ra) # 573c <printf>
        exit(1);
    4324:	4505                	li	a0,1
    ...
    4334:	55050513          	addi	a0,a0,1360 # 7880 <statistics+0x1f9e>
    4338:	00001097          	auipc	ra,0x1
    433c:	404080e7          	jalr	1028(ra) # 573c <printf>
          exit(1);
    4340:	4505                	li	a0,1
    ...
    4374:	4c178793          	addi	a5,a5,1217 # b831 <buf+0x1>
    ...
    4396:	50650513          	addi	a0,a0,1286 # 7898 <statistics+0x1fb6>
    439a:	00001097          	auipc	ra,0x1
    439e:	3a2080e7          	jalr	930(ra) # 573c <printf>
          exit(1);
    43a2:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    43ec:	4c050513          	addi	a0,a0,1216 # 78a8 <statistics+0x1fc6>
    43f0:	00001097          	auipc	ra,0x1
    43f4:	34c080e7          	jalr	844(ra) # 573c <printf>
      exit(1);
    43f8:	4505                	li	a0,1
...
0000000000004420 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    444e:	476b8b93          	addi	s7,s7,1142 # 78c0 <statistics+0x1fde>
  for(i = 0; i < N; i++){
    ...
    4490:	43c50513          	addi	a0,a0,1084 # 78c8 <statistics+0x1fe6>
    4494:	00001097          	auipc	ra,0x1
    4498:	2a8080e7          	jalr	680(ra) # 573c <printf>
        exit(1);
    449c:	4505                	li	a0,1
    ...
    44ae:	41650513          	addi	a0,a0,1046 # 78c0 <statistics+0x1fde>
  ...
  fd = open(".", 0);
    ...
    44e6:	f1650513          	addi	a0,a0,-234 # 63f8 <statistics+0xb16>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    455c:	39050513          	addi	a0,a0,912 # 78e8 <statistics+0x2006>
    4560:	00001097          	auipc	ra,0x1
    4564:	1dc080e7          	jalr	476(ra) # 573c <printf>
        exit(1);
    4568:	4505                	li	a0,1
    ...
    457c:	39050513          	addi	a0,a0,912 # 7908 <statistics+0x2026>
    4580:	00001097          	auipc	ra,0x1
    4584:	1bc080e7          	jalr	444(ra) # 573c <printf>
        exit(1);
    4588:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    45b4:	38050513          	addi	a0,a0,896 # 7930 <statistics+0x204e>
    45b8:	00001097          	auipc	ra,0x1
    45bc:	184080e7          	jalr	388(ra) # 573c <printf>
    exit(1);
    45c0:	4505                	li	a0,1
    ...
    45d0:	fcc50513          	addi	a0,a0,-52 # 6598 <statistics+0xcb6>
    45d4:	00001097          	auipc	ra,0x1
    45d8:	168080e7          	jalr	360(ra) # 573c <printf>
      exit(1);
    45dc:	4505                	li	a0,1
...
000000000000477a <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    47ba:	07a90913          	addi	s2,s2,122 # b830 <buf>
  for(i = 0; i < N; i++){
    47be:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4802:	16a50513          	addi	a0,a0,362 # 7968 <statistics+0x2086>
  ...
  for(i = 0; ; i++){
    ...
    4818:	01c90913          	addi	s2,s2,28 # b830 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4866:	11650513          	addi	a0,a0,278 # 7978 <statistics+0x2096>
    486a:	00001097          	auipc	ra,0x1
    486e:	ed2080e7          	jalr	-302(ra) # 573c <printf>
    exit(1);
    4872:	4505                	li	a0,1
    ...
    4882:	11a50513          	addi	a0,a0,282 # 7998 <statistics+0x20b6>
    4886:	00001097          	auipc	ra,0x1
    488a:	eb6080e7          	jalr	-330(ra) # 573c <printf>
      exit(1);
    488e:	4505                	li	a0,1
    ...
    489e:	11e50513          	addi	a0,a0,286 # 79b8 <statistics+0x20d6>
    48a2:	00001097          	auipc	ra,0x1
    48a6:	e9a080e7          	jalr	-358(ra) # 573c <printf>
    exit(1);
    48aa:	4505                	li	a0,1
    ...
    48ba:	12250513          	addi	a0,a0,290 # 79d8 <statistics+0x20f6>
    48be:	00001097          	auipc	ra,0x1
    48c2:	e7e080e7          	jalr	-386(ra) # 573c <printf>
      exit(1);
    48c6:	4505                	li	a0,1
    ...
    48d6:	12650513          	addi	a0,a0,294 # 79f8 <statistics+0x2116>
    48da:	00001097          	auipc	ra,0x1
    48de:	e62080e7          	jalr	-414(ra) # 573c <printf>
      exit(1);
    48e2:	4505                	li	a0,1
    ...
    48f2:	12250513          	addi	a0,a0,290 # 7a10 <statistics+0x212e>
    48f6:	00001097          	auipc	ra,0x1
    48fa:	e46080e7          	jalr	-442(ra) # 573c <printf>
      exit(1);
    48fe:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4920:	04c50513          	addi	a0,a0,76 # 7968 <statistics+0x2086>
    ...
    4944:	0f050513          	addi	a0,a0,240 # 7a30 <statistics+0x214e>
    4948:	00001097          	auipc	ra,0x1
    494c:	df4080e7          	jalr	-524(ra) # 573c <printf>
    exit(1);
    4950:	4505                	li	a0,1
...
000000000000495a <dirtest>:
{
  ...
  printf("mkdir test\n");
    ...
    496a:	0ea50513          	addi	a0,a0,234 # 7a50 <statistics+0x216e>
    496e:	00001097          	auipc	ra,0x1
    4972:	dce080e7          	jalr	-562(ra) # 573c <printf>
  if(mkdir("dir0") < 0){
    4976:	00003517          	auipc	a0,0x3
    497a:	0ea50513          	addi	a0,a0,234 # 7a60 <statistics+0x217e>
  ...
  if(chdir("dir0") < 0){
    ...
    498e:	0d650513          	addi	a0,a0,214 # 7a60 <statistics+0x217e>
  ...
  if(chdir("..") < 0){
    ...
    49a2:	ae250513          	addi	a0,a0,-1310 # 7480 <statistics+0x1b9e>
  ...
  if(unlink("dir0") < 0){
    ...
    49b6:	0ae50513          	addi	a0,a0,174 # 7a60 <statistics+0x217e>
  ...
  printf("%s: mkdir test ok\n");
    ...
    49ca:	0ea50513          	addi	a0,a0,234 # 7ab0 <statistics+0x21ce>
    49ce:	00001097          	auipc	ra,0x1
    49d2:	d6e080e7          	jalr	-658(ra) # 573c <printf>
}
    ...
    49e6:	43e50513          	addi	a0,a0,1086 # 6e20 <statistics+0x153e>
    49ea:	00001097          	auipc	ra,0x1
    49ee:	d52080e7          	jalr	-686(ra) # 573c <printf>
    exit(1);
    49f2:	4505                	li	a0,1
    ...
    4a02:	06a50513          	addi	a0,a0,106 # 7a68 <statistics+0x2186>
    4a06:	00001097          	auipc	ra,0x1
    4a0a:	d36080e7          	jalr	-714(ra) # 573c <printf>
    exit(1);
    4a0e:	4505                	li	a0,1
    ...
    4a1e:	06650513          	addi	a0,a0,102 # 7a80 <statistics+0x219e>
    4a22:	00001097          	auipc	ra,0x1
    4a26:	d1a080e7          	jalr	-742(ra) # 573c <printf>
    exit(1);
    4a2a:	4505                	li	a0,1
    ...
    4a3a:	06250513          	addi	a0,a0,98 # 7a98 <statistics+0x21b6>
    4a3e:	00001097          	auipc	ra,0x1
    4a42:	cfe080e7          	jalr	-770(ra) # 573c <printf>
    exit(1);
    4a46:	4505                	li	a0,1
...
0000000000004a50 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4a72:	05a50513          	addi	a0,a0,90 # 7ac8 <statistics+0x21e6>
    4a76:	00001097          	auipc	ra,0x1
    4a7a:	cc6080e7          	jalr	-826(ra) # 573c <printf>
  for(nfiles = 0; ; nfiles++){
    4a7e:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4a92:	04ac8c93          	addi	s9,s9,74 # 7ad8 <statistics+0x21f6>
    int total = 0;
    4a96:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4a98:	00007a17          	auipc	s4,0x7
    4a9c:	d98a0a13          	addi	s4,s4,-616 # b830 <buf>
    name[0] = 'f';
    ...
    4aea:	c56080e7          	jalr	-938(ra) # 573c <printf>
    ...
    4b0c:	fe050513          	addi	a0,a0,-32 # 7ae8 <statistics+0x2206>
    4b10:	00001097          	auipc	ra,0x1
    4b14:	c2c080e7          	jalr	-980(ra) # 573c <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    4b82:	f9a50513          	addi	a0,a0,-102 # 7b18 <statistics+0x2236>
    4b86:	00001097          	auipc	ra,0x1
    4b8a:	bb6080e7          	jalr	-1098(ra) # 573c <printf>
}
    ...
    4bd2:	f3250513          	addi	a0,a0,-206 # 7b00 <statistics+0x221e>
    4bd6:	00001097          	auipc	ra,0x1
    4bda:	b66080e7          	jalr	-1178(ra) # 573c <printf>
    close(fd);
    4bde:	854e                	mv	a0,s3
...
0000000000004bf0 <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    4bfa:	40a70713          	addi	a4,a4,1034 # 8000 <randstate>
    4bfe:	6308                	ld	a0,0(a4)
    4c00:	001967b7          	lui	a5,0x196
    4c04:	60d78793          	addi	a5,a5,1549 # 19660d <_end+0x187dcd>
    4c08:	02f50533          	mul	a0,a0,a5
    4c0c:	3c6ef7b7          	lui	a5,0x3c6ef
    4c10:	35f78793          	addi	a5,a5,863 # 3c6ef35f <_end+0x3c6e0b1f>
...
0000000000004c20 <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    4c94:	ea050513          	addi	a0,a0,-352 # 7b30 <statistics+0x224e>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    4cac:	10858593          	addi	a1,a1,264 # 5db0 <statistics+0x4ce>
    ...
    4cc2:	e9250513          	addi	a0,a0,-366 # 7b50 <statistics+0x226e>
    4cc6:	00001097          	auipc	ra,0x1
    4cca:	a76080e7          	jalr	-1418(ra) # 573c <printf>
    exit(1);
    4cce:	4505                	li	a0,1
    ...
    4cdc:	e6050513          	addi	a0,a0,-416 # 7b38 <statistics+0x2256>
    4ce0:	00001097          	auipc	ra,0x1
    4ce4:	a5c080e7          	jalr	-1444(ra) # 573c <printf>
      exit(1);
    4ce8:	4505                	li	a0,1
    ...
    4cf6:	e4650513          	addi	a0,a0,-442 # 7b38 <statistics+0x2256>
    4cfa:	00001097          	auipc	ra,0x1
    4cfe:	a42080e7          	jalr	-1470(ra) # 573c <printf>
    exit(1);
    4d02:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    4d1a:	e1a50513          	addi	a0,a0,-486 # 7b30 <statistics+0x224e>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    4d70:	04490913          	addi	s2,s2,68 # 5db0 <statistics+0x4ce>
      uint64 a = (uint64) sbrk(4096);
    ...
    4da4:	e0050513          	addi	a0,a0,-512 # 7ba0 <statistics+0x22be>
    4da8:	00001097          	auipc	ra,0x1
    4dac:	994080e7          	jalr	-1644(ra) # 573c <printf>
        exit(1);
    4db0:	4505                	li	a0,1
    ...
    4dbe:	da650513          	addi	a0,a0,-602 # 7b60 <statistics+0x227e>
    4dc2:	00001097          	auipc	ra,0x1
    4dc6:	97a080e7          	jalr	-1670(ra) # 573c <printf>
    exit(1);
    4dca:	4505                	li	a0,1
    ...
    4dd8:	dac50513          	addi	a0,a0,-596 # 7b80 <statistics+0x229e>
    4ddc:	00001097          	auipc	ra,0x1
    4de0:	960080e7          	jalr	-1696(ra) # 573c <printf>
    exit(1);
    4de4:	4505                	li	a0,1
  ...
  while(1){
    ...
    4e0c:	db850513          	addi	a0,a0,-584 # 7bc0 <statistics+0x22de>
    4e10:	00001097          	auipc	ra,0x1
    4e14:	92c080e7          	jalr	-1748(ra) # 573c <printf>
      exit(1);
    4e18:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4e76:	d6e50513          	addi	a0,a0,-658 # 7be0 <statistics+0x22fe>
    4e7a:	00001097          	auipc	ra,0x1
    4e7e:	8c2080e7          	jalr	-1854(ra) # 573c <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    4ea6:	d6650513          	addi	a0,a0,-666 # 7c08 <statistics+0x2326>
    4eaa:	00001097          	auipc	ra,0x1
    4eae:	892080e7          	jalr	-1902(ra) # 573c <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4eca:	d2a50513          	addi	a0,a0,-726 # 7bf0 <statistics+0x230e>
    4ece:	00001097          	auipc	ra,0x1
    4ed2:	86e080e7          	jalr	-1938(ra) # 573c <printf>
    exit(1);
    4ed6:	4505                	li	a0,1
    ...
    4ef2:	d2250513          	addi	a0,a0,-734 # 7c10 <statistics+0x232e>
    4ef6:	00001097          	auipc	ra,0x1
    4efa:	846080e7          	jalr	-1978(ra) # 573c <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    4f3a:	a5278793          	addi	a5,a5,-1454 # 5988 <statistics+0xa6>
    4f3e:	c4040713          	addi	a4,s0,-960
    4f42:	00001817          	auipc	a6,0x1
    4f46:	dc680813          	addi	a6,a6,-570 # 5d08 <statistics+0x426>
  ...
  printf("usertests starting\n");
    ...
    4f6a:	d6250513          	addi	a0,a0,-670 # 7cc8 <statistics+0x23e6>
    4f6e:	00000097          	auipc	ra,0x0
    4f72:	7ce080e7          	jalr	1998(ra) # 573c <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    4fa4:	ce050513          	addi	a0,a0,-800 # 7c80 <statistics+0x239e>
    4fa8:	00000097          	auipc	ra,0x0
    4fac:	794080e7          	jalr	1940(ra) # 573c <printf>
    exit(1);
    4fb0:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    4fc0:	c5c58593          	addi	a1,a1,-932 # 7c18 <statistics+0x2336>
    ...
    4fd6:	d2e58593          	addi	a1,a1,-722 # 7d00 <statistics+0x241e>
    ...
    4ffa:	c2a50513          	addi	a0,a0,-982 # 7c20 <statistics+0x233e>
    4ffe:	00000097          	auipc	ra,0x0
    5002:	73e080e7          	jalr	1854(ra) # 573c <printf>
    exit(1);
    5006:	4505                	li	a0,1
    ...
    5024:	71c080e7          	jalr	1820(ra) # 573c <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    506c:	c0050513          	addi	a0,a0,-1024 # 7c68 <statistics+0x2386>
    5070:	00000097          	auipc	ra,0x0
    5074:	6cc080e7          	jalr	1740(ra) # 573c <printf>
    exit(1);
    5078:	4505                	li	a0,1
    ...
    5086:	c2e50513          	addi	a0,a0,-978 # 7cb0 <statistics+0x23ce>
    508a:	00000097          	auipc	ra,0x0
    508e:	6b2080e7          	jalr	1714(ra) # 573c <printf>
    exit(0);
    5092:	4501                	li	a0,0
    ...
    50a2:	69e080e7          	jalr	1694(ra) # 573c <printf>
        if(continuous != 2)
    ...
    50e4:	8a878793          	addi	a5,a5,-1880 # 5988 <statistics+0xa6>
    50e8:	c4040713          	addi	a4,s0,-960
    50ec:	00001817          	auipc	a6,0x1
    50f0:	c1c80813          	addi	a6,a6,-996 # 5d08 <statistics+0x426>
    ...
    5114:	bd050513          	addi	a0,a0,-1072 # 7ce0 <statistics+0x23fe>
    5118:	00000097          	auipc	ra,0x0
    511c:	624080e7          	jalr	1572(ra) # 573c <printf>
        printf("SOME TESTS FAILED\n");
    5120:	00003a97          	auipc	s5,0x3
    5124:	b48a8a93          	addi	s5,s5,-1208 # 7c68 <statistics+0x2386>
        if(continuous != 2)
    5128:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    512a:	00003b17          	auipc	s6,0x3
    512e:	b1eb0b13          	addi	s6,s6,-1250 # 7c48 <statistics+0x2366>
...
putc(int fd, char c)
{
    5464:	1101                	addi	sp,sp,-32
    5466:	ec06                	sd	ra,24(sp)
    5468:	e822                	sd	s0,16(sp)
    546a:	1000                	addi	s0,sp,32
    546c:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5470:	4605                	li	a2,1
    5472:	fef40593          	addi	a1,s0,-17
    5476:	00000097          	auipc	ra,0x0
    547a:	f6e080e7          	jalr	-146(ra) # 53e4 <write>
}
    547e:	60e2                	ld	ra,24(sp)
    5480:	6442                	ld	s0,16(sp)
    5482:	6105                	addi	sp,sp,32
    5484:	8082                	ret

0000000000005486 <printint>:
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
    5494:	c299                	beqz	a3,549a <printint+0x14>
    5496:	0005cd63          	bltz	a1,54b0 <printint+0x2a>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    549a:	2581                	sext.w	a1,a1
  neg = 0;
    549c:	4301                	li	t1,0
    549e:	fc040713          	addi	a4,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    54a4:	2601                	sext.w	a2,a2
    54a6:	00003897          	auipc	a7,0x3
    54aa:	b0a88893          	addi	a7,a7,-1270 # 7fb0 <digits>
    54ae:	a801                	j	54be <printint+0x38>
    x = -xx;
    54b0:	40b005bb          	negw	a1,a1
    54b4:	2581                	sext.w	a1,a1
    neg = 1;
    54b6:	4305                	li	t1,1
    x = -xx;
    54b8:	b7dd                	j	549e <printint+0x18>
  }while((x /= base) != 0);
    54ba:	85be                	mv	a1,a5
    buf[i++] = digits[x % base];
    54bc:	8836                	mv	a6,a3
    54be:	0018069b          	addiw	a3,a6,1
    54c2:	02c5f7bb          	remuw	a5,a1,a2
    54c6:	1782                	slli	a5,a5,0x20
    54c8:	9381                	srli	a5,a5,0x20
    54ca:	97c6                	add	a5,a5,a7
    54cc:	0007c783          	lbu	a5,0(a5)
    54d0:	00f70023          	sb	a5,0(a4)
  }while((x /= base) != 0);
    54d4:	0705                	addi	a4,a4,1
    54d6:	02c5d7bb          	divuw	a5,a1,a2
    54da:	fec5f0e3          	bleu	a2,a1,54ba <printint+0x34>
  if(neg)
    54de:	00030b63          	beqz	t1,54f4 <printint+0x6e>
    buf[i++] = '-';
    54e2:	fd040793          	addi	a5,s0,-48
    54e6:	96be                	add	a3,a3,a5
    54e8:	02d00793          	li	a5,45
    54ec:	fef68823          	sb	a5,-16(a3) # ff0 <bigdir+0x74>
    54f0:	0028069b          	addiw	a3,a6,2

  while(--i >= 0)
    54f4:	02d05963          	blez	a3,5526 <printint+0xa0>
    54f8:	89aa                	mv	s3,a0
    54fa:	fc040793          	addi	a5,s0,-64
    54fe:	00d784b3          	add	s1,a5,a3
    5502:	fff78913          	addi	s2,a5,-1
    5506:	9936                	add	s2,s2,a3
    5508:	36fd                	addiw	a3,a3,-1
    550a:	1682                	slli	a3,a3,0x20
    550c:	9281                	srli	a3,a3,0x20
    550e:	40d90933          	sub	s2,s2,a3
    putc(fd, buf[i]);
    5512:	fff4c583          	lbu	a1,-1(s1)
    5516:	854e                	mv	a0,s3
    5518:	00000097          	auipc	ra,0x0
    551c:	f4c080e7          	jalr	-180(ra) # 5464 <putc>
  while(--i >= 0)
    5520:	14fd                	addi	s1,s1,-1
    5522:	ff2498e3          	bne	s1,s2,5512 <printint+0x8c>
}
    5526:	70e2                	ld	ra,56(sp)
    5528:	7442                	ld	s0,48(sp)
    552a:	74a2                	ld	s1,40(sp)
    552c:	7902                	ld	s2,32(sp)
    552e:	69e2                	ld	s3,24(sp)
    5530:	6121                	addi	sp,sp,64
    5532:	8082                	ret

0000000000005534 <vprintf>:
}
...
{
    5534:	7119                	addi	sp,sp,-128
    5536:	fc86                	sd	ra,120(sp)
    5538:	f8a2                	sd	s0,112(sp)
    553a:	f4a6                	sd	s1,104(sp)
    553c:	f0ca                	sd	s2,96(sp)
    553e:	ecce                	sd	s3,88(sp)
    5540:	e8d2                	sd	s4,80(sp)
    5542:	e4d6                	sd	s5,72(sp)
    5544:	e0da                	sd	s6,64(sp)
    5546:	fc5e                	sd	s7,56(sp)
    5548:	f862                	sd	s8,48(sp)
    554a:	f466                	sd	s9,40(sp)
    554c:	f06a                	sd	s10,32(sp)
    554e:	ec6e                	sd	s11,24(sp)
    5550:	0100                	addi	s0,sp,128
  char *s;
  int c, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    5552:	0005c483          	lbu	s1,0(a1)
    5556:	18048d63          	beqz	s1,56f0 <vprintf+0x1bc>
    555a:	8aaa                	mv	s5,a0
    555c:	8b32                	mv	s6,a2
    555e:	00158913          	addi	s2,a1,1
  state = 0;
    5562:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5564:	02500a13          	li	s4,37
      if(c == 'd'){
    5568:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    556c:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    5570:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    5574:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5578:	00003b97          	auipc	s7,0x3
    557c:	a38b8b93          	addi	s7,s7,-1480 # 7fb0 <digits>
    5580:	a839                	j	559e <vprintf+0x6a>
        putc(fd, c);
    5582:	85a6                	mv	a1,s1
    5584:	8556                	mv	a0,s5
    5586:	00000097          	auipc	ra,0x0
    558a:	ede080e7          	jalr	-290(ra) # 5464 <putc>
    558e:	a019                	j	5594 <vprintf+0x60>
    } else if(state == '%'){
    5590:	01498f63          	beq	s3,s4,55ae <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    5594:	0905                	addi	s2,s2,1
    5596:	fff94483          	lbu	s1,-1(s2)
    559a:	14048b63          	beqz	s1,56f0 <vprintf+0x1bc>
    c = fmt[i] & 0xff;
    559e:	0004879b          	sext.w	a5,s1
    if(state == 0){
    55a2:	fe0997e3          	bnez	s3,5590 <vprintf+0x5c>
      if(c == '%'){
    55a6:	fd479ee3          	bne	a5,s4,5582 <vprintf+0x4e>
        state = '%';
    55aa:	89be                	mv	s3,a5
    55ac:	b7e5                	j	5594 <vprintf+0x60>
      if(c == 'd'){
    55ae:	05878063          	beq	a5,s8,55ee <vprintf+0xba>
      } else if(c == 'l') {
    55b2:	05978c63          	beq	a5,s9,560a <vprintf+0xd6>
      } else if(c == 'x') {
    55b6:	07a78863          	beq	a5,s10,5626 <vprintf+0xf2>
      } else if(c == 'p') {
    55ba:	09b78463          	beq	a5,s11,5642 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    55be:	07300713          	li	a4,115
    55c2:	0ce78563          	beq	a5,a4,568c <vprintf+0x158>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    55c6:	06300713          	li	a4,99
    55ca:	0ee78c63          	beq	a5,a4,56c2 <vprintf+0x18e>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    55ce:	11478663          	beq	a5,s4,56da <vprintf+0x1a6>
        putc(fd, c);
      } else {
    ...
    55da:	e8e080e7          	jalr	-370(ra) # 5464 <putc>
        putc(fd, c);
    55de:	85a6                	mv	a1,s1
    55e0:	8556                	mv	a0,s5
    55e2:	00000097          	auipc	ra,0x0
    55e6:	e82080e7          	jalr	-382(ra) # 5464 <putc>
      }
      state = 0;
    55ea:	4981                	li	s3,0
    55ec:	b765                	j	5594 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    55ee:	008b0493          	addi	s1,s6,8
    55f2:	4685                	li	a3,1
    55f4:	4629                	li	a2,10
    55f6:	000b2583          	lw	a1,0(s6)
    55fa:	8556                	mv	a0,s5
    55fc:	00000097          	auipc	ra,0x0
    5600:	e8a080e7          	jalr	-374(ra) # 5486 <printint>
    5604:	8b26                	mv	s6,s1
      state = 0;
    5606:	4981                	li	s3,0
    5608:	b771                	j	5594 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    560a:	008b0493          	addi	s1,s6,8
    560e:	4681                	li	a3,0
    5610:	4629                	li	a2,10
    5612:	000b2583          	lw	a1,0(s6)
    5616:	8556                	mv	a0,s5
    5618:	00000097          	auipc	ra,0x0
    561c:	e6e080e7          	jalr	-402(ra) # 5486 <printint>
    5620:	8b26                	mv	s6,s1
      state = 0;
    5622:	4981                	li	s3,0
    5624:	bf85                	j	5594 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    5626:	008b0493          	addi	s1,s6,8
    562a:	4681                	li	a3,0
    562c:	4641                	li	a2,16
    562e:	000b2583          	lw	a1,0(s6)
    5632:	8556                	mv	a0,s5
    5634:	00000097          	auipc	ra,0x0
    5638:	e52080e7          	jalr	-430(ra) # 5486 <printint>
    563c:	8b26                	mv	s6,s1
      state = 0;
    563e:	4981                	li	s3,0
    5640:	bf91                	j	5594 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5642:	008b0793          	addi	a5,s6,8
    5646:	f8f43423          	sd	a5,-120(s0)
    564a:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    564e:	03000593          	li	a1,48
    5652:	8556                	mv	a0,s5
    5654:	00000097          	auipc	ra,0x0
    5658:	e10080e7          	jalr	-496(ra) # 5464 <putc>
  putc(fd, 'x');
    565c:	85ea                	mv	a1,s10
    565e:	8556                	mv	a0,s5
    5660:	00000097          	auipc	ra,0x0
    5664:	e04080e7          	jalr	-508(ra) # 5464 <putc>
    5668:	44c1                	li	s1,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    566a:	03c9d793          	srli	a5,s3,0x3c
    566e:	97de                	add	a5,a5,s7
    5670:	0007c583          	lbu	a1,0(a5)
    5674:	8556                	mv	a0,s5
    5676:	00000097          	auipc	ra,0x0
    567a:	dee080e7          	jalr	-530(ra) # 5464 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    567e:	0992                	slli	s3,s3,0x4
    5680:	34fd                	addiw	s1,s1,-1
    5682:	f4e5                	bnez	s1,566a <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    5684:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5688:	4981                	li	s3,0
    568a:	b729                	j	5594 <vprintf+0x60>
        s = va_arg(ap, char*);
    568c:	008b0993          	addi	s3,s6,8
    5690:	000b3483          	ld	s1,0(s6)
        if(s == 0)
    5694:	c085                	beqz	s1,56b4 <vprintf+0x180>
        while(*s != 0){
    5696:	0004c583          	lbu	a1,0(s1)
    569a:	c9a1                	beqz	a1,56ea <vprintf+0x1b6>
          putc(fd, *s);
    569c:	8556                	mv	a0,s5
    569e:	00000097          	auipc	ra,0x0
    56a2:	dc6080e7          	jalr	-570(ra) # 5464 <putc>
          s++;
    56a6:	0485                	addi	s1,s1,1
        while(*s != 0){
    56a8:	0004c583          	lbu	a1,0(s1)
    56ac:	f9e5                	bnez	a1,569c <vprintf+0x168>
        s = va_arg(ap, char*);
    56ae:	8b4e                	mv	s6,s3
      state = 0;
    56b0:	4981                	li	s3,0
    56b2:	b5cd                	j	5594 <vprintf+0x60>
          s = "(null)";
    56b4:	00003497          	auipc	s1,0x3
    56b8:	91448493          	addi	s1,s1,-1772 # 7fc8 <digits+0x18>
        while(*s != 0){
    56bc:	02800593          	li	a1,40
    56c0:	bff1                	j	569c <vprintf+0x168>
        putc(fd, va_arg(ap, uint));
    56c2:	008b0493          	addi	s1,s6,8
    56c6:	000b4583          	lbu	a1,0(s6)
    56ca:	8556                	mv	a0,s5
    56cc:	00000097          	auipc	ra,0x0
    56d0:	d98080e7          	jalr	-616(ra) # 5464 <putc>
    56d4:	8b26                	mv	s6,s1
      state = 0;
    56d6:	4981                	li	s3,0
    56d8:	bd75                	j	5594 <vprintf+0x60>
        putc(fd, c);
    56da:	85d2                	mv	a1,s4
    56dc:	8556                	mv	a0,s5
    56de:	00000097          	auipc	ra,0x0
    56e2:	d86080e7          	jalr	-634(ra) # 5464 <putc>
      state = 0;
    56e6:	4981                	li	s3,0
    56e8:	b575                	j	5594 <vprintf+0x60>
        s = va_arg(ap, char*);
    56ea:	8b4e                	mv	s6,s3
      state = 0;
    56ec:	4981                	li	s3,0
    56ee:	b55d                	j	5594 <vprintf+0x60>
    }
  }
}
    56f0:	70e6                	ld	ra,120(sp)
    56f2:	7446                	ld	s0,112(sp)
    56f4:	74a6                	ld	s1,104(sp)
    56f6:	7906                	ld	s2,96(sp)
    56f8:	69e6                	ld	s3,88(sp)
    56fa:	6a46                	ld	s4,80(sp)
    56fc:	6aa6                	ld	s5,72(sp)
    56fe:	6b06                	ld	s6,64(sp)
    5700:	7be2                	ld	s7,56(sp)
    5702:	7c42                	ld	s8,48(sp)
    5704:	7ca2                	ld	s9,40(sp)
    5706:	7d02                	ld	s10,32(sp)
    5708:	6de2                	ld	s11,24(sp)
    570a:	6109                	addi	sp,sp,128
    570c:	8082                	ret

000000000000570e <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    570e:	715d                	addi	sp,sp,-80
    5710:	ec06                	sd	ra,24(sp)
    5712:	e822                	sd	s0,16(sp)
    5714:	1000                	addi	s0,sp,32
    5716:	e010                	sd	a2,0(s0)
    5718:	e414                	sd	a3,8(s0)
    571a:	e818                	sd	a4,16(s0)
    571c:	ec1c                	sd	a5,24(s0)
    571e:	03043023          	sd	a6,32(s0)
    5722:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5726:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    572a:	8622                	mv	a2,s0
    572c:	00000097          	auipc	ra,0x0
    5730:	e08080e7          	jalr	-504(ra) # 5534 <vprintf>
}
    5734:	60e2                	ld	ra,24(sp)
    5736:	6442                	ld	s0,16(sp)
    5738:	6161                	addi	sp,sp,80
    573a:	8082                	ret

000000000000573c <printf>:

void
printf(const char *fmt, ...)
{
    573c:	711d                	addi	sp,sp,-96
    573e:	ec06                	sd	ra,24(sp)
    5740:	e822                	sd	s0,16(sp)
    5742:	1000                	addi	s0,sp,32
    5744:	e40c                	sd	a1,8(s0)
    5746:	e810                	sd	a2,16(s0)
    5748:	ec14                	sd	a3,24(s0)
    574a:	f018                	sd	a4,32(s0)
    574c:	f41c                	sd	a5,40(s0)
    574e:	03043823          	sd	a6,48(s0)
    5752:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5756:	00840613          	addi	a2,s0,8
    575a:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    575e:	85aa                	mv	a1,a0
    5760:	4505                	li	a0,1
    5762:	00000097          	auipc	ra,0x0
    5766:	dd2080e7          	jalr	-558(ra) # 5534 <vprintf>
}
    576a:	60e2                	ld	ra,24(sp)
    576c:	6442                	ld	s0,16(sp)
    576e:	6125                	addi	sp,sp,96
    5770:	8082                	ret

0000000000005772 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    5772:	1141                	addi	sp,sp,-16
    5774:	e422                	sd	s0,8(sp)
    5776:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5778:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    577c:	00003797          	auipc	a5,0x3
    5780:	89478793          	addi	a5,a5,-1900 # 8010 <freep>
    5784:	639c                	ld	a5,0(a5)
    5786:	a805                	j	57b6 <free+0x44>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5788:	4618                	lw	a4,8(a2)
    578a:	9db9                	addw	a1,a1,a4
    578c:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5790:	6398                	ld	a4,0(a5)
    5792:	6318                	ld	a4,0(a4)
    5794:	fee53823          	sd	a4,-16(a0)
    5798:	a091                	j	57dc <free+0x6a>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    579a:	ff852703          	lw	a4,-8(a0)
    579e:	9e39                	addw	a2,a2,a4
    57a0:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    57a2:	ff053703          	ld	a4,-16(a0)
    57a6:	e398                	sd	a4,0(a5)
    57a8:	a099                	j	57ee <free+0x7c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    57aa:	6398                	ld	a4,0(a5)
    57ac:	00e7e463          	bltu	a5,a4,57b4 <free+0x42>
    57b0:	00e6ea63          	bltu	a3,a4,57c4 <free+0x52>
{
    57b4:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    57b6:	fed7fae3          	bleu	a3,a5,57aa <free+0x38>
    57ba:	6398                	ld	a4,0(a5)
    57bc:	00e6e463          	bltu	a3,a4,57c4 <free+0x52>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    57c0:	fee7eae3          	bltu	a5,a4,57b4 <free+0x42>
  if(bp + bp->s.size == p->s.ptr){
    57c4:	ff852583          	lw	a1,-8(a0)
    57c8:	6390                	ld	a2,0(a5)
    57ca:	02059713          	slli	a4,a1,0x20
    57ce:	9301                	srli	a4,a4,0x20
    57d0:	0712                	slli	a4,a4,0x4
    57d2:	9736                	add	a4,a4,a3
    57d4:	fae60ae3          	beq	a2,a4,5788 <free+0x16>
    bp->s.ptr = p->s.ptr;
    57d8:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    57dc:	4790                	lw	a2,8(a5)
    57de:	02061713          	slli	a4,a2,0x20
    57e2:	9301                	srli	a4,a4,0x20
    57e4:	0712                	slli	a4,a4,0x4
    57e6:	973e                	add	a4,a4,a5
    57e8:	fae689e3          	beq	a3,a4,579a <free+0x28>
  } else
    p->s.ptr = bp;
    57ec:	e394                	sd	a3,0(a5)
  freep = p;
    57ee:	00003717          	auipc	a4,0x3
    57f2:	82f73123          	sd	a5,-2014(a4) # 8010 <freep>
}
    57f6:	6422                	ld	s0,8(sp)
    57f8:	0141                	addi	sp,sp,16
    57fa:	8082                	ret

00000000000057fc <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    57fc:	7139                	addi	sp,sp,-64
    57fe:	fc06                	sd	ra,56(sp)
    5800:	f822                	sd	s0,48(sp)
    5802:	f426                	sd	s1,40(sp)
    5804:	f04a                	sd	s2,32(sp)
    5806:	ec4e                	sd	s3,24(sp)
    5808:	e852                	sd	s4,16(sp)
    580a:	e456                	sd	s5,8(sp)
    580c:	e05a                	sd	s6,0(sp)
    580e:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5810:	02051993          	slli	s3,a0,0x20
    5814:	0209d993          	srli	s3,s3,0x20
    5818:	09bd                	addi	s3,s3,15
    581a:	0049d993          	srli	s3,s3,0x4
    581e:	2985                	addiw	s3,s3,1
    5820:	0009891b          	sext.w	s2,s3
  if((prevp = freep) == 0){
    5824:	00002797          	auipc	a5,0x2
    5828:	7ec78793          	addi	a5,a5,2028 # 8010 <freep>
    582c:	6388                	ld	a0,0(a5)
    582e:	c515                	beqz	a0,585a <malloc+0x5e>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5830:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5832:	4798                	lw	a4,8(a5)
    5834:	03277f63          	bleu	s2,a4,5872 <malloc+0x76>
    5838:	8a4e                	mv	s4,s3
    583a:	0009871b          	sext.w	a4,s3
    583e:	6685                	lui	a3,0x1
    5840:	00d77363          	bleu	a3,a4,5846 <malloc+0x4a>
    5844:	6a05                	lui	s4,0x1
    5846:	000a0a9b          	sext.w	s5,s4
  p = sbrk(nu * sizeof(Header));
    584a:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    584e:	00002497          	auipc	s1,0x2
    5852:	7c248493          	addi	s1,s1,1986 # 8010 <freep>
  if(p == (char*)-1)
    5856:	5b7d                	li	s6,-1
    5858:	a885                	j	58c8 <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
    585a:	00009797          	auipc	a5,0x9
    585e:	fd678793          	addi	a5,a5,-42 # e830 <base>
    5862:	00002717          	auipc	a4,0x2
    5866:	7af73723          	sd	a5,1966(a4) # 8010 <freep>
    586a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    586c:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5870:	b7e1                	j	5838 <malloc+0x3c>
      if(p->s.size == nunits)
    5872:	02e90b63          	beq	s2,a4,58a8 <malloc+0xac>
        p->s.size -= nunits;
    5876:	4137073b          	subw	a4,a4,s3
    587a:	c798                	sw	a4,8(a5)
        p += p->s.size;
    587c:	1702                	slli	a4,a4,0x20
    587e:	9301                	srli	a4,a4,0x20
    5880:	0712                	slli	a4,a4,0x4
    5882:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5884:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5888:	00002717          	auipc	a4,0x2
    588c:	78a73423          	sd	a0,1928(a4) # 8010 <freep>
      return (void*)(p + 1);
    5890:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    5894:	70e2                	ld	ra,56(sp)
    5896:	7442                	ld	s0,48(sp)
    5898:	74a2                	ld	s1,40(sp)
    589a:	7902                	ld	s2,32(sp)
    589c:	69e2                	ld	s3,24(sp)
    589e:	6a42                	ld	s4,16(sp)
    58a0:	6aa2                	ld	s5,8(sp)
    58a2:	6b02                	ld	s6,0(sp)
    58a4:	6121                	addi	sp,sp,64
    58a6:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    58a8:	6398                	ld	a4,0(a5)
    58aa:	e118                	sd	a4,0(a0)
    58ac:	bff1                	j	5888 <malloc+0x8c>
  hp->s.size = nu;
    58ae:	01552423          	sw	s5,8(a0)
  free((void*)(hp + 1));
    58b2:	0541                	addi	a0,a0,16
    58b4:	00000097          	auipc	ra,0x0
    58b8:	ebe080e7          	jalr	-322(ra) # 5772 <free>
  return freep;
    58bc:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
    58be:	d979                	beqz	a0,5894 <malloc+0x98>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    58c0:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    58c2:	4798                	lw	a4,8(a5)
    58c4:	fb2777e3          	bleu	s2,a4,5872 <malloc+0x76>
    if(p == freep)
    58c8:	6098                	ld	a4,0(s1)
    58ca:	853e                	mv	a0,a5
    58cc:	fef71ae3          	bne	a4,a5,58c0 <malloc+0xc4>
  p = sbrk(nu * sizeof(Header));
    58d0:	8552                	mv	a0,s4
    58d2:	00000097          	auipc	ra,0x0
    58d6:	b7a080e7          	jalr	-1158(ra) # 544c <sbrk>
  if(p == (char*)-1)
    58da:	fd651ae3          	bne	a0,s6,58ae <malloc+0xb2>
        return 0;
    58de:	4501                	li	a0,0
    58e0:	bf55                	j	5894 <malloc+0x98>

00000000000058e2 <statistics>:
#include "kernel/fcntl.h"
#include "user/user.h"
...
{
    58e2:	7179                	addi	sp,sp,-48
    58e4:	f406                	sd	ra,40(sp)
    58e6:	f022                	sd	s0,32(sp)
    58e8:	ec26                	sd	s1,24(sp)
    58ea:	e84a                	sd	s2,16(sp)
    58ec:	e44e                	sd	s3,8(sp)
    58ee:	e052                	sd	s4,0(sp)
    58f0:	1800                	addi	s0,sp,48
    58f2:	8a2a                	mv	s4,a0
    58f4:	892e                	mv	s2,a1
  int fd, i, n;
  ...
  fd = open("statistics", O_RDONLY);
    58f6:	4581                	li	a1,0
    58f8:	00002517          	auipc	a0,0x2
    58fc:	6d850513          	addi	a0,a0,1752 # 7fd0 <digits+0x20>
    5900:	00000097          	auipc	ra,0x0
    5904:	b04080e7          	jalr	-1276(ra) # 5404 <open>
  if(fd < 0) {
    5908:	04054263          	bltz	a0,594c <statistics+0x6a>
    590c:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
    590e:	4481                	li	s1,0
    5910:	03205063          	blez	s2,5930 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
    5914:	4099063b          	subw	a2,s2,s1
    5918:	009a05b3          	add	a1,s4,s1
    591c:	854e                	mv	a0,s3
    591e:	00000097          	auipc	ra,0x0
    5922:	abe080e7          	jalr	-1346(ra) # 53dc <read>
    5926:	00054563          	bltz	a0,5930 <statistics+0x4e>
      break;
    }
    i += n;
    592a:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
    592c:	ff24c4e3          	blt	s1,s2,5914 <statistics+0x32>
  }
  close(fd);
    5930:	854e                	mv	a0,s3
    5932:	00000097          	auipc	ra,0x0
    5936:	aba080e7          	jalr	-1350(ra) # 53ec <close>
  return i;
}
    593a:	8526                	mv	a0,s1
    593c:	70a2                	ld	ra,40(sp)
    593e:	7402                	ld	s0,32(sp)
    5940:	64e2                	ld	s1,24(sp)
    5942:	6942                	ld	s2,16(sp)
    5944:	69a2                	ld	s3,8(sp)
    5946:	6a02                	ld	s4,0(sp)
    5948:	6145                	addi	sp,sp,48
    594a:	8082                	ret
      fprintf(2, "stats: open failed\n");
    594c:	00002597          	auipc	a1,0x2
    5950:	69458593          	addi	a1,a1,1684 # 7fe0 <digits+0x30>
    5954:	4509                	li	a0,2
    5956:	00000097          	auipc	ra,0x0
    595a:	db8080e7          	jalr	-584(ra) # 570e <fprintf>
      exit(1);
    595e:	4505                	li	a0,1
    5960:	00000097          	auipc	ra,0x0
    5964:	a64080e7          	jalr	-1436(ra) # 53c4 <exit>
