...
wc(int fd, char *name)
{
  ...
  3c:	998a0a13          	addi	s4,s4,-1640 # 9d0 <statistics+0x8c>
        inword = 0;
  40:	4b81                	li	s7,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  ba:	93250513          	addi	a0,a0,-1742 # 9e8 <statistics+0xa4>
  ...
  e8:	8f450513          	addi	a0,a0,-1804 # 9d8 <statistics+0x94>
...
main(int argc, char *argv[])
{
 ...
 162:	89a58593          	addi	a1,a1,-1894 # 9f8 <statistics+0xb4>
 166:	4501                	li	a0,0
 ...
 180:	88450513          	addi	a0,a0,-1916 # a00 <statistics+0xbc>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 50c:	51088893          	addi	a7,a7,1296 # a18 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5de:	43eb8b93          	addi	s7,s7,1086 # a18 <digits>
 ...
 71a:	31a48493          	addi	s1,s1,794 # a30 <digits+0x18>
        while(*s != 0){
...
free(void *ap)
{
 ...
 7e2:	28278793          	addi	a5,a5,642 # a60 <__bss_start>
 7e6:	639c                	ld	a5,0(a5)
 ...
 812:	00e6ea63          	bltu	a3,a4,826 <free+0x52>
{
 ...
 854:	20f73823          	sd	a5,528(a4) # a60 <__bss_start>
}
 858:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 88a:	1da78793          	addi	a5,a5,474 # a60 <__bss_start>
 88e:	6388                	ld	a0,0(a5)
 ...
 8b4:	1b048493          	addi	s1,s1,432 # a60 <__bss_start>
  if(p == (char*)-1)
 8b8:	5b7d                	li	s6,-1
 8ba:	a885                	j	92a <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
 8bc:	00000797          	auipc	a5,0x0
 8c0:	3ac78793          	addi	a5,a5,940 # c68 <base>
 8c4:	00000717          	auipc	a4,0x0
 8c8:	18f73e23          	sd	a5,412(a4) # a60 <__bss_start>
 8cc:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8ee:	16a73b23          	sd	a0,374(a4) # a60 <__bss_start>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 95e:	0de50513          	addi	a0,a0,222 # a38 <digits+0x20>
 962:	00000097          	auipc	ra,0x0
 966:	b04080e7          	jalr	-1276(ra) # 466 <open>
  if(fd < 0) {
 96a:	04054263          	bltz	a0,9ae <statistics+0x6a>
 96e:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 970:	4481                	li	s1,0
 972:	03205063          	blez	s2,992 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 976:	4099063b          	subw	a2,s2,s1
 97a:	009a05b3          	add	a1,s4,s1
 97e:	854e                	mv	a0,s3
 980:	00000097          	auipc	ra,0x0
 984:	abe080e7          	jalr	-1346(ra) # 43e <read>
 988:	00054563          	bltz	a0,992 <statistics+0x4e>
      break;
    }
    i += n;
 98c:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 98e:	ff24c4e3          	blt	s1,s2,976 <statistics+0x32>
  }
  close(fd);
 992:	854e                	mv	a0,s3
 994:	00000097          	auipc	ra,0x0
 998:	aba080e7          	jalr	-1350(ra) # 44e <close>
  return i;
}
 99c:	8526                	mv	a0,s1
 99e:	70a2                	ld	ra,40(sp)
 9a0:	7402                	ld	s0,32(sp)
 9a2:	64e2                	ld	s1,24(sp)
 ...
 9ac:	8082                	ret
      fprintf(2, "stats: open failed\n");
 9ae:	00000597          	auipc	a1,0x0
 9b2:	09a58593          	addi	a1,a1,154 # a48 <digits+0x30>
 9b6:	4509                	li	a0,2
 9b8:	00000097          	auipc	ra,0x0
 9bc:	db8080e7          	jalr	-584(ra) # 770 <fprintf>
      exit(1);
 9c0:	4505                	li	a0,1
 9c2:	00000097          	auipc	ra,0x0
 9c6:	a64080e7          	jalr	-1436(ra) # 426 <exit>
