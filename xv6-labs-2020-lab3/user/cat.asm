...
cat(int fd)
{
  ...
  44:	91058593          	addi	a1,a1,-1776 # 950 <statistics+0x88>
  48:	4509                	li	a0,2
  ...
  72:	8fa58593          	addi	a1,a1,-1798 # 968 <statistics+0xa0>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 102:	88258593          	addi	a1,a1,-1918 # 980 <statistics+0xb8>
 106:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 490:	50c88893          	addi	a7,a7,1292 # 998 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 562:	43ab8b93          	addi	s7,s7,1082 # 998 <digits>
 ...
 69e:	31648493          	addi	s1,s1,790 # 9b0 <digits+0x18>
        while(*s != 0){
...
free(void *ap)
{
 ...
 766:	27e78793          	addi	a5,a5,638 # 9e0 <__bss_start>
 76a:	639c                	ld	a5,0(a5)
 ...
 796:	00e6ea63          	bltu	a3,a4,7aa <free+0x52>
{
 ...
 7d8:	20f73623          	sd	a5,524(a4) # 9e0 <__bss_start>
}
 7dc:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 80e:	1d678793          	addi	a5,a5,470 # 9e0 <__bss_start>
 812:	6388                	ld	a0,0(a5)
 ...
 838:	1ac48493          	addi	s1,s1,428 # 9e0 <__bss_start>
  if(p == (char*)-1)
 83c:	5b7d                	li	s6,-1
 83e:	a885                	j	8ae <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
 840:	00000797          	auipc	a5,0x0
 844:	3a878793          	addi	a5,a5,936 # be8 <base>
 848:	00000717          	auipc	a4,0x0
 84c:	18f73c23          	sd	a5,408(a4) # 9e0 <__bss_start>
 850:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 872:	16a73923          	sd	a0,370(a4) # 9e0 <__bss_start>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 8e2:	0da50513          	addi	a0,a0,218 # 9b8 <digits+0x20>
 8e6:	00000097          	auipc	ra,0x0
 8ea:	b04080e7          	jalr	-1276(ra) # 3ea <open>
  if(fd < 0) {
 8ee:	04054263          	bltz	a0,932 <statistics+0x6a>
 8f2:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 8f4:	4481                	li	s1,0
 8f6:	03205063          	blez	s2,916 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 8fa:	4099063b          	subw	a2,s2,s1
 8fe:	009a05b3          	add	a1,s4,s1
 902:	854e                	mv	a0,s3
 904:	00000097          	auipc	ra,0x0
 908:	abe080e7          	jalr	-1346(ra) # 3c2 <read>
 90c:	00054563          	bltz	a0,916 <statistics+0x4e>
      break;
    }
    i += n;
 910:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 912:	ff24c4e3          	blt	s1,s2,8fa <statistics+0x32>
  }
  close(fd);
 916:	854e                	mv	a0,s3
 918:	00000097          	auipc	ra,0x0
 91c:	aba080e7          	jalr	-1350(ra) # 3d2 <close>
  return i;
}
 920:	8526                	mv	a0,s1
 ...
 930:	8082                	ret
      fprintf(2, "stats: open failed\n");
 932:	00000597          	auipc	a1,0x0
 936:	09658593          	addi	a1,a1,150 # 9c8 <digits+0x30>
 93a:	4509                	li	a0,2
 93c:	00000097          	auipc	ra,0x0
 940:	db8080e7          	jalr	-584(ra) # 6f4 <fprintf>
      exit(1);
 944:	4505                	li	a0,1
 946:	00000097          	auipc	ra,0x0
 94a:	a64080e7          	jalr	-1436(ra) # 3aa <exit>
