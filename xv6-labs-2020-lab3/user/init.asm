...
main(void)
{
  ...
  12:	93250513          	addi	a0,a0,-1742 # 940 <statistics+0x86>
  16:	00000097          	auipc	ra,0x0
  1a:	3c6080e7          	jalr	966(ra) # 3dc <open>
  ...
  28:	3f0080e7          	jalr	1008(ra) # 414 <dup>
  dup(0);  // stderr
  2c:	4501                	li	a0,0
  2e:	00000097          	auipc	ra,0x0
  32:	3e6080e7          	jalr	998(ra) # 414 <dup>

  for(;;){
    printf("init: starting sh\n");
  36:	00001917          	auipc	s2,0x1
  3a:	92290913          	addi	s2,s2,-1758 # 958 <statistics+0x9e>
  3e:	854a                	mv	a0,s2
  40:	00000097          	auipc	ra,0x0
  44:	6d4080e7          	jalr	1748(ra) # 714 <printf>
    pid = fork();
  48:	00000097          	auipc	ra,0x0
  4c:	34c080e7          	jalr	844(ra) # 394 <fork>
  50:	84aa                	mv	s1,a0
    if(pid < 0){
  ...
  5e:	34a080e7          	jalr	842(ra) # 3a4 <wait>
      if(wpid == pid){
  ...
  6e:	93e50513          	addi	a0,a0,-1730 # 9a8 <statistics+0xee>
  72:	00000097          	auipc	ra,0x0
  76:	6a2080e7          	jalr	1698(ra) # 714 <printf>
        exit(1);
  7a:	4505                	li	a0,1
  7c:	00000097          	auipc	ra,0x0
  80:	320080e7          	jalr	800(ra) # 39c <exit>
    mknod("console", CONSOLE, 0);
  84:	4601                	li	a2,0
  86:	4585                	li	a1,1
  88:	00001517          	auipc	a0,0x1
  8c:	8b850513          	addi	a0,a0,-1864 # 940 <statistics+0x86>
  90:	00000097          	auipc	ra,0x0
  94:	354080e7          	jalr	852(ra) # 3e4 <mknod>
    mknod("statistics", STATS, 0);
  98:	4601                	li	a2,0
  9a:	4589                	li	a1,2
  9c:	00001517          	auipc	a0,0x1
  a0:	8ac50513          	addi	a0,a0,-1876 # 948 <statistics+0x8e>
  a4:	00000097          	auipc	ra,0x0
  a8:	340080e7          	jalr	832(ra) # 3e4 <mknod>
    open("console", O_RDWR);
  ac:	4589                	li	a1,2
  ae:	00001517          	auipc	a0,0x1
  b2:	89250513          	addi	a0,a0,-1902 # 940 <statistics+0x86>
  b6:	00000097          	auipc	ra,0x0
  ba:	326080e7          	jalr	806(ra) # 3dc <open>
  be:	b795                	j	22 <main+0x22>
      printf("init: fork failed\n");
  c0:	00001517          	auipc	a0,0x1
  c4:	8b050513          	addi	a0,a0,-1872 # 970 <statistics+0xb6>
  c8:	00000097          	auipc	ra,0x0
  cc:	64c080e7          	jalr	1612(ra) # 714 <printf>
      exit(1);
  d0:	4505                	li	a0,1
  d2:	00000097          	auipc	ra,0x0
  d6:	2ca080e7          	jalr	714(ra) # 39c <exit>
      exec("sh", argv);
  da:	00001597          	auipc	a1,0x1
  de:	92658593          	addi	a1,a1,-1754 # a00 <argv>
  e2:	00001517          	auipc	a0,0x1
  e6:	8a650513          	addi	a0,a0,-1882 # 988 <statistics+0xce>
  ea:	00000097          	auipc	ra,0x0
  ee:	2ea080e7          	jalr	746(ra) # 3d4 <exec>
      printf("init: exec sh failed\n");
  f2:	00001517          	auipc	a0,0x1
  f6:	89e50513          	addi	a0,a0,-1890 # 990 <statistics+0xd6>
  fa:	00000097          	auipc	ra,0x0
  fe:	61a080e7          	jalr	1562(ra) # 714 <printf>
      exit(1);
 102:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 482:	54a88893          	addi	a7,a7,1354 # 9c8 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 554:	478b8b93          	addi	s7,s7,1144 # 9c8 <digits>
 ...
 690:	35448493          	addi	s1,s1,852 # 9e0 <digits+0x18>
        while(*s != 0){
...
free(void *ap)
{
 ...
 758:	2bc78793          	addi	a5,a5,700 # a10 <_edata>
 75c:	639c                	ld	a5,0(a5)
 ...
 788:	00e6ea63          	bltu	a3,a4,79c <free+0x52>
{
 ...
 7ca:	24f73523          	sd	a5,586(a4) # a10 <_edata>
}
 7ce:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 800:	21478793          	addi	a5,a5,532 # a10 <_edata>
 804:	6388                	ld	a0,0(a5)
 ...
 82a:	1ea48493          	addi	s1,s1,490 # a10 <_edata>
  if(p == (char*)-1)
 82e:	5b7d                	li	s6,-1
 830:	a885                	j	8a0 <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
 832:	00000797          	auipc	a5,0x0
 836:	1e678793          	addi	a5,a5,486 # a18 <base>
 83a:	00000717          	auipc	a4,0x0
 83e:	1cf73b23          	sd	a5,470(a4) # a10 <_edata>
 842:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 864:	1aa73823          	sd	a0,432(a4) # a10 <_edata>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 8d4:	07850513          	addi	a0,a0,120 # 948 <statistics+0x8e>
 ...
 928:	0c458593          	addi	a1,a1,196 # 9e8 <digits+0x20>
 92c:	4509                	li	a0,2
