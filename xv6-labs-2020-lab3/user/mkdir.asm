...
main(int argc, char *argv[])
{
  ...
  42:	87258593          	addi	a1,a1,-1934 # 8b0 <statistics+0x8a>
  46:	4509                	li	a0,2
  ...
  60:	86c58593          	addi	a1,a1,-1940 # 8c8 <statistics+0xa2>
  64:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ee:	4fe88893          	addi	a7,a7,1278 # 8e8 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c0:	42cb8b93          	addi	s7,s7,1068 # 8e8 <digits>
 ...
 5fc:	30848493          	addi	s1,s1,776 # 900 <digits+0x18>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c4:	27078793          	addi	a5,a5,624 # 930 <__bss_start>
 6c8:	639c                	ld	a5,0(a5)
 ...
 6f4:	00e6ea63          	bltu	a3,a4,708 <free+0x52>
{
 ...
 736:	1ef73f23          	sd	a5,510(a4) # 930 <__bss_start>
}
 73a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 76c:	1c878793          	addi	a5,a5,456 # 930 <__bss_start>
 770:	6388                	ld	a0,0(a5)
 ...
 796:	19e48493          	addi	s1,s1,414 # 930 <__bss_start>
  if(p == (char*)-1)
 79a:	5b7d                	li	s6,-1
 79c:	a885                	j	80c <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
 79e:	00000797          	auipc	a5,0x0
 7a2:	19a78793          	addi	a5,a5,410 # 938 <base>
 7a6:	00000717          	auipc	a4,0x0
 7aa:	18f73523          	sd	a5,394(a4) # 930 <__bss_start>
 7ae:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7d0:	16a73223          	sd	a0,356(a4) # 930 <__bss_start>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 840:	0cc50513          	addi	a0,a0,204 # 908 <digits+0x20>
 844:	00000097          	auipc	ra,0x0
 848:	b04080e7          	jalr	-1276(ra) # 348 <open>
  if(fd < 0) {
 84c:	04054263          	bltz	a0,890 <statistics+0x6a>
 850:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 852:	4481                	li	s1,0
 854:	03205063          	blez	s2,874 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 858:	4099063b          	subw	a2,s2,s1
 85c:	009a05b3          	add	a1,s4,s1
 860:	854e                	mv	a0,s3
 862:	00000097          	auipc	ra,0x0
 866:	abe080e7          	jalr	-1346(ra) # 320 <read>
 86a:	00054563          	bltz	a0,874 <statistics+0x4e>
      break;
    }
    i += n;
 86e:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 870:	ff24c4e3          	blt	s1,s2,858 <statistics+0x32>
  }
  close(fd);
 874:	854e                	mv	a0,s3
 876:	00000097          	auipc	ra,0x0
 87a:	aba080e7          	jalr	-1350(ra) # 330 <close>
  return i;
}
 87e:	8526                	mv	a0,s1
 ...
 894:	08858593          	addi	a1,a1,136 # 918 <digits+0x30>
 898:	4509                	li	a0,2
 89a:	00000097          	auipc	ra,0x0
 89e:	db8080e7          	jalr	-584(ra) # 652 <fprintf>
      exit(1);
 8a2:	4505                	li	a0,1
 8a4:	00000097          	auipc	ra,0x0
 8a8:	a64080e7          	jalr	-1436(ra) # 308 <exit>
