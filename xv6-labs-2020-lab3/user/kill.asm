...
main(int argc, char **argv)
{
  ...
  4c:	85058593          	addi	a1,a1,-1968 # 898 <statistics+0x86>
  50:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3da:	4da88893          	addi	a7,a7,1242 # 8b0 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ac:	408b8b93          	addi	s7,s7,1032 # 8b0 <digits>
 ...
 5e8:	2e448493          	addi	s1,s1,740 # 8c8 <digits+0x18>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b0:	24c78793          	addi	a5,a5,588 # 8f8 <__bss_start>
 6b4:	639c                	ld	a5,0(a5)
 ...
 6e0:	00e6ea63          	bltu	a3,a4,6f4 <free+0x52>
{
 ...
 722:	1cf73d23          	sd	a5,474(a4) # 8f8 <__bss_start>
}
 726:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 758:	1a478793          	addi	a5,a5,420 # 8f8 <__bss_start>
 75c:	6388                	ld	a0,0(a5)
 ...
 782:	17a48493          	addi	s1,s1,378 # 8f8 <__bss_start>
  if(p == (char*)-1)
 786:	5b7d                	li	s6,-1
 788:	a885                	j	7f8 <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
 78a:	00000797          	auipc	a5,0x0
 78e:	17678793          	addi	a5,a5,374 # 900 <base>
 792:	00000717          	auipc	a4,0x0
 796:	16f73323          	sd	a5,358(a4) # 8f8 <__bss_start>
 79a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7bc:	14a73023          	sd	a0,320(a4) # 8f8 <__bss_start>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 82c:	0a850513          	addi	a0,a0,168 # 8d0 <digits+0x20>
 830:	00000097          	auipc	ra,0x0
 834:	b04080e7          	jalr	-1276(ra) # 334 <open>
  if(fd < 0) {
 838:	04054263          	bltz	a0,87c <statistics+0x6a>
 83c:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 83e:	4481                	li	s1,0
 840:	03205063          	blez	s2,860 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 844:	4099063b          	subw	a2,s2,s1
 848:	009a05b3          	add	a1,s4,s1
 84c:	854e                	mv	a0,s3
 84e:	00000097          	auipc	ra,0x0
 852:	abe080e7          	jalr	-1346(ra) # 30c <read>
 856:	00054563          	bltz	a0,860 <statistics+0x4e>
      break;
    }
    i += n;
 85a:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 85c:	ff24c4e3          	blt	s1,s2,844 <statistics+0x32>
  }
  close(fd);
 860:	854e                	mv	a0,s3
 862:	00000097          	auipc	ra,0x0
 866:	aba080e7          	jalr	-1350(ra) # 31c <close>
  return i;
}
 86a:	8526                	mv	a0,s1
 ...
 87a:	8082                	ret
      fprintf(2, "stats: open failed\n");
 87c:	00000597          	auipc	a1,0x0
 880:	06458593          	addi	a1,a1,100 # 8e0 <digits+0x30>
 884:	4509                	li	a0,2
 886:	00000097          	auipc	ra,0x0
 88a:	db8080e7          	jalr	-584(ra) # 63e <fprintf>
      exit(1);
 88e:	4505                	li	a0,1
 890:	00000097          	auipc	ra,0x0
 894:	a64080e7          	jalr	-1436(ra) # 2f4 <exit>
