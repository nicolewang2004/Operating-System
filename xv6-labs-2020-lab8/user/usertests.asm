...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	f9a50513          	addi	a0,a0,-102 # 5fd8 <statistics+0x45a>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
    if(uninit[i] != '\0'){
      ...
      5c:	4387c783          	lbu	a5,1080(a5) # 9490 <uninit>
      60:	e385                	bnez	a5,80 <bsstest+0x28>
      62:	00009797          	auipc	a5,0x9
      66:	42f78793          	addi	a5,a5,1071 # 9491 <uninit+0x1>
      6a:	0000c697          	auipc	a3,0xc
      6e:	b3668693          	addi	a3,a3,-1226 # bba0 <buf>
      ...
      7e:	8082                	ret
{
      ...
      8e:	f6e50513          	addi	a0,a0,-146 # 5ff8 <statistics+0x47a>
...
00000000000000a4 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      b6:	f5e50513          	addi	a0,a0,-162 # 6010 <statistics+0x492>
  ...
  fd = open("doesnotexist", 0);
      ...
      d4:	f6050513          	addi	a0,a0,-160 # 6030 <statistics+0x4b2>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f4:	f2850513          	addi	a0,a0,-216 # 6018 <statistics+0x49a>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     110:	f3450513          	addi	a0,a0,-204 # 6040 <statistics+0x4c2>
...
0000000000000126 <truncate2>:
{
  ...
  int n = write(fd1, "x", 1);
     ...
     18a:	efa58593          	addi	a1,a1,-262 # 6080 <statistics+0x502>
     18e:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     1a2:	eca50513          	addi	a0,a0,-310 # 6068 <statistics+0x4ea>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1d8:	eb450513          	addi	a0,a0,-332 # 6088 <statistics+0x50a>
...
000000000000026e <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     28a:	e2a50513          	addi	a0,a0,-470 # 60b0 <statistics+0x532>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     29e:	e16a0a13          	addi	s4,s4,-490 # 60b0 <statistics+0x532>
      int cc = write(fd, buf, sz);
     2a2:	0000c997          	auipc	s3,0xc
     2a6:	8fe98993          	addi	s3,s3,-1794 # bba0 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2aa:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     320:	da450513          	addi	a0,a0,-604 # 60c0 <statistics+0x542>
     ...
     344:	da050513          	addi	a0,a0,-608 # 60e0 <statistics+0x562>
...
000000000000035a <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     386:	d76a0a13          	addi	s4,s4,-650 # 60f8 <statistics+0x57a>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     430:	cd450513          	addi	a0,a0,-812 # 6100 <statistics+0x582>
     ...
     44e:	cce50513          	addi	a0,a0,-818 # 6118 <statistics+0x59a>
     ...
     46c:	ce050513          	addi	a0,a0,-800 # 6148 <statistics+0x5ca>
     ...
     486:	cf650513          	addi	a0,a0,-778 # 6178 <statistics+0x5fa>
     ...
     4a4:	ce850513          	addi	a0,a0,-792 # 6188 <statistics+0x60a>
...
00000000000004ba <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4e8:	cd4a0a13          	addi	s4,s4,-812 # 61b8 <statistics+0x63a>
    n = write(fds[1], "x", 1);
     4ec:	00006a97          	auipc	s5,0x6
     4f0:	b94a8a93          	addi	s5,s5,-1132 # 6080 <statistics+0x502>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     594:	c3050513          	addi	a0,a0,-976 # 61c0 <statistics+0x642>
     ...
     5b2:	c2a50513          	addi	a0,a0,-982 # 61d8 <statistics+0x65a>
     ...
     5cc:	bb050513          	addi	a0,a0,-1104 # 6178 <statistics+0x5fa>
     ...
     5e6:	c2650513          	addi	a0,a0,-986 # 6208 <statistics+0x68a>
     ...
     604:	c2050513          	addi	a0,a0,-992 # 6220 <statistics+0x6a2>
...
000000000000061a <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     65a:	a2258593          	addi	a1,a1,-1502 # 6078 <statistics+0x4fa>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     676:	9f650513          	addi	a0,a0,-1546 # 6068 <statistics+0x4ea>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     6a2:	9ca50513          	addi	a0,a0,-1590 # 6068 <statistics+0x4ea>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6b6:	9b650513          	addi	a0,a0,-1610 # 6068 <statistics+0x4ea>
  ...
  write(fd1, "abcdef", 6);
     ...
     6f4:	bc058593          	addi	a1,a1,-1088 # 62b0 <statistics+0x732>
     6f8:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     736:	93650513          	addi	a0,a0,-1738 # 6068 <statistics+0x4ea>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     77a:	ada50513          	addi	a0,a0,-1318 # 6250 <statistics+0x6d2>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     796:	ade50513          	addi	a0,a0,-1314 # 6270 <statistics+0x6f2>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     7aa:	ada50513          	addi	a0,a0,-1318 # 6280 <statistics+0x702>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7c6:	ade50513          	addi	a0,a0,-1314 # 62a0 <statistics+0x722>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     7da:	aaa50513          	addi	a0,a0,-1366 # 6280 <statistics+0x702>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7f8:	ac450513          	addi	a0,a0,-1340 # 62b8 <statistics+0x73a>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     816:	ac650513          	addi	a0,a0,-1338 # 62d8 <statistics+0x75a>
...
000000000000082c <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     84a:	ab250513          	addi	a0,a0,-1358 # 62f8 <statistics+0x77a>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     862:	ac298993          	addi	s3,s3,-1342 # 6320 <statistics+0x7a2>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     866:	00006a97          	auipc	s5,0x6
     86a:	af2a8a93          	addi	s5,s5,-1294 # 6358 <statistics+0x7da>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8b0:	a4c50513          	addi	a0,a0,-1460 # 62f8 <statistics+0x77a>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8ca:	2da58593          	addi	a1,a1,730 # bba0 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8ec:	a1050513          	addi	a0,a0,-1520 # 62f8 <statistics+0x77a>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     916:	9ee50513          	addi	a0,a0,-1554 # 6300 <statistics+0x782>
    ...
    exit(1);
     ...
     934:	a0050513          	addi	a0,a0,-1536 # 6330 <statistics+0x7b2>
     ...
     952:	a1a50513          	addi	a0,a0,-1510 # 6368 <statistics+0x7ea>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     96e:	a2650513          	addi	a0,a0,-1498 # 6390 <statistics+0x812>
    ...
    printf("%s: read failed\n", s);
     ...
     98a:	a2a50513          	addi	a0,a0,-1494 # 63b0 <statistics+0x832>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9a6:	a2650513          	addi	a0,a0,-1498 # 63c8 <statistics+0x84a>
...
00000000000009bc <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9d8:	a1450513          	addi	a0,a0,-1516 # 63e8 <statistics+0x86a>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9ec:	1b890913          	addi	s2,s2,440 # bba0 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a2a:	9c250513          	addi	a0,a0,-1598 # 63e8 <statistics+0x86a>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a3e:	16690913          	addi	s2,s2,358 # bba0 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a72:	98250513          	addi	a0,a0,-1662 # 63f0 <statistics+0x872>
    ...
    exit(1);
     ...
     a90:	98450513          	addi	a0,a0,-1660 # 6410 <statistics+0x892>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     aac:	99050513          	addi	a0,a0,-1648 # 6438 <statistics+0x8ba>
  ...
  if(unlink("big") < 0){
     ...
     ad8:	91450513          	addi	a0,a0,-1772 # 63e8 <statistics+0x86a>
     ...
     b04:	95850513          	addi	a0,a0,-1704 # 6458 <statistics+0x8da>
     ...
     b22:	96250513          	addi	a0,a0,-1694 # 6480 <statistics+0x902>
     ...
     b40:	95c50513          	addi	a0,a0,-1700 # 6498 <statistics+0x91a>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b5c:	96850513          	addi	a0,a0,-1688 # 64c0 <statistics+0x942>
...
0000000000000b72 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b8a:	95250513          	addi	a0,a0,-1710 # 64d8 <statistics+0x95a>
  ...
  write(fd, "hello", SZ);
     ...
     ba2:	96a58593          	addi	a1,a1,-1686 # 6508 <statistics+0x98a>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bbe:	91e50513          	addi	a0,a0,-1762 # 64d8 <statistics+0x95a>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bd4:	90850513          	addi	a0,a0,-1784 # 64d8 <statistics+0x95a>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bea:	8f250513          	addi	a0,a0,-1806 # 64d8 <statistics+0x95a>
  ...
  write(fd1, "yyy", 3);
     ...
     bfe:	95658593          	addi	a1,a1,-1706 # 6550 <statistics+0x9d2>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c1a:	f8a58593          	addi	a1,a1,-118 # bba0 <buf>
     c1e:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c66:	87650513          	addi	a0,a0,-1930 # 64d8 <statistics+0x95a>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c86:	86650513          	addi	a0,a0,-1946 # 64e8 <statistics+0x96a>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     ca2:	87250513          	addi	a0,a0,-1934 # 6510 <statistics+0x992>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cbe:	87650513          	addi	a0,a0,-1930 # 6530 <statistics+0x9b2>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cda:	88250513          	addi	a0,a0,-1918 # 6558 <statistics+0x9da>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     cf6:	88650513          	addi	a0,a0,-1914 # 6578 <statistics+0x9fa>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d12:	88a50513          	addi	a0,a0,-1910 # 6598 <statistics+0xa1a>
...
0000000000000d28 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d76:	79658593          	addi	a1,a1,1942 # 6508 <statistics+0x98a>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d96:	82e58593          	addi	a1,a1,-2002 # 65c0 <statistics+0xa42>
     d9a:	00006517          	auipc	a0,0x6
     d9e:	81e50513          	addi	a0,a0,-2018 # 65b8 <statistics+0xa3a>
  ...
  unlink("lf1");
     ...
     db2:	80a50513          	addi	a0,a0,-2038 # 65b8 <statistics+0xa3a>
     db6:	00005097          	auipc	ra,0x5
     dba:	8fa080e7          	jalr	-1798(ra) # 56b0 <unlink>
  if(open("lf1", 0) >= 0){
     dbe:	4581                	li	a1,0
     dc0:	00005517          	auipc	a0,0x5
     dc4:	7f850513          	addi	a0,a0,2040 # 65b8 <statistics+0xa3a>
  ...
  fd = open("lf2", 0);
     ...
     dda:	7ea50513          	addi	a0,a0,2026 # 65c0 <statistics+0xa42>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     df2:	db258593          	addi	a1,a1,-590 # bba0 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e12:	7b258593          	addi	a1,a1,1970 # 65c0 <statistics+0xa42>
     e16:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e28:	79c50513          	addi	a0,a0,1948 # 65c0 <statistics+0xa42>
     e2c:	00005097          	auipc	ra,0x5
     e30:	884080e7          	jalr	-1916(ra) # 56b0 <unlink>
  if(link("lf2", "lf1") >= 0){
     e34:	00005597          	auipc	a1,0x5
     e38:	78458593          	addi	a1,a1,1924 # 65b8 <statistics+0xa3a>
     e3c:	00005517          	auipc	a0,0x5
     e40:	78450513          	addi	a0,a0,1924 # 65c0 <statistics+0xa42>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e54:	76858593          	addi	a1,a1,1896 # 65b8 <statistics+0xa3a>
     e58:	00006517          	auipc	a0,0x6
     e5c:	87050513          	addi	a0,a0,-1936 # 66c8 <statistics+0xb4a>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e7e:	74e50513          	addi	a0,a0,1870 # 65c8 <statistics+0xa4a>
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e9a:	74a50513          	addi	a0,a0,1866 # 65e0 <statistics+0xa62>
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     eb6:	74650513          	addi	a0,a0,1862 # 65f8 <statistics+0xa7a>
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ed2:	74a50513          	addi	a0,a0,1866 # 6618 <statistics+0xa9a>
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     eee:	75e50513          	addi	a0,a0,1886 # 6648 <statistics+0xaca>
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     f0a:	75a50513          	addi	a0,a0,1882 # 6660 <statistics+0xae2>
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f26:	75650513          	addi	a0,a0,1878 # 6678 <statistics+0xafa>
    ...
    printf("%s: link non-existant succeeded! oops\n", s);
     ...
     f42:	76250513          	addi	a0,a0,1890 # 66a0 <statistics+0xb22>
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f5e:	77650513          	addi	a0,a0,1910 # 66d0 <statistics+0xb52>
...
0000000000000f74 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fc4:	730a0a13          	addi	s4,s4,1840 # 66f0 <statistics+0xb72>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1016:	6de50513          	addi	a0,a0,1758 # 66f0 <statistics+0xb72>
  ...
  for(i = 0; i < N; i++){
    ...
    1086:	67650513          	addi	a0,a0,1654 # 66f8 <statistics+0xb7a>
    ...
    10a6:	67650513          	addi	a0,a0,1654 # 6718 <statistics+0xb9a>
    ...
    10c2:	67a50513          	addi	a0,a0,1658 # 6738 <statistics+0xbba>
...
00000000000010d8 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10f4:	66898993          	addi	s3,s3,1640 # 6758 <statistics+0xbda>
    10f8:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1130:	63c50513          	addi	a0,a0,1596 # 6768 <statistics+0xbea>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1158:	21c78793          	addi	a5,a5,540 # 8370 <digits+0x48>
...
badarg(char *s)
{
    ...
    1190:	35048493          	addi	s1,s1,848 # c350 <buf+0x7b0>
  for(int i = 0; i < 50000; i++){
    ...
    119e:	e7698993          	addi	s3,s3,-394 # 6010 <statistics+0x492>
    argv[0] = (char*)0xffffffff;
...
00000000000011c6 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1228:	72478793          	addi	a5,a5,1828 # 7948 <statistics+0x1dca>
  ...
  if(pid == 0){
    ...
    125e:	22e78793          	addi	a5,a5,558 # 8488 <big.1288>
    1262:	00008697          	auipc	a3,0x8
    1266:	22668693          	addi	a3,a3,550 # 9488 <__global_pointer$+0x918>
      big[i] = 'x';
    ...
    127c:	20078823          	sb	zero,528(a5) # 9488 <__global_pointer$+0x918>
    char *args2[] = { big, big, big, 0 };
    1280:	00005797          	auipc	a5,0x5
    1284:	98878793          	addi	a5,a5,-1656 # 5c08 <statistics+0x8a>
    ...
    12a8:	d6c50513          	addi	a0,a0,-660 # 6010 <statistics+0x492>
    ...
    12c0:	55450513          	addi	a0,a0,1364 # 6810 <statistics+0xc92>
    ...
    12e0:	4ac50513          	addi	a0,a0,1196 # 6788 <statistics+0xc0a>
    ...
    1300:	4ac50513          	addi	a0,a0,1196 # 67a8 <statistics+0xc2a>
    ...
    1322:	4aa50513          	addi	a0,a0,1194 # 67c8 <statistics+0xc4a>
    ...
    1342:	4b250513          	addi	a0,a0,1202 # 67f0 <statistics+0xc72>
    ...
    135c:	91850513          	addi	a0,a0,-1768 # 6c70 <statistics+0x10f2>
  ...
  if(st != 747){
    ...
    13a6:	49650513          	addi	a0,a0,1174 # 6838 <statistics+0xcba>
...
00000000000013bc <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13d8:	c9450513          	addi	a0,a0,-876 # 6068 <statistics+0x4ea>
  ...
  if(pid == 0){
    ...
    1402:	c6a98993          	addi	s3,s3,-918 # 6068 <statistics+0x4ea>
      int n = write(fd, "1234567890", 10);
    1406:	00005a97          	auipc	s5,0x5
    140a:	492a8a93          	addi	s5,s5,1170 # 6898 <statistics+0xd1a>
      int fd = open("truncfile", O_WRONLY);
    140e:	4585                	li	a1,1
    1410:	854e                	mv	a0,s3
    ...
    147a:	3f250513          	addi	a0,a0,1010 # 6868 <statistics+0xcea>
    ...
    1496:	3ee50513          	addi	a0,a0,1006 # 6880 <statistics+0xd02>
    ...
    14b4:	3f850513          	addi	a0,a0,1016 # 68a8 <statistics+0xd2a>
    ...
    14d2:	b9a98993          	addi	s3,s3,-1126 # 6068 <statistics+0x4ea>
    int n = write(fd, "xxx", 3);
    14d6:	00005a97          	auipc	s5,0x5
    14da:	3f2a8a93          	addi	s5,s5,1010 # 68c8 <statistics+0xd4a>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1524:	b4850513          	addi	a0,a0,-1208 # 6068 <statistics+0x4ea>
  ...
  exit(xstatus);
    ...
    1542:	34250513          	addi	a0,a0,834 # 6880 <statistics+0xd02>
    ...
    1560:	37450513          	addi	a0,a0,884 # 68d0 <statistics+0xd52>
...
0000000000001576 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1588:	a8c78793          	addi	a5,a5,-1396 # 6010 <statistics+0x492>
    158c:	fcf43023          	sd	a5,-64(s0)
    1590:	00005797          	auipc	a5,0x5
    1594:	36078793          	addi	a5,a5,864 # 68f0 <statistics+0xd72>
    1598:	fcf43423          	sd	a5,-56(s0)
    159c:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    15a0:	00005517          	auipc	a0,0x5
    15a4:	35850513          	addi	a0,a0,856 # 68f8 <statistics+0xd7a>
  ...
  if(pid == 0) {
    ...
    15d2:	32a50513          	addi	a0,a0,810 # 68f8 <statistics+0xd7a>
    ...
    15ee:	32e50513          	addi	a0,a0,814 # 6918 <statistics+0xd9a>
    ...
    160a:	26250513          	addi	a0,a0,610 # 6868 <statistics+0xcea>
    ...
    1626:	2de50513          	addi	a0,a0,734 # 6900 <statistics+0xd82>
    ...
    1644:	9d050513          	addi	a0,a0,-1584 # 6010 <statistics+0x492>
  ...
  if(xstatus != 0)
    ...
    1678:	2b450513          	addi	a0,a0,692 # 6928 <statistics+0xdaa>
    ...
    1694:	2b050513          	addi	a0,a0,688 # 6940 <statistics+0xdc2>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    16a8:	25450513          	addi	a0,a0,596 # 68f8 <statistics+0xd7a>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16d2:	ce250513          	addi	a0,a0,-798 # 63b0 <statistics+0x832>
    ...
    16ee:	19650513          	addi	a0,a0,406 # 6880 <statistics+0xd02>
  ...
  unlink("echo-ok");
    ...
    1708:	1f450513          	addi	a0,a0,500 # 68f8 <statistics+0xd7a>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1732:	22a50513          	addi	a0,a0,554 # 6958 <statistics+0xdda>
...
0000000000001752 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    179a:	40a90913          	addi	s2,s2,1034 # bba0 <buf>
      if(cc > sizeof(buf))
    ...
    17c8:	3dd70713          	addi	a4,a4,989 # bba1 <buf+0x1>
    ...
    17ee:	18650513          	addi	a0,a0,390 # 6970 <statistics+0xdf2>
    ...
    1814:	390a8a93          	addi	s5,s5,912 # bba0 <buf>
    ...
    1834:	8b56                	mv	s6,s5
{
    ...
    187a:	11250513          	addi	a0,a0,274 # 6988 <statistics+0xe0a>
    ...
    1896:	10e50513          	addi	a0,a0,270 # 69a0 <statistics+0xe22>
    ...
    18da:	0e250513          	addi	a0,a0,226 # 69b8 <statistics+0xe3a>
    ...
    191a:	0c250513          	addi	a0,a0,194 # 69d8 <statistics+0xe5a>
...
0000000000001930 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    198c:	ee050513          	addi	a0,a0,-288 # 6868 <statistics+0xcea>
    ...
    19a8:	04c50513          	addi	a0,a0,76 # 69f0 <statistics+0xe72>
    ...
    19c4:	04850513          	addi	a0,a0,72 # 6a08 <statistics+0xe8a>
...
00000000000019e4 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a3c:	e3050513          	addi	a0,a0,-464 # 6868 <statistics+0xcea>
    ...
    1a60:	e0c50513          	addi	a0,a0,-500 # 6868 <statistics+0xcea>
...
0000000000001a7e <forkfork>:
{
    ...
    1ada:	f5250513          	addi	a0,a0,-174 # 6a28 <statistics+0xeaa>
    ...
    1aec:	b78080e7          	jalr	-1160(ra) # 5660 <exit>
{
    ...
    1b32:	f0a50513          	addi	a0,a0,-246 # 6a38 <statistics+0xeba>
...
0000000000001b48 <reparent2>:
{
  ...
  exit(0);
    ...
    1b80:	0f450513          	addi	a0,a0,244 # 6c70 <statistics+0x10f2>
...
0000000000001bb0 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1c1e:	05650513          	addi	a0,a0,86 # 6c70 <statistics+0x10f2>
    ...
    1c4a:	cba50513          	addi	a0,a0,-838 # 6900 <statistics+0xd82>
    ...
    1cbc:	da050513          	addi	a0,a0,-608 # 6a58 <statistics+0xeda>
    ...
    1cf0:	d8450513          	addi	a0,a0,-636 # 6a70 <statistics+0xef2>
    ...
    1d56:	d4650513          	addi	a0,a0,-698 # 6a98 <statistics+0xf1a>
...
0000000000001dd6 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1df6:	28e50513          	addi	a0,a0,654 # 6080 <statistics+0x502>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e32:	252a8a93          	addi	s5,s5,594 # 6080 <statistics+0x502>
      link("cat", "x");
    1e36:	00005b97          	auipc	s7,0x5
    1e3a:	c8ab8b93          	addi	s7,s7,-886 # 6ac0 <statistics+0xf42>
    1e3e:	a091                	j	1e82 <linkunlink+0xac>
    printf("%s: fork failed\n", s);
    1e40:	85a6                	mv	a1,s1
    1e42:	00005517          	auipc	a0,0x5
    1e46:	a2650513          	addi	a0,a0,-1498 # 6868 <statistics+0xcea>
...
0000000000001ed8 <manywrites>:
{
  ...
  exit(0);
    ...
    1f34:	d4050513          	addi	a0,a0,-704 # 6c70 <statistics+0x10f2>
    ...
    1f70:	c34a8a93          	addi	s5,s5,-972 # bba0 <buf>
    ...
    1fe4:	ae850513          	addi	a0,a0,-1304 # 6ac8 <statistics+0xf4a>
    ...
    2004:	0e050513          	addi	a0,a0,224 # 60e0 <statistics+0x562>
...
0000000000002022 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    2052:	aaa50513          	addi	a0,a0,-1366 # 6af8 <statistics+0xf7a>
  ...
  if(wait(0) != -1){
    ...
    20b4:	a3050513          	addi	a0,a0,-1488 # 6ae0 <statistics+0xf62>
    ...
    20d0:	a5450513          	addi	a0,a0,-1452 # 6b20 <statistics+0xfa2>
    ...
    20ec:	a5050513          	addi	a0,a0,-1456 # 6b38 <statistics+0xfba>
...
0000000000002102 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    211e:	35098993          	addi	s3,s3,848 # c350 <buf+0x7b0>
    2122:	1003d937          	lui	s2,0x1003d
    2126:	090e                	slli	s2,s2,0x3
    2128:	48090913          	addi	s2,s2,1152 # 1003d480 <_end+0x1002e8d0>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    216c:	70050513          	addi	a0,a0,1792 # 6868 <statistics+0xcea>
    ...
    218e:	9c650513          	addi	a0,a0,-1594 # 6b50 <statistics+0xfd2>
...
00000000000021ae <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    21be:	9b650513          	addi	a0,a0,-1610 # 6b70 <statistics+0xff2>
  ...
  fd = open("bigarg-ok", 0);
    ...
    21f0:	98450513          	addi	a0,a0,-1660 # 6b70 <statistics+0xff2>
  ...
  close(fd);
    ...
    2216:	17678793          	addi	a5,a5,374 # 8388 <args.1858>
    221a:	00006697          	auipc	a3,0x6
    221e:	26668693          	addi	a3,a3,614 # 8480 <args.1858+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    2222:	00005717          	auipc	a4,0x5
    2226:	95e70713          	addi	a4,a4,-1698 # 6b80 <statistics+0x1002>
    ...
    227a:	9ea50513          	addi	a0,a0,-1558 # 6c60 <statistics+0x10e2>
    ...
    229e:	9e650513          	addi	a0,a0,-1562 # 6c80 <statistics+0x1102>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    22f2:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <_end+0xffffffffffff0450>
    22f6:	85a6                	mv	a1,s1
    22f8:	00005517          	auipc	a0,0x5
    22fc:	9a850513          	addi	a0,a0,-1624 # 6ca0 <statistics+0x1122>
    ...
    2318:	55450513          	addi	a0,a0,1364 # 6868 <statistics+0xcea>
...
0000000000002338 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    23b6:	59678793          	addi	a5,a5,1430 # 7948 <statistics+0x1dca>
  ...
  if(ret != -1){
    ...
    23fa:	8d250513          	addi	a0,a0,-1838 # 6cc8 <statistics+0x114a>
    ...
    2418:	37450513          	addi	a0,a0,884 # 6788 <statistics+0xc0a>
    ...
    2436:	37650513          	addi	a0,a0,886 # 67a8 <statistics+0xc2a>
    ...
    2456:	37650513          	addi	a0,a0,886 # 67c8 <statistics+0xc4a>
    ...
    2474:	38050513          	addi	a0,a0,896 # 67f0 <statistics+0xc72>
...
000000000000248a <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    24c0:	84c50513          	addi	a0,a0,-1972 # 6d08 <statistics+0x118a>
  ...
  if(n >= 0){
    ...
    24e8:	862a                	mv	a2,a0
    24ea:	85a6                	mv	a1,s1
    24ec:	00005517          	auipc	a0,0x5
    24f0:	83c50513          	addi	a0,a0,-1988 # 6d28 <statistics+0x11aa>
    ...
    250a:	7ca50513          	addi	a0,a0,1994 # 6cd0 <statistics+0x1152>
    ...
    2524:	7c850513          	addi	a0,a0,1992 # 6ce8 <statistics+0x116a>
    ...
    253e:	7d650513          	addi	a0,a0,2006 # 6d10 <statistics+0x1192>
  ...
  unlink("rwsbrk");
    ...
    2562:	7aa50513          	addi	a0,a0,1962 # 6d08 <statistics+0x118a>
    2566:	00003097          	auipc	ra,0x3
    256a:	14a080e7          	jalr	330(ra) # 56b0 <unlink>
  fd = open("README", O_RDONLY);
    256e:	4581                	li	a1,0
    2570:	00004517          	auipc	a0,0x4
    2574:	c4850513          	addi	a0,a0,-952 # 61b8 <statistics+0x63a>
  ...
  if(n >= 0){
    ...
    259e:	7be50513          	addi	a0,a0,1982 # 6d58 <statistics+0x11da>
    ...
    25b8:	75c50513          	addi	a0,a0,1884 # 6d10 <statistics+0x1192>
...
00000000000025e2 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2620:	6705                	lui	a4,0x1
      *b = 99;
    2622:	00d50023          	sb	a3,0(a0) # 40000000 <_end+0x3fff1450>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    263a:	74a50513          	addi	a0,a0,1866 # 6d80 <statistics+0x1202>
  ...
  for(i = 0; i < 5000; i++){
    ...
    268e:	71650513          	addi	a0,a0,1814 # 6da0 <statistics+0x1222>
  ...
  if(c != a + 1){
    ...
    26f0:	71450513          	addi	a0,a0,1812 # 6e00 <statistics+0x1282>
    ...
    2710:	6b450513          	addi	a0,a0,1716 # 6dc0 <statistics+0x1242>
    ...
    272c:	6b850513          	addi	a0,a0,1720 # 6de0 <statistics+0x1262>
...
0000000000002768 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    27c8:	fee78fa3          	sb	a4,-1(a5) # 63fffff <_end+0x63f144f>
  a = sbrk(0);
    27cc:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    282c:	fff7c703          	lbu	a4,-1(a5) # 63fffff <_end+0x63f144f>
  ...
  if(c != a){
    ...
    2874:	5b050513          	addi	a0,a0,1456 # 6e20 <statistics+0x12a2>
    ...
    2890:	5dc50513          	addi	a0,a0,1500 # 6e68 <statistics+0x12ea>
    ...
    28b0:	5dc50513          	addi	a0,a0,1500 # 6e88 <statistics+0x130a>
    ...
    28d0:	5fc50513          	addi	a0,a0,1532 # 6ec8 <statistics+0x134a>
    ...
    28ec:	61050513          	addi	a0,a0,1552 # 6ef8 <statistics+0x137a>
    ...
    290c:	62850513          	addi	a0,a0,1576 # 6f30 <statistics+0x13b2>
...
0000000000002922 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2946:	61650513          	addi	a0,a0,1558 # 6f58 <statistics+0x13da>
    294a:	00003097          	auipc	ra,0x3
    294e:	d56080e7          	jalr	-682(ra) # 56a0 <open>
    2952:	84aa                	mv	s1,a0
  unlink("sbrk");
    2954:	00004517          	auipc	a0,0x4
    2958:	60450513          	addi	a0,a0,1540 # 6f58 <statistics+0x13da>
  ...
  if(pipe((int *) a) != 0){
    ...
    29ac:	5b850513          	addi	a0,a0,1464 # 6f60 <statistics+0x13e2>
    ...
    29c8:	5b450513          	addi	a0,a0,1460 # 6f78 <statistics+0x13fa>
    ...
    29e4:	f9050513          	addi	a0,a0,-112 # 6970 <statistics+0xdf2>
...
00000000000029fa <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a0e:	58650513          	addi	a0,a0,1414 # 6f90 <statistics+0x1412>
  ...
  close(fd);
    ...
    2a56:	e2e50513          	addi	a0,a0,-466 # 6880 <statistics+0xd02>
...
0000000000002a6c <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2aa6:	1ce50513          	addi	a0,a0,462 # 6c70 <statistics+0x10f2>
  ...
  if(pid == 0){
    ...
    2afc:	17850513          	addi	a0,a0,376 # 6c70 <statistics+0x10f2>
  ...
  if(pid == 0){
    ...
    2b5c:	11850513          	addi	a0,a0,280 # 6c70 <statistics+0x10f2>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2bc8:	0ac50513          	addi	a0,a0,172 # 6c70 <statistics+0x10f2>
    ...
    2c1c:	3f850513          	addi	a0,a0,1016 # 6010 <statistics+0x492>
    2c20:	faa43c23          	sd	a0,-72(s0)
    2c24:	00003797          	auipc	a5,0x3
    2c28:	45c78793          	addi	a5,a5,1116 # 6080 <statistics+0x502>
...
0000000000002c4a <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2c5a:	51250513          	addi	a0,a0,1298 # 7168 <statistics+0x15ea>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2c6c:	35850513          	addi	a0,a0,856 # 6fc0 <statistics+0x1442>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2c82:	39a50513          	addi	a0,a0,922 # 7018 <statistics+0x149a>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2ca0:	3f450513          	addi	a0,a0,1012 # 7090 <statistics+0x1512>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2cbc:	44850513          	addi	a0,a0,1096 # 7100 <statistics+0x1582>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2cce:	48e50513          	addi	a0,a0,1166 # 7158 <statistics+0x15da>
  ...
  unlink("12345678901234");
    ...
    2d4c:	25050513          	addi	a0,a0,592 # 6f98 <statistics+0x141a>
    ...
    2d68:	27c50513          	addi	a0,a0,636 # 6fe0 <statistics+0x1462>
    ...
    2d84:	2c850513          	addi	a0,a0,712 # 7048 <statistics+0x14ca>
    ...
    2da0:	32450513          	addi	a0,a0,804 # 70c0 <statistics+0x1542>
    ...
    2dbc:	36850513          	addi	a0,a0,872 # 7120 <statistics+0x15a2>
    ...
    2dd8:	3a450513          	addi	a0,a0,932 # 7178 <statistics+0x15fa>
...
0000000000002dee <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2dfe:	3b650513          	addi	a0,a0,950 # 71b0 <statistics+0x1632>
  ...
  if(chdir("iputdir") < 0){
    ...
    2e12:	3a250513          	addi	a0,a0,930 # 71b0 <statistics+0x1632>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2e26:	3ce50513          	addi	a0,a0,974 # 71f0 <statistics+0x1672>
  ...
  if(chdir("/") < 0){
    ...
    2e3a:	3ea50513          	addi	a0,a0,1002 # 7220 <statistics+0x16a2>
    ...
    2e5a:	36250513          	addi	a0,a0,866 # 71b8 <statistics+0x163a>
    ...
    2e76:	35e50513          	addi	a0,a0,862 # 71d0 <statistics+0x1652>
    ...
    2e92:	37250513          	addi	a0,a0,882 # 7200 <statistics+0x1682>
    ...
    2eae:	37e50513          	addi	a0,a0,894 # 7228 <statistics+0x16aa>
...
0000000000002ec4 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2ee2:	2d250513          	addi	a0,a0,722 # 71b0 <statistics+0x1632>
    ...
    2ef6:	2be50513          	addi	a0,a0,702 # 71b0 <statistics+0x1632>
    ...
    2f0a:	2ea50513          	addi	a0,a0,746 # 71f0 <statistics+0x1672>
    ...
    2f2a:	94250513          	addi	a0,a0,-1726 # 6868 <statistics+0xcea>
    ...
    2f46:	27650513          	addi	a0,a0,630 # 71b8 <statistics+0x163a>
    ...
    2f62:	2e250513          	addi	a0,a0,738 # 7240 <statistics+0x16c2>
    ...
    2f7e:	28650513          	addi	a0,a0,646 # 7200 <statistics+0x1682>
...
0000000000002fac <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    2fbc:	2a050513          	addi	a0,a0,672 # 7258 <statistics+0x16da>
  ...
  if(chdir("dir0") < 0){
    ...
    2fd0:	28c50513          	addi	a0,a0,652 # 7258 <statistics+0x16da>
  ...
  if(chdir("..") < 0){
    ...
    2fe4:	29850513          	addi	a0,a0,664 # 7278 <statistics+0x16fa>
  ...
  if(unlink("dir0") < 0){
    ...
    2ff8:	26450513          	addi	a0,a0,612 # 7258 <statistics+0x16da>
    ...
    3018:	1a450513          	addi	a0,a0,420 # 71b8 <statistics+0x163a>
    ...
    3034:	23050513          	addi	a0,a0,560 # 7260 <statistics+0x16e2>
    ...
    3050:	23450513          	addi	a0,a0,564 # 7280 <statistics+0x1702>
    ...
    306c:	23050513          	addi	a0,a0,560 # 7298 <statistics+0x171a>
...
0000000000003082 <subdir>:
{
  ...
  unlink("ff");
    ...
    3094:	35050513          	addi	a0,a0,848 # 73e0 <statistics+0x1862>
    3098:	00002097          	auipc	ra,0x2
    309c:	618080e7          	jalr	1560(ra) # 56b0 <unlink>
  if(mkdir("dd") != 0){
    30a0:	00004517          	auipc	a0,0x4
    30a4:	21050513          	addi	a0,a0,528 # 72b0 <statistics+0x1732>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    30bc:	21850513          	addi	a0,a0,536 # 72d0 <statistics+0x1752>
  ...
  write(fd, "ff", 2);
    ...
    30d4:	31058593          	addi	a1,a1,784 # 73e0 <statistics+0x1862>
  ...
  if(unlink("dd") >= 0){
    ...
    30ee:	1c650513          	addi	a0,a0,454 # 72b0 <statistics+0x1732>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3102:	22a50513          	addi	a0,a0,554 # 7328 <statistics+0x17aa>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    311a:	23a50513          	addi	a0,a0,570 # 7350 <statistics+0x17d2>
  ...
  write(fd, "FF", 2);
    ...
    3132:	25258593          	addi	a1,a1,594 # 7380 <statistics+0x1802>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    314e:	23e50513          	addi	a0,a0,574 # 7388 <statistics+0x180a>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    3166:	a3e58593          	addi	a1,a1,-1474 # bba0 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    317c:	a2874703          	lbu	a4,-1496(a4) # bba0 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3196:	24658593          	addi	a1,a1,582 # 73d8 <statistics+0x185a>
    319a:	00004517          	auipc	a0,0x4
    319e:	1b650513          	addi	a0,a0,438 # 7350 <statistics+0x17d2>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    31b2:	1a250513          	addi	a0,a0,418 # 7350 <statistics+0x17d2>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    31c8:	18c50513          	addi	a0,a0,396 # 7350 <statistics+0x17d2>
  ...
  if(chdir("dd") != 0){
    ...
    31dc:	0d850513          	addi	a0,a0,216 # 72b0 <statistics+0x1732>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    31f0:	28450513          	addi	a0,a0,644 # 7470 <statistics+0x18f2>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3204:	2a050513          	addi	a0,a0,672 # 74a0 <statistics+0x1922>
  ...
  if(chdir("./..") != 0){
    ...
    3218:	2bc50513          	addi	a0,a0,700 # 74d0 <statistics+0x1952>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    322e:	1ae50513          	addi	a0,a0,430 # 73d8 <statistics+0x185a>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    3246:	95e58593          	addi	a1,a1,-1698 # bba0 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3268:	0ec50513          	addi	a0,a0,236 # 7350 <statistics+0x17d2>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3280:	2e450513          	addi	a0,a0,740 # 7560 <statistics+0x19e2>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3298:	2fc50513          	addi	a0,a0,764 # 7590 <statistics+0x1a12>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    32b0:	00450513          	addi	a0,a0,4 # 72b0 <statistics+0x1732>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    32c6:	fee50513          	addi	a0,a0,-18 # 72b0 <statistics+0x1732>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    32dc:	fd850513          	addi	a0,a0,-40 # 72b0 <statistics+0x1732>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    32f0:	33458593          	addi	a1,a1,820 # 7620 <statistics+0x1aa2>
    32f4:	00004517          	auipc	a0,0x4
    32f8:	26c50513          	addi	a0,a0,620 # 7560 <statistics+0x19e2>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    330c:	31858593          	addi	a1,a1,792 # 7620 <statistics+0x1aa2>
    3310:	00004517          	auipc	a0,0x4
    3314:	28050513          	addi	a0,a0,640 # 7590 <statistics+0x1a12>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    3328:	0b458593          	addi	a1,a1,180 # 73d8 <statistics+0x185a>
    332c:	00004517          	auipc	a0,0x4
    3330:	fa450513          	addi	a0,a0,-92 # 72d0 <statistics+0x1752>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3344:	22050513          	addi	a0,a0,544 # 7560 <statistics+0x19e2>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    3358:	23c50513          	addi	a0,a0,572 # 7590 <statistics+0x1a12>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    336c:	07050513          	addi	a0,a0,112 # 73d8 <statistics+0x185a>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3380:	21450513          	addi	a0,a0,532 # 7590 <statistics+0x1a12>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3394:	1d050513          	addi	a0,a0,464 # 7560 <statistics+0x19e2>
  ...
  if(chdir("dd/ff") == 0){
    ...
    33a8:	f2c50513          	addi	a0,a0,-212 # 72d0 <statistics+0x1752>
  ...
  if(chdir("dd/xx") == 0){
    ...
    33bc:	3b850513          	addi	a0,a0,952 # 7770 <statistics+0x1bf2>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    33d0:	00c50513          	addi	a0,a0,12 # 73d8 <statistics+0x185a>
  ...
  if(unlink("dd/ff") != 0){
    ...
    33e4:	ef050513          	addi	a0,a0,-272 # 72d0 <statistics+0x1752>
  ...
  if(unlink("dd") == 0){
    ...
    33f8:	ebc50513          	addi	a0,a0,-324 # 72b0 <statistics+0x1732>
  ...
  if(unlink("dd/dd") < 0){
    ...
    340c:	3d850513          	addi	a0,a0,984 # 77e0 <statistics+0x1c62>
  ...
  if(unlink("dd") < 0){
    ...
    3420:	e9450513          	addi	a0,a0,-364 # 72b0 <statistics+0x1732>
    ...
    3442:	e7a50513          	addi	a0,a0,-390 # 72b8 <statistics+0x173a>
    ...
    345e:	e7e50513          	addi	a0,a0,-386 # 72d8 <statistics+0x175a>
    ...
    347a:	e8250513          	addi	a0,a0,-382 # 72f8 <statistics+0x177a>
    ...
    3496:	e9e50513          	addi	a0,a0,-354 # 7330 <statistics+0x17b2>
    ...
    34b2:	eb250513          	addi	a0,a0,-334 # 7360 <statistics+0x17e2>
    ...
    34ce:	ece50513          	addi	a0,a0,-306 # 7398 <statistics+0x181a>
    ...
    34ea:	ed250513          	addi	a0,a0,-302 # 73b8 <statistics+0x183a>
    ...
    3506:	ee650513          	addi	a0,a0,-282 # 73e8 <statistics+0x186a>
    ...
    3522:	ef250513          	addi	a0,a0,-270 # 7410 <statistics+0x1892>
    ...
    353e:	ef650513          	addi	a0,a0,-266 # 7430 <statistics+0x18b2>
    ...
    355a:	f0250513          	addi	a0,a0,-254 # 7458 <statistics+0x18da>
    ...
    3576:	f0e50513          	addi	a0,a0,-242 # 7480 <statistics+0x1902>
    ...
    3592:	f2250513          	addi	a0,a0,-222 # 74b0 <statistics+0x1932>
    ...
    35ae:	f2e50513          	addi	a0,a0,-210 # 74d8 <statistics+0x195a>
    ...
    35ca:	f2a50513          	addi	a0,a0,-214 # 74f0 <statistics+0x1972>
    ...
    35e6:	f2e50513          	addi	a0,a0,-210 # 7510 <statistics+0x1992>
    ...
    3602:	f3250513          	addi	a0,a0,-206 # 7530 <statistics+0x19b2>
    ...
    361e:	f5650513          	addi	a0,a0,-170 # 7570 <statistics+0x19f2>
    ...
    363a:	f6a50513          	addi	a0,a0,-150 # 75a0 <statistics+0x1a22>
    ...
    3656:	f6e50513          	addi	a0,a0,-146 # 75c0 <statistics+0x1a42>
    ...
    3672:	f7250513          	addi	a0,a0,-142 # 75e0 <statistics+0x1a62>
    ...
    368e:	f7650513          	addi	a0,a0,-138 # 7600 <statistics+0x1a82>
    ...
    36aa:	f8a50513          	addi	a0,a0,-118 # 7630 <statistics+0x1ab2>
    ...
    36c6:	f9650513          	addi	a0,a0,-106 # 7658 <statistics+0x1ada>
    ...
    36e2:	fa250513          	addi	a0,a0,-94 # 7680 <statistics+0x1b02>
    ...
    36fe:	fae50513          	addi	a0,a0,-82 # 76a8 <statistics+0x1b2a>
    ...
    371a:	fb250513          	addi	a0,a0,-78 # 76c8 <statistics+0x1b4a>
    ...
    3736:	fb650513          	addi	a0,a0,-74 # 76e8 <statistics+0x1b6a>
    ...
    3752:	fc250513          	addi	a0,a0,-62 # 7710 <statistics+0x1b92>
    ...
    376e:	fc650513          	addi	a0,a0,-58 # 7730 <statistics+0x1bb2>
    ...
    378a:	fca50513          	addi	a0,a0,-54 # 7750 <statistics+0x1bd2>
    ...
    37a6:	fd650513          	addi	a0,a0,-42 # 7778 <statistics+0x1bfa>
    ...
    37c2:	c5250513          	addi	a0,a0,-942 # 7410 <statistics+0x1892>
    ...
    37de:	fbe50513          	addi	a0,a0,-66 # 7798 <statistics+0x1c1a>
    ...
    37fa:	fc250513          	addi	a0,a0,-62 # 77b8 <statistics+0x1c3a>
    ...
    3816:	fd650513          	addi	a0,a0,-42 # 77e8 <statistics+0x1c6a>
    ...
    3832:	fda50513          	addi	a0,a0,-38 # 7808 <statistics+0x1c8a>
...
0000000000003848 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3858:	fcc50513          	addi	a0,a0,-52 # 7820 <statistics+0x1ca2>
  ...
  if(chdir("dots") != 0){
    ...
    386a:	fba50513          	addi	a0,a0,-70 # 7820 <statistics+0x1ca2>
  ...
  if(unlink(".") == 0){
    ...
    387c:	e5050513          	addi	a0,a0,-432 # 66c8 <statistics+0xb4a>
  ...
  if(unlink("..") == 0){
    ...
    388e:	9ee50513          	addi	a0,a0,-1554 # 7278 <statistics+0x16fa>
  ...
  if(chdir("/") != 0){
    ...
    38a0:	98450513          	addi	a0,a0,-1660 # 7220 <statistics+0x16a2>
  ...
  if(unlink("dots/.") == 0){
    ...
    38b2:	fda50513          	addi	a0,a0,-38 # 7888 <statistics+0x1d0a>
  ...
  if(unlink("dots/..") == 0){
    ...
    38c4:	ff050513          	addi	a0,a0,-16 # 78b0 <statistics+0x1d32>
  ...
  if(unlink("dots") != 0){
    ...
    38d6:	f4e50513          	addi	a0,a0,-178 # 7820 <statistics+0x1ca2>
    ...
    38f4:	f3850513          	addi	a0,a0,-200 # 7828 <statistics+0x1caa>
    ...
    3910:	f3450513          	addi	a0,a0,-204 # 7840 <statistics+0x1cc2>
    ...
    392c:	f3050513          	addi	a0,a0,-208 # 7858 <statistics+0x1cda>
    ...
    3948:	f2c50513          	addi	a0,a0,-212 # 7870 <statistics+0x1cf2>
    ...
    3964:	8c850513          	addi	a0,a0,-1848 # 7228 <statistics+0x16aa>
    ...
    3980:	f1450513          	addi	a0,a0,-236 # 7890 <statistics+0x1d12>
    ...
    399c:	f2050513          	addi	a0,a0,-224 # 78b8 <statistics+0x1d3a>
    ...
    39b8:	f2450513          	addi	a0,a0,-220 # 78d8 <statistics+0x1d5a>
...
00000000000039ce <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    39e4:	f1850513          	addi	a0,a0,-232 # 78f8 <statistics+0x1d7a>
  ...
  if(chdir("dirfile") == 0){
    ...
    3a00:	efc50513          	addi	a0,a0,-260 # 78f8 <statistics+0x1d7a>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3a14:	f3050513          	addi	a0,a0,-208 # 7940 <statistics+0x1dc2>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3a2c:	f1850513          	addi	a0,a0,-232 # 7940 <statistics+0x1dc2>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3a40:	f0450513          	addi	a0,a0,-252 # 7940 <statistics+0x1dc2>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3a54:	ef050513          	addi	a0,a0,-272 # 7940 <statistics+0x1dc2>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3a68:	edc58593          	addi	a1,a1,-292 # 7940 <statistics+0x1dc2>
    3a6c:	00002517          	auipc	a0,0x2
    3a70:	74c50513          	addi	a0,a0,1868 # 61b8 <statistics+0x63a>
  ...
  if(unlink("dirfile") != 0){
    ...
    3a84:	e7850513          	addi	a0,a0,-392 # 78f8 <statistics+0x1d7a>
  ...
  fd = open(".", O_RDWR);
    ...
    3a9a:	c3250513          	addi	a0,a0,-974 # 66c8 <statistics+0xb4a>
  ...
  fd = open(".", 0);
    ...
    3ab0:	c1c50513          	addi	a0,a0,-996 # 66c8 <statistics+0xb4a>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3ac4:	5c058593          	addi	a1,a1,1472 # 6080 <statistics+0x502>
  ...
  close(fd);
    ...
    3af0:	e1450513          	addi	a0,a0,-492 # 7900 <statistics+0x1d82>
    ...
    3b0c:	e1850513          	addi	a0,a0,-488 # 7920 <statistics+0x1da2>
    ...
    3b28:	e2c50513          	addi	a0,a0,-468 # 7950 <statistics+0x1dd2>
    ...
    3b44:	e1050513          	addi	a0,a0,-496 # 7950 <statistics+0x1dd2>
    ...
    3b60:	e1c50513          	addi	a0,a0,-484 # 7978 <statistics+0x1dfa>
    ...
    3b7c:	e2850513          	addi	a0,a0,-472 # 79a0 <statistics+0x1e22>
    ...
    3b98:	e3450513          	addi	a0,a0,-460 # 79c8 <statistics+0x1e4a>
    ...
    3bb4:	e4050513          	addi	a0,a0,-448 # 79f0 <statistics+0x1e72>
    ...
    3bd0:	e4450513          	addi	a0,a0,-444 # 7a10 <statistics+0x1e92>
    ...
    3bec:	e5050513          	addi	a0,a0,-432 # 7a38 <statistics+0x1eba>
...
0000000000003c02 <iref>:
{
    ...
    3c20:	e34a0a13          	addi	s4,s4,-460 # 7a50 <statistics+0x1ed2>
    mkdir("");
    3c24:	00004497          	auipc	s1,0x4
    3c28:	93448493          	addi	s1,s1,-1740 # 7558 <statistics+0x19da>
    link("README", "");
    3c2c:	00002a97          	auipc	s5,0x2
    3c30:	58ca8a93          	addi	s5,s5,1420 # 61b8 <statistics+0x63a>
    fd = open("xx", O_CREATE);
    3c34:	00004997          	auipc	s3,0x4
    3c38:	d1498993          	addi	s3,s3,-748 # 7948 <statistics+0x1dca>
    3c3c:	a891                	j	3c90 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3c3e:	85da                	mv	a1,s6
    3c40:	00004517          	auipc	a0,0x4
    3c44:	e1850513          	addi	a0,a0,-488 # 7a58 <statistics+0x1eda>
    ...
    3c60:	e1450513          	addi	a0,a0,-492 # 7a70 <statistics+0x1ef2>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3cf4:	58898993          	addi	s3,s3,1416 # 7278 <statistics+0x16fa>
    unlink("irefd");
    3cf8:	00004917          	auipc	s2,0x4
    3cfc:	d5890913          	addi	s2,s2,-680 # 7a50 <statistics+0x1ed2>
    chdir("..");
    3d00:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3d1c:	50850513          	addi	a0,a0,1288 # 7220 <statistics+0x16a2>
...
0000000000003d3c <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3d4c:	d4050513          	addi	a0,a0,-704 # 7a88 <statistics+0x1f0a>
  ...
  if(pid == 0){
    ...
    3d70:	d1c50513          	addi	a0,a0,-740 # 7a88 <statistics+0x1f0a>
    ...
    3d86:	d2650513          	addi	a0,a0,-730 # 7aa8 <statistics+0x1f2a>
    ...
    3da2:	cf250513          	addi	a0,a0,-782 # 7a90 <statistics+0x1f12>
    ...
    3dbe:	aae50513          	addi	a0,a0,-1362 # 6868 <statistics+0xcea>
  ...
  if(unlink("oidir") != 0){
    ...
    3dec:	ca050513          	addi	a0,a0,-864 # 7a88 <statistics+0x1f0a>
    ...
    3e00:	c5c50513          	addi	a0,a0,-932 # 6a58 <statistics+0xeda>
...
0000000000003e2e <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3e3e:	c9650513          	addi	a0,a0,-874 # 7ad0 <statistics+0x1f52>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3e6a:	c6a50513          	addi	a0,a0,-918 # 7ad0 <statistics+0x1f52>
  ...
  sleep(10); // one second
    ...
    3ea2:	b8a50513          	addi	a0,a0,-1142 # 6a28 <statistics+0xeaa>
    ...
    3ebc:	c1848493          	addi	s1,s1,-1000 # 7ad0 <statistics+0x1f52>
    3ec0:	4581                	li	a1,0
    3ec2:	8526                	mv	a0,s1
...
0000000000003efe <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3f28:	b0450513          	addi	a0,a0,-1276 # 6a28 <statistics+0xeaa>
  ...
  if(pid2 == 0)
    ...
    3f56:	91650513          	addi	a0,a0,-1770 # 6868 <statistics+0xcea>
  ...
  if(pid3 == 0){
    ...
    3f9a:	0ea58593          	addi	a1,a1,234 # 6080 <statistics+0x502>
    ...
    3fc4:	8a850513          	addi	a0,a0,-1880 # 6868 <statistics+0xcea>
    ...
    3fe0:	b0450513          	addi	a0,a0,-1276 # 7ae0 <statistics+0x1f62>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4000:	ba458593          	addi	a1,a1,-1116 # bba0 <buf>
    ...
    401c:	ae050513          	addi	a0,a0,-1312 # 7af8 <statistics+0x1f7a>
  ...
  printf("kill... ");
    ...
    4048:	acc50513          	addi	a0,a0,-1332 # 7b10 <statistics+0x1f92>
  ...
  printf("wait... ");
    ...
    4076:	aae50513          	addi	a0,a0,-1362 # 7b20 <statistics+0x1fa2>
...
00000000000040a2 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    40d8:	89c50513          	addi	a0,a0,-1892 # 6970 <statistics+0xdf2>
    ...
    410c:	f7858593          	addi	a1,a1,-136 # 6080 <statistics+0x502>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    41d0:	96450513          	addi	a0,a0,-1692 # 7b30 <statistics+0x1fb2>
    ...
    41ec:	68050513          	addi	a0,a0,1664 # 6868 <statistics+0xcea>
    ...
    4238:	91c50513          	addi	a0,a0,-1764 # 7b50 <statistics+0x1fd2>
...
0000000000004258 <reparent>:
{
  ...
  exit(0);
    ...
    42ac:	5c050513          	addi	a0,a0,1472 # 6868 <statistics+0xcea>
    ...
    42c8:	72c50513          	addi	a0,a0,1836 # 69f0 <statistics+0xe72>
...
0000000000004308 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4376:	80e50513          	addi	a0,a0,-2034 # 7b80 <statistics+0x2002>
...
00000000000043b4 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    444a:	76a50513          	addi	a0,a0,1898 # 7bb0 <statistics+0x2032>
    ...
    4466:	77650513          	addi	a0,a0,1910 # 7bd8 <statistics+0x205a>
  ...
  fd = open("sharedfd", 0);
    ...
    44aa:	6fa50513          	addi	a0,a0,1786 # 7ba0 <statistics+0x2022>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    44ea:	71250513          	addi	a0,a0,1810 # 7bf8 <statistics+0x207a>
    ...
    4504:	fd2783e3          	beq	a5,s2,44ca <sharedfd+0x116>
      if(buf[i] == 'c')
    4508:	0007c703          	lbu	a4,0(a5) # 3e800000 <_end+0x3e7f1450>
  ...
  unlink("sharedfd");
    ...
    4526:	67e50513          	addi	a0,a0,1662 # 7ba0 <statistics+0x2022>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    454c:	6d850513          	addi	a0,a0,1752 # 7c20 <statistics+0x20a2>
...
000000000000456c <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4590:	6ac78793          	addi	a5,a5,1708 # 7c38 <statistics+0x20ba>
    4594:	f6f43823          	sd	a5,-144(s0)
    4598:	00003797          	auipc	a5,0x3
    459c:	6a878793          	addi	a5,a5,1704 # 7c40 <statistics+0x20c2>
    45a0:	f6f43c23          	sd	a5,-136(s0)
    45a4:	00003797          	auipc	a5,0x3
    45a8:	6a478793          	addi	a5,a5,1700 # 7c48 <statistics+0x20ca>
    45ac:	f8f43023          	sd	a5,-128(s0)
    45b0:	00003797          	auipc	a5,0x3
    45b4:	6a078793          	addi	a5,a5,1696 # 7c50 <statistics+0x20d2>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    460c:	59898993          	addi	s3,s3,1432 # bba0 <buf>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4622:	65250513          	addi	a0,a0,1618 # 6c70 <statistics+0x10f2>
    ...
    469a:	5c250513          	addi	a0,a0,1474 # 7c58 <statistics+0x20da>
    ...
    46b6:	5b650513          	addi	a0,a0,1462 # 7c68 <statistics+0x20ea>
    ...
    46f6:	4af78793          	addi	a5,a5,1199 # bba1 <buf+0x1>
    ...
    4718:	56c50513          	addi	a0,a0,1388 # 7c80 <statistics+0x2102>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    476e:	52650513          	addi	a0,a0,1318 # 7c90 <statistics+0x2112>
...
00000000000047a2 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    47d0:	4dcb8b93          	addi	s7,s7,1244 # 7ca8 <statistics+0x212a>
  for(i = 0; i < N; i++){
    ...
    4812:	4a250513          	addi	a0,a0,1186 # 7cb0 <statistics+0x2132>
    ...
    4830:	47c50513          	addi	a0,a0,1148 # 7ca8 <statistics+0x212a>
  ...
  fd = open(".", 0);
    ...
    4868:	e6450513          	addi	a0,a0,-412 # 66c8 <statistics+0xb4a>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    48de:	3f650513          	addi	a0,a0,1014 # 7cd0 <statistics+0x2152>
    ...
    48fe:	3f650513          	addi	a0,a0,1014 # 7cf0 <statistics+0x2172>
  ...
  for(i = 0; i < N; i++){
    ...
    4936:	3e650513          	addi	a0,a0,998 # 7d18 <statistics+0x219a>
    ...
    4952:	f1a50513          	addi	a0,a0,-230 # 6868 <statistics+0xcea>
...
0000000000004afc <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4b3c:	06890913          	addi	s2,s2,104 # bba0 <buf>
  for(i = 0; i < N; i++){
    4b40:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4b84:	1d050513          	addi	a0,a0,464 # 7d50 <statistics+0x21d2>
  ...
  for(i = 0; ; i++){
    ...
    4b9a:	00a90913          	addi	s2,s2,10 # bba0 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4be8:	17c50513          	addi	a0,a0,380 # 7d60 <statistics+0x21e2>
    ...
    4c04:	18050513          	addi	a0,a0,384 # 7d80 <statistics+0x2202>
    ...
    4c20:	18450513          	addi	a0,a0,388 # 7da0 <statistics+0x2222>
    ...
    4c3c:	18850513          	addi	a0,a0,392 # 7dc0 <statistics+0x2242>
    ...
    4c58:	18c50513          	addi	a0,a0,396 # 7de0 <statistics+0x2262>
    ...
    4c74:	18850513          	addi	a0,a0,392 # 7df8 <statistics+0x227a>
  ...
  unlink("bigfile.dat");
    ...
    4ca2:	0b250513          	addi	a0,a0,178 # 7d50 <statistics+0x21d2>
    ...
    4cc6:	15650513          	addi	a0,a0,342 # 7e18 <statistics+0x229a>
...
0000000000004cdc <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4cfe:	13e50513          	addi	a0,a0,318 # 7e38 <statistics+0x22ba>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4d1e:	12ec8c93          	addi	s9,s9,302 # 7e48 <statistics+0x22ca>
    int total = 0;
    4d22:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4d24:	00007a17          	auipc	s4,0x7
    4d28:	e7ca0a13          	addi	s4,s4,-388 # bba0 <buf>
    name[0] = 'f';
    ...
    4d98:	0c450513          	addi	a0,a0,196 # 7e58 <statistics+0x22da>
  ...
  printf("fsfull test finished\n");
    ...
    4e0e:	06e50513          	addi	a0,a0,110 # 7e78 <statistics+0x22fa>
    ...
    4e5e:	00e50513          	addi	a0,a0,14 # 7e68 <statistics+0x22ea>
...
0000000000004e7c <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    4e86:	4f670713          	addi	a4,a4,1270 # 8378 <randstate>
    4e8a:	6308                	ld	a0,0(a4)
    4e8c:	001967b7          	lui	a5,0x196
    4e90:	60d78793          	addi	a5,a5,1549 # 19660d <_end+0x187a5d>
    4e94:	02f50533          	mul	a0,a0,a5
    4e98:	3c6ef7b7          	lui	a5,0x3c6ef
    4e9c:	35f78793          	addi	a5,a5,863 # 3c6ef35f <_end+0x3c6e07af>
...
0000000000004eac <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    4f20:	f7450513          	addi	a0,a0,-140 # 7e90 <statistics+0x2312>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    4f38:	14c58593          	addi	a1,a1,332 # 6080 <statistics+0x502>
    ...
    4f4e:	f6650513          	addi	a0,a0,-154 # 7eb0 <statistics+0x2332>
    ...
    4f68:	f3450513          	addi	a0,a0,-204 # 7e98 <statistics+0x231a>
    ...
    4f82:	f1a50513          	addi	a0,a0,-230 # 7e98 <statistics+0x231a>
  ...
  unlink("junk");
    ...
    4fa6:	eee50513          	addi	a0,a0,-274 # 7e90 <statistics+0x2312>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    4ffc:	08890913          	addi	s2,s2,136 # 6080 <statistics+0x502>
      uint64 a = (uint64) sbrk(4096);
    ...
    5030:	ed450513          	addi	a0,a0,-300 # 7f00 <statistics+0x2382>
    ...
    504a:	e7a50513          	addi	a0,a0,-390 # 7ec0 <statistics+0x2342>
    ...
    5064:	e8050513          	addi	a0,a0,-384 # 7ee0 <statistics+0x2362>
  ...
  while(1){
    ...
    5098:	e8c50513          	addi	a0,a0,-372 # 7f20 <statistics+0x23a2>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5102:	e4250513          	addi	a0,a0,-446 # 7f40 <statistics+0x23c2>
  ...
  if(pid == 0) {
    ...
    5132:	e3a50513          	addi	a0,a0,-454 # 7f68 <statistics+0x23ea>
    ...
    5156:	dfe50513          	addi	a0,a0,-514 # 7f50 <statistics+0x23d2>
    ...
    517e:	df650513          	addi	a0,a0,-522 # 7f70 <statistics+0x23f2>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    51c6:	a6678793          	addi	a5,a5,-1434 # 5c28 <statistics+0xaa>
    51ca:	c1040713          	addi	a4,s0,-1008
    51ce:	00001817          	auipc	a6,0x1
    51d2:	dfa80813          	addi	a6,a6,-518 # 5fc8 <statistics+0x44a>
  ...
  printf("usertests starting\n");
    ...
    51fe:	e2e50513          	addi	a0,a0,-466 # 8028 <statistics+0x24aa>
  ...
  if(fail){
    ...
    5238:	dac50513          	addi	a0,a0,-596 # 7fe0 <statistics+0x2462>
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    5254:	d2858593          	addi	a1,a1,-728 # 7f78 <statistics+0x23fa>
    ...
    526a:	dfa58593          	addi	a1,a1,-518 # 8060 <statistics+0x24e2>
    ...
    528e:	cf650513          	addi	a0,a0,-778 # 7f80 <statistics+0x2402>
  ...
  if(fail){
    ...
    5300:	ccc50513          	addi	a0,a0,-820 # 7fc8 <statistics+0x244a>
    ...
    531a:	cfa50513          	addi	a0,a0,-774 # 8010 <statistics+0x2492>
    ...
    5378:	8b478793          	addi	a5,a5,-1868 # 5c28 <statistics+0xaa>
    537c:	c1040713          	addi	a4,s0,-1008
    5380:	00001817          	auipc	a6,0x1
    5384:	c4880813          	addi	a6,a6,-952 # 5fc8 <statistics+0x44a>
    ...
    53b0:	c9450513          	addi	a0,a0,-876 # 8040 <statistics+0x24c2>
    53b4:	00000097          	auipc	ra,0x0
    53b8:	624080e7          	jalr	1572(ra) # 59d8 <printf>
        printf("SOME TESTS FAILED\n");
    53bc:	00003a97          	auipc	s5,0x3
    53c0:	c0ca8a93          	addi	s5,s5,-1012 # 7fc8 <statistics+0x244a>
        if(continuous != 2)
    53c4:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    53c6:	00003b17          	auipc	s6,0x3
    53ca:	be2b0b13          	addi	s6,s6,-1054 # 7fa8 <statistics+0x242a>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5746:	be688893          	addi	a7,a7,-1050 # 8328 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5818:	b14b8b93          	addi	s7,s7,-1260 # 8328 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5954:	9f048493          	addi	s1,s1,-1552 # 8340 <digits+0x18>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    5a1c:	96878793          	addi	a5,a5,-1688 # 8380 <_edata>
    ...
    5a4c:	00e6ea63          	bltu	a3,a4,5a60 <free+0x52>
{
  ...
  freep = p;
    ...
    5a8e:	8ef73b23          	sd	a5,-1802(a4) # 8380 <_edata>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    5ac4:	8c078793          	addi	a5,a5,-1856 # 8380 <_edata>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    5aea:	00003497          	auipc	s1,0x3
    5aee:	89648493          	addi	s1,s1,-1898 # 8380 <_edata>
  if(p == (char*)-1)
    5af2:	5b7d                	li	s6,-1
    5af4:	a885                	j	5b64 <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
    5af6:	00009797          	auipc	a5,0x9
    5afa:	0aa78793          	addi	a5,a5,170 # eba0 <base>
    5afe:	00003717          	auipc	a4,0x3
    5b02:	88f73123          	sd	a5,-1918(a4) # 8380 <_edata>
    ...
    5b20:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5b24:	00003717          	auipc	a4,0x3
    5b28:	84a73e23          	sd	a0,-1956(a4) # 8380 <_edata>
      return (void*)(p + 1);
...
{
    5b7e:	7179                	addi	sp,sp,-48
    5b80:	f406                	sd	ra,40(sp)
    5b82:	f022                	sd	s0,32(sp)
    5b84:	ec26                	sd	s1,24(sp)
    5b86:	e84a                	sd	s2,16(sp)
    5b88:	e44e                	sd	s3,8(sp)
    5b8a:	e052                	sd	s4,0(sp)
    5b8c:	1800                	addi	s0,sp,48
    5b8e:	8a2a                	mv	s4,a0
    5b90:	892e                	mv	s2,a1
  int fd, i, n;
  ...
  fd = open("statistics", O_RDONLY);
    5b92:	4581                	li	a1,0
    5b94:	00002517          	auipc	a0,0x2
    5b98:	7b450513          	addi	a0,a0,1972 # 8348 <digits+0x20>
    5b9c:	00000097          	auipc	ra,0x0
    5ba0:	b04080e7          	jalr	-1276(ra) # 56a0 <open>
  if(fd < 0) {
    5ba4:	04054263          	bltz	a0,5be8 <statistics+0x6a>
    5ba8:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
    5baa:	4481                	li	s1,0
    5bac:	03205063          	blez	s2,5bcc <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
    5bb0:	4099063b          	subw	a2,s2,s1
    5bb4:	009a05b3          	add	a1,s4,s1
    5bb8:	854e                	mv	a0,s3
    5bba:	00000097          	auipc	ra,0x0
    5bbe:	abe080e7          	jalr	-1346(ra) # 5678 <read>
    5bc2:	00054563          	bltz	a0,5bcc <statistics+0x4e>
      break;
    }
    i += n;
    5bc6:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
    5bc8:	ff24c4e3          	blt	s1,s2,5bb0 <statistics+0x32>
  }
  close(fd);
    5bcc:	854e                	mv	a0,s3
    5bce:	00000097          	auipc	ra,0x0
    5bd2:	aba080e7          	jalr	-1350(ra) # 5688 <close>
  return i;
}
    5bd6:	8526                	mv	a0,s1
    5bd8:	70a2                	ld	ra,40(sp)
    5bda:	7402                	ld	s0,32(sp)
    5bdc:	64e2                	ld	s1,24(sp)
    5bde:	6942                	ld	s2,16(sp)
    5be0:	69a2                	ld	s3,8(sp)
    5be2:	6a02                	ld	s4,0(sp)
    5be4:	6145                	addi	sp,sp,48
    5be6:	8082                	ret
      fprintf(2, "stats: open failed\n");
    5be8:	00002597          	auipc	a1,0x2
    5bec:	77058593          	addi	a1,a1,1904 # 8358 <digits+0x30>
    5bf0:	4509                	li	a0,2
    5bf2:	00000097          	auipc	ra,0x0
    5bf6:	db8080e7          	jalr	-584(ra) # 59aa <fprintf>
      exit(1);
    5bfa:	4505                	li	a0,1
    5bfc:	00000097          	auipc	ra,0x0
    5c00:	a64080e7          	jalr	-1436(ra) # 5660 <exit>
