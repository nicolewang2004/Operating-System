...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	3b058593          	addi	a1,a1,944 # 13c0 <statistics+0xb8>
      18:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	36858593          	addi	a1,a1,872 # 13c8 <statistics+0xc0>
      68:	4509                	li	a0,2
      6a:	00001097          	auipc	ra,0x1
      6e:	0ca080e7          	jalr	202(ra) # 1134 <fprintf>
  exit(1);
      72:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	33650513          	addi	a0,a0,822 # 13d0 <statistics+0xc8>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	2ca70713          	addi	a4,a4,714 # 1390 <statistics+0x88>
    ...
    panic("runcmd");
      ...
      e4:	2f850513          	addi	a0,a0,760 # 13d8 <statistics+0xd0>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	2de58593          	addi	a1,a1,734 # 13e0 <statistics+0xd8>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	2a258593          	addi	a1,a1,674 # 13f0 <statistics+0xe8>
     156:	4509                	li	a0,2
    ...
    break;
     ...
     1e8:	21c50513          	addi	a0,a0,540 # 1400 <statistics+0xf8>
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     28a:	f9c080e7          	jalr	-100(ra) # 1222 <malloc>
     28e:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     2d4:	f52080e7          	jalr	-174(ra) # 1222 <malloc>
     2d8:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     32e:	ef8080e7          	jalr	-264(ra) # 1222 <malloc>
     332:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     334:	4661                	li	a2,24
     336:	4581                	li	a1,0
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     374:	eb2080e7          	jalr	-334(ra) # 1222 <malloc>
     378:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     37a:	4661                	li	a2,24
     37c:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3b6:	e70080e7          	jalr	-400(ra) # 1222 <malloc>
     3ba:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     3bc:	4641                	li	a2,16
     3be:	4581                	li	a1,0
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     44c:	0d898993          	addi	s3,s3,216 # 1520 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     490:	09498993          	addi	s3,s3,148 # 1520 <whitespace>
     494:	00001a97          	auipc	s5,0x1
     498:	084a8a93          	addi	s5,s5,132 # 1518 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     540:	fe498993          	addi	s3,s3,-28 # 1520 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5b0:	e7cb8b93          	addi	s7,s7,-388 # 1428 <statistics+0x120>
  ...
  while(peek(ps, es, "<>")){
     ...
     5c2:	e4a50513          	addi	a0,a0,-438 # 1408 <statistics+0x100>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6aa:	d8a60613          	addi	a2,a2,-630 # 1430 <statistics+0x128>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6da:	d7ab0b13          	addi	s6,s6,-646 # 1450 <statistics+0x148>
  ...
  return ret;
     ...
     714:	d2850513          	addi	a0,a0,-728 # 1438 <statistics+0x130>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     772:	cd250513          	addi	a0,a0,-814 # 1440 <statistics+0x138>
...
000000000000078c <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7ac:	cb060613          	addi	a2,a2,-848 # 1458 <statistics+0x150>
     7b0:	85ce                	mv	a1,s3
     7b2:	854a                	mv	a0,s2
...
00000000000007fa <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     81c:	c48a0a13          	addi	s4,s4,-952 # 1460 <statistics+0x158>
     820:	8652                	mv	a2,s4
     822:	85ca                	mv	a1,s2
     824:	8526                	mv	a0,s1
  ...
  if(peek(ps, es, ";")){
     ...
     852:	c1a60613          	addi	a2,a2,-998 # 1468 <statistics+0x160>
     856:	85ca                	mv	a1,s2
     858:	8526                	mv	a0,s1
...
00000000000008a2 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b8:	b7c60613          	addi	a2,a2,-1156 # 1430 <statistics+0x128>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e8:	b9c60613          	addi	a2,a2,-1124 # 1480 <statistics+0x178>
     8ec:	85ca                	mv	a1,s2
     8ee:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     92a:	b4a50513          	addi	a0,a0,-1206 # 1470 <statistics+0x168>
     92e:	fffff097          	auipc	ra,0xfffff
     932:	728080e7          	jalr	1832(ra) # 56 <panic>
    panic("syntax - missing )");
     936:	00001517          	auipc	a0,0x1
     93a:	b5250513          	addi	a0,a0,-1198 # 1488 <statistics+0x180>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     966:	a4670713          	addi	a4,a4,-1466 # 13a8 <statistics+0xa0>
...
00000000000009de <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a12:	a9260613          	addi	a2,a2,-1390 # 14a0 <statistics+0x198>
     a16:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a48:	a6458593          	addi	a1,a1,-1436 # 14a8 <statistics+0x1a0>
     a4c:	4509                	li	a0,2
     a4e:	00000097          	auipc	ra,0x0
     a52:	6e6080e7          	jalr	1766(ra) # 1134 <fprintf>
    panic("syntax");
     a56:	00001517          	auipc	a0,0x1
     a5a:	9e250513          	addi	a0,a0,-1566 # 1438 <statistics+0x130>
...
0000000000000a66 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a7c:	a4048493          	addi	s1,s1,-1472 # 14b8 <statistics+0x1b0>
     a80:	4589                	li	a1,2
     a82:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     aa2:	a9248493          	addi	s1,s1,-1390 # 1530 <buf.1157>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa6:	06300913          	li	s2,99
     aaa:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aae:	00001a17          	auipc	s4,0x1
     ab2:	a85a0a13          	addi	s4,s4,-1403 # 1533 <buf.1157+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab6:	00001a97          	auipc	s5,0x1
     aba:	a0aa8a93          	addi	s5,s5,-1526 # 14c0 <statistics+0x1b8>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b32:	606080e7          	jalr	1542(ra) # 1134 <fprintf>
     b36:	bf79                	j	ad4 <main+0x6e>
      runcmd(parsecmd(buf));
     b38:	00001517          	auipc	a0,0x1
     b3c:	9f850513          	addi	a0,a0,-1544 # 1530 <buf.1157>
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     ea0:	f6e080e7          	jalr	-146(ra) # e0a <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
     eba:	c299                	beqz	a3,ec0 <printint+0x14>
     ebc:	0005cd63          	bltz	a1,ed6 <printint+0x2a>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ecc:	00000897          	auipc	a7,0x0
     ed0:	60488893          	addi	a7,a7,1540 # 14d0 <digits>
     ed4:	a801                	j	ee4 <printint+0x38>
    x = -xx;
     ed6:	40b005bb          	negw	a1,a1
     eda:	2581                	sext.w	a1,a1
    neg = 1;
     edc:	4305                	li	t1,1
    x = -xx;
     ede:	b7dd                	j	ec4 <printint+0x18>
  }while((x /= base) != 0);
     ee0:	85be                	mv	a1,a5
    buf[i++] = digits[x % base];
     ee2:	8836                	mv	a6,a3
     ee4:	0018069b          	addiw	a3,a6,1
     ee8:	02c5f7bb          	remuw	a5,a1,a2
     eec:	1782                	slli	a5,a5,0x20
     eee:	9381                	srli	a5,a5,0x20
     ef0:	97c6                	add	a5,a5,a7
     ef2:	0007c783          	lbu	a5,0(a5)
     ef6:	00f70023          	sb	a5,0(a4)
  }while((x /= base) != 0);
     efa:	0705                	addi	a4,a4,1
     efc:	02c5d7bb          	divuw	a5,a1,a2
     f00:	fec5f0e3          	bleu	a2,a1,ee0 <printint+0x34>
  if(neg)
     f04:	00030b63          	beqz	t1,f1a <printint+0x6e>
    buf[i++] = '-';
     f08:	fd040793          	addi	a5,s0,-48
     f0c:	96be                	add	a3,a3,a5
     f0e:	02d00793          	li	a5,45
     f12:	fef68823          	sb	a5,-16(a3)
     f16:	0028069b          	addiw	a3,a6,2

  while(--i >= 0)
     f1a:	02d05963          	blez	a3,f4c <printint+0xa0>
     f1e:	89aa                	mv	s3,a0
     f20:	fc040793          	addi	a5,s0,-64
     f24:	00d784b3          	add	s1,a5,a3
     f28:	fff78913          	addi	s2,a5,-1
     f2c:	9936                	add	s2,s2,a3
     f2e:	36fd                	addiw	a3,a3,-1
     f30:	1682                	slli	a3,a3,0x20
     f32:	9281                	srli	a3,a3,0x20
     f34:	40d90933          	sub	s2,s2,a3
    putc(fd, buf[i]);
     f38:	fff4c583          	lbu	a1,-1(s1)
     f3c:	854e                	mv	a0,s3
     f3e:	00000097          	auipc	ra,0x0
     f42:	f4c080e7          	jalr	-180(ra) # e8a <putc>
  while(--i >= 0)
     f46:	14fd                	addi	s1,s1,-1
     f48:	ff2498e3          	bne	s1,s2,f38 <printint+0x8c>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
     f78:	0005c483          	lbu	s1,0(a1)
     f7c:	18048d63          	beqz	s1,1116 <vprintf+0x1bc>
     f80:	8aaa                	mv	s5,a0
     f82:	8b32                	mv	s6,a2
     f84:	00158913          	addi	s2,a1,1
  state = 0;
     f88:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     fa2:	532b8b93          	addi	s7,s7,1330 # 14d0 <digits>
     fa6:	a839                	j	fc4 <vprintf+0x6a>
        putc(fd, c);
     fa8:	85a6                	mv	a1,s1
     faa:	8556                	mv	a0,s5
     fac:	00000097          	auipc	ra,0x0
     fb0:	ede080e7          	jalr	-290(ra) # e8a <putc>
     fb4:	a019                	j	fba <vprintf+0x60>
    } else if(state == '%'){
     fb6:	01498f63          	beq	s3,s4,fd4 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
     fba:	0905                	addi	s2,s2,1
     fbc:	fff94483          	lbu	s1,-1(s2)
     fc0:	14048b63          	beqz	s1,1116 <vprintf+0x1bc>
    c = fmt[i] & 0xff;
     fc4:	0004879b          	sext.w	a5,s1
    if(state == 0){
     ...
     fe8:	0ce78563          	beq	a5,a4,10b2 <vprintf+0x158>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
     ...
     ff0:	0ee78c63          	beq	a5,a4,10e8 <vprintf+0x18e>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
     ff4:	11478663          	beq	a5,s4,1100 <vprintf+0x1a6>
        putc(fd, c);
      } else {
    ...
    1000:	e8e080e7          	jalr	-370(ra) # e8a <putc>
        putc(fd, c);
    1004:	85a6                	mv	a1,s1
    1006:	8556                	mv	a0,s5
    1008:	00000097          	auipc	ra,0x0
    100c:	e82080e7          	jalr	-382(ra) # e8a <putc>
      }
      state = 0;
    1010:	4981                	li	s3,0
    1012:	b765                	j	fba <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    1014:	008b0493          	addi	s1,s6,8
    1018:	4685                	li	a3,1
    101a:	4629                	li	a2,10
    101c:	000b2583          	lw	a1,0(s6)
    1020:	8556                	mv	a0,s5
    1022:	00000097          	auipc	ra,0x0
    1026:	e8a080e7          	jalr	-374(ra) # eac <printint>
    102a:	8b26                	mv	s6,s1
      state = 0;
    102c:	4981                	li	s3,0
    ...
    1042:	e6e080e7          	jalr	-402(ra) # eac <printint>
    1046:	8b26                	mv	s6,s1
      state = 0;
    1048:	4981                	li	s3,0
    ...
    105e:	e52080e7          	jalr	-430(ra) # eac <printint>
    1062:	8b26                	mv	s6,s1
      state = 0;
    1064:	4981                	li	s3,0
  ...
  putc(fd, '0');
    ...
    107e:	e10080e7          	jalr	-496(ra) # e8a <putc>
  putc(fd, 'x');
    1082:	85ea                	mv	a1,s10
    1084:	8556                	mv	a0,s5
    1086:	00000097          	auipc	ra,0x0
    108a:	e04080e7          	jalr	-508(ra) # e8a <putc>
    108e:	44c1                	li	s1,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    ...
    10a0:	dee080e7          	jalr	-530(ra) # e8a <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    10a4:	0992                	slli	s3,s3,0x4
    10a6:	34fd                	addiw	s1,s1,-1
    10a8:	f4e5                	bnez	s1,1090 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    10aa:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    10ae:	4981                	li	s3,0
    10b0:	b729                	j	fba <vprintf+0x60>
        s = va_arg(ap, char*);
    10b2:	008b0993          	addi	s3,s6,8
    10b6:	000b3483          	ld	s1,0(s6)
        if(s == 0)
    10ba:	c085                	beqz	s1,10da <vprintf+0x180>
        while(*s != 0){
    10bc:	0004c583          	lbu	a1,0(s1)
    10c0:	c9a1                	beqz	a1,1110 <vprintf+0x1b6>
          putc(fd, *s);
    10c2:	8556                	mv	a0,s5
    ...
    10cc:	0485                	addi	s1,s1,1
        while(*s != 0){
    10ce:	0004c583          	lbu	a1,0(s1)
    10d2:	f9e5                	bnez	a1,10c2 <vprintf+0x168>
        s = va_arg(ap, char*);
    10d4:	8b4e                	mv	s6,s3
      state = 0;
    10d6:	4981                	li	s3,0
    10d8:	b5cd                	j	fba <vprintf+0x60>
          s = "(null)";
    10da:	00000497          	auipc	s1,0x0
    10de:	40e48493          	addi	s1,s1,1038 # 14e8 <digits+0x18>
        while(*s != 0){
    10e2:	02800593          	li	a1,40
    10e6:	bff1                	j	10c2 <vprintf+0x168>
        putc(fd, va_arg(ap, uint));
    10e8:	008b0493          	addi	s1,s6,8
    ...
    1108:	d86080e7          	jalr	-634(ra) # e8a <putc>
      state = 0;
    110c:	4981                	li	s3,0
    110e:	b575                	j	fba <vprintf+0x60>
        s = va_arg(ap, char*);
    1110:	8b4e                	mv	s6,s3
      state = 0;
    1112:	4981                	li	s3,0
    1114:	b55d                	j	fba <vprintf+0x60>
    }
  }
}
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  vprintf(fd, fmt, ap);
    ...
    1156:	e08080e7          	jalr	-504(ra) # f5a <vprintf>
}
...
printf(const char *fmt, ...)
{
  ...
  vprintf(1, fmt, ap);
    ...
    118c:	dd2080e7          	jalr	-558(ra) # f5a <vprintf>
}
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11a6:	38678793          	addi	a5,a5,902 # 1528 <freep>
    11aa:	639c                	ld	a5,0(a5)
    11ac:	a805                	j	11dc <free+0x44>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    11ae:	4618                	lw	a4,8(a2)
    11b0:	9db9                	addw	a1,a1,a4
    11b2:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    11b6:	6398                	ld	a4,0(a5)
    11b8:	6318                	ld	a4,0(a4)
    11ba:	fee53823          	sd	a4,-16(a0)
    11be:	a091                	j	1202 <free+0x6a>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    11c0:	ff852703          	lw	a4,-8(a0)
    11c4:	9e39                	addw	a2,a2,a4
    11c6:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    11c8:	ff053703          	ld	a4,-16(a0)
    11cc:	e398                	sd	a4,0(a5)
    11ce:	a099                	j	1214 <free+0x7c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11d0:	6398                	ld	a4,0(a5)
    11d2:	00e7e463          	bltu	a5,a4,11da <free+0x42>
    11d6:	00e6ea63          	bltu	a3,a4,11ea <free+0x52>
{
    11da:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    11dc:	fed7fae3          	bleu	a3,a5,11d0 <free+0x38>
    11e0:	6398                	ld	a4,0(a5)
    11e2:	00e6e463          	bltu	a3,a4,11ea <free+0x52>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11e6:	fee7eae3          	bltu	a5,a4,11da <free+0x42>
  if(bp + bp->s.size == p->s.ptr){
    11ea:	ff852583          	lw	a1,-8(a0)
    11ee:	6390                	ld	a2,0(a5)
    11f0:	02059713          	slli	a4,a1,0x20
    11f4:	9301                	srli	a4,a4,0x20
    11f6:	0712                	slli	a4,a4,0x4
    11f8:	9736                	add	a4,a4,a3
    11fa:	fae60ae3          	beq	a2,a4,11ae <free+0x16>
    bp->s.ptr = p->s.ptr;
    11fe:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    1202:	4790                	lw	a2,8(a5)
    1204:	02061713          	slli	a4,a2,0x20
    1208:	9301                	srli	a4,a4,0x20
    120a:	0712                	slli	a4,a4,0x4
    120c:	973e                	add	a4,a4,a5
    120e:	fae689e3          	beq	a3,a4,11c0 <free+0x28>
  } else
    p->s.ptr = bp;
    1212:	e394                	sd	a3,0(a5)
  freep = p;
    1214:	00000717          	auipc	a4,0x0
    1218:	30f73a23          	sd	a5,788(a4) # 1528 <freep>
}
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1236:	02051993          	slli	s3,a0,0x20
    123a:	0209d993          	srli	s3,s3,0x20
    123e:	09bd                	addi	s3,s3,15
    1240:	0049d993          	srli	s3,s3,0x4
    1244:	2985                	addiw	s3,s3,1
    1246:	0009891b          	sext.w	s2,s3
  if((prevp = freep) == 0){
    124a:	00000797          	auipc	a5,0x0
    124e:	2de78793          	addi	a5,a5,734 # 1528 <freep>
    1252:	6388                	ld	a0,0(a5)
    1254:	c515                	beqz	a0,1280 <malloc+0x5e>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    125a:	03277f63          	bleu	s2,a4,1298 <malloc+0x76>
    125e:	8a4e                	mv	s4,s3
    1260:	0009871b          	sext.w	a4,s3
    1264:	6685                	lui	a3,0x1
    1266:	00d77363          	bleu	a3,a4,126c <malloc+0x4a>
    126a:	6a05                	lui	s4,0x1
    126c:	000a0a9b          	sext.w	s5,s4
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    1274:	00000497          	auipc	s1,0x0
    1278:	2b448493          	addi	s1,s1,692 # 1528 <freep>
  if(p == (char*)-1)
    127c:	5b7d                	li	s6,-1
    127e:	a885                	j	12ee <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
    1280:	00000797          	auipc	a5,0x0
    1284:	31878793          	addi	a5,a5,792 # 1598 <base>
    1288:	00000717          	auipc	a4,0x0
    128c:	2af73023          	sd	a5,672(a4) # 1528 <freep>
    1290:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    1292:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    1296:	b7e1                	j	125e <malloc+0x3c>
      if(p->s.size == nunits)
    1298:	02e90b63          	beq	s2,a4,12ce <malloc+0xac>
        p->s.size -= nunits;
    ...
    12b2:	26a73d23          	sd	a0,634(a4) # 1528 <freep>
      return (void*)(p + 1);
    ...
    12d2:	bff1                	j	12ae <malloc+0x8c>
  hp->s.size = nu;
    12d4:	01552423          	sw	s5,8(a0)
  free((void*)(hp + 1));
    12d8:	0541                	addi	a0,a0,16
    12da:	00000097          	auipc	ra,0x0
    12de:	ebe080e7          	jalr	-322(ra) # 1198 <free>
  return freep;
    12e2:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
    12e4:	d979                	beqz	a0,12ba <malloc+0x98>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12e6:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    12e8:	4798                	lw	a4,8(a5)
    12ea:	fb2777e3          	bleu	s2,a4,1298 <malloc+0x76>
    if(p == freep)
    12ee:	6098                	ld	a4,0(s1)
    12f0:	853e                	mv	a0,a5
    12f2:	fef71ae3          	bne	a4,a5,12e6 <malloc+0xc4>
  p = sbrk(nu * sizeof(Header));
    12f6:	8552                	mv	a0,s4
    12f8:	00000097          	auipc	ra,0x0
    12fc:	b7a080e7          	jalr	-1158(ra) # e72 <sbrk>
  if(p == (char*)-1)
    1300:	fd651ae3          	bne	a0,s6,12d4 <malloc+0xb2>
        return 0;
    1304:	4501                	li	a0,0
    1306:	bf55                	j	12ba <malloc+0x98>

0000000000001308 <statistics>:
#include "kernel/fcntl.h"
#include "user/user.h"
...
{
    1308:	7179                	addi	sp,sp,-48
    130a:	f406                	sd	ra,40(sp)
    130c:	f022                	sd	s0,32(sp)
    130e:	ec26                	sd	s1,24(sp)
    1310:	e84a                	sd	s2,16(sp)
    1312:	e44e                	sd	s3,8(sp)
    1314:	e052                	sd	s4,0(sp)
    1316:	1800                	addi	s0,sp,48
    1318:	8a2a                	mv	s4,a0
    131a:	892e                	mv	s2,a1
  int fd, i, n;
  ...
  fd = open("statistics", O_RDONLY);
    ...
    1322:	1d250513          	addi	a0,a0,466 # 14f0 <digits+0x20>
    1326:	00000097          	auipc	ra,0x0
    132a:	b04080e7          	jalr	-1276(ra) # e2a <open>
  if(fd < 0) {
    132e:	04054263          	bltz	a0,1372 <statistics+0x6a>
    1332:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
    1334:	4481                	li	s1,0
    1336:	03205063          	blez	s2,1356 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
    133a:	4099063b          	subw	a2,s2,s1
    133e:	009a05b3          	add	a1,s4,s1
    1342:	854e                	mv	a0,s3
    1344:	00000097          	auipc	ra,0x0
    1348:	abe080e7          	jalr	-1346(ra) # e02 <read>
    134c:	00054563          	bltz	a0,1356 <statistics+0x4e>
      break;
    }
    i += n;
    1350:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
    1352:	ff24c4e3          	blt	s1,s2,133a <statistics+0x32>
  }
  close(fd);
    1356:	854e                	mv	a0,s3
    1358:	00000097          	auipc	ra,0x0
    135c:	aba080e7          	jalr	-1350(ra) # e12 <close>
  return i;
}
    1360:	8526                	mv	a0,s1
    1362:	70a2                	ld	ra,40(sp)
    1364:	7402                	ld	s0,32(sp)
    1366:	64e2                	ld	s1,24(sp)
    1368:	6942                	ld	s2,16(sp)
    136a:	69a2                	ld	s3,8(sp)
    136c:	6a02                	ld	s4,0(sp)
    136e:	6145                	addi	sp,sp,48
    1370:	8082                	ret
      fprintf(2, "stats: open failed\n");
    1372:	00000597          	auipc	a1,0x0
    1376:	18e58593          	addi	a1,a1,398 # 1500 <digits+0x30>
    137a:	4509                	li	a0,2
    137c:	00000097          	auipc	ra,0x0
    1380:	db8080e7          	jalr	-584(ra) # 1134 <fprintf>
      exit(1);
    1384:	4505                	li	a0,1
    1386:	00000097          	auipc	ra,0x0
    138a:	a64080e7          	jalr	-1436(ra) # dea <exit>
